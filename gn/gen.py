...
def main():
    ...
    with open(os.path.join(SCRIPT_DIR, "BUILD.gn"), "w") as build_gn:
        build_gn.write("""
...
""")
    base_path = os.path.abspath(os.path.join(SCRIPT_DIR, os.pardir, os.pardir))
...
""" % (binary["bootfs_path"], binary_path))
    ...
    dotfile_path = os.path.join(base_path, "packages", "gn", ".gn")
