...
#ifndef APPS_LEDGER_CLOUD_PROVIDER_IMPL_WATCH_CLIENT_IMPL_H_
#define APPS_LEDGER_CLOUD_PROVIDER_IMPL_WATCH_CLIENT_IMPL_H_
...
#endif  // APPS_LEDGER_CLOUD_PROVIDER_IMPL_WATCH_CLIENT_IMPL_H_
