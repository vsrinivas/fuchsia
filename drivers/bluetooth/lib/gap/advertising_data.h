...
#ifndef GARNET_DRIVERS_BLUETOOTH_LIB_GAP_ADVERTISING_DATA_H_
#define GARNET_DRIVERS_BLUETOOTH_LIB_GAP_ADVERTISING_DATA_H_
...
#endif  // GARNET_DRIVERS_BLUETOOTH_LIB_GAP_ADVERTISING_DATA_H_
