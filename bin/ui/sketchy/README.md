...
* `SharedBuffer` is shared between `sketchy` and `scenic`: it wraps around an `escher::Buffer` and the corresponding `ui::gfx::Buffer`. It does NOT change size once created.
