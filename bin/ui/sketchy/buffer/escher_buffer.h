...
#ifndef GARNET_BIN_UI_SKETCHY_BUFFER_ESCHER_BUFFER_H_
#define GARNET_BIN_UI_SKETCHY_BUFFER_ESCHER_BUFFER_H_
...
class EscherBuffer {
 public:
  explicit EscherBuffer(escher::BufferFactory* factory);
 ...
 private:
  ...
  FXL_DISALLOW_COPY_AND_ASSIGN(EscherBuffer);
};

}  // namespace sketchy_service

#endif  // GARNET_BIN_UI_SKETCHY_BUFFER_ESCHER_BUFFER_H_
