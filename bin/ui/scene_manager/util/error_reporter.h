...
#ifndef GARNET_BIN_UI_SCENE_MANAGER_UTIL_ERROR_REPORTER_H_
#define GARNET_BIN_UI_SCENE_MANAGER_UTIL_ERROR_REPORTER_H_
...
#endif  // GARNET_BIN_UI_SCENE_MANAGER_UTIL_ERROR_REPORTER_H_
