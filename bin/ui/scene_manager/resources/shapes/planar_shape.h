...
#ifndef GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_SHAPES_PLANAR_SHAPE_H_
#define GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_SHAPES_PLANAR_SHAPE_H_
...
#endif  // GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_SHAPES_PLANAR_SHAPE_H_
