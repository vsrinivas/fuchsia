...
#ifndef GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_IMPORT_H_
#define GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_IMPORT_H_
...
#endif  // GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_IMPORT_H_
