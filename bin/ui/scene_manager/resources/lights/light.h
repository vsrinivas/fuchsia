...
#ifndef GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_LIGHTS_LIGHT_H_
#define GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_LIGHTS_LIGHT_H_
...
#endif  // GARNET_BIN_UI_SCENE_MANAGER_RESOURCES_LIGHTS_LIGHT_H_
