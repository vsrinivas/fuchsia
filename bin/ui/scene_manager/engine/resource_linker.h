...
#ifndef GARNET_BIN_UI_SCENE_MANAGER_ENGINE_RESOURCE_LINKER_H_
#define GARNET_BIN_UI_SCENE_MANAGER_ENGINE_RESOURCE_LINKER_H_
...
#endif  // GARNET_BIN_UI_SCENE_MANAGER_ENGINE_RESOURCE_LINKER_H_
