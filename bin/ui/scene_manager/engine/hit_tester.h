...
#ifndef GARNET_BIN_UI_SCENE_MANAGER_ENGINE_HIT_TESTER_H_
#define GARNET_BIN_UI_SCENE_MANAGER_ENGINE_HIT_TESTER_H_
...
#endif  // GARNET_BIN_UI_SCENE_MANAGER_ENGINE_HIT_TESTER_H_
