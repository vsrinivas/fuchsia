...
#ifndef GARNET_BIN_UI_ROOT_PRESENTER_DISPLAYS_DISPLAY_CONFIGURATION_H_
#define GARNET_BIN_UI_ROOT_PRESENTER_DISPLAYS_DISPLAY_CONFIGURATION_H_
...
#endif  // GARNET_BIN_UI_ROOT_PRESENTER_DISPLAYS_DISPLAY_CONFIGURATION_H_
