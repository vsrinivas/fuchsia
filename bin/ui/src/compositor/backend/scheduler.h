...
#ifndef APPS_MOZART_SRC_COMPOSITOR_BACKEND_SCHEDULER_H_
#define APPS_MOZART_SRC_COMPOSITOR_BACKEND_SCHEDULER_H_
...
#endif  // APPS_MOZART_SRC_COMPOSITOR_BACKEND_SCHEDULER_H_
