...
#ifndef APPS_MOZART_SRC_COMPOSITOR_BACKEND_FRAMEBUFFER_OUTPUT_CPU_H_
#define APPS_MOZART_SRC_COMPOSITOR_BACKEND_FRAMEBUFFER_OUTPUT_CPU_H_
...
// Uses Skia CPU backend.
class FramebufferOutputCpu : public Output {
 public:
  FramebufferOutputCpu();
  ~FramebufferOutputCpu() override;
 ...
 private:
  ...
  ftl::WeakPtrFactory<FramebufferOutputCpu> weak_ptr_factory_;

  FTL_DISALLOW_COPY_AND_ASSIGN(FramebufferOutputCpu);
};

}  // namespace compositor

#endif  // APPS_MOZART_SRC_COMPOSITOR_BACKEND_FRAMEBUFFER_OUTPUT_CPU_H_
