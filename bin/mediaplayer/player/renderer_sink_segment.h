...
#ifndef GARNET_BIN_MEDIAPLAYER_PLAYER_RENDERER_SINK_SEGMENT_H_
#define GARNET_BIN_MEDIAPLAYER_PLAYER_RENDERER_SINK_SEGMENT_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_PLAYER_RENDERER_SINK_SEGMENT_H_
