...
#ifndef GARNET_BIN_MEDIAPLAYER_PLAYER_DEMUX_SOURCE_SEGMENT_H_
#define GARNET_BIN_MEDIAPLAYER_PLAYER_DEMUX_SOURCE_SEGMENT_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_PLAYER_DEMUX_SOURCE_SEGMENT_H_
