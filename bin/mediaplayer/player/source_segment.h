...
#ifndef GARNET_BIN_MEDIAPLAYER_PLAYER_SOURCE_SEGMENT_H_
#define GARNET_BIN_MEDIAPLAYER_PLAYER_SOURCE_SEGMENT_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_PLAYER_SOURCE_SEGMENT_H_
