...
#ifndef GARNET_BIN_MEDIAPLAYER_GRAPH_TYPES_TEXT_STREAM_TYPE_H_
#define GARNET_BIN_MEDIAPLAYER_GRAPH_TYPES_TEXT_STREAM_TYPE_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_GRAPH_TYPES_TEXT_STREAM_TYPE_H_
