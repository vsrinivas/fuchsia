...
#ifndef GARNET_BIN_MEDIAPLAYER_GRAPH_MODELS_STAGE_H_
#define GARNET_BIN_MEDIAPLAYER_GRAPH_MODELS_STAGE_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_GRAPH_MODELS_STAGE_H_
