...
#ifndef GARNET_BIN_MEDIAPLAYER_GRAPH_STAGES_STAGE_IMPL_H_
#define GARNET_BIN_MEDIAPLAYER_GRAPH_STAGES_STAGE_IMPL_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_GRAPH_STAGES_STAGE_IMPL_H_
