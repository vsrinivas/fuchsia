...
#ifndef GARNET_BIN_MEDIAPLAYER_CORE_SOURCE_SEGMENT_H_
#define GARNET_BIN_MEDIAPLAYER_CORE_SOURCE_SEGMENT_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_CORE_SOURCE_SEGMENT_H_
