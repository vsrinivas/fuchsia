...
#ifndef GARNET_BIN_MEDIAPLAYER_RENDER_FIDL_AUDIO_RENDERER_H_
#define GARNET_BIN_MEDIAPLAYER_RENDER_FIDL_AUDIO_RENDERER_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_RENDER_FIDL_AUDIO_RENDERER_H_
