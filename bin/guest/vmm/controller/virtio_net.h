...
#ifndef GARNET_BIN_GUEST_VMM_CONTROLLER_VIRTIO_NET_H_
#define GARNET_BIN_GUEST_VMM_CONTROLLER_VIRTIO_NET_H_
...
#endif  // GARNET_BIN_GUEST_VMM_CONTROLLER_VIRTIO_NET_H_
