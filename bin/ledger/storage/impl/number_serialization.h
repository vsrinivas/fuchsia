...
#ifndef PERIDOT_BIN_LEDGER_STORAGE_IMPL_NUMBER_SERIALIZATION_H_
#define PERIDOT_BIN_LEDGER_STORAGE_IMPL_NUMBER_SERIALIZATION_H_
...
#endif  // PERIDOT_BIN_LEDGER_STORAGE_IMPL_NUMBER_SERIALIZATION_H_
