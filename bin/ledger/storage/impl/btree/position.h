...
#ifndef APPS_LEDGER_SRC_STORAGE_IMPL_BTREE_POSITION_H_
#define APPS_LEDGER_SRC_STORAGE_IMPL_BTREE_POSITION_H_
...
#endif  // APPS_LEDGER_SRC_STORAGE_IMPL_BTREE_POSITION_H_
