...
#ifndef APPS_LEDGER_SRC_STORAGE_PUBLIC_COMMIT_CONTENTS_H_
#define APPS_LEDGER_SRC_STORAGE_PUBLIC_COMMIT_CONTENTS_H_
...
#endif  // APPS_LEDGER_SRC_STORAGE_PUBLIC_COMMIT_CONTENTS_H_
