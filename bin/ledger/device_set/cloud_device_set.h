...
#ifndef PERIDOT_BIN_LEDGER_DEVICE_SET_CLOUD_DEVICE_SET_H_
#define PERIDOT_BIN_LEDGER_DEVICE_SET_CLOUD_DEVICE_SET_H_
...
#endif  // PERIDOT_BIN_LEDGER_DEVICE_SET_CLOUD_DEVICE_SET_H_
