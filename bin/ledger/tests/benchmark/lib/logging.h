...
#ifndef PERIDOT_BIN_LEDGER_TESTS_BENCHMARK_LIB_LOGGING_H_
#define PERIDOT_BIN_LEDGER_TESTS_BENCHMARK_LIB_LOGGING_H_
...
#endif  // PERIDOT_BIN_LEDGER_TESTS_BENCHMARK_LIB_LOGGING_H_
