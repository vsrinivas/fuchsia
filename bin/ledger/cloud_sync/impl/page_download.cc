...
void PageDownload::OnNewCommits(f1dl::Array<cloud_provider::CommitPtr> commits,
                                f1dl::Array<uint8_t> position_token,
...
void PageDownload::OnNewObject(f1dl::Array<uint8_t> /*id*/,
...
void PageDownload::DownloadBatch(f1dl::Array<cloud_provider::CommitPtr> commits,
                                 f1dl::Array<uint8_t> position_token,
                                 fxl::Closure on_done) {
  ...
  batch_download_ = std::make_unique<BatchDownload>(
      ...
      [this, on_done = std::move(on_done)] {
        ...
        commits_to_download_ = f1dl::Array<cloud_provider::CommitPtr>::New(0);
