...
#ifndef APPS_LEDGER_SRC_CLOUD_SYNC_IMPL_BASE_COORDINATOR_DELEGATE_H_
#define APPS_LEDGER_SRC_CLOUD_SYNC_IMPL_BASE_COORDINATOR_DELEGATE_H_
...
#endif  // APPS_LEDGER_SRC_CLOUD_SYNC_IMPL_BASE_COORDINATOR_DELEGATE_H_
