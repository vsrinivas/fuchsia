...
void ConflictResolverClient::GetFullDiff(f1dl::Array<uint8_t> token,
...
void ConflictResolverClient::GetDiff(
  ...
  diff_utils::ComputeThreeWayDiff(
      ...
      callback::MakeScoped(
          ...
          [this, callback](
              Status status,
              std::pair<f1dl::Array<DiffEntryPtr>, std::string> page_change) {
            if (cancelled_) {
...
void ConflictResolverClient::Merge(f1dl::Array<MergedValuePtr> merged_values,
