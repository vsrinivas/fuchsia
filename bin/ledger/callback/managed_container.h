...
#ifndef PERIDOT_BIN_LEDGER_CALLBACK_MANAGED_CONTAINER_H_
#define PERIDOT_BIN_LEDGER_CALLBACK_MANAGED_CONTAINER_H_
...
#endif  // PERIDOT_BIN_LEDGER_CALLBACK_MANAGED_CONTAINER_H_
