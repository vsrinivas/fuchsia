...
#ifndef PERIDOT_BIN_LEDGER_CALLBACK_AUTO_CLEANABLE_H_
#define PERIDOT_BIN_LEDGER_CALLBACK_AUTO_CLEANABLE_H_
...
#endif  // PERIDOT_BIN_LEDGER_CALLBACK_AUTO_CLEANABLE_H_
