...
#ifndef APPS_LEDGER_SRC_CLOUD_PROVIDER_PUBLIC_NOTIFICATION_WATCHER_H_
#define APPS_LEDGER_SRC_CLOUD_PROVIDER_PUBLIC_NOTIFICATION_WATCHER_H_
...
#endif  // APPS_LEDGER_SRC_CLOUD_PROVIDER_PUBLIC_NOTIFICATION_WATCHER_H_
