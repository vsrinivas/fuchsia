...
#ifndef APPS_LEDGER_SRC_CLOUD_PROVIDER_PUBLIC_NOTIFICATION_H_
#define APPS_LEDGER_SRC_CLOUD_PROVIDER_PUBLIC_NOTIFICATION_H_
...
#endif  // APPS_LEDGER_SRC_CLOUD_PROVIDER_PUBLIC_NOTIFICATION_H_
