...
#ifndef PERIDOT_BIN_LEDGER_CLOUD_PROVIDER_IMPL_WATCH_CLIENT_IMPL_H_
#define PERIDOT_BIN_LEDGER_CLOUD_PROVIDER_IMPL_WATCH_CLIENT_IMPL_H_
...
#endif  // PERIDOT_BIN_LEDGER_CLOUD_PROVIDER_IMPL_WATCH_CLIENT_IMPL_H_
