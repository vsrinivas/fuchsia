...
#ifndef PERIDOT_BIN_LEDGER_CLOUD_PROVIDER_IMPL_PATHS_H_
#define PERIDOT_BIN_LEDGER_CLOUD_PROVIDER_IMPL_PATHS_H_
...
#endif  // PERIDOT_BIN_LEDGER_CLOUD_PROVIDER_IMPL_PATHS_H_
