...
#ifndef APPS_MODULAR_SRC_STORY_RUNNER_PAGE_SNAPSHOT_H_
#define APPS_MODULAR_SRC_STORY_RUNNER_PAGE_SNAPSHOT_H_
...
#endif  // APPS_MODULAR_SRC_STORY_RUNNER_PAGE_SNAPSHOT_H_
