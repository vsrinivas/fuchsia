...
#ifndef APPS_MODULAR_SRC_BOOTSTRAP_DELEGATING_APPLICATION_LOADER_H_
#define APPS_MODULAR_SRC_BOOTSTRAP_DELEGATING_APPLICATION_LOADER_H_
...
#endif  // APPS_MODULAR_SRC_BOOTSTRAP_DELEGATING_APPLICATION_LOADER_H_
