...
TEST(TypeUtils, GetPointedToType_NoPointedToType) {
  // Pointer to nothing.
  auto ptr_type = fxl::MakeRefCounted<ModifiedType>(Symbol::kTagPointerType, LazySymbol());
...
TEST(TypeUtils, GetPointedToType_Good) {
  auto int32_type = fxl::MakeRefCounted<BaseType>(BaseType::kBaseTypeSigned, 4, "int32_t");
  auto ptr_type = fxl::MakeRefCounted<ModifiedType>(Symbol::kTagPointerType, LazySymbol(int32_type));
