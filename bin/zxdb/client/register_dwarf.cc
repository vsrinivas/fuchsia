...
RegisterID GetX64DWARFRegisterID(uint32_t dwarf_reg_id) {
  ...
  // Page 62
  switch (dwarf_reg_id) {
    case 0: return RegisterID::kX64_rax;
    case 1: return RegisterID::kX64_rdx;
    case 2: return RegisterID::kX64_rcx;
    case 3: return RegisterID::kX64_rbx;
    case 4: return RegisterID::kX64_rsi;
    case 5: return RegisterID::kX64_rdi;
    case 6: return RegisterID::kX64_rbp;
    case 7: return RegisterID::kX64_rsp;
    case 8:
    case 9:
    case 10:
    case 11:
    ...
    case 49: return RegisterID::kX64_rflags;
...
debug_ipc::RegisterID GetARMv8DWARFRegisterID(uint32_t dwarf_reg_id) {
  ...
  switch (dwarf_reg_id) {
    case 32: return RegisterID::kARMv8_sp;
    // 31: Reserved
