...
#ifndef GARNET_BIN_MEDIA_FRAMEWORK_MODELS_MULTISTREAM_SOURCE_H_
#define GARNET_BIN_MEDIA_FRAMEWORK_MODELS_MULTISTREAM_SOURCE_H_
...
class MultistreamSource : public Node<MultistreamSourceStage> {
 public:
  ...
  virtual media::PacketPtr PullPacket(size_t* stream_index_out) = 0;
};

}  // namespace media_player

#endif  // GARNET_BIN_MEDIA_FRAMEWORK_MODELS_MULTISTREAM_SOURCE_H_
