...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_FIDL_FIDL_DECODER_FACTORY_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_FIDL_FIDL_DECODER_FACTORY_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_FIDL_FIDL_DECODER_FACTORY_H_
