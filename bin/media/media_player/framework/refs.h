...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_FRAMEWORK_REFS_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_FRAMEWORK_REFS_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_FRAMEWORK_REFS_H_
