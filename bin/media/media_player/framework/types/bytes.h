...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_FRAMEWORK_TYPES_BYTES_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_FRAMEWORK_TYPES_BYTES_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_FRAMEWORK_TYPES_BYTES_H_
