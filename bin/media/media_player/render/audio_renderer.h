...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_RENDER_AUDIO_RENDERER_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_RENDER_AUDIO_RENDERER_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_RENDER_AUDIO_RENDERER_H_
