...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_UTIL_SAFE_CLONE_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_UTIL_SAFE_CLONE_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_UTIL_SAFE_CLONE_H_
