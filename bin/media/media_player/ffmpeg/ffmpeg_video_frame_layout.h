...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_FFMPEG_FFMPEG_VIDEO_FRAME_LAYOUT_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_FFMPEG_FFMPEG_VIDEO_FRAME_LAYOUT_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_FFMPEG_FFMPEG_VIDEO_FRAME_LAYOUT_H_
