...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_SPARSE_BYTE_BUFFER_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_SPARSE_BYTE_BUFFER_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_SPARSE_BYTE_BUFFER_H_
