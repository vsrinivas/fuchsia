...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_HTTP_READER_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_HTTP_READER_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_HTTP_READER_H_
