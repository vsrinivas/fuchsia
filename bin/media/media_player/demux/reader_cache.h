...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_READER_CACHE_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_READER_CACHE_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_DEMUX_READER_CACHE_H_
