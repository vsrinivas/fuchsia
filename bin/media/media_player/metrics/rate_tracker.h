...
#ifndef GARNET_BIN_MEDIA_MEDIA_PLAYER_METRICS_RATE_TRACKER_H_
#define GARNET_BIN_MEDIA_MEDIA_PLAYER_METRICS_RATE_TRACKER_H_
...
#endif  // GARNET_BIN_MEDIA_MEDIA_PLAYER_METRICS_RATE_TRACKER_H_
