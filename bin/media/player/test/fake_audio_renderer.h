...
#ifndef GARNET_BIN_MEDIA_PLAYER_TEST_FAKE_AUDIO_RENDERER_H_
#define GARNET_BIN_MEDIA_PLAYER_TEST_FAKE_AUDIO_RENDERER_H_
...
#endif  // GARNET_BIN_MEDIA_PLAYER_TEST_FAKE_AUDIO_RENDERER_H_
