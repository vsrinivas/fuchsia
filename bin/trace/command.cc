...
Command::Command(modular::ApplicationContext* context) : context_(context) {}

Command::~Command() = default;

modular::ApplicationContext* Command::context() {
  return context_;
}

modular::ApplicationContext* Command::context() const {
  return context_;
}
