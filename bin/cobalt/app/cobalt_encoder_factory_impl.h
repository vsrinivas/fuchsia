...
#ifndef GARNET_BIN_COBALT_APP_COBALT_ENCODER_FACTORY_IMPL_H
#define GARNET_BIN_COBALT_APP_COBALT_ENCODER_FACTORY_IMPL_H
...
#endif  // GARNET_BIN_COBALT_APP_COBALT_ENCODER_FACTORY_IMPL_H
