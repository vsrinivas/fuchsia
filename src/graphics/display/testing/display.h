...
class Display {
 public:
  ...
  ::llcpp::fuchsia::hardware::display::wire::Mode mode() const { return modes_[mode_idx_]; }
  ::llcpp::fuchsia::hardware::display::wire::CursorInfo cursor() const { return cursors_[0]; }
