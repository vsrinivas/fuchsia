...
#ifndef SRC_GRAPHICS_DISPLAY_DRIVERS_MT8167S_DISPLAY_COLOR_H_
#define SRC_GRAPHICS_DISPLAY_DRIVERS_MT8167S_DISPLAY_COLOR_H_
...
class Color {
 ...
 private:
  std::optional<ddk::MmioBuffer> color_mmio_;
...
#endif  // SRC_GRAPHICS_DISPLAY_DRIVERS_MT8167S_DISPLAY_COLOR_H_
