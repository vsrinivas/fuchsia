...
class TestDdi : public DdiPhysicalLayer {
 public:
  explicit TestDdi(tgl_registers::Ddi ddi_id) : DdiPhysicalLayer(ddi_id) {}
...
class TestDdiManager : public DdiManager {
 public:
  ...
  void AddDdi(tgl_registers::Ddi ddi_id) { ddi_map()[ddi_id] = std::make_unique<TestDdi>(ddi_id); }

  TestDdi* GetDdi(tgl_registers::Ddi ddi_id) {
...
TEST(DdiManager, GetDdiReference_Success) {
  ...
  ddi_manager.AddDdi(tgl_registers::DDI_A);
  ddi_manager.AddDdi(tgl_registers::DDI_B);

  {
    EXPECT_FALSE(ddi_manager.GetDdi(tgl_registers::DDI_A)->IsEnabled());
    DdiReference ddi_a_reference = ddi_manager.GetDdiReference(tgl_registers::DDI_A);
    EXPECT_FALSE(ddi_a_reference.IsNull());
    EXPECT_TRUE(ddi_manager.GetDdi(tgl_registers::DDI_A)->IsEnabled());
  }

  // Create and destroy multiple references to a single DDI
  {
    EXPECT_FALSE(ddi_manager.GetDdi(tgl_registers::DDI_A)->IsEnabled());
    DdiReference ddi_a_reference_1 = ddi_manager.GetDdiReference(tgl_registers::DDI_A);
    EXPECT_FALSE(ddi_a_reference_1.IsNull());
    EXPECT_TRUE(ddi_manager.GetDdi(tgl_registers::DDI_A)->IsEnabled());

    DdiReference ddi_a_reference_2 = ddi_manager.GetDdiReference(tgl_registers::DDI_A);
  ...
  // DdiReference can be move-assigned
  {
    ...
    EXPECT_FALSE(ddi_manager.GetDdi(tgl_registers::DDI_B)->IsEnabled());
    DdiReference ddi_b_reference = ddi_manager.GetDdiReference(tgl_registers::DDI_B);
    EXPECT_FALSE(ddi_b_reference.IsNull());
    EXPECT_TRUE(ddi_manager.GetDdi(tgl_registers::DDI_B)->IsEnabled());
...
TEST(DdiManager, GetDdiReference_Failure_UnsupportedDdi) {
  ...
  EXPECT_DEATH(ddi_manager.GetDdiReference(tgl_registers::DDI_TC_1), "DDI .+ is not available");
}
...
TEST(DdiManager, GetDdiReference_Failure_DdiCannotEnable) {
  ...
  ddi_manager.GetDdi(tgl_registers::DDI_A)->SetCanEnable(false);
  auto ddi_reference = ddi_manager.GetDdiReference(tgl_registers::DDI_A);
...
TEST(DdiManagerTigerLake, ParseVbtTable_Dell5420) {
  ...
  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_A, true);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_A, true);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_A, false);

  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_B, false);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_B, false);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_B, false);

  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_TC_1, false);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_TC_1, true);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_TC_1, true);

  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_TC_2, false);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_TC_2, true);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_TC_2, true);
  ...
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_A), ddi_map.end());
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_B), ddi_map.end());
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_TC_1), ddi_map.end());
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_TC_2), ddi_map.end());

  // Verify DDI physical layer information.
  auto ddi_a_info = ddi_map.at(tgl_registers::DDI_A)->GetPhysicalLayerInfo();
  ...
  auto ddi_b_info = ddi_map.at(tgl_registers::DDI_B)->GetPhysicalLayerInfo();
  ...
  auto ddi_tc_1_info = ddi_map.at(tgl_registers::DDI_TC_1)->GetPhysicalLayerInfo();
  ...
  auto ddi_tc_2_info = ddi_map.at(tgl_registers::DDI_TC_2)->GetPhysicalLayerInfo();
...
TEST(DdiManagerTigerLake, ParseVbtTable_NUC11PAHi5) {
  ...
  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_TC_3, false);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_TC_3, false);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_TC_3, false);

  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_TC_4, false);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_TC_4, true);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_TC_4, false);

  test_igd_opregion.SetIsEdpForTesting(tgl_registers::DDI_TC_6, false);
  test_igd_opregion.SetSupportsDpForTesting(tgl_registers::DDI_TC_6, true);
  test_igd_opregion.SetIsTypeCForTesting(tgl_registers::DDI_TC_6, true);
  ...
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_TC_1), ddi_map.end());
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_TC_3), ddi_map.end());
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_TC_4), ddi_map.end());
  EXPECT_NE(ddi_map.find(tgl_registers::DDI_TC_6), ddi_map.end());
  ...
  auto ddi_tc_3_info = ddi_map.at(tgl_registers::DDI_TC_3)->GetPhysicalLayerInfo();
  ...
  auto ddi_tc_4_info = ddi_map.at(tgl_registers::DDI_TC_4)->GetPhysicalLayerInfo();
  ...
  auto ddi_tc_6_info = ddi_map.at(tgl_registers::DDI_TC_6)->GetPhysicalLayerInfo();
