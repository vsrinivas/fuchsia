...
zx_status_t InitInterrupts(i915::Interrupts* i, zx_device_t* dev, ddk::Pci& pci,
                           fdf::MmioBuffer* mmio) {
  return i->Init(NopPipeVsyncCb, NopHotplugCb, dev, pci, mmio, i915::GetDdis(i915::kTestDeviceDid));
}
