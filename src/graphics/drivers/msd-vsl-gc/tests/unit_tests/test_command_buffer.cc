...
void TestCommandBuffer::CreateAndPrepareBatch(
    std::shared_ptr<MsdVslContext> context, std::shared_ptr<MsdVslBuffer> buffer,
...
void TestCommandBuffer::WriteEventCommand(
    std::unique_ptr<MsdVslDevice>& device, std::shared_ptr<MsdVslContext> context,
    std::shared_ptr<MsdVslBuffer> buf, uint32_t offset,
