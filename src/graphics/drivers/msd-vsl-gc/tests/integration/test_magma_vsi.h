...
#ifndef SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_TESTS_INTEGRATION_TEST_MAGMA_VSI_H_
#define SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_TESTS_INTEGRATION_TEST_MAGMA_VSI_H_
...
#endif  // SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_TESTS_INTEGRATION_TEST_MAGMA_VSI_H_
