...
#ifndef SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_GPU_FEATURES_H_
#define SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_GPU_FEATURES_H_
...
#endif  // SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_GPU_FEATURES_H_
