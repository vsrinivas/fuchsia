...
#ifndef SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_SEQUENCER_H_
#define SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_SEQUENCER_H_
...
#endif  // SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_SEQUENCER_H_
