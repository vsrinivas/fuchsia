...
#ifndef SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_PAGE_TABLE_SLOT_ALLOCATOR_H_
#define SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_PAGE_TABLE_SLOT_ALLOCATOR_H_
...
#endif  // SRC_GRAPHICS_DRIVERS_MSD_VSL_GC_SRC_PAGE_TABLE_SLOT_ALLOCATOR_H_
