...
#include "spinel_device_config_utils.h"
...
{
  vk_spinel_device_configuration_t * spinel_config = (vk_spinel_device_configuration_t *)opaque;
  ...
  // Now, grab the target requirements and copy them to |device_config|.
  ...
  device_config->features = (const VkPhysicalDeviceFeatures){};
