...
#ifndef SRC_GRAPHICS_LIB_COMPUTE_TESTS_COMMON_VK_DEVICE_SURFACE_INFO_H_
#define SRC_GRAPHICS_LIB_COMPUTE_TESTS_COMMON_VK_DEVICE_SURFACE_INFO_H_
...
#endif  // SRC_GRAPHICS_LIB_COMPUTE_TESTS_COMMON_VK_DEVICE_SURFACE_INFO_H_
