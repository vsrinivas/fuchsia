...
//
static float
spinel_angle_x(float const x, float const y)
{
               ...
               spinel_arc_params_t * arc_params)
{
  ...
  *arc_params = (spinel_arc_params_t){ .x0 = x0,  //
                                       .y0 = y0,
                                       .x1 = x1,
                                       .y1 = y1,
                                       .rx = rx,
  ...
  arc_params->theta       = spinel_angle_x(v0x, v0y);
  arc_params->theta_delta = spinel_angle_x(v1x, v1y) - arc_params->theta;
