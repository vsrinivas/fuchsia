...
#define SPN_VK_P_ID_RASTERIZE_PROJ_CUBIC rasterize_proj_cubic
#define SPN_VK_P_ID_RASTERIZE_PROJ_LINE  rasterize_proj_line
#define SPN_VK_P_ID_RASTERIZE_PROJ_QUAD  rasterize_proj_quad
...
#define SPN_VK_P_EXPAND()                                                                                \
  ...
  SPN_VK_P_EXPAND_X(12,SPN_VK_P_ID_RASTERIZE_PROJ_CUBIC ,SPN_VK_HOST_DECL_KERNEL_RASTERIZE_PROJ_CUBIC()) \
  SPN_VK_P_EXPAND_X(13,SPN_VK_P_ID_RASTERIZE_PROJ_LINE  ,SPN_VK_HOST_DECL_KERNEL_RASTERIZE_PROJ_LINE())  \
  SPN_VK_P_EXPAND_X(14,SPN_VK_P_ID_RASTERIZE_PROJ_QUAD  ,SPN_VK_HOST_DECL_KERNEL_RASTERIZE_PROJ_QUAD())  \
  SPN_VK_P_EXPAND_X(15,SPN_VK_P_ID_RASTERIZE_QUAD       ,SPN_VK_HOST_DECL_KERNEL_RASTERIZE_QUAD())       \
  SPN_VK_P_EXPAND_X(16,SPN_VK_P_ID_RASTERIZE_RAT_CUBIC  ,SPN_VK_HOST_DECL_KERNEL_RASTERIZE_RAT_CUBIC())  \
  SPN_VK_P_EXPAND_X(17,SPN_VK_P_ID_RASTERIZE_RAT_QUAD   ,SPN_VK_HOST_DECL_KERNEL_RASTERIZE_RAT_QUAD())   \
  SPN_VK_P_EXPAND_X(18,SPN_VK_P_ID_RASTERS_ALLOC        ,SPN_VK_HOST_DECL_KERNEL_RASTERS_ALLOC())        \
  SPN_VK_P_EXPAND_X(19,SPN_VK_P_ID_RASTERS_PREFIX       ,SPN_VK_HOST_DECL_KERNEL_RASTERS_PREFIX())       \
  SPN_VK_P_EXPAND_X(20,SPN_VK_P_ID_RASTERS_RECLAIM      ,SPN_VK_HOST_DECL_KERNEL_RASTERS_RECLAIM())      \
  SPN_VK_P_EXPAND_X(21,SPN_VK_P_ID_RENDER               ,SPN_VK_HOST_DECL_KERNEL_RENDER())               \
  SPN_VK_P_EXPAND_X(22,SPN_VK_P_ID_SEGMENT_TTCK         ,SPN_VK_HOST_DECL_KERNEL_SEGMENT_TTCK())         \
  SPN_VK_P_EXPAND_X(23,SPN_VK_P_ID_SEGMENT_TTRK         ,SPN_VK_HOST_DECL_KERNEL_SEGMENT_TTRK())

#define SPN_VK_P_COUNT  24  // this is validated with a static assert
...
//
// KERNEL: RASTERIZE_PROJ_CUBIC
//

#define SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_PROJ_CUBIC()    \
  SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_VK_GLSL_DECL_KERNEL_RASTERIZE_PROJ_CUBIC()    \
  SPN_VK_GLSL_DECL_KERNEL_RASTERIZE_XXX()

#define SPN_VK_HOST_DECL_KERNEL_RASTERIZE_PROJ_CUBIC()                                            \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_CUBIC,0,SPN_VK_DS_ID_BLOCK_POOL)                      \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_CUBIC,1,SPN_VK_DS_ID_RASTERIZE)                       \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_CUBIC,2,SPN_VK_DS_ID_TTRKS)                           \
  SPN_VK_HOST_PUSH(SPN_VK_P_ID_RASTERIZE_PROJ_CUBIC,SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_PROJ_CUBIC())

//
// KERNEL: RASTERIZE_PROJ_LINE
//

#define SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_PROJ_LINE()    \
  SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_VK_GLSL_DECL_KERNEL_RASTERIZE_PROJ_LINE()    \
  SPN_VK_GLSL_DECL_KERNEL_RASTERIZE_XXX()

#define SPN_VK_HOST_DECL_KERNEL_RASTERIZE_PROJ_LINE()                                            \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_LINE,0,SPN_VK_DS_ID_BLOCK_POOL)                      \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_LINE,1,SPN_VK_DS_ID_RASTERIZE)                       \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_LINE,2,SPN_VK_DS_ID_TTRKS)                           \
  SPN_VK_HOST_PUSH(SPN_VK_P_ID_RASTERIZE_PROJ_LINE,SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_PROJ_LINE())

//
// KERNEL: RASTERIZE_PROJ_QUAD
//

#define SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_PROJ_QUAD()    \
  SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_VK_GLSL_DECL_KERNEL_RASTERIZE_PROJ_QUAD()    \
  SPN_VK_GLSL_DECL_KERNEL_RASTERIZE_XXX()

#define SPN_VK_HOST_DECL_KERNEL_RASTERIZE_PROJ_QUAD()                                            \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_QUAD,0,SPN_VK_DS_ID_BLOCK_POOL)                      \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_QUAD,1,SPN_VK_DS_ID_RASTERIZE)                       \
  SPN_VK_HOST_DS(SPN_VK_P_ID_RASTERIZE_PROJ_QUAD,2,SPN_VK_DS_ID_TTRKS)                           \
  SPN_VK_HOST_PUSH(SPN_VK_P_ID_RASTERIZE_PROJ_QUAD,SPN_VK_GLSL_PUSH_KERNEL_RASTERIZE_PROJ_QUAD())
