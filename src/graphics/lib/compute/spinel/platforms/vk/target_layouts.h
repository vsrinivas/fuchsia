...
// PIPELINE EXPANSION
//
// NOTE: Pipelines are in alphabetical order -- at least for now
//
// NOTE: Some kernels don't have push constants:
//

#define SPN_TARGET_P_ID_BLOCK_POOL_INIT     block_pool_init
#define SPN_TARGET_P_ID_FILLS_DISPATCH      fills_dispatch
#define SPN_TARGET_P_ID_FILLS_EXPAND        fills_expand
#define SPN_TARGET_P_ID_FILLS_SCAN          fills_scan
#define SPN_TARGET_P_ID_PATHS_ALLOC         paths_alloc
#define SPN_TARGET_P_ID_PATHS_COPY          paths_copy
#define SPN_TARGET_P_ID_PATHS_RECLAIM       paths_reclaim
#define SPN_TARGET_P_ID_PLACE               place
#define SPN_TARGET_P_ID_RASTERIZE_CUBIC     rasterize_cubic
#define SPN_TARGET_P_ID_RASTERIZE_LINE      rasterize_line
#define SPN_TARGET_P_ID_RASTERIZE_QUAD      rasterize_quad
#define SPN_TARGET_P_ID_RASTERIZE_RAT_CUBIC rasterize_rat_cubic
#define SPN_TARGET_P_ID_RASTERIZE_RAT_QUAD  rasterize_rat_quad
#define SPN_TARGET_P_ID_RASTERS_ALLOC       rasters_alloc
#define SPN_TARGET_P_ID_RASTERS_PREFIX      rasters_prefix
#define SPN_TARGET_P_ID_RASTERS_RECLAIM     rasters_reclaim
#define SPN_TARGET_P_ID_RENDER              render
#define SPN_TARGET_P_ID_SEGMENT_TTCK        segment_ttck
#define SPN_TARGET_P_ID_SEGMENT_TTRK        segment_ttrk

#define SPN_TARGET_P_EXPAND()                                                                                   \
  SPN_TARGET_P_EXPAND_X(0 ,SPN_TARGET_P_ID_BLOCK_POOL_INIT    ,SPN_TARGET_VK_DECL_KERNEL_BLOCK_POOL_INIT())     \
  SPN_TARGET_P_EXPAND_X(1 ,SPN_TARGET_P_ID_FILLS_DISPATCH     ,SPN_TARGET_VK_DECL_KERNEL_FILLS_DISPATCH())      \
  SPN_TARGET_P_EXPAND_X(2 ,SPN_TARGET_P_ID_FILLS_EXPAND       ,SPN_TARGET_VK_DECL_KERNEL_FILLS_EXPAND())        \
  SPN_TARGET_P_EXPAND_X(3 ,SPN_TARGET_P_ID_FILLS_SCAN         ,SPN_TARGET_VK_DECL_KERNEL_FILLS_SCAN())          \
  SPN_TARGET_P_EXPAND_X(4 ,SPN_TARGET_P_ID_PATHS_ALLOC        ,SPN_TARGET_VK_DECL_KERNEL_PATHS_ALLOC())         \
  SPN_TARGET_P_EXPAND_X(5 ,SPN_TARGET_P_ID_PATHS_COPY         ,SPN_TARGET_VK_DECL_KERNEL_PATHS_COPY())          \
  SPN_TARGET_P_EXPAND_X(6 ,SPN_TARGET_P_ID_PATHS_RECLAIM      ,SPN_TARGET_VK_DECL_KERNEL_PATHS_RECLAIM())       \
  SPN_TARGET_P_EXPAND_X(7 ,SPN_TARGET_P_ID_PLACE              ,SPN_TARGET_VK_DECL_KERNEL_PLACE())               \
  SPN_TARGET_P_EXPAND_X(8 ,SPN_TARGET_P_ID_RASTERIZE_CUBIC    ,SPN_TARGET_VK_DECL_KERNEL_RASTERIZE_CUBIC())     \
  SPN_TARGET_P_EXPAND_X(9 ,SPN_TARGET_P_ID_RASTERIZE_LINE     ,SPN_TARGET_VK_DECL_KERNEL_RASTERIZE_LINE())      \
  SPN_TARGET_P_EXPAND_X(10,SPN_TARGET_P_ID_RASTERIZE_QUAD     ,SPN_TARGET_VK_DECL_KERNEL_RASTERIZE_QUAD())      \
  SPN_TARGET_P_EXPAND_X(11,SPN_TARGET_P_ID_RASTERIZE_RAT_CUBIC,SPN_TARGET_VK_DECL_KERNEL_RASTERIZE_RAT_CUBIC()) \
  SPN_TARGET_P_EXPAND_X(12,SPN_TARGET_P_ID_RASTERIZE_RAT_QUAD ,SPN_TARGET_VK_DECL_KERNEL_RASTERIZE_RAT_QUAD())  \
  SPN_TARGET_P_EXPAND_X(13,SPN_TARGET_P_ID_RASTERS_ALLOC      ,SPN_TARGET_VK_DECL_KERNEL_RASTERS_ALLOC())       \
  SPN_TARGET_P_EXPAND_X(14,SPN_TARGET_P_ID_RASTERS_PREFIX     ,SPN_TARGET_VK_DECL_KERNEL_RASTERS_PREFIX())      \
  SPN_TARGET_P_EXPAND_X(15,SPN_TARGET_P_ID_RASTERS_RECLAIM    ,SPN_TARGET_VK_DECL_KERNEL_RASTERS_RECLAIM())     \
  SPN_TARGET_P_EXPAND_X(16,SPN_TARGET_P_ID_RENDER             ,SPN_TARGET_VK_DECL_KERNEL_RENDER())              \
  SPN_TARGET_P_EXPAND_X(17,SPN_TARGET_P_ID_SEGMENT_TTCK       ,SPN_TARGET_VK_DECL_KERNEL_SEGMENT_TTCK())        \
  SPN_TARGET_P_EXPAND_X(18,SPN_TARGET_P_ID_SEGMENT_TTRK       ,SPN_TARGET_VK_DECL_KERNEL_SEGMENT_TTRK())

#define SPN_TARGET_P_COUNT  19  // this is validated elsewhere
...
#define SPN_TARGET_DS_ID_BLOCK_POOL     block_pool
#define SPN_TARGET_DS_ID_PATHS_COPY     paths_copy
...
#define SPN_TARGET_GLSL_DS_EXPAND()                                                                     \
  SPN_TARGET_GLSL_DS_BLOCK_POOL    (SPN_EMPTY,SPN_EMPTY,SPN_EMPTY,SPN_EMPTY,SPN_EMPTY);                 \
...
#define SPN_TARGET_DS_EXPAND()                                                                  \
  SPN_TARGET_DS_EXPAND_X(0 ,SPN_TARGET_DS_ID_BLOCK_POOL,    SPN_TARGET_DS_BLOCK_POOL())         \
  SPN_TARGET_DS_EXPAND_X(1 ,SPN_TARGET_DS_ID_PATHS_COPY,    SPN_TARGET_DS_PATHS_COPY())         \
...
#define SPN_TARGET_DS_COUNT  8 // this is validated elsewhere
...
#define SPN_TARGET_ALLOC_PERM_BIT  (1u<<31)
#define SPN_TARGET_ALLOC_TEMP_BIT  (1u<<30)

// (SPN_TARGET_TEMP | copy to DEVICE_LOCAL)         or
// (SPN_TARGET_PERM | HOST_VISIBLE | HOST_COHERENT) or
// (SPN_TARGET_PERM | DEVICE_LOCAL | HOST_VISIBLE | HOST_COHERENT)
...
#if 0
#define SPN_TARGET_EXTENT_PDRW
#define SPN_TARGET_EXTENT_TDRW
#define SPN_TARGET_EXTENT_PHWN_PDRN
#define SPN_TARGET_EXTENT_PHW1G_TDR1S
#define SPN_TARGET_EXTENT_PHW1G_TDRNS
#define SPN_TARGET_EXTENT_IMAGE
#endif
...
#define SPN_TARGET_BINDING_BP_IDS         0
#define SPN_TARGET_BINDING_BP_BLOCKS      1
#define SPN_TARGET_BINDING_BP_HOST_MAP    2

#define SPN_TARGET_DS_BLOCK_POOL()                                                                                                            \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL, SPN_TARGET_BINDING_BP_IDS,      SPN_TARGET_EXTENT_PDRW, bp_ids)            \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL, SPN_TARGET_BINDING_BP_BLOCKS,   SPN_TARGET_EXTENT_PDRW, bp_blocks)         \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL, SPN_TARGET_BINDING_BP_HOST_MAP, SPN_TARGET_EXTENT_PDRW, bp_host_map)

#define SPN_TARGET_GLSL_DS_BLOCK_POOL(idx,mq_atomics,mq_ids,mq_blocks,mq_host_map)      \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL,idx,                        \
                                SPN_TARGET_BINDING_BP_IDS,bp_ids) {                     \
    mq_atomics  SPN_MEMBER_FARRAY_UINT(bp_atomics,2);                                   \
    SPN_TARGET_GLSL_ALIGN()                                                             \
    mq_ids      SPN_MEMBER_VARRAY_UINT(bp_ids);                                         \
  };                                                                                    \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL,idx,                        \
                                SPN_TARGET_BINDING_BP_BLOCKS,bp_blocks) {               \
    mq_blocks   SPN_MEMBER_VARRAY_UINT(bp_blocks);                                      \
  };                                                                                    \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL,idx,                        \
                                SPN_TARGET_BINDING_BP_BLOCKS,bp_blocks_uvec4) {         \
    mq_blocks   SPN_MEMBER_VARRAY_UVEC4(bp_blocks_uvec4);                               \
  };                                                                                    \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_BLOCK_POOL,idx,                        \
                                SPN_TARGET_BINDING_BP_HOST_MAP,bp_host_map) {           \
...
#define SPN_TARGET_BINDING_PC_ALLOC       0
#define SPN_TARGET_BINDING_PC_RING        1

#define SPN_TARGET_DS_PATHS_COPY()                                                                                                            \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_PATHS_COPY, SPN_TARGET_BINDING_PC_ALLOC, SPN_TARGET_EXTENT_PDRW,        pc_alloc)      \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_PATHS_COPY, SPN_TARGET_BINDING_PC_RING,  SPN_TARGET_EXTENT_PHW1G_TDR1S, pc_ring)

#define SPN_TARGET_GLSL_DS_PATHS_COPY(idx,mq_alloc,mq_cmds,mq_blocks)   \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_PATHS_COPY,idx,        \
                                SPN_TARGET_BINDING_PC_ALLOC,pc_alloc) { \
    mq_alloc  SPN_MEMBER_VARRAY_UINT(pc_alloc);                         \
  };                                                                    \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_PATHS_COPY,idx,        \
                                SPN_TARGET_BINDING_PC_RING,pc_ring) {   \
...
#define SPN_TARGET_BINDING_FILL_CMDS      0
#define SPN_TARGET_BINDING_FILL_QUADS     1
#define SPN_TARGET_BINDING_FILL_SCAN      2
#define SPN_TARGET_BINDING_RAST_CMDS      3

#define SPN_TARGET_DS_RASTERIZE()                                                                                                             \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_RASTERIZE, SPN_TARGET_BINDING_FILL_CMDS,  SPN_TARGET_EXTENT_PHW1G_TDRNS, fill_cmds)    \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_RASTERIZE, SPN_TARGET_BINDING_FILL_QUADS, SPN_TARGET_EXTENT_PHW1G_TDRNS, fill_quads)   \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_RASTERIZE, SPN_TARGET_BINDING_FILL_SCAN,  SPN_TARGET_EXTENT_TDRW,        fill_scan)    \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_RASTERIZE, SPN_TARGET_BINDING_RAST_CMDS,  SPN_TARGET_EXTENT_TDRW,        rast_cmds)

#define SPN_TARGET_GLSL_DS_RASTERIZE(idx,                                                               \
                                     mq_fill_cmds,mq_fill_quads,                                        \
                                     mq_fill_scan_counts,mq_fill_scan_prefix,                           \
                                     mq_rast_cmds)                                                      \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_RASTERIZE,idx,                                         \
                                SPN_TARGET_BINDING_FILL_CMDS,fill_cmds) {                               \
    mq_fill_cmds        SPN_MEMBER_VARRAY_UVEC4(fill_cmds);                                             \
  };                                                                                                    \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_RASTERIZE,idx,                                         \
                                SPN_TARGET_BINDING_FILL_QUADS,fill_quads) {                             \
    mq_fill_quads       SPN_MEMBER_VARRAY_VEC4(fill_quads);                                             \
  };                                                                                                    \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_RASTERIZE,idx,                                         \
                                SPN_TARGET_BINDING_FILL_SCAN,fill_scan) {                               \
  ...
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_RASTERIZE,idx,                                         \
                                SPN_TARGET_BINDING_RAST_CMDS,rast_cmds) {                               \
...
#define SPN_TARGET_BINDING_TTRKS          0

#define SPN_TARGET_DS_RASTERIZE_POST()                                                                                          \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_RASTERIZE_POST, SPN_TARGET_BINDING_TTRKS, SPN_TARGET_EXTENT_TDRW, ttrks)

#define SPN_TARGET_GLSL_DS_RASTERIZE_POST(idx,mq_ttrks_meta,mq_ttrks_count,mq_ttrks_keys)       \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_RASTERIZE_POST,idx,                            \
                                SPN_TARGET_BINDING_TTRKS,ttrks) {                               \
...
#define SPN_TARGET_BINDING_STYLING        0

#define SPN_TARGET_DS_STYLING()                                                                                                         \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_STYLING, SPN_TARGET_BINDING_STYLING, SPN_TARGET_EXTENT_PHWN_PDRN, styling)

#define SPN_TARGET_GLSL_DS_STYLING(idx,mq_styling)                      \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_STYLING,idx,           \
                                SPN_TARGET_BINDING_STYLING,styling)  {  \
...
#define SPN_TARGET_BINDING_SURFACE        0 // STORAGE_IMAGE

#ifdef SPN_KERNEL_RENDER_SURFACE_IS_IMAGE

#define SPN_TARGET_DS_SURFACE()                                                                                                 \
  SPN_TARGET_DESC_TYPE_STORAGE_IMAGE(SPN_TARGET_DS_ID_SURFACE, SPN_TARGET_BINDING_SURFACE, SPN_TARGET_EXTENT_IMAGE, surface)

#define SPN_TARGET_GLSL_DS_SURFACE(idx,mq_surface,surface_type) \
  SPN_TARGET_GLSL_LAYOUT_IMAGE2D(SPN_TARGET_DS_ID_SURFACE,idx,  \
                                 SPN_TARGET_BINDING_SURFACE,    \
                                 surface_type,surface);
#else

#define SPN_TARGET_DS_SURFACE()                                                                                                 \
  SPN_TARGET_DESC_TYPE_STORAGE_BUFFER(SPN_TARGET_DS_ID_SURFACE, SPN_TARGET_BINDING_SURFACE, SPN_TARGET_EXTENT_PDRW, surface)

#define SPN_TARGET_GLSL_DS_SURFACE(idx,mq_surface,surface_type) \
  SPN_TARGET_GLSL_LAYOUT_BUFFER(SPN_TARGET_DS_ID_SURFACE,idx,   \
                                SPN_TARGET_BINDING_SURFACE,     \
                                surface) {                      \
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_BLOCK_POOL_INIT()   \
  SPN_TARGET_PUSH_UINT(bp_size)

#define SPN_TARGET_GLSL_DECL_KERNEL_BLOCK_POOL_INIT()                                   \
  SPN_TARGET_GLSL_DS_BLOCK_POOL(0,SPN_TARGET_GLSL_MQ_RW,writeonly,writeonly,writeonly); \
  SPN_TARGET_GLSL_PUSH(SPN_TARGET_GLSL_PUSH_KERNEL_BLOCK_POOL_INIT());

#define SPN_TARGET_VK_DECL_KERNEL_BLOCK_POOL_INIT()                                \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_BLOCK_POOL_INIT,0,SPN_TARGET_DS_ID_BLOCK_POOL)  \
  SPN_TARGET_VK_PUSH(SPN_TARGET_P_ID_BLOCK_POOL_INIT,SPN_TARGET_GLSL_PUSH_KERNEL_BLOCK_POOL_INIT())
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_ALLOC()     \
  SPN_TARGET_PUSH_UINT(bp_mask)                       \
  SPN_TARGET_PUSH_UINT(pc_alloc_idx)                  \
  SPN_TARGET_PUSH_UINT(pc_span)

#define SPN_TARGET_GLSL_DECL_KERNEL_PATHS_ALLOC()                               \
  SPN_TARGET_GLSL_DS_BLOCK_POOL(0,readwrite,readonly,writeonly,writeonly);      \
  SPN_TARGET_GLSL_DS_PATHS_COPY(1,writeonly,noaccess,noaccess);                 \
  SPN_TARGET_GLSL_PUSH(SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_ALLOC());

#define SPN_TARGET_VK_DECL_KERNEL_PATHS_ALLOC()                                                  \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_PATHS_ALLOC,0,SPN_TARGET_DS_ID_BLOCK_POOL)                    \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_PATHS_ALLOC,1,SPN_TARGET_DS_ID_PATHS_COPY)                    \
  SPN_TARGET_VK_PUSH(SPN_TARGET_P_ID_PATHS_ALLOC,SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_ALLOC())

//
// KERNEL: PATHS COPY
//

#define SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_COPY()    \
  SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_ALLOC()         \
  SPN_TARGET_PUSH_UINT(pc_head)                     \
  SPN_TARGET_PUSH_UINT(pc_rolling)                  \
  SPN_TARGET_PUSH_UINT(pc_size)

#define SPN_TARGET_GLSL_DECL_KERNEL_PATHS_COPY()                              \
  SPN_TARGET_GLSL_DS_BLOCK_POOL(0,readonly,readonly,writeonly,writeonly);     \
  SPN_TARGET_GLSL_DS_PATHS_COPY(1,readonly,readonly,readonly);                \
  SPN_TARGET_GLSL_PUSH(SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_COPY());

#define SPN_TARGET_VK_DECL_KERNEL_PATHS_COPY()                                                \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_PATHS_COPY,0,SPN_TARGET_DS_ID_BLOCK_POOL)                  \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_PATHS_COPY,1,SPN_TARGET_DS_ID_PATHS_COPY)                  \
  SPN_TARGET_VK_PUSH(SPN_TARGET_P_ID_PATHS_COPY,SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_COPY())

//
// KERNEL: FILLS SCAN
//

#define SPN_TARGET_GLSL_PUSH_KERNEL_FILLS_SCAN()      \
  SPN_TARGET_PUSH_UINT(bp_mask)                       \
  SPN_TARGET_PUSH_UINT(cmd_count)
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_FILLS_EXPAND()      \
...
#define SPN_TARGET_GLSL_DECL_KERNEL_FILLS_EXPAND()                      \
  ...
  SPN_TARGET_GLSL_DS_RASTERIZE(2,                                       \
                               ...
                               readonly,readonly,                       \
                               writeonly);                              \
  SPN_TARGET_GLSL_PUSH(SPN_TARGET_GLSL_PUSH_KERNEL_FILLS_EXPAND());
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_XXX()    \
  SPN_TARGET_GLSL_PUSH_KERNEL_FILLS_SCAN()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_LINE()    \
  SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_LINE()    \
  SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_XXX()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_CUBIC()   \
  SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_CUBIC()   \
  SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_XXX()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_QUAD()    \
  SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_QUAD()    \
  SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_XXX()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_RAT_CUBIC()       \
  SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_RAT_CUBIC()       \
  SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_XXX()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_RAT_QUAD()        \
  SPN_TARGET_GLSL_PUSH_KERNEL_RASTERIZE_XXX()

#define SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_RAT_QUAD()        \
  SPN_TARGET_GLSL_DECL_KERNEL_RASTERIZE_XXX()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_SEGMENT_TTRK()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERS_ALLOC()     \
  SPN_TARGET_PUSH_UINT(bp_mask)                         \
  SPN_TARGET_PUSH_UINT(cmd_count)
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_RASTERS_PREFIX()    \
  SPN_TARGET_GLSL_PUSH_KERNEL_RASTERS_ALLOC()
...
#define SPN_TARGET_GLSL_PUSH_KERNEL_PLACE()     \
  SPN_TARGET_PUSH_IVEC4(place_clip)
...
#define SPN_TARGET_VK_DECL_KERNEL_RENDER()                                   \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_RENDER,0,SPN_TARGET_DS_ID_BLOCK_POOL)     \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_RENDER,1,SPN_TARGET_DS_ID_TTCKS)          \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_RENDER,2,SPN_TARGET_DS_ID_STYLING)        \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_RENDER,3,SPN_TARGET_DS_ID_SURFACE)        \
  SPN_TARGET_VK_PUSH(SPN_TARGET_P_ID_RENDER,SPN_TARGET_GLSL_PUSH_KERNEL_RENDER())
...
#define SPN_TARGET_GLSL_DECL_KERNEL_PATHS_RECLAIM()                           \
  ...
  SPN_TARGET_GLSL_PUSH(SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_RECLAIM());

#define SPN_TARGET_VK_DECL_KERNEL_PATHS_RECLAIM()                                  \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_PATHS_RECLAIM,0,SPN_TARGET_DS_ID_BLOCK_POOL)    \
  SPN_TARGET_VK_PUSH(SPN_TARGET_P_ID_PATHS_RECLAIM,SPN_TARGET_GLSL_PUSH_KERNEL_PATHS_RECLAIM())
...
#define SPN_TARGET_GLSL_DECL_KERNEL_RASTERS_RECLAIM()                         \
  SPN_TARGET_GLSL_DS_BLOCK_POOL(0,readwrite,readwrite,readonly,readonly);     \
  SPN_TARGET_GLSL_PUSH(SPN_TARGET_GLSL_PUSH_KERNEL_RASTERS_RECLAIM());

#define SPN_TARGET_VK_DECL_KERNEL_RASTERS_RECLAIM()                                \
  SPN_TARGET_VK_DS(SPN_TARGET_P_ID_RASTERS_RECLAIM,0,SPN_TARGET_DS_ID_BLOCK_POOL)  \
