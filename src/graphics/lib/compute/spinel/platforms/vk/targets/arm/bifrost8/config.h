...
#ifndef SRC_GRAPHICS_LIB_COMPUTE_SPINEL_PLATFORMS_VK_TARGETS_ARM_BIFROST8_CONFIG_H_
#define SRC_GRAPHICS_LIB_COMPUTE_SPINEL_PLATFORMS_VK_TARGETS_ARM_BIFROST8_CONFIG_H_
...
#define SPN_KERNEL_PLACE_BLOCK_EXPAND_SIZE                                                         \
  ((SPN_BLOCK_POOL_BLOCK_DWORDS / 2) / SPN_KERNEL_PLACE_SUBGROUP_SIZE)
...
#define SPN_KERNEL_PATHS_RECLAIM_EXPAND_SIZE                                                       \
  (SPN_BLOCK_POOL_BLOCK_DWORDS / SPN_KERNEL_PATHS_RECLAIM_SUBGROUP_SIZE)
...
#define SPN_KERNEL_RASTERS_RECLAIM_EXPAND_SIZE                                                     \
  (SPN_BLOCK_POOL_BLOCK_DWORDS / SPN_KERNEL_RASTERS_RECLAIM_SUBGROUP_SIZE / 2)

//
//
//

#endif  // SRC_GRAPHICS_LIB_COMPUTE_SPINEL_PLATFORMS_VK_TARGETS_ARM_BIFROST8_CONFIG_H_
