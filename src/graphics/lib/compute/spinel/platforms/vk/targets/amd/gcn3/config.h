...
#ifndef SRC_GRAPHICS_LIB_COMPUTE_SPINEL_PLATFORMS_VK_TARGETS_AMD_GCN3_CONFIG_H_
#define SRC_GRAPHICS_LIB_COMPUTE_SPINEL_PLATFORMS_VK_TARGETS_AMD_GCN3_CONFIG_H_
...
#define SPN_KERNEL_RENDER_TILE_CHANNEL_IS_FP16                    // GCN3/4 support single rate fp16
...
#endif  // SRC_GRAPHICS_LIB_COMPUTE_SPINEL_PLATFORMS_VK_TARGETS_AMD_GCN3_CONFIG_H_
