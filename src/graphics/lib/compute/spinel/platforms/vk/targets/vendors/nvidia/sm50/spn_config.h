...
#define SPN_ENABLE_EXTENSION_SUBGROUP_UNIFORM
...
#define SPN_TILE_WIDTH_LOG2                                       4
#define SPN_TILE_HEIGHT_LOG2                                      4
...
// #define SPN_KERNEL_RENDER_TILE_CHANNEL_IS_FP16   // compute capability: 5.3, 6.0, 6.2, 7.x
// #define SPN_KERNEL_RENDER_TILE_CHANNEL_IS_FP16X2 // compute capability: 5.3, 6.0, 6.2, 7.x
