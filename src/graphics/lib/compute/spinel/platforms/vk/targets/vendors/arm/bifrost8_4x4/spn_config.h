...
#define SPN_TILE_WIDTH_LOG2                                       2 // 4
#define SPN_TILE_HEIGHT_LOG2                                      2 // 4
...
#define SPN_KERNEL_RENDER_LGF_USE_SHARED
#define SPN_KERNEL_RENDER_TTCKS_USE_SHARED
#define SPN_KERNEL_RENDER_STYLING_CMDS_USE_SHARED
#define SPN_KERNEL_RENDER_NO_VOTE
#define SPN_KERNEL_RENDER_COVERAGE_USE_SHARED
#define SPN_KERNEL_RENDER_TILE_CHANNEL_IS_FP16X2                  // requires GL_EXT_shader_explicit_arithmetic_types_float16
