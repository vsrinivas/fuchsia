...
// key/value size target.
//

//
// FIXME -
//
//   - record set/binding/offset for each vout/vin
//
//
...
//
// FIXME -- add two-phase indirect sorting to heavily reduce latency
// and waiting on a readback
//
// 1. Launch compute shader that updates the conditional max-value key
//    initialization shaders and the dispatch indirect buffers for the
//    sorting phase... and then launches a dispatch indirect with a
//    completion semaphore.
//
// 2. While the sorting phase is running, get the total keyval count
//    and launch the merge phase dependent on the previous semaphore.
//
//
