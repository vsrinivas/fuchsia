...
#ifndef SRC_GRAPHICS_LIB_COMPUTE_HOTSORT_HOTSORT_GEN_GEN_H_
#define SRC_GRAPHICS_LIB_COMPUTE_HOTSORT_HOTSORT_GEN_GEN_H_
...
struct hsg_config
{
  ...
  struct
  {  // This provides GLSL-specific support for specifying the set and binding
    struct
    {                // locations for the input and output buffers.  Note that this will be
...
typedef void (*hsg_target_pfn)(struct hsg_target * const       target,
...
#endif  // SRC_GRAPHICS_LIB_COMPUTE_HOTSORT_HOTSORT_GEN_GEN_H_
