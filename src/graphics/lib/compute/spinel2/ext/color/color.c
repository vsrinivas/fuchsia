...
{
  rgba[2] = (float)(rgb24 & 0xFF) / 255.0f;        // b
  rgba[1] = (float)(rgb24 >> 8 & 0xFF) / 255.0f;   // g
  rgba[0] = (float)(rgb24 >> 16 & 0xFF) / 255.0f;  // r
  rgba[3] = opacity;                               // a
}
...
{
  color_rgb32_to_rgba_f32(rgba, argb32, (float)(argb32 >> 24 & 0xFF) / 255.0f);
}
