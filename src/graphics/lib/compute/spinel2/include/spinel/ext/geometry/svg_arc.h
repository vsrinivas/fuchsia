...
#ifndef SRC_GRAPHICS_LIB_COMPUTE_SPINEL2_INCLUDE_SPINEL_EXT_GEOMETRY_SVG_ARC_H_
#define SRC_GRAPHICS_LIB_COMPUTE_SPINEL2_INCLUDE_SPINEL_EXT_GEOMETRY_SVG_ARC_H_
...
#endif  // SRC_GRAPHICS_LIB_COMPUTE_SPINEL2_INCLUDE_SPINEL_EXT_GEOMETRY_SVG_ARC_H_
