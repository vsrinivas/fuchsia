...
#ifndef SRC_GRAPHICS_LIB_COMPUTE_SPINEL2_STATE_ASSERT_H_
#define SRC_GRAPHICS_LIB_COMPUTE_SPINEL2_STATE_ASSERT_H_
...
#endif  // SRC_GRAPHICS_LIB_COMPUTE_SPINEL2_STATE_ASSERT_H_
