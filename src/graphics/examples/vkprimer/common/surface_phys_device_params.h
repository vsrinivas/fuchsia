...
#ifndef SRC_GRAPHICS_EXAMPLES_VKPRIMER_COMMON_SURFACE_PHYS_DEVICE_PARAMS_H_
#define SRC_GRAPHICS_EXAMPLES_VKPRIMER_COMMON_SURFACE_PHYS_DEVICE_PARAMS_H_
...
#endif  // SRC_GRAPHICS_EXAMPLES_VKPRIMER_COMMON_SURFACE_PHYS_DEVICE_PARAMS_H_
