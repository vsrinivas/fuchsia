...
#ifndef SRC_GRAPHICS_EXAMPLES_VKPRIMER_COMMON_VULKAN_SYNC_H_
#define SRC_GRAPHICS_EXAMPLES_VKPRIMER_COMMON_VULKAN_SYNC_H_
...
#endif  // SRC_GRAPHICS_EXAMPLES_VKPRIMER_COMMON_VULKAN_SYNC_H_
