...
class ClientTest : private ::loop_fixture::RealLoop, public ::testing::Test {
 public:
  ...
  fidl::SyncClient<fidl_clientsuite::Target>& target() { return target_; }
 ...
 private:
  fidl::SyncClient<fidl_clientsuite::Target> target_;
  fidl::SyncClient<fidl_clientsuite::Finisher> finisher_;
  fidl_clientsuite::Test test_;

  static fidl::SyncClient<fidl_clientsuite::Harness> harness_;
};
