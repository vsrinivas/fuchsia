...
void main(List<String> args) {
  ...
  Future<void> runIperfClientTests(
      PerfTestHelper helper, Protocol proto, String label,
  ...
  void addIperfTest(String label, Protocol proto,
    ...
    tests.add(() {
      test(label, () async {
        ...
        try {
          await runIperfClientTests(helper, proto, label,
  ...
  addIperfTest('localhost_tcp', Protocol.tcp, send: true, recv: true);
  addIperfTest('localhost_udp', Protocol.udp, send: true, recv: true);
  ...
  addIperfTest('ethernet_tcp_send', Protocol.tcp,
      send: true, deviceLocal: false);
  addIperfTest('ethernet_tcp_recv', Protocol.tcp,
      recv: true, deviceLocal: false);
  addIperfTest('ethernet_udp_send', Protocol.udp,
      send: true, deviceLocal: false);
  addIperfTest('ethernet_ucp_recv', Protocol.udp,
      recv: true, deviceLocal: false);
