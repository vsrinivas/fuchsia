    ...
    test('Test --with=summary', () async {
      ...
      expect(
          ...
          equals(
              ...
              '      6857656971.484771 write request  fuchsia.io/Directory.Open(".")\n'
              '        -> Channel:4db5cb4f(dir:/svc)\n'
              '\n'
              '  startup Job:4cc5cb17(job-default)\n'
              '\n'
              '  startup Channel:4c85cb0f(directory-request:/)\n'
              '      6857656971.484771 read  request  fuchsia.io/Node.Clone\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open("diagnostics")\n'
              ...
              '    created by zx_channel_create\n'
              '      6857656971.484771 write request  fuchsia.sys/Launcher.CreateComponent\n'
              '    closed by zx_handle_close\n'
              '\n'
              ...
              '    created by zx_channel_create\n'
              '      6857656975.779738 read  event    '
              'fuchsia.sys/ComponentController.OnDirectoryReady\n'
              '    closed by zx_handle_close\n'
              '\n'
              ...
              ' in process echo_server_cpp.cmx:26568\n'
              '    created by zx_channel_create\n'
              '      6857656971.484771 write request  fidl.examples.echo/Echo.EchoString\n'
              '      6857656975.779738 read  response fidl.examples.echo/Echo.EchoString\n'
              '    closed by zx_handle_close\n'
              '\n'
              ...
              '      6857656975.779738 write event    fuchsia.io/Node.OnOpen\n'
              '    closed by zx_handle_close\n'
              '\n'
              '  Channel:4df5f45f(directory-request:/diagnostics)\n'
              '    created by Channel:4c85cb0f(directory-request:/)'
              ...
              '      6857656975.779738 write request  fuchsia.io/Directory.Open(".")\n'
              '        -> Channel:831ae04b(dir:/svc)\n'
              '\n'
              '  startup Job:839ae0df(job-default)\n'
              '\n'
              '  startup Channel:839ae0d7(directory-request:/)\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open("svc")\n'
              '        -> Channel:83cadf63(directory-request:/svc)\n'
              '      6857656975.779738 read  request  fuchsia.io/Node.Clone\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open("diagnostics")\n'
              ...
              ' receiving fuchsia.io/Directory.Open\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open('
              '"fidl.examples.echo.Echo")\n'
              ...
              ' receiving fuchsia.io/Directory.Open\n'
              '      6857656975.779738 read  request  fidl.examples.echo/Echo.EchoString\n'
              '      6857656975.779738 write response fidl.examples.echo/Echo.EchoString\n'
              '\n'
    ...
    test('Test --with=top', () async {
      ...
      expect(
          ...
          equals(
              ...
              '    Open: 4 events\n'
              '      6857656971.484771 write request  fuchsia.io/Directory.Open('
              'Channel:4cb5cb07(dir:/svc), ".")\n'
              '        -> Channel:4db5cb4f(dir:/svc)\n'
              '      6857656971.484771 write request  fuchsia.io/Directory.Open('
              'Channel:4db5cb4f(dir:/svc),'
              ' "fuchsia.sys.Launcher")\n'
              '        -> Channel:4ca5cbab(dir:/svc/fuchsia.sys.Launcher)\n'
              '      6857656971.484771 write request  fuchsia.io/Directory.Open(Channel:4cc5cba7('
              'server:fuchsia-pkg://fuchsia.com/echo_server_cpp#meta/echo_server_cpp.cmx),'
              ' "fidl.examples.echo.Echo")\n'
              '        -> Channel:4c85f443('
              'server:fuchsia-pkg://fuchsia.com/echo_server_cpp#meta/echo_server_cpp.cmx/'
              'fidl.examples.echo.Echo)\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open(Channel:4c85cb0f('
              'directory-request:/), "diagnostics")\n'
              '        -> Channel:4df5f45f(directory-request:/diagnostics)\n'
              '\n'
              '  fuchsia.io/Node: 3 events\n'
              '    OnOpen: 2 events\n'
              '      6857656975.779738 write event    fuchsia.io/Node.OnOpen(Channel:4cc5cb2f('
              'directory-request:/))\n'
              '      6857656975.779738 write event    fuchsia.io/Node.OnOpen(Channel:4df5f45f('
              'directory-request:/diagnostics))\n'
              '    Clone: 1 event\n'
              '      6857656971.484771 read  request  fuchsia.io/Node.Clone('
              'Channel:4c85cb0f(directory-request:/))\n'
              '\n'
              '  fidl.examples.echo/Echo: 2 events\n'
              '    EchoString: 2 events\n'
              '      6857656971.484771 write request  fidl.examples.echo/Echo.EchoString('
              'Channel:4c85f443(server:fuchsia-pkg://fuchsia.com/echo_server_cpp'
              ...
              '    Open: 4 events\n'
              '      6857656975.779738 write request  fuchsia.io/Directory.Open('
              'Channel:830ae0cb(dir:/svc), ".")\n'
              '        -> Channel:831ae04b(dir:/svc)\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open('
              'Channel:839ae0d7(directory-request:/), "svc")\n'
              '        -> Channel:83cadf63(directory-request:/svc)\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open(Channel:83cadf63('
              'directory-request:/svc), "fidl.examples.echo.Echo")\n'
              '        -> Channel:833adf7b(directory-request:/svc/fidl.examples.echo.Echo)\n'
              '      6857656975.779738 read  request  fuchsia.io/Directory.Open(Channel:839ae0d7('
              'directory-request:/), "diagnostics")\n'
              '        -> Channel:83aae067(directory-request:/diagnostics)\n'
              '\n'
              '  fidl.examples.echo/Echo: 2 events\n'
              ...
              '    Clone: 1 event\n'
              '      6857656975.779738 read  request  fuchsia.io/Node.Clone('
              'Channel:839ae0d7(directory-request:/))\n'
              '    OnOpen: 1 event\n'
              '      6857656975.779738 write event    fuchsia.io/Node.OnOpen(Channel:83aae003('
              'directory-request:/))\n'),
          reason: instance.additionalResult);
    });
