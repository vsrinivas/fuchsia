...
const VERSION_HISTORY_SCHEMA_ID: &str = "https://fuchsia.dev/schema/version_history-96c19b0c.json";
...
mod tests {
    ...
    fn test_parse_history_works() {
        let expected_bytes = br#"{
            ...
            "schema_id": "https://fuchsia.dev/schema/version_history-96c19b0c.json"
        }"#;
    ...
    fn test_parse_history_rejects_invalid_schema() {
        ...
        assert_eq!(
            ...
            "invalid value: string \"some-schema\", expected https://fuchsia.dev/schema/version_history-96c19b0c.json"
        );
    }
    ...
    fn test_parse_history_rejects_invalid_versions() {
        for (api_level, abi_revision, err) in [
            (
                "some-version",
                "1",
                "invalid value: string \"some-version\", expected an unsigned integer at line 1 column 131",
            ),
            (
                "-1",
                "1",
                 "invalid value: string \"-1\", expected an unsigned integer at line 1 column 121",
            ),
            (
                "1",
                "some-revision",
                "invalid value: string \"some-revision\", expected a hex unsigned integer at line 1 column 115",
            ),
            (
                "1",
                "-1",
                "invalid value: string \"-1\", expected a hex unsigned integer at line 1 column 104",
            ),
        ] {
            let expected_bytes = serde_json::to_vec(&serde_json::json!({
                "data": {
                    "name": VERSION_HISTORY_NAME,
                    "element_type": VERSION_HISTORY_TYPE,
                    "versions": [
                        {
                            "api_level": api_level,
