...
/// Defines the light and dark themes for the settings application.
class AppTheme {
  AppTheme._();
  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        tooltipTheme: TooltipThemeData(
          ...
          textStyle: _SettingsTypography.theme.bodyText2!
        ...
        // Used by AppBar under details screen.
        ...
        dialogTheme: DialogTheme(
          ...
          titleTextStyle: _SettingsTypography.theme.headline5,
          contentTextStyle: _SettingsTypography.theme.bodyText1,
        ),
        // Used for AppBar bottom.
        indicatorColor: FuchsiaColors.grey04,
        textTheme: _SettingsTypography.theme.copyWith(
            caption: _SettingsTypography.theme.caption!
...
class _SettingsTypography {
  const _SettingsTypography._();
