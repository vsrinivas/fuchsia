...
mod tests {
    ...
    // Tests that an InputReport containting one media button generates an InputEvent containting
    ...
    // Tests that an InputReport containting two media button generates an InputEvent containting
    // both media buttons.
    #[fasync::run_singlethreaded(test)]
    ...
    // Tests that three InputReports containting one media button generates three InputEvents
    // containting the same media buttons.
    #[fasync::run_singlethreaded(test)]
