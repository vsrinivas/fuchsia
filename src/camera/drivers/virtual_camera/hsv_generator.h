...
#ifndef SRC_CAMERA_DRIVERS_VIRTUAL_CAMERA_HSV_GENERATOR_H_
#define SRC_CAMERA_DRIVERS_VIRTUAL_CAMERA_HSV_GENERATOR_H_
...
#endif  // SRC_CAMERA_DRIVERS_VIRTUAL_CAMERA_HSV_GENERATOR_H_
