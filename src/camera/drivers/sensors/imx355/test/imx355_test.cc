...
class FakeImx355Device : public Imx355Device {
 public:
  FakeImx355Device()
      : Imx355Device(fake_ddk::FakeParent(), nullptr, nullptr, nullptr, nullptr, nullptr, nullptr),
...
class Imx355DeviceTest : public zxtest::Test {
 public:
  ...
  void SetUp() override {
    auto dut = std::make_unique<FakeImx355Device>();
    dut_.ExpectInit();
    dut_.ExpectDeInit();
  }
  ...
  FakeImx355Device& dut() { return dut_; }

 private:
  fake_ddk::Bind ddk_;
  FakeImx355Device dut_;
};
...
TEST_F(Imx355DeviceTest, Sanity) { ASSERT_OK(dut().CameraSensor2Init()); }

// TODO(50737): The expected I2C operations don't match up with those made by
// CameraSensor2GetSensorId.
TEST_F(Imx355DeviceTest, DISABLED_GetSensorId) {
...
TEST_F(Imx355DeviceTest, DISABLED_GetSetTestPatternMode) {
...
TEST_F(Imx355DeviceTest, GetFrameRateCoarseIntLut) {
