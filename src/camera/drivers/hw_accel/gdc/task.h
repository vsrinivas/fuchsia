...
public:
    ...
    // |input_buffer_index| : Index of the input buffer for which the address is requested.
    // |out| : Returns the physical address if the index provided is valid.
    ...
    // |config_vmo|                           : Configuration is stored in this VMO.
    // |callback|                             : Callback function to call for this task.
    // |out|                                  : Pointer to a task object returned to the caller.
