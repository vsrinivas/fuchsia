...
use crate::{
    ...
    platform_metrics, shutdown_watcher, system_profile_handler, system_shutdown_handler,
    temperature_handler, thermal_limiter, thermal_load_driver, thermal_policy, thermal_shutdown,
};
