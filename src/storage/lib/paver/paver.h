...
class DataSinkImpl {
 public:
  ...
  zx::status<::llcpp::fuchsia::mem::wire::Buffer> ReadAsset(
      ::llcpp::fuchsia::paver::wire::Configuration configuration,
      ::llcpp::fuchsia::paver::wire::Asset asset);

  zx::status<> WriteAsset(::llcpp::fuchsia::paver::wire::Configuration configuration,
                          ::llcpp::fuchsia::paver::wire::Asset asset,
  ...
  std::variant<zx_status_t, fidl::aligned<bool>> WriteFirmware(
      ::llcpp::fuchsia::paver::wire::Configuration configuration, fidl::StringView type,
      ::llcpp::fuchsia::mem::wire::Buffer payload);

  zx::status<> WriteVolumes(zx::channel payload_stream);

  zx::status<> WriteBootloader(::llcpp::fuchsia::mem::wire::Buffer payload);

  zx::status<> WriteDataFile(fidl::StringView filename, ::llcpp::fuchsia::mem::wire::Buffer payload);
...
class DataSink : public ::llcpp::fuchsia::paver::DataSink::RawChannelInterface {
 public:
  ...
  void WriteAsset(::llcpp::fuchsia::paver::wire::Configuration configuration,
                  ::llcpp::fuchsia::paver::wire::Asset asset, ::llcpp::fuchsia::mem::wire::Buffer payload,
