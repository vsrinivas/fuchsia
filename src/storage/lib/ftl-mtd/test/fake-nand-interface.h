...
#ifndef SRC_STORAGE_LIB_FTL_MTD_TEST_FAKE_NAND_INTERFACE_H_
#define SRC_STORAGE_LIB_FTL_MTD_TEST_FAKE_NAND_INTERFACE_H_
...
#endif  // SRC_STORAGE_LIB_FTL_MTD_TEST_FAKE_NAND_INTERFACE_H_
