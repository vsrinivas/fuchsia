...
#ifndef SRC_STORAGE_LIB_FTL_MTD_NAND_VOLUME_DRIVER_H_
#define SRC_STORAGE_LIB_FTL_MTD_NAND_VOLUME_DRIVER_H_
...
#endif  // SRC_STORAGE_LIB_FTL_MTD_NAND_VOLUME_DRIVER_H_
