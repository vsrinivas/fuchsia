...
#ifndef SRC_COBALT_BIN_SYSTEM_METRICS_FAKE_TEMPERATURE_FETCHER_H_
#define SRC_COBALT_BIN_SYSTEM_METRICS_FAKE_TEMPERATURE_FETCHER_H_
...
#endif  // SRC_COBALT_BIN_SYSTEM_METRICS_FAKE_TEMPERATURE_FETCHER_H_
