...
const ARCHIVIST_URL: &str =
    "fuchsia-pkg://fuchsia.com/archivist_integration_tests#meta/unified_reader_test_archivist.cmx";
const ARCHIVIST_CONFIG: &[u8] = include_bytes!("../configs/archivist_config.json");
const SERVICE_URL: &str =
    "fuchsia-pkg://fuchsia.com/archivist_integration_tests#meta/iquery_example_component.cmx";
