...
#ifndef SRC_DIAGNOSTICS_EXAMPLES_INSPECT_CPP_PART_3_REVERSER_H_
#define SRC_DIAGNOSTICS_EXAMPLES_INSPECT_CPP_PART_3_REVERSER_H_
...
#endif  // SRC_DIAGNOSTICS_EXAMPLES_INSPECT_CPP_PART_3_REVERSER_H_
