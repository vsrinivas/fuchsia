...
void PtyClientDevice::ClrSetFeature(uint32_t clr, uint32_t set,
  ...
  constexpr uint32_t kAllowedFeatureBits = ::llcpp::fuchsia::hardware::pty::wire::FEATURE_RAW;
...
void PtyClientDevice::Seek(int64_t offset, ::llcpp::fuchsia::io::wire::SeekOrigin start,
