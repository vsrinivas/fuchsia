...
static fidl::WireSyncClient<fhd::Controller> dc_client;

static fidl::WireSyncClient<sysmem::Allocator> sysmem_allocator;
...
fidl::WireSyncClient<sysmem::Allocator>& get_sysmem_allocator() { return sysmem_allocator; }
...
static zx_status_t create_buffer_collection(
    ...
    fidl::WireSyncClient<sysmem::BufferCollection>* collection_client) {
