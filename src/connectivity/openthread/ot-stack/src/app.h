...
class OtStackApp : public fidl::WireSyncEventHandler<fidl_spinel::Device> {
 ...
 private:
  ...
  void OnReadyForSendFrames(
      fidl::WireEvent<fidl_spinel::Device::OnReadyForSendFrames>* event) override;
  void OnReceiveFrame(fidl::WireEvent<fidl_spinel::Device::OnReceiveFrame>* event) override;
  void OnError(fidl::WireEvent<fidl_spinel::Device::OnError>* event) override;
  ...
  fidl::WireSyncClient<fidl_spinel::DeviceSetup> device_setup_client_ptr_;
  fidl::WireSyncClient<fidl_spinel::Device> device_client_ptr_;
  ...
  uint32_t radio_outbound_allowance_ __TA_GUARDED(radio_q_mtx_);
  ...
  std::vector<uint8_t> radio_outbound_frame_ __TA_GUARDED(radio_q_mtx_);
