...
gen_commands! {
    Cmd {
        ...
        ReadLongChr = ("read-long-chr", ["id", "offset", "max bytes"], "Read a long characteristic"),
        WriteChr = ("write-chr", ["[-w]", "id", "value"], "Write to a characteristic"),
        WriteLongChr = ("write-long-chr", ["[-r]", "id", "offset", "value"], "Write to a long characteristic"),
        ReadDesc = ("read-desc", ["id"], "Read a characteristic descriptor"),
        ReadLongDesc = ("read-long-desc", ["id", "offset", "max bytes"], "Read a long characteristic descriptor"),
        WriteDesc = ("write-desc", ["id", "value"], "Write to a characteristic descriptor"),
        WriteLongDesc = ("write-long-desc", ["id", "offset", "value"], "Write to a long characteristic descriptor"),
