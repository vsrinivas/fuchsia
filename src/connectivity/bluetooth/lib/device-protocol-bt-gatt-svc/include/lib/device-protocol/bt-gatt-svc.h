...
static inline int bt_gatt_compare_uuid(const bt_gatt_uuid_t* u1, const bt_gatt_uuid_t* u2) {
  return memcmp(u1->bytes, u2->bytes, 16);
}

__END_CDECLS

#endif  // SRC_CONNECTIVITY_BLUETOOTH_LIB_DEVICE_PROTOCOL_BT_GATT_SVC_INCLUDE_LIB_DEVICE_PROTOCOL_BT_GATT_SVC_H_
