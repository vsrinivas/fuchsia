...
void FakeSignalingServer::ProcessConfigurationResponse(hci_spec::ConnectionHandle conn,
  ...
  const l2cap::ChannelId local_cid =
      configuration_res.ReadMember<&l2cap::ConfigurationResponsePayload::src_cid>();
  const l2cap::ConfigurationResult result =
      configuration_res.ReadMember<&l2cap::ConfigurationResponsePayload::result>();
...
void FakeSignalingServer::ProcessDisconnectionRequest(hci_spec::ConnectionHandle conn,
  ...
  const auto& disconn_req = disconnection_req.To<l2cap::DisconnectionRequestPayload>();
