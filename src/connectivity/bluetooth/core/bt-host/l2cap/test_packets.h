...
inline DynamicByteBuffer AclSFrameReceiverReady(hci::ConnectionHandle link_handle,
...
inline DynamicByteBuffer AclSFrameReceiverNotReady(hci::ConnectionHandle link_handle,
                                                   l2cap::ChannelId channel_id,
                                                   uint8_t receive_seq_num, bool is_poll_request,
                                                   bool is_poll_response) {
