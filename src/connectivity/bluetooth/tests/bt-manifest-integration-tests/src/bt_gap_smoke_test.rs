...
fn route_from_bt_gap_to_mock_client<S: DiscoverableProtocolMarker>(builder: &mut RealmBuilder) {
    let _ = builder
...
async fn bt_gap_component_topology() {
    ...
    let _ = builder
        ...
        .add_component(BT_GAP_MONIKER, ComponentSource::url(BT_GAP_URL.to_string()))
        .await
    ...
    route_from_bt_gap_to_mock_client::<ProfileMarker>(&mut builder);
    route_from_bt_gap_to_mock_client::<fbgatt::Server_Marker>(&mut builder);
    route_from_bt_gap_to_mock_client::<fble::CentralMarker>(&mut builder);
    route_from_bt_gap_to_mock_client::<fble::PeripheralMarker>(&mut builder);
    route_from_bt_gap_to_mock_client::<AccessMarker>(&mut builder);
    route_from_bt_gap_to_mock_client::<BootstrapMarker>(&mut builder);
    route_from_bt_gap_to_mock_client::<ConfigurationMarker>(&mut builder);
    route_from_bt_gap_to_mock_client::<HostWatcherMarker>(&mut builder);
    ...
    let _ = builder
        ...
        .add_protocol_route::<SecureStoreMarker>(
            ...
            vec![RouteEndpoint::component(BT_GAP_MONIKER)],
        )
