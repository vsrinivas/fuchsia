...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ONE_MESSAGE_TEST(1048576, 7, 4991, TwoNode, &Win_3_3, 1, 2),
        ONE_MESSAGE_TEST(1, 1, 3, TwoNode, &Win_3_3, 2, 1),
        ONE_MESSAGE_TEST(1048576, 7, 4991, TwoNode, &Win_3_3, 2, 1),
        ...
        ONE_MESSAGE_TEST(1048576, 10, 7170, ThreeNode, &Happy, &Win_3_3, 1, 2, 3),
        ...
        ONE_MESSAGE_TEST(1048576, 7, 5400, ThreeNode, &Win_3_3, &Happy, 1, 2, 3),
        ...
        ONE_MESSAGE_TEST(32768, 1, 222, ThreeNode, &Win_3_3, &Win_3_3, 1, 2, 3),
        ONE_MESSAGE_TEST(1048576, 10, 6598, ThreeNode, &Win_3_3, &Win_3_3, 1, 2, 3),
