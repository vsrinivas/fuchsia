...
const LINK_FRAME_LABEL_TO_CLIENT: u8 = 0x04;
...
impl LinkFrameLabel {
    ...
    pub fn encode_for_link(
        ...
        match self.target.endpoint {
            Endpoint::Client => control |= LINK_FRAME_LABEL_TO_CLIENT,
            Endpoint::Server => (),
        }
    ...
    pub fn decode(
        ...
        let h = LinkFrameLabel {
            ...
            target: RoutingTarget {
                endpoint: if (control & LINK_FRAME_LABEL_TO_CLIENT) != 0 {
                    Endpoint::Client
                } else {
                    Endpoint::Server
                },
...
mod test {
    ...
    fn round_trip_examples() {
        round_trips(
            LinkFrameLabel {
                target: RoutingTarget { endpoint: Endpoint::Server, src: 1.into(), dst: 2.into() },
                ping: Some(3),
                pong: None,
                debug_token: None,
            },
        ...
        round_trips(
            LinkFrameLabel {
                target: RoutingTarget { endpoint: Endpoint::Client, src: 1.into(), dst: 2.into() },
                ping: None,
                pong: None,
                debug_token: None,
            },
        ...
        round_trips(
            LinkFrameLabel {
                target: RoutingTarget { endpoint: Endpoint::Server, src: 1.into(), dst: 3.into() },
                ping: None,
                pong: None,
                debug_token: None,
            },
        ...
        round_trips(
            LinkFrameLabel {
                target: RoutingTarget { endpoint: Endpoint::Client, src: 1.into(), dst: 3.into() },
                ping: None,
                pong: None,
        ...
        round_trips(
            LinkFrameLabel {
                target: RoutingTarget { endpoint: Endpoint::Server, src: 3.into(), dst: 2.into() },
                ping: Some(1),
                pong: None,
                debug_token: LinkFrameLabel::new_debug_token(),
            },
        ...
        round_trips(
            LinkFrameLabel {
                target: RoutingTarget { endpoint: Endpoint::Client, src: 3.into(), dst: 2.into() },
                ping: None,
