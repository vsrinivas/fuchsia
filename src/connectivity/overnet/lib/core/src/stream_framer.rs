...
//! TODO: switch around framing so that null byte is the start of frame delimiter, and \n is the end
//! of frame delimeter - this will play much more nicely with line-based flushing implementations.
