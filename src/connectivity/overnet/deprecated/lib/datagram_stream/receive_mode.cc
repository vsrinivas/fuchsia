...
#include "src/connectivity/overnet/deprecated/lib/datagram_stream/receive_mode.h"
...
void Error::Begin(uint64_t seq, BeginCallback ready) { ready(Status::Cancelled()); }
