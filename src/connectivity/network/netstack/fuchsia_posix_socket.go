...
func (s *datagramSocketImpl) GetSockOpt(ctx fidl.Context, level, optName int16) (socket.BaseSocketGetSockOptResult, error) {
	opts, err := s.endpointWithEvent.GetSockOpt(ctx, level, optName)
