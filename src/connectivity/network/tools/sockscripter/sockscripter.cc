...
bool SockScripter::Join6(char* arg) {
  ...
  // can pick either one.
  return JoinOrDrop6(__FUNCTION__, arg, IPV6_ADD_MEMBERSHIP, "IPV6_ADD_MEMBERSHIP");
}

bool SockScripter::Drop6(char* arg) {
  return JoinOrDrop6(__FUNCTION__, arg, IPV6_DROP_MEMBERSHIP, "IPV6_DROP_MEMBERSHIP");
}
