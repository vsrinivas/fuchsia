...
#ifndef SRC_CONNECTIVITY_NETWORK_TESTING_NETEMUL_NETWORK_CONTEXT_LIB_INTERCEPTORS_PACKET_LOSS_H_
#define SRC_CONNECTIVITY_NETWORK_TESTING_NETEMUL_NETWORK_CONTEXT_LIB_INTERCEPTORS_PACKET_LOSS_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_TESTING_NETEMUL_NETWORK_CONTEXT_LIB_INTERCEPTORS_PACKET_LOSS_H_
