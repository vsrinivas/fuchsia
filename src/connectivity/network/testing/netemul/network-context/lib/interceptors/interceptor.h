...
#ifndef SRC_CONNECTIVITY_NETWORK_TESTING_NETEMUL_NETWORK_CONTEXT_LIB_INTERCEPTORS_INTERCEPTOR_H_
#define SRC_CONNECTIVITY_NETWORK_TESTING_NETEMUL_NETWORK_CONTEXT_LIB_INTERCEPTORS_INTERCEPTOR_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_TESTING_NETEMUL_NETWORK_CONTEXT_LIB_INTERCEPTORS_INTERCEPTOR_H_
