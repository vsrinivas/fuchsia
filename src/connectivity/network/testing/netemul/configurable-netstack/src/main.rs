...
enum NetstackError {
    ...
    RemoveAddress {
        error: fnet_interfaces_admin::ControlRemoveAddressError,
...
async fn configure_interface(
    ...
    if without_autogenerated_addresses.unwrap_or_default() {
        ...
        let fnet::Subnet { addr, prefix_len } = match addresses.as_slice() {
        ...
        let mut interface_addr = match addr {
            ...
            fnet::IpAddress::Ipv6(ipv6) => fnet::InterfaceAddress::Ipv6(ipv6.clone()),
        };
