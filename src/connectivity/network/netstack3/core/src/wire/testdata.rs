...
pub(crate) mod arp_request {
    use super::*;

    use crate::device::arp::ArpOp;

    pub(crate) const ETHERNET_FRAME: TestPacket<EthernetFrameMetadata> = TestPacket {
        bytes: &[
    ...
    pub(crate) const ARP_OPERATION: ArpOp = ArpOp::Request;
}
...
pub(crate) mod dns_request_v4 {
    ...
    pub(crate) const IPV4_PACKET: TestPacket<Ipv4PacketMetadata> = TestPacket {
        bytes: &[
            0x45, 0x00, 0x00, 0x3f, 0x17, 0xf1, 0x00, 0x00, 0x40, 0x11, 0xdf, 0x5c, 0xc0, 0xa8,
            0x01, 0x0f, 0xc0, 0xa8, 0x01, 0x01, 0x8b, 0x4a, 0x00, 0x35, 0x00, 0x2b, 0x07, 0xf7,
            0x47, 0xb5, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x30,
    ...
    pub(crate) const UDP_PACKET: TestPacket<UdpPacketMetadata> = TestPacket {
        bytes: &[
...
pub(crate) mod tls_client_hello_v4 {
    ...
    pub(crate) const TCP_SEGMENT: TestPacket<TcpSegmentMetadata> = TestPacket {
        bytes: &[
...
pub(crate) mod dns_request_v6 {
    ...
    pub(crate) const IPV6_PACKET: TestPacket<Ipv6PacketMetadata> = TestPacket {
        bytes: &[
            0x60, 0x0e, 0xa5, 0x28, 0x00, 0x3b, 0x11, 0x40, 0x26, 0x20, 0x00, 0x00, 0x10, 0x00,
            0x50, 0x10, 0x69, 0xb4, 0xab, 0xc9, 0x7b, 0x21, 0x92, 0x15, 0x20, 0x01, 0x48, 0x60,
            0x48, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x88, 0x88, 0xd9, 0xa1,
...
pub(crate) mod mld_router_query {
    ...
    pub(crate) const HOST_GROUP_ADDRESS: Ipv6Addr = Ipv6Addr::new([0; 16]);
...
pub(crate) mod mld_router_report {
    ...
    pub(crate) const HOST_GROUP_ADDRESS: Ipv6Addr =
