...
#ifndef SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_DNS_READING_H_
#define SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_DNS_READING_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_DNS_READING_H_
