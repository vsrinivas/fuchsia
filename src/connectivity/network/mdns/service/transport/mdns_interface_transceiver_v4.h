...
#ifndef SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_TRANSPORT_MDNS_INTERFACE_TRANSCEIVER_V4_H_
#define SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_TRANSPORT_MDNS_INTERFACE_TRANSCEIVER_V4_H_
...
class MdnsInterfaceTransceiverV4 : public MdnsInterfaceTransceiver {
 public:
  MdnsInterfaceTransceiverV4(inet::IpAddress address, const std::string& name, uint32_t id,
                             Media media);
...
#endif  // SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_TRANSPORT_MDNS_INTERFACE_TRANSCEIVER_V4_H_
