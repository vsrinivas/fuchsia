...
#ifndef SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_PACKET_WRITER_H_
#define SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_PACKET_WRITER_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_PACKET_WRITER_H_
