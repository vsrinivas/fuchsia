...
#ifndef SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_ENCODING_PACKET_WRITER_H_
#define SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_ENCODING_PACKET_WRITER_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_ENCODING_PACKET_WRITER_H_
