...
#ifndef SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_SERVICE_INSTANCE_RESOLVER_H_
#define SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_SERVICE_INSTANCE_RESOLVER_H_
...
class ServiceInstanceResolver : public MdnsAgent {
 ...
 private:
  ...
  fuchsia::net::mdns::ServiceInstance2 instance_;
  zx::time timeout_;
  Mdns::ResolveServiceInstance2Callback callback_;
  inet::IpPort port_;
...
#endif  // SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_SERVICE_INSTANCE_RESOLVER_H_
