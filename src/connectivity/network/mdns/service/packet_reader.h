...
#ifndef SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_PACKET_READER_H_
#define SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_PACKET_READER_H_
...
#endif  // SRC_CONNECTIVITY_NETWORK_MDNS_SERVICE_PACKET_READER_H_
