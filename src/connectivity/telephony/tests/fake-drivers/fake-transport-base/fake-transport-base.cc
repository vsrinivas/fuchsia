...
void Device::SetChannel(
    ...
    fidl_tel_transport::Qmi::RawChannelInterface::SetChannelCompleter::Sync& completer) {
...
void Device::SetNetwork(
    bool connected,
    fidl_tel_transport::Qmi::RawChannelInterface::SetNetworkCompleter::Sync& completer) {
...
void Device::SetSnoopChannel(
    ...
    fidl_tel_transport::Qmi::RawChannelInterface::SetSnoopChannelCompleter::Sync& completer) {
