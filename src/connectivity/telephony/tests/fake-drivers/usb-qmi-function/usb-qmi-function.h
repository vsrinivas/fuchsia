...
class FakeUsbQmiFunction : public ddk::Device<FakeUsbQmiFunction, ddk::UnbindableDeprecated>,
                           public ddk::UsbFunctionInterfaceProtocol<FakeUsbQmiFunction> {
 public:
  FakeUsbQmiFunction(zx_device_t* parent)
      : ddk::Device<FakeUsbQmiFunction, ddk::UnbindableDeprecated>(parent), function_(parent) {}
  zx_status_t Bind();
  // |ddk::Device|
