...
mod tests {
    ...
    fn test_start_after_start_failure() {
        ...
        requested_id.ssid = Ssid::from("second_test_ssid");
    ...
    fn test_state_tracker_reset() {
        ...
        assert_variant!(state.inner.lock().state.as_ref(), Some(ApStateUpdate {
            ...
            let expected_ssid = Ssid::from("test_ssid");
    ...
    fn test_state_tracker_consume_sme_update() {
        ...
        let ap_info =
            fidl_sme::Ap { ssid: Ssid::from("test_ssid").to_vec(), channel: 6, num_clients: 123 };
        state
    ...
    fn test_state_tracker_failure_modes() {
        ...
        let _ = state
            .consume_sme_status_update(
                Cbw::Cbw20,
                fidl_sme::Ap {
                    ssid: Ssid::from("test_ssid").to_vec(),
                    channel: 6,
                    num_clients: 123,
                },
            )
