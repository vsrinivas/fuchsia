...
fn query_iface(ifaces: &IfaceMap, id: u16) -> Result<fidl_svc::QueryIfaceResponse, zx::Status> {
    ...
    let role = match iface.device_info.role {
        fidl_wlan_common::WlanMacRole::Client => fidl_wlan_common::WlanMacRole::Client,
        fidl_wlan_common::WlanMacRole::Ap => fidl_wlan_common::WlanMacRole::Ap,
        fidl_wlan_common::WlanMacRole::Mesh => fidl_wlan_common::WlanMacRole::Mesh,
    };
...
mod tests {
    ...
    fn query_iface_success() {
        ...
        assert_eq!(response.role, fidl_wlan_common::WlanMacRole::Client);
