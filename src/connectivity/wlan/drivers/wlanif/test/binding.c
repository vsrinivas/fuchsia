...
void wlanif_auth_resp(void* ctx, wlanif_auth_resp_t* ind) { printf("***** auth_ind\n"); }

void wlanif_deauth_req(void* ctx, wlanif_deauth_req_t* req) { printf("***** deauth_req\n"); }
...
void wlanif_assoc_resp(void* ctx, wlanif_assoc_resp_t* ind) { printf("***** assoc_ind\n"); }

void wlanif_disassoc_req(void* ctx, wlanif_disassoc_req_t* req) { printf("***** disassoc_req\n"); }

void wlanif_reset_req(void* ctx, wlanif_reset_req_t* req) { printf("***** reset_req\n"); }

void wlanif_start_req(void* ctx, wlanif_start_req_t* req) { printf("***** start_req\n"); }

void wlanif_stop_req(void* ctx, wlanif_stop_req_t* req) { printf("***** stop_req\n"); }

void wlanif_set_keys_req(void* ctx, wlanif_set_keys_req_t* req) { printf("***** set_keys_req\n"); }

void wlanif_del_keys_req(void* ctx, wlanif_del_keys_req_t* req) { printf("***** del_keys_req\n"); }

void wlanif_eapol_req(void* ctx, wlanif_eapol_req_t* req) { printf("***** eapol_req\n"); }
...
zx_status_t dev_init(void** out_ctx) { return ZX_OK; }
