...
class Device : public DeviceInterface {
 public:
  ...
  zx_status_t StartPassiveScan(const wlanmac_passive_scan_args_t* passive_scan_args, uint64_t* out_scan_id) final;
  zx_status_t StartActiveScan(const wlanmac_active_scan_args_t* active_scan_args, uint64_t* out_scan_id) final;
