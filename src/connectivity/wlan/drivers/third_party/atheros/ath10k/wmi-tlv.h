 ...
 */
#ifndef SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_WMI_TLV_H_
#define SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_WMI_TLV_H_
...
enum wmi_tlv_cmd_id {
    ...
    WMI_TLV_NETWORK_LIST_OFFLOAD_CONFIG_CMDID = WMI_TLV_CMD(WMI_TLV_GRP_NLO_OFL),
    ...
    WMI_TLV_TXBF_CMDID,
    WMI_TLV_FWTEST_VDEV_MCC_SET_TBTT_MODE_CMDID = WMI_TLV_CMD(WMI_TLV_GRP_FWTEST),
    ...
    WMI_TLV_BATCH_SCAN_ENABLE_CMDID = WMI_TLV_CMD(WMI_TLV_GRP_LOCATION_SCAN),
    ...
    WMI_TLV_SET_DHCP_SERVER_OFFLOAD_CMDID = WMI_TLV_CMD(WMI_TLV_GRP_DHCP_OFL),
...
enum wmi_tlv_event_id {
    ...
    WMI_TLV_BATCH_SCAN_ENABLED_EVENTID = WMI_TLV_EV(WMI_TLV_GRP_LOCATION_SCAN),
...
static inline void wmi_tlv_svc_map(const uint32_t* in, BITARR_TYPE* out, size_t len) {
    SVCMAP(WMI_TLV_SERVICE_BEACON_OFFLOAD, WMI_SERVICE_BEACON_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_SCAN_OFFLOAD, WMI_SERVICE_SCAN_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_ROAM_SCAN_OFFLOAD, WMI_SERVICE_ROAM_SCAN_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_BCN_MISS_OFFLOAD, WMI_SERVICE_BCN_MISS_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_STA_PWRSAVE, WMI_SERVICE_STA_PWRSAVE, len);
    SVCMAP(WMI_TLV_SERVICE_STA_ADVANCED_PWRSAVE, WMI_SERVICE_STA_ADVANCED_PWRSAVE, len);
    SVCMAP(WMI_TLV_SERVICE_AP_UAPSD, WMI_SERVICE_AP_UAPSD, len);
    SVCMAP(WMI_TLV_SERVICE_AP_DFS, WMI_SERVICE_AP_DFS, len);
    SVCMAP(WMI_TLV_SERVICE_11AC, WMI_SERVICE_11AC, len);
    SVCMAP(WMI_TLV_SERVICE_BLOCKACK, WMI_SERVICE_BLOCKACK, len);
    SVCMAP(WMI_TLV_SERVICE_PHYERR, WMI_SERVICE_PHYERR, len);
    SVCMAP(WMI_TLV_SERVICE_BCN_FILTER, WMI_SERVICE_BCN_FILTER, len);
    SVCMAP(WMI_TLV_SERVICE_RTT, WMI_SERVICE_RTT, len);
    SVCMAP(WMI_TLV_SERVICE_WOW, WMI_SERVICE_WOW, len);
    SVCMAP(WMI_TLV_SERVICE_RATECTRL_CACHE, WMI_SERVICE_RATECTRL_CACHE, len);
    SVCMAP(WMI_TLV_SERVICE_IRAM_TIDS, WMI_SERVICE_IRAM_TIDS, len);
    SVCMAP(WMI_TLV_SERVICE_ARPNS_OFFLOAD, WMI_SERVICE_ARPNS_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_NLO, WMI_SERVICE_NLO, len);
    SVCMAP(WMI_TLV_SERVICE_GTK_OFFLOAD, WMI_SERVICE_GTK_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_SCAN_SCH, WMI_SERVICE_SCAN_SCH, len);
    SVCMAP(WMI_TLV_SERVICE_CSA_OFFLOAD, WMI_SERVICE_CSA_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_CHATTER, WMI_SERVICE_CHATTER, len);
    SVCMAP(WMI_TLV_SERVICE_COEX_FREQAVOID, WMI_SERVICE_COEX_FREQAVOID, len);
    SVCMAP(WMI_TLV_SERVICE_PACKET_POWER_SAVE, WMI_SERVICE_PACKET_POWER_SAVE, len);
    SVCMAP(WMI_TLV_SERVICE_FORCE_FW_HANG, WMI_SERVICE_FORCE_FW_HANG, len);
    SVCMAP(WMI_TLV_SERVICE_GPIO, WMI_SERVICE_GPIO, len);
    SVCMAP(WMI_TLV_SERVICE_STA_DTIM_PS_MODULATED_DTIM, WMI_SERVICE_STA_DTIM_PS_MODULATED_DTIM, len);
    SVCMAP(WMI_TLV_SERVICE_STA_UAPSD_BASIC_AUTO_TRIG, WMI_SERVICE_STA_UAPSD_BASIC_AUTO_TRIG, len);
    SVCMAP(WMI_TLV_SERVICE_STA_UAPSD_VAR_AUTO_TRIG, WMI_SERVICE_STA_UAPSD_VAR_AUTO_TRIG, len);
    SVCMAP(WMI_TLV_SERVICE_STA_KEEP_ALIVE, WMI_SERVICE_STA_KEEP_ALIVE, len);
    SVCMAP(WMI_TLV_SERVICE_TX_ENCAP, WMI_SERVICE_TX_ENCAP, len);
    SVCMAP(WMI_TLV_SERVICE_AP_PS_DETECT_OUT_OF_SYNC, WMI_SERVICE_AP_PS_DETECT_OUT_OF_SYNC, len);
    SVCMAP(WMI_TLV_SERVICE_EARLY_RX, WMI_SERVICE_EARLY_RX, len);
    SVCMAP(WMI_TLV_SERVICE_STA_SMPS, WMI_SERVICE_STA_SMPS, len);
    SVCMAP(WMI_TLV_SERVICE_FWTEST, WMI_SERVICE_FWTEST, len);
    SVCMAP(WMI_TLV_SERVICE_STA_WMMAC, WMI_SERVICE_STA_WMMAC, len);
    SVCMAP(WMI_TLV_SERVICE_TDLS, WMI_SERVICE_TDLS, len);
    SVCMAP(WMI_TLV_SERVICE_BURST, WMI_SERVICE_BURST, len);
    SVCMAP(WMI_TLV_SERVICE_MCC_BCN_INTERVAL_CHANGE, WMI_SERVICE_MCC_BCN_INTERVAL_CHANGE, len);
    SVCMAP(WMI_TLV_SERVICE_ADAPTIVE_OCS, WMI_SERVICE_ADAPTIVE_OCS, len);
    SVCMAP(WMI_TLV_SERVICE_BA_SSN_SUPPORT, WMI_SERVICE_BA_SSN_SUPPORT, len);
    SVCMAP(WMI_TLV_SERVICE_FILTER_IPSEC_NATKEEPALIVE, WMI_SERVICE_FILTER_IPSEC_NATKEEPALIVE, len);
    SVCMAP(WMI_TLV_SERVICE_WLAN_HB, WMI_SERVICE_WLAN_HB, len);
    SVCMAP(WMI_TLV_SERVICE_LTE_ANT_SHARE_SUPPORT, WMI_SERVICE_LTE_ANT_SHARE_SUPPORT, len);
    SVCMAP(WMI_TLV_SERVICE_BATCH_SCAN, WMI_SERVICE_BATCH_SCAN, len);
    SVCMAP(WMI_TLV_SERVICE_QPOWER, WMI_SERVICE_QPOWER, len);
    SVCMAP(WMI_TLV_SERVICE_PLMREQ, WMI_SERVICE_PLMREQ, len);
    SVCMAP(WMI_TLV_SERVICE_THERMAL_MGMT, WMI_SERVICE_THERMAL_MGMT, len);
    SVCMAP(WMI_TLV_SERVICE_RMC, WMI_SERVICE_RMC, len);
    SVCMAP(WMI_TLV_SERVICE_MHF_OFFLOAD, WMI_SERVICE_MHF_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_COEX_SAR, WMI_SERVICE_COEX_SAR, len);
    SVCMAP(WMI_TLV_SERVICE_BCN_TXRATE_OVERRIDE, WMI_SERVICE_BCN_TXRATE_OVERRIDE, len);
    SVCMAP(WMI_TLV_SERVICE_NAN, WMI_SERVICE_NAN, len);
    SVCMAP(WMI_TLV_SERVICE_L1SS_STAT, WMI_SERVICE_L1SS_STAT, len);
    SVCMAP(WMI_TLV_SERVICE_ESTIMATE_LINKSPEED, WMI_SERVICE_ESTIMATE_LINKSPEED, len);
    SVCMAP(WMI_TLV_SERVICE_OBSS_SCAN, WMI_SERVICE_OBSS_SCAN, len);
    SVCMAP(WMI_TLV_SERVICE_TDLS_OFFCHAN, WMI_SERVICE_TDLS_OFFCHAN, len);
    SVCMAP(WMI_TLV_SERVICE_TDLS_UAPSD_BUFFER_STA, WMI_SERVICE_TDLS_UAPSD_BUFFER_STA, len);
    SVCMAP(WMI_TLV_SERVICE_TDLS_UAPSD_SLEEP_STA, WMI_SERVICE_TDLS_UAPSD_SLEEP_STA, len);
    SVCMAP(WMI_TLV_SERVICE_IBSS_PWRSAVE, WMI_SERVICE_IBSS_PWRSAVE, len);
    SVCMAP(WMI_TLV_SERVICE_LPASS, WMI_SERVICE_LPASS, len);
    SVCMAP(WMI_TLV_SERVICE_EXTSCAN, WMI_SERVICE_EXTSCAN, len);
    SVCMAP(WMI_TLV_SERVICE_D0WOW, WMI_SERVICE_D0WOW, len);
    SVCMAP(WMI_TLV_SERVICE_HSOFFLOAD, WMI_SERVICE_HSOFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_ROAM_HO_OFFLOAD, WMI_SERVICE_ROAM_HO_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_RX_FULL_REORDER, WMI_SERVICE_RX_FULL_REORDER, len);
    SVCMAP(WMI_TLV_SERVICE_DHCP_OFFLOAD, WMI_SERVICE_DHCP_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_STA_RX_IPA_OFFLOAD_SUPPORT, WMI_SERVICE_STA_RX_IPA_OFFLOAD_SUPPORT, len);
    SVCMAP(WMI_TLV_SERVICE_MDNS_OFFLOAD, WMI_SERVICE_MDNS_OFFLOAD, len);
    SVCMAP(WMI_TLV_SERVICE_SAP_AUTH_OFFLOAD, WMI_SERVICE_SAP_AUTH_OFFLOAD, len);
}
...
#define WMI_TLV_DBGLOG_BITMAP_MAX_WORDS (WMI_TLV_DBGLOG_BITMAP_MAX_IDS / sizeof(uint32_t))
#define WMI_TLV_DBGLOG_ALL_MODULES 0xffff
#define WMI_TLV_DBGLOG_LOG_LEVEL_VALUE(module_id, log_level) \
    (((module_id << 16) & 0xffff0000) | ((log_level << 0) & 0x000000ff))
...
#define WMI_TLV_MSG(type, hdr) MSG(WMI_TLV_PFX(type), ATH10K_MSG_TYPE_WMI_TLV, sizeof(struct hdr))
...
#endif  // SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_WMI_TLV_H_
