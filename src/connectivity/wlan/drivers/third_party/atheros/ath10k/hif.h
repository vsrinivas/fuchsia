...
#ifndef SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_HIF_H_
#define SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_HIF_H_
...
static inline zx_status_t ath10k_hif_start(struct ath10k* ar) { return ar->hif.ops->start(ar); }

static inline void ath10k_hif_stop(struct ath10k* ar) { return ar->hif.ops->stop(ar); }
...
static inline void ath10k_hif_power_down(struct ath10k* ar) { ar->hif.ops->power_down(ar); }
...
#endif  // SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_HIF_H_
