...
#ifndef SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_SPECTRAL_H_
#define SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_SPECTRAL_H_
...
static inline int ath10k_spectral_start(struct ath10k* ar) { return 0; }

static inline int ath10k_spectral_vif_stop(struct ath10k_vif* arvif) { return 0; }

static inline int ath10k_spectral_create(struct ath10k* ar) { return 0; }

static inline void ath10k_spectral_destroy(struct ath10k* ar) {}

#endif /* CONFIG_ATH10K_DEBUGFS */

#endif  // SRC_CONNECTIVITY_WLAN_DRIVERS_THIRD_PARTY_ATHEROS_ATH10K_SPECTRAL_H_
