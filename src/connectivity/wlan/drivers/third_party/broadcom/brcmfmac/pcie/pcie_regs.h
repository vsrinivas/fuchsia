...
constexpr uint32_t BRCMF_CONSOLE_BUFADDR_OFFSET = 0x08;
constexpr uint32_t BRCMF_CONSOLE_BUFSIZE_OFFSET = 0x0C;
constexpr uint32_t BRCMF_CONSOLE_WRITEIDX_OFFSET = 0x10;
