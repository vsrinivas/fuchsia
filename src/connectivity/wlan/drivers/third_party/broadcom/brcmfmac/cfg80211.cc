...
static zx_status_t brcmf_escan_prep(struct brcmf_cfg80211_info* cfg,
  ...
  // TODO(fxbug.dev/88653): The case where n_channels exceeds the width of a 16-bit integer is
  // not handled.
  ...
  // TODO(fxbug.dev/88653): The case where n_ssids exceeds the width of a 16-bit integer is
  // not handled.
