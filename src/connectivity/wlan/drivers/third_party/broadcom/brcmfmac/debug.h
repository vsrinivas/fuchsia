...
class Debug {
 public:
  ...
  // TODO(fxr/336233) enable console log for debugging issues, disable after system stability
  static constexpr uint32_t kBrcmfMsgFilter =
      static_cast<uint32_t>(Filter::kFWCON) | static_cast<uint32_t>(Filter::kWLANIF);
