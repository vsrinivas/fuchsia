...
#ifndef SRC_CONNECTIVITY_WLAN_DRIVERS_MEDIATEK_RALINK_DRIVER_H_
#define SRC_CONNECTIVITY_WLAN_DRIVERS_MEDIATEK_RALINK_DRIVER_H_
...
#endif  // SRC_CONNECTIVITY_WLAN_DRIVERS_MEDIATEK_RALINK_DRIVER_H_
