...
#ifndef SRC_CONNECTIVITY_WLAN_DRIVERS_REALTEK_RTL88XX_DEVICE_H_
#define SRC_CONNECTIVITY_WLAN_DRIVERS_REALTEK_RTL88XX_DEVICE_H_
...
#endif  // SRC_CONNECTIVITY_WLAN_DRIVERS_REALTEK_RTL88XX_DEVICE_H_
