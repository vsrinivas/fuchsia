...
TEST(TxVectorIndexTest, TxVectorMapping) {
  ...
  std::vector<TestVector> tvs = {
      // clang-format off
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 1,  0},   1,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 1,  7},   8,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 2,  8},   9,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 2, 15},  16,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 1,  0},  33,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 1,  7},  40,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 2,  8},  41,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 2, 15},  48,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 1,  0},  65,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 1,  7},  72,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 2,  8},  73,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 2, 15},  80,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 1,  0},  97,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 1,  7}, 104,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 2,  8}, 105,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 2, 15}, 112,},

        {{WLAN_INFO_PHY_TYPE_ERP,  WLAN_GI_800NS, CBW20, 1, 0}, 129,},
        {{WLAN_INFO_PHY_TYPE_ERP,  WLAN_GI_800NS, CBW20, 1, 7}, 136,},
        {{WLAN_INFO_PHY_TYPE_DSSS, WLAN_GI_800NS, CBW20, 1, 0}, 137,},
        {{WLAN_INFO_PHY_TYPE_CCK,  WLAN_GI_800NS, CBW20, 1, 3}, 140,},
      // clang-format on
  };
...
TEST(TxVectorIndexTest, NotUsedParam) {
  ...
  std::vector<TestVector> tvs = {
      // clang-format off
        //                                   nss not used
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 0,  0},   1,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 1,  7},   8,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 2,  8},   9,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW20, 3, 15},  16,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 4,  0},  33,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 3,  7},  40,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 2,  8},  41,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_800NS, CBW40, 1, 15},  48,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 0,  0},  65,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 1,  7},  72,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 2,  8},  73,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW20, 3, 15},  80,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 4,  0},  97,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 3,  7}, 104,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 2,  8}, 105,},
        {{WLAN_INFO_PHY_TYPE_HT, WLAN_GI_400NS, CBW40, 1, 15}, 112,},

        // only compare phy and mcs_idx
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_800NS, CBW20,  1, 0}, 129,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_400NS, CBW40,  2, 7}, 136,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_800NS, CBW80,  3, 0}, 129,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_400NS, CBW160, 4, 7}, 136,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_800NS, CBW80,  3, 0}, 129,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_400NS, CBW40,  2, 7}, 136,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_800NS, CBW20,  1, 0}, 129,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_400NS, CBW40,  0, 7}, 136,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_400NS, CBW80,  8, 0}, 129,},
        {{WLAN_INFO_PHY_TYPE_ERP, WLAN_GI_800NS, CBW160, 9, 7}, 136,},

        {{WLAN_INFO_PHY_TYPE_DSSS, WLAN_GI_800NS, CBW20,  1, 0}, 137,},
        {{WLAN_INFO_PHY_TYPE_CCK,  WLAN_GI_400NS, CBW40,  2, 3}, 140,},
        {{WLAN_INFO_PHY_TYPE_DSSS, WLAN_GI_800NS, CBW80,  3, 0}, 137,},
        {{WLAN_INFO_PHY_TYPE_CCK,  WLAN_GI_400NS, CBW160, 4, 3}, 140,},
        {{WLAN_INFO_PHY_TYPE_DSSS, WLAN_GI_800NS, CBW80,  3, 0}, 137,},
        {{WLAN_INFO_PHY_TYPE_CCK,  WLAN_GI_400NS, CBW40,  2, 3}, 140,},
        {{WLAN_INFO_PHY_TYPE_DSSS, WLAN_GI_800NS, CBW20,  1, 0}, 137,},
        {{WLAN_INFO_PHY_TYPE_CCK,  WLAN_GI_400NS, CBW40,  0, 3}, 140,},
        {{WLAN_INFO_PHY_TYPE_DSSS, WLAN_GI_400NS, CBW80,  8, 0}, 137,},
        {{WLAN_INFO_PHY_TYPE_CCK,  WLAN_GI_800NS, CBW160, 9, 3}, 140,},
      // clang-format on
  };
