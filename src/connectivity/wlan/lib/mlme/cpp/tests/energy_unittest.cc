...
TEST_F(EnergyTest, FemtoWattToDbm) {
  ...
  EXPECT_EQ(to_dBm(FemtoWatt(1'000'000'000ull)).val,
            -30);  // 1 microwatt = -30 dBm
  EXPECT_EQ(to_dBm(FemtoWatt(1'000'000'000'000ull)).val,
            0);  // 1 milliwatt = 0 dBm
  EXPECT_EQ(to_dBm(FemtoWatt(1'000'000'000'000'000ull)).val,
            30);  // 1 watt = 30 dBm
