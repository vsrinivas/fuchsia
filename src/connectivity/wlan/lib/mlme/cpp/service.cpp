...
zx_status_t SendJoinConfirm(DeviceInterface* device,
                            wlan_mlme::JoinResultCodes result_code) {
  debugfn();
...
zx_status_t SendAuthConfirm(DeviceInterface* device,
...
zx_status_t SendAuthIndication(DeviceInterface* device,
                               const common::MacAddr& peer_sta,
...
zx_status_t SendAssocConfirm(DeviceInterface* device,
                             wlan_mlme::AssociateResultCodes code,
                             uint16_t aid) {
  debugfn();
...
zx_status_t SendSignalReportIndication(DeviceInterface* device,
  ...
  return SendServiceMsg(device, &ind,
                        fuchsia_wlan_mlme_MLMESignalReportOrdinal);
}

zx_status_t SendEapolConfirm(DeviceInterface* device,
                             wlan_mlme::EapolResultCodes result_code) {
  debugfn();
...
zx_status_t SendStartConfirm(DeviceInterface* device,
                             wlan_mlme::StartResultCodes code) {
...
zx_status_t SendStopConfirm(DeviceInterface* device,
                            wlan_mlme::StopResultCodes code) {
