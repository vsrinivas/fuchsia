 ...
 public:
  class Listener {
   public:
    ...
    virtual void WlantapMacConfigureBss(uint16_t id,
                                        wlan_bss_config_t* config) = 0;
    virtual void WlantapMacSetKey(uint16_t id,
                                  wlan_key_config_t* key_config) = 0;
  };
...
zx_status_t CreateWlantapMac(
    zx_device_t* parent_phy, const ::fuchsia::wlan::device::MacRole role,
