...
#ifndef SRC_MODULAR_LIB_ENTITY_CPP_JSON_H_
#define SRC_MODULAR_LIB_ENTITY_CPP_JSON_H_
...
bool ExtractEntityTypesFromJson(const std::string& json, std::vector<std::string>* output);
bool ExtractEntityTypesFromJson(const rapidjson::Value& value, std::vector<std::string>* output);

}  // namespace modular

#endif  // SRC_MODULAR_LIB_ENTITY_CPP_JSON_H_
