...
#ifndef SRC_MODULAR_LIB_CONTEXT_CPP_CONTEXT_METADATA_BUILDER_H_
#define SRC_MODULAR_LIB_CONTEXT_CPP_CONTEXT_METADATA_BUILDER_H_
...
class ContextMetadataBuilder {
 public:
  ...
  explicit ContextMetadataBuilder(fuchsia::modular::ContextMetadata initial_value);
  ...
  ContextMetadataBuilder& SetLinkPath(const std::vector<std::string>& module_path,
...
#endif  // SRC_MODULAR_LIB_CONTEXT_CPP_CONTEXT_METADATA_BUILDER_H_
