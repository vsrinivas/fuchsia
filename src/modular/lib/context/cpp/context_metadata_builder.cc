...
ContextMetadataBuilder::ContextMetadataBuilder(fuchsia::modular::ContextMetadata initial_value)
    : m_(std::move(initial_value)) {}

ContextMetadataBuilder& ContextMetadataBuilder::SetStoryId(const fidl::StringPtr& story_id) {
...
ContextMetadataBuilder& ContextMetadataBuilder::SetStoryFocused(bool focused) {
  ...
  story_meta->focused->state = focused ? fuchsia::modular::FocusedStateState::FOCUSED
                                       : fuchsia::modular::FocusedStateState::NOT_FOCUSED;
  return *this;
}

ContextMetadataBuilder& ContextMetadataBuilder::SetModuleUrl(const fidl::StringPtr& url) {
...
ContextMetadataBuilder& ContextMetadataBuilder::SetModuleFocused(bool focused) {
  ...
  module_meta->focused->state = focused ? fuchsia::modular::FocusedStateState::FOCUSED
                                        : fuchsia::modular::FocusedStateState::NOT_FOCUSED;
  return *this;
}

ContextMetadataBuilder& ContextMetadataBuilder::SetEntityTopic(const fidl::StringPtr& topic) {
  EntityMetadata()->topic = topic;
  return *this;
}
ContextMetadataBuilder& ContextMetadataBuilder::AddEntityType(const fidl::StringPtr& type) {
...
fuchsia::modular::ContextMetadata ContextMetadataBuilder::Build() { return std::move(m_); }
