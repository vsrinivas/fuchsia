...
#ifndef SRC_MODULAR_LIB_MESSAGE_QUEUE_CPP_MESSAGE_SENDER_CLIENT_H_
#define SRC_MODULAR_LIB_MESSAGE_QUEUE_CPP_MESSAGE_SENDER_CLIENT_H_
...
#endif  // SRC_MODULAR_LIB_MESSAGE_QUEUE_CPP_MESSAGE_SENDER_CLIENT_H_
