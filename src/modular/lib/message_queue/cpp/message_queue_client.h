...
#ifndef SRC_MODULAR_LIB_MESSAGE_QUEUE_CPP_MESSAGE_QUEUE_CLIENT_H_
#define SRC_MODULAR_LIB_MESSAGE_QUEUE_CPP_MESSAGE_QUEUE_CLIENT_H_
...
class MessageQueueClient : public fuchsia::modular::MessageReader {
 public:
  using ReceiverCallback = fit::function<void(std::string message, fit::function<void()> ack)>;
 ...
 private:
  ...
  void OnReceive(fuchsia::mem::Buffer message, fit::function<void()> ack) override;
...
#endif  // SRC_MODULAR_LIB_MESSAGE_QUEUE_CPP_MESSAGE_QUEUE_CLIENT_H_
