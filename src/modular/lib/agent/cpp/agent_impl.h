...
#ifndef SRC_MODULAR_LIB_AGENT_CPP_AGENT_IMPL_H_
#define SRC_MODULAR_LIB_AGENT_CPP_AGENT_IMPL_H_
  ...
  class Delegate {
   public:
    virtual void Connect(
        fidl::InterfaceRequest<fuchsia::sys::ServiceProvider> outgoing_services) = 0;
    virtual void RunTask(const fidl::StringPtr& task_id, fit::function<void()> done) = 0;
  };

  AgentImpl(const std::shared_ptr<sys::OutgoingDirectory>& outgoing_services, Delegate* delegate);
...
#endif  // SRC_MODULAR_LIB_AGENT_CPP_AGENT_IMPL_H_
