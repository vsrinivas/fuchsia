...
AgentImpl::AgentImpl(const std::shared_ptr<sys::OutgoingDirectory>& outgoing_services,
...
AgentImpl::AgentImpl(fbl::RefPtr<fs::PseudoDir> directory, Delegate* const delegate)
    : delegate_(delegate), binding_(this) {
  directory->AddEntry(fuchsia::modular::Agent::Name_,
...
void AgentImpl::Connect(std::string requestor_url,
