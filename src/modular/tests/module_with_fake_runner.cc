...
// This module is launched with a specific runner speicifed in its .cmx. The
// module itself does nothing until it's terminated.
...
int main(int /*argc*/, const char** /*argv*/) {
  ...
  modular::ModuleDriver<ModuleWithFakeRunner> driver(context.get(),
                                                     [&loop] { loop.Quit(); });
  loop.Run();
  return 0;
}
