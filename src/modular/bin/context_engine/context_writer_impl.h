...
#ifndef SRC_MODULAR_BIN_CONTEXT_ENGINE_CONTEXT_WRITER_IMPL_H_
#define SRC_MODULAR_BIN_CONTEXT_ENGINE_CONTEXT_WRITER_IMPL_H_
...
#endif  // SRC_MODULAR_BIN_CONTEXT_ENGINE_CONTEXT_WRITER_IMPL_H_
