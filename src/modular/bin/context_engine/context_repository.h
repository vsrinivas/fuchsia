...
#ifndef SRC_MODULAR_BIN_CONTEXT_ENGINE_CONTEXT_REPOSITORY_H_
#define SRC_MODULAR_BIN_CONTEXT_ENGINE_CONTEXT_REPOSITORY_H_
...
#endif  // SRC_MODULAR_BIN_CONTEXT_ENGINE_CONTEXT_REPOSITORY_H_
