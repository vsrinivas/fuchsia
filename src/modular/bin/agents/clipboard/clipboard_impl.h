...
#ifndef SRC_MODULAR_BIN_AGENTS_CLIPBOARD_CLIPBOARD_IMPL_H_
#define SRC_MODULAR_BIN_AGENTS_CLIPBOARD_CLIPBOARD_IMPL_H_
...
#endif  // SRC_MODULAR_BIN_AGENTS_CLIPBOARD_CLIPBOARD_IMPL_H_
