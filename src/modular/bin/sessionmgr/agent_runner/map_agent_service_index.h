...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_AGENT_RUNNER_MAP_AGENT_SERVICE_INDEX_H_
#define SRC_MODULAR_BIN_SESSIONMGR_AGENT_RUNNER_MAP_AGENT_SERVICE_INDEX_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_AGENT_RUNNER_MAP_AGENT_SERVICE_INDEX_H_
