...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_INTELLIGENCE_SERVICES_IMPL_H_
#define SRC_MODULAR_BIN_SESSIONMGR_INTELLIGENCE_SERVICES_IMPL_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_INTELLIGENCE_SERVICES_IMPL_H_
