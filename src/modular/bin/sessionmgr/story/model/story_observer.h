...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_STORY_OBSERVER_H_
#define SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_STORY_OBSERVER_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_STORY_OBSERVER_H_
