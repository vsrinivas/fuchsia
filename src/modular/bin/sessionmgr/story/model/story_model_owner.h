...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_STORY_MODEL_OWNER_H_
#define SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_STORY_MODEL_OWNER_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_STORY_MODEL_OWNER_H_
