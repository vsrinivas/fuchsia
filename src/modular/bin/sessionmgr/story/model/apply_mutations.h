...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_APPLY_MUTATIONS_H_
#define SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_APPLY_MUTATIONS_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_STORY_MODEL_APPLY_MUTATIONS_H_
