...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_PRESENTATION_PROVIDER_H_
#define SRC_MODULAR_BIN_SESSIONMGR_PRESENTATION_PROVIDER_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_PRESENTATION_PROVIDER_H_
