...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_STORY_RUNNER_STORY_ENTITY_PROVIDER_H_
#define SRC_MODULAR_BIN_SESSIONMGR_STORY_RUNNER_STORY_ENTITY_PROVIDER_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_STORY_RUNNER_STORY_ENTITY_PROVIDER_H_
