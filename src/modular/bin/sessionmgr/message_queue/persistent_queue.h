...
#ifndef SRC_MODULAR_BIN_SESSIONMGR_MESSAGE_QUEUE_PERSISTENT_QUEUE_H_
#define SRC_MODULAR_BIN_SESSIONMGR_MESSAGE_QUEUE_PERSISTENT_QUEUE_H_
...
#endif  // SRC_MODULAR_BIN_SESSIONMGR_MESSAGE_QUEUE_PERSISTENT_QUEUE_H_
