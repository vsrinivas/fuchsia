...
#ifndef SRC_MODULAR_BIN_MODULE_RESOLVER_LOCAL_MODULE_RESOLVER_H_
#define SRC_MODULAR_BIN_MODULE_RESOLVER_LOCAL_MODULE_RESOLVER_H_
...
#endif  // SRC_MODULAR_BIN_MODULE_RESOLVER_LOCAL_MODULE_RESOLVER_H_
