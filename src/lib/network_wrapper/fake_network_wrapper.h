...
#ifndef SRC_LIB_NETWORK_WRAPPER_FAKE_NETWORK_WRAPPER_H_
#define SRC_LIB_NETWORK_WRAPPER_FAKE_NETWORK_WRAPPER_H_
...
#endif  // SRC_LIB_NETWORK_WRAPPER_FAKE_NETWORK_WRAPPER_H_
