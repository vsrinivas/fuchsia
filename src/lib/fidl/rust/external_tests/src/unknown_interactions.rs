...
fn two_way_strict_err_sync_send() {
    run_two_way_sync(
        ...
        &[
            0x02, 0x00, 0x00, 0x01, //
            0x63, 0xc5, 0xa8, 0xfe, 0xbd, 0x70, 0x9e, 0x02, //
        ],
        &[
            0x02, 0x00, 0x00, 0x01, //
            0x63, 0xc5, 0xa8, 0xfe, 0xbd, 0x70, 0x9e, 0x02, //
...
fn two_way_flexible_err_sync_send() {
    run_two_way_sync(
        ...
        &[
            0x02, 0x00, 0x80, 0x01, //
            0xa1, 0x16, 0xe1, 0xe4, 0x2e, 0x9b, 0x8e, 0x1a, //
        ],
        &[
            0x02, 0x00, 0x80, 0x01, //
            0xa1, 0x16, 0xe1, 0xe4, 0x2e, 0x9b, 0x8e, 0x1a, //
...
async fn send_strict_err_event() {
    run_send_event(
        ...
        &[
            0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01, //
            0x1e, 0x2f, 0xeb, 0x73, 0xc2, 0xa1, 0xb3, 0x4a, //
...
async fn send_flexible_err_event_success() {
    run_send_event(
        ...
        &[
            0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x80, 0x01, //
            0x22, 0xad, 0xfe, 0x4c, 0x67, 0xc5, 0x75, 0x62, //
            // Result union with success:
            // ordinal  ---------------------------------|
            0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //
            // inline value -----|  nhandles |  flags ---|
