...
class AnyErrorInImpl : private AnyErrorInBase {
 public:
  explicit AnyErrorInImpl(fidl::Error framework_error) : error_(framework_error) {}
  explicit AnyErrorInImpl(DomainError domain_error) : error_(domain_error) {}
...
class AnyErrorIn : public internal::AnyErrorInImpl<internal::NaturalDomainError<FidlMethod>> {
 public:
  using internal::AnyErrorInImpl<internal::NaturalDomainError<FidlMethod>>::AnyErrorInImpl;
};
