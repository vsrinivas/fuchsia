...
using ::fidl::internal_wavl::internal::is_sentinel_ptr;
using ::fidl::internal_wavl::internal::valid_sentinel_ptr;
...
#endif  // SRC_LIB_FIDL_LLCPP_TESTS_DISPATCHER_INTRUSIVE_CONTAINER_INTRUSIVE_WAVL_TREE_CHECKER_H_
