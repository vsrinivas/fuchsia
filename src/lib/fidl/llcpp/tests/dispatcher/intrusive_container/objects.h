...
class TestObj<ContainerTraits_>
    : public ContainerTraits_::TestObjBaseType,
      ...
      public std::conditional_t<ContainerTraits_::ContainerType::PtrTraits::CanCopy,
                                ...
                                fidl::internal_wavl::DefaultObjectTag> {  // just an empty struct
                                                                          // otherwise
 public:
...
class RefedTestObj : public TestObj<ContainerTraits>,
                     public ::fbl::RefCounted<RefedTestObj<ContainerTraits>> {
 public:
...
#endif  // SRC_LIB_FIDL_LLCPP_TESTS_DISPATCHER_INTRUSIVE_CONTAINER_OBJECTS_H_
