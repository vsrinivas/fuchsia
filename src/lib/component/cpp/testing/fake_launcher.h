...
#ifndef SRC_LIB_COMPONENT_CPP_TESTING_FAKE_LAUNCHER_H_
#define SRC_LIB_COMPONENT_CPP_TESTING_FAKE_LAUNCHER_H_
...
#endif  // SRC_LIB_COMPONENT_CPP_TESTING_FAKE_LAUNCHER_H_
