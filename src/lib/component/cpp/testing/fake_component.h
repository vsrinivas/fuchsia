...
#ifndef SRC_LIB_COMPONENT_CPP_TESTING_FAKE_COMPONENT_H_
#define SRC_LIB_COMPONENT_CPP_TESTING_FAKE_COMPONENT_H_
...
#endif  // SRC_LIB_COMPONENT_CPP_TESTING_FAKE_COMPONENT_H_
