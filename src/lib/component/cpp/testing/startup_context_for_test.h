...
#ifndef SRC_LIB_COMPONENT_CPP_TESTING_STARTUP_CONTEXT_FOR_TEST_H_
#define SRC_LIB_COMPONENT_CPP_TESTING_STARTUP_CONTEXT_FOR_TEST_H_
...
#endif  // SRC_LIB_COMPONENT_CPP_TESTING_STARTUP_CONTEXT_FOR_TEST_H_
