...
#ifndef SRC_LIB_COMPONENT_CPP_ENVIRONMENT_SERVICES_HELPER_H_
#define SRC_LIB_COMPONENT_CPP_ENVIRONMENT_SERVICES_HELPER_H_
...
#endif  // SRC_LIB_COMPONENT_CPP_ENVIRONMENT_SERVICES_HELPER_H_
