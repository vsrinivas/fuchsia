...
pub(crate) enum MessageInternal {
    ...
    ScenicPresentSubmitted(ViewKey, fidl_fuchsia_ui_composition::FuturePresentationTimes),
    ScenicPresentDone(ViewKey, fidl_fuchsia_ui_composition::FramePresentedInfo),
    Focus(ViewKey),
