...
#ifndef SRC_LIB_INSPECT_DEPRECATED_QUERY_DISCOVER_H_
#define SRC_LIB_INSPECT_DEPRECATED_QUERY_DISCOVER_H_
...
#endif  // SRC_LIB_INSPECT_DEPRECATED_QUERY_DISCOVER_H_
