...
#ifndef SRC_LIB_INSPECT_DEPRECATED_QUERY_TEXT_FORMATTER_H_
#define SRC_LIB_INSPECT_DEPRECATED_QUERY_TEXT_FORMATTER_H_
...
#endif  // SRC_LIB_INSPECT_DEPRECATED_QUERY_TEXT_FORMATTER_H_
