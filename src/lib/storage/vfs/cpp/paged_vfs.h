...
class PagedVfs : public ManagedVfs {
 public:
  ...
  // UnregisterPagedVmo() to free this reference.
  //
  ...
  //
  // PagedVnodes should unregister themselves when being freed or when the VMO is destroyed to
  // prevent leaks or use-after-free errors.
  //
