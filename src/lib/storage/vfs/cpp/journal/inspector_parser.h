...
#ifndef SRC_LIB_STORAGE_VFS_CPP_JOURNAL_INSPECTOR_PARSER_H_
#define SRC_LIB_STORAGE_VFS_CPP_JOURNAL_INSPECTOR_PARSER_H_
...
#endif  // SRC_LIB_STORAGE_VFS_CPP_JOURNAL_INSPECTOR_PARSER_H_
