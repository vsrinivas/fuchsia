...
#ifndef SRC_LIB_STORAGE_VFS_CPP_JOURNAL_DISK_STRUCT_H_
#define SRC_LIB_STORAGE_VFS_CPP_JOURNAL_DISK_STRUCT_H_
...
#endif  // SRC_LIB_STORAGE_VFS_CPP_JOURNAL_DISK_STRUCT_H_
