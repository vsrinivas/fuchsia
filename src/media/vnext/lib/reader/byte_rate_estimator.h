...
#ifndef SRC_MEDIA_VNEXT_LIB_READER_BYTE_RATE_ESTIMATOR_H_
#define SRC_MEDIA_VNEXT_LIB_READER_BYTE_RATE_ESTIMATOR_H_
...
#endif  // SRC_MEDIA_VNEXT_LIB_READER_BYTE_RATE_ESTIMATOR_H_
