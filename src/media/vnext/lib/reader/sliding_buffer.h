...
#ifndef SRC_MEDIA_VNEXT_LIB_READER_SLIDING_BUFFER_H_
#define SRC_MEDIA_VNEXT_LIB_READER_SLIDING_BUFFER_H_
...
class SlidingBuffer {
 public:
  ...
  explicit SlidingBuffer(size_t capacity);
...
#endif  // SRC_MEDIA_VNEXT_LIB_READER_SLIDING_BUFFER_H_
