...
#ifndef SRC_MEDIA_VNEXT_LIB_FFMPEG_AV_FORMAT_CONTEXT_H_
#define SRC_MEDIA_VNEXT_LIB_FFMPEG_AV_FORMAT_CONTEXT_H_
...
struct AvFormatContext {
  static AvFormatContextPtr OpenInput(const AvIoContextPtr& io_context) {
    ...
    if (r < 0) {
      ...
      FX_CHECK(format_context == nullptr);
...
#endif  // SRC_MEDIA_VNEXT_LIB_FFMPEG_AV_FORMAT_CONTEXT_H_
