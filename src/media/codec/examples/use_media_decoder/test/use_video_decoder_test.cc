          ...
          if (test_params->per_frame_golden_sha256) {
            ...
            if (sha256_so_far != expected_sha256) {
              ...
              if (test_params->compare_to_sw_decode && !test_params->require_sw) {
                ...
                if (0 != use_video_decoder_test(input_file_path, expected_frame_count, use_video_decoder, is_secure_output, is_secure_input, min_output_buffer_count, &sw_decode_test_params)) {
                  emit_frame_failure_seen = true;
                }
              }
              emit_frame_failure_seen = true;
