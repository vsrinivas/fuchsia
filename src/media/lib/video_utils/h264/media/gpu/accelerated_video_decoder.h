...
#ifndef SRC_MEDIA_LIB_VIDEO_UTILS_H264_MEDIA_GPU_ACCELERATED_VIDEO_DECODER_H_
#define SRC_MEDIA_LIB_VIDEO_UTILS_H264_MEDIA_GPU_ACCELERATED_VIDEO_DECODER_H_
...
#endif  // SRC_MEDIA_LIB_VIDEO_UTILS_H264_MEDIA_GPU_ACCELERATED_VIDEO_DECODER_H_
