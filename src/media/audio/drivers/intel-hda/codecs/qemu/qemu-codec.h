...
#ifndef SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_QEMU_QEMU_CODEC_H_
#define SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_QEMU_QEMU_CODEC_H_
...
#endif  // SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_QEMU_QEMU_CODEC_H_
