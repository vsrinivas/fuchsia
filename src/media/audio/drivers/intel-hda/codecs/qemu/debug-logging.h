...
#ifndef SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_QEMU_DEBUG_LOGGING_H_
#define SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_QEMU_DEBUG_LOGGING_H_
...
#endif  // SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_QEMU_DEBUG_LOGGING_H_
