...
#ifndef SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_REALTEK_DEBUG_LOGGING_H_
#define SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_REALTEK_DEBUG_LOGGING_H_
...
#endif  // SRC_MEDIA_AUDIO_DRIVERS_INTEL_HDA_CODECS_REALTEK_DEBUG_LOGGING_H_
