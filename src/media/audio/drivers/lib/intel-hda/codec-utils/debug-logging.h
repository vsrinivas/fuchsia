...
#ifndef SRC_MEDIA_AUDIO_DRIVERS_LIB_INTEL_HDA_CODEC_UTILS_DEBUG_LOGGING_H_
#define SRC_MEDIA_AUDIO_DRIVERS_LIB_INTEL_HDA_CODEC_UTILS_DEBUG_LOGGING_H_
...
#endif  // SRC_MEDIA_AUDIO_DRIVERS_LIB_INTEL_HDA_CODEC_UTILS_DEBUG_LOGGING_H_
