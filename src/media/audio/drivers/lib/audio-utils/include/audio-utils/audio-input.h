...
#ifndef SRC_MEDIA_AUDIO_DRIVERS_LIB_AUDIO_UTILS_INCLUDE_AUDIO_UTILS_AUDIO_INPUT_H_
#define SRC_MEDIA_AUDIO_DRIVERS_LIB_AUDIO_UTILS_INCLUDE_AUDIO_UTILS_AUDIO_INPUT_H_
...
#endif  // SRC_MEDIA_AUDIO_DRIVERS_LIB_AUDIO_UTILS_INCLUDE_AUDIO_UTILS_AUDIO_INPUT_H_
