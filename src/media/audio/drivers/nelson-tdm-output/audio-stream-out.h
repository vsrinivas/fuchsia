...
#ifndef SRC_MEDIA_AUDIO_DRIVERS_NELSON_TDM_OUTPUT_AUDIO_STREAM_OUT_H_
#define SRC_MEDIA_AUDIO_DRIVERS_NELSON_TDM_OUTPUT_AUDIO_STREAM_OUT_H_
...
#endif  // SRC_MEDIA_AUDIO_DRIVERS_NELSON_TDM_OUTPUT_AUDIO_STREAM_OUT_H_
