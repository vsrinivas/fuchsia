...
void VmoHelperBase::DestroyVmo() { io_buffer_release(&buffer_); }
...
void VmoHelper<true>::printoffsetinvmo(uint32_t offset) {
  ...
  zxlogf(TRACE, "Current position: 0x%04x. data: ", offset);
