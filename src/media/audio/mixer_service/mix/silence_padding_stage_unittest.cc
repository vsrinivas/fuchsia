...
TEST(SilencePaddingStageTest, NoSource) {
  ...
  const auto packet = silence_padding_stage.Read(Fixed(0), 20);
...
TEST(SilencePaddingStageTest, AfterOnePacket) {
  ...
  // Silence.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(20), 10);
  ...
  // No further data.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(25), 10);
    ExpectNullPacket(packet);
  }
}
...
TEST(SilencePaddingStageTest, AfterTwoPackets) {
  ...
  // Second source packet.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(20), 20);
  ...
  // Silence.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(40), 10);
  ...
  // No further data.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(45), 10);
    ExpectNullPacket(packet);
  }
}
...
TEST(SilencePaddingStageTest, GapBetweenPacketsLongerThanSilence) {
  ...
  {
    SCOPED_TRACE("Read(20, 10)");
    const auto packet = silence_padding_stage.Read(Fixed(20), 5);
    ExpectPacket(packet, Fixed(20), Fixed(25), 0);
  }
  ...
  // Empty gap.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(25), 20);
    ExpectNullPacket(packet);
  }
  ...
  // Second silence.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(55), 10);
...
TEST(SilencePaddingStageTest, GapBetweenPacketsShorterThanSilence) {
  ...
  // Second source packet.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(21), 20);
...
TEST(SilencePaddingStageTest, GapBetweenPacketsShorterThanSilenceAndFractionalRoundUp) {
  ...
  // Second source packet.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(22), 20);
    ExpectPacket(packet, Fixed(21) + ffl::FromRatio(1, 2), Fixed(31) + ffl::FromRatio(1, 2),
                 expected_sample);
  }
}
...
TEST(SilencePaddingStageTest, CreateRoundsUpNumberOfFrames) {
  ...
  // No more data.
  {
    ...
    const auto packet = silence_padding_stage.Read(Fixed(21), 10);
    ExpectNullPacket(packet);
  }
}
