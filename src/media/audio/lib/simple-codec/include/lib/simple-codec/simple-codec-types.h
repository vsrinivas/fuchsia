...
struct DaiSupportedFormats {
  ...
  // Custom frame formats supported by the codec.
...
struct DaiFormat {
  ...
  // The custom format of all samples in the DAI if frame_format is CUSTOM.
  frame_format_custom_t frame_format_custom;
