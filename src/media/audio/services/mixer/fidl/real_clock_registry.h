...
#ifndef SRC_MEDIA_AUDIO_SERVICES_MIXER_FIDL_REAL_CLOCK_REGISTRY_H_
#define SRC_MEDIA_AUDIO_SERVICES_MIXER_FIDL_REAL_CLOCK_REGISTRY_H_
...
#endif  // SRC_MEDIA_AUDIO_SERVICES_MIXER_FIDL_REAL_CLOCK_REGISTRY_H_
