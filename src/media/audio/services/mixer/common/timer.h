...
#ifndef SRC_MEDIA_AUDIO_SERVICES_MIXER_COMMON_TIMER_H_
#define SRC_MEDIA_AUDIO_SERVICES_MIXER_COMMON_TIMER_H_
...
#endif  // SRC_MEDIA_AUDIO_SERVICES_MIXER_COMMON_TIMER_H_
