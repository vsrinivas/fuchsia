...
#ifndef SRC_MEDIA_AUDIO_SERVICES_COMMON_FIDL_THREAD_H_
#define SRC_MEDIA_AUDIO_SERVICES_COMMON_FIDL_THREAD_H_
...
#endif  // SRC_MEDIA_AUDIO_SERVICES_COMMON_FIDL_THREAD_H_
