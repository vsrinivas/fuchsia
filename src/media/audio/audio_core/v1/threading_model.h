...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_THREADING_MODEL_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_THREADING_MODEL_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_THREADING_MODEL_H_
