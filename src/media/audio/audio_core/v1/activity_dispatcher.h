...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_ACTIVITY_DISPATCHER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_ACTIVITY_DISPATCHER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_ACTIVITY_DISPATCHER_H_
