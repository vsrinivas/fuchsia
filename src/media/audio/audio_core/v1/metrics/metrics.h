...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_METRICS_METRICS_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_METRICS_METRICS_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_METRICS_METRICS_H_
