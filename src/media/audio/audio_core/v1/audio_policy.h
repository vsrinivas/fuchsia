...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_AUDIO_POLICY_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_AUDIO_POLICY_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_AUDIO_POLICY_H_
