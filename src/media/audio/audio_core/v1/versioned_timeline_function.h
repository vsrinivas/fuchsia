...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_VERSIONED_TIMELINE_FUNCTION_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_VERSIONED_TIMELINE_FUNCTION_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_VERSIONED_TIMELINE_FUNCTION_H_
