...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_PROCESS_CONFIG_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_PROCESS_CONFIG_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_PROCESS_CONFIG_H_
