...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_V1_THROTTLE_OUTPUT_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_V1_THROTTLE_OUTPUT_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_V1_THROTTLE_OUTPUT_H_
