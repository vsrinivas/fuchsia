...
const std::array<uint32_t, FrequencySet::kNumReferenceFreqs> FrequencySet::kReferenceFreqs = {
    ...
    28673, 30103, 31949, 32768, 33451, 34133, 35497, 38227, 43007, 54613, 60073, 60209,
    64853, 65535, 98303, 131071 };
...
const std::array<uint32_t, FrequencySet::kNumReferenceFreqs> FrequencySet::kRefFreqsTranslated = {
    ...
    21001, 22049, 23400, 24000, 24500, 25000, 26000, 28000, 31500, 40000, 44000, 44100,
    47500, 47999, 71999, 95999  };
