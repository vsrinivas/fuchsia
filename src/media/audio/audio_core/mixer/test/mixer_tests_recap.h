...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_MIXER_TEST_MIXER_TESTS_RECAP_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_MIXER_TEST_MIXER_TESTS_RECAP_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_MIXER_TEST_MIXER_TESTS_RECAP_H_
