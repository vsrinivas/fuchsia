...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_MATCHERS_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_MATCHERS_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_TESTING_MATCHERS_H_
