...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_ACTIVE_STREAM_COUNT_REPORTER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_ACTIVE_STREAM_COUNT_REPORTER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_ACTIVE_STREAM_COUNT_REPORTER_H_
