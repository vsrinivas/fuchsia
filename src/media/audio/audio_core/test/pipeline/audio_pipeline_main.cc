...
class AudioPipelineEnvironment : public testing::Environment {
 public:
  ...
  void SetUp() override {
    ...
    // We use this Control to enable virtualaudio prior to tests that require
...
int main(int argc, char** argv) {
  ...
  testing::AddGlobalTestEnvironment(new media::audio::test::AudioPipelineEnvironment);
