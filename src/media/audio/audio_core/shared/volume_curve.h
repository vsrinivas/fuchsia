...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_VOLUME_CURVE_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_VOLUME_CURVE_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_VOLUME_CURVE_H_
