...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_MIXER_CONSTANTS_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_MIXER_CONSTANTS_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_MIXER_CONSTANTS_H_
