...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_MIXER_SINC_SAMPLER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_MIXER_SINC_SAMPLER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_MIXER_SINC_SAMPLER_H_
