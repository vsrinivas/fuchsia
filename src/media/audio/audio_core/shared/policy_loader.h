...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_POLICY_LOADER_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_POLICY_LOADER_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_POLICY_LOADER_H_
