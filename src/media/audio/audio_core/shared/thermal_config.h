...
#ifndef SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_THERMAL_CONFIG_H_
#define SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_THERMAL_CONFIG_H_
...
#endif  // SRC_MEDIA_AUDIO_AUDIO_CORE_SHARED_THERMAL_CONFIG_H_
