...
#ifndef SRC_MEDIA_DRIVERS_AMLOGIC_ENCODER_INTERNAL_BUFFER_H_
#define SRC_MEDIA_DRIVERS_AMLOGIC_ENCODER_INTERNAL_BUFFER_H_
...
// fuchsia::sysmem::HeapType::SYSTEM_RAM memory
class InternalBuffer {
 public:
  ...
  //
  // |is_mapping_needed| if a mapping to the allocated buffer is needed.
  ...
  zx_status_t vmo_duplicate(zx::vmo* dup);

  // flushes cache, or panics if the flush doesn't work.
  //
 ...
 private:
  InternalBuffer(size_t size, bool is_writable, bool is_mapping_needed);
...
#endif  // SRC_MEDIA_DRIVERS_AMLOGIC_ENCODER_INTERNAL_BUFFER_H_
