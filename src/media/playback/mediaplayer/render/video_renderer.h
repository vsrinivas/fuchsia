...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_RENDER_VIDEO_RENDERER_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_RENDER_VIDEO_RENDERER_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_RENDER_VIDEO_RENDERER_H_
