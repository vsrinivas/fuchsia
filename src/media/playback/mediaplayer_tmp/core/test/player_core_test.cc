...
#include "src/media/playback/mediaplayer_tmp/core/player_core.h"
...
#include "src/media/playback/mediaplayer_tmp/core/test/fake_audio_renderer.h"
#include "src/media/playback/mediaplayer_tmp/core/test/fake_demux.h"
#include "src/media/playback/mediaplayer_tmp/core/test/fake_sink_segment.h"
#include "src/media/playback/mediaplayer_tmp/core/test/fake_source_segment.h"
#include "src/media/playback/mediaplayer_tmp/core/test/fake_video_renderer.h"
...
void ExpectRealSegmentsGraph(const PlayerCore& player_core) {
  ...
  EXPECT_EQ(0, strcmp("FakeDemux", source_node_ref.GetNode()->label()));
