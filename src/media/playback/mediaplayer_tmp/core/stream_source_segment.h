...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_STREAM_SOURCE_SEGMENT_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_STREAM_SOURCE_SEGMENT_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_STREAM_SOURCE_SEGMENT_H_
