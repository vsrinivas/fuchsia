...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_PLAYER_CORE_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_PLAYER_CORE_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_PLAYER_CORE_H_
