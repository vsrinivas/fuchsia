...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_DEMUX_SOURCE_SEGMENT_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_DEMUX_SOURCE_SEGMENT_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_DEMUX_SOURCE_SEGMENT_H_
