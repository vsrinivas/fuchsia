...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_CONVERSION_PIPELINE_BUILDER_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_CONVERSION_PIPELINE_BUILDER_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_CORE_CONVERSION_PIPELINE_BUILDER_H_
