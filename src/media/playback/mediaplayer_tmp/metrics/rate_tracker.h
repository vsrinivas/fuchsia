...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_METRICS_RATE_TRACKER_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_METRICS_RATE_TRACKER_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_METRICS_RATE_TRACKER_H_
