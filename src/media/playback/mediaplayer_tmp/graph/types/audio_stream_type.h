...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_GRAPH_TYPES_AUDIO_STREAM_TYPE_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_GRAPH_TYPES_AUDIO_STREAM_TYPE_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_GRAPH_TYPES_AUDIO_STREAM_TYPE_H_
