...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_GRAPH_PAYLOADS_PAYLOAD_ALLOCATOR_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_GRAPH_PAYLOADS_PAYLOAD_ALLOCATOR_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_GRAPH_PAYLOADS_PAYLOAD_ALLOCATOR_H_
