...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_RENDER_RENDERER_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_RENDER_RENDERER_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_RENDER_RENDERER_H_
