...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_MEDIAPLAYER_TEST_UTIL_VIEW_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_MEDIAPLAYER_TEST_UTIL_VIEW_H_
...
#include "src/media/playback/mediaplayer_tmp/test/command_queue.h"
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_MEDIAPLAYER_TEST_UTIL_VIEW_H_
