...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_MEDIAPLAYER_TEST_UTIL_PARAMS_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_MEDIAPLAYER_TEST_UTIL_PARAMS_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_MEDIAPLAYER_TEST_UTIL_PARAMS_H_
