...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_FAKES_FAKE_AUDIO_RENDERER_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_FAKES_FAKE_AUDIO_RENDERER_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_FAKES_FAKE_AUDIO_RENDERER_H_
