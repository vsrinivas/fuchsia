...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_FAKES_FAKE_SCENIC_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_FAKES_FAKE_SCENIC_H_
...
#include "src/media/playback/mediaplayer_tmp/test/fakes/fake_session.h"
#include "src/media/playback/mediaplayer_tmp/test/fakes/fake_view_manager.h"
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_FAKES_FAKE_SCENIC_H_
