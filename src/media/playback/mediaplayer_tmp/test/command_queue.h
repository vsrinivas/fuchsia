...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_COMMAND_QUEUE_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_COMMAND_QUEUE_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_TEST_COMMAND_QUEUE_H_
