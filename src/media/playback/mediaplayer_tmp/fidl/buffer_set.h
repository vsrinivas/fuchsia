...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_FIDL_BUFFER_SET_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_FIDL_BUFFER_SET_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_FIDL_BUFFER_SET_H_
