...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_FIDL_FIDL_DECODER_FACTORY_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_FIDL_FIDL_DECODER_FACTORY_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_FIDL_FIDL_DECODER_FACTORY_H_
