...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_DEMUX_BYTE_RATE_ESTIMATOR_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_DEMUX_BYTE_RATE_ESTIMATOR_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_DEMUX_BYTE_RATE_ESTIMATOR_H_