...
#ifndef SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_DEMUX_READER_H_
#define SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_DEMUX_READER_H_
...
#endif  // SRC_MEDIA_PLAYBACK_MEDIAPLAYER_TMP_DEMUX_READER_H_
