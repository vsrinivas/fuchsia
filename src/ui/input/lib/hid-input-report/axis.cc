...
fuchsia_input_report::wire::Unit HidUnitToLlcppUnit(hid::unit::UnitType unit) {
  ...
  switch (unit) {
    ...
    case hid::unit::UnitType::Distance:
      out_unit.type = fuchsia_input_report::wire::UnitType::METERS;
      out_unit.exponent = -6;
      return out_unit;
    case hid::unit::UnitType::Weight:
      out_unit.type = fuchsia_input_report::wire::UnitType::GRAMS;
      out_unit.exponent = -3;
      return out_unit;
    case hid::unit::UnitType::Rotation:
      out_unit.type = fuchsia_input_report::wire::UnitType::DEGREES;
      out_unit.exponent = -3;
      return out_unit;
    case hid::unit::UnitType::AngularVelocity:
      out_unit.type = fuchsia_input_report::wire::UnitType::ENGLISH_ANGULAR_VELOCITY;
      out_unit.exponent = -3;
      return out_unit;
    case hid::unit::UnitType::LinearVelocity:
      out_unit.type = fuchsia_input_report::wire::UnitType::SI_LINEAR_VELOCITY;
      out_unit.exponent = -3;
      return out_unit;
    case hid::unit::UnitType::Acceleration:
      out_unit.type = fuchsia_input_report::wire::UnitType::SI_LINEAR_ACCELERATION;
      out_unit.exponent = -3;
      return out_unit;
    case hid::unit::UnitType::MagneticFlux:
      out_unit.type = fuchsia_input_report::wire::UnitType::WEBERS;
      out_unit.exponent = -6;
      return out_unit;
    case hid::unit::UnitType::Light:
      out_unit.type = fuchsia_input_report::wire::UnitType::CANDELAS;
      out_unit.exponent = 0;
      return out_unit;
    case hid::unit::UnitType::Pressure:
      out_unit.type = fuchsia_input_report::wire::UnitType::PASCALS;
      out_unit.exponent = -3;
      return out_unit;
    case hid::unit::UnitType::Lux:
      out_unit.type = fuchsia_input_report::wire::UnitType::LUX;
      out_unit.exponent = -6;
      return out_unit;
    default:
      out_unit.type = fuchsia_input_report::wire::UnitType::OTHER;
      out_unit.exponent = 0;
      return out_unit;
  }
}
...
zx_status_t HidSensorUsageToLlcppSensorType(hid::usage::Sensor usage,
  ...
  switch (usage) {
    case hid::usage::Sensor::kAccelerationAxisX:
      *type = fuchsia_input_report::wire::SensorType::ACCELEROMETER_X;
      break;
    case hid::usage::Sensor::kAccelerationAxisY:
      *type = fuchsia_input_report::wire::SensorType::ACCELEROMETER_Y;
      break;
    case hid::usage::Sensor::kAccelerationAxisZ:
      *type = fuchsia_input_report::wire::SensorType::ACCELEROMETER_Z;
      break;
    case hid::usage::Sensor::kMagneticFluxAxisX:
      *type = fuchsia_input_report::wire::SensorType::MAGNETOMETER_X;
      break;
    case hid::usage::Sensor::kMagneticFluxAxisY:
      *type = fuchsia_input_report::wire::SensorType::MAGNETOMETER_Y;
      break;
    case hid::usage::Sensor::kMagneticFluxAxisZ:
      *type = fuchsia_input_report::wire::SensorType::MAGNETOMETER_Z;
      break;
    case hid::usage::Sensor::kAngularVelocityX:
      *type = fuchsia_input_report::wire::SensorType::GYROSCOPE_X;
      break;
    case hid::usage::Sensor::kAngularVelocityY:
      *type = fuchsia_input_report::wire::SensorType::GYROSCOPE_Y;
      break;
    case hid::usage::Sensor::kAngularVelocityZ:
      *type = fuchsia_input_report::wire::SensorType::GYROSCOPE_Z;
      break;
    case hid::usage::Sensor::kLightIlluminance:
      *type = fuchsia_input_report::wire::SensorType::LIGHT_ILLUMINANCE;
      break;
    case hid::usage::Sensor::kLightRedLight:
      *type = fuchsia_input_report::wire::SensorType::LIGHT_RED;
      break;
    case hid::usage::Sensor::kLightBlueLight:
      *type = fuchsia_input_report::wire::SensorType::LIGHT_BLUE;
      break;
    case hid::usage::Sensor::kLightGreenLight:
      *type = fuchsia_input_report::wire::SensorType::LIGHT_GREEN;
      break;
    default:
...
zx_status_t HidLedUsageToLlcppLedType(hid::usage::LEDs usage,
  ...
  switch (usage) {
    case hid::usage::LEDs::kNumLock:
      *type = fuchsia_input_report::wire::LedType::NUM_LOCK;
      break;
    case hid::usage::LEDs::kCapsLock:
      *type = fuchsia_input_report::wire::LedType::CAPS_LOCK;
      break;
    case hid::usage::LEDs::kScrollLock:
      *type = fuchsia_input_report::wire::LedType::SCROLL_LOCK;
      break;
    case hid::usage::LEDs::kCompose:
      *type = fuchsia_input_report::wire::LedType::COMPOSE;
      break;
    case hid::usage::LEDs::kKana:
      *type = fuchsia_input_report::wire::LedType::KANA;
      break;
    default:
      return ZX_ERR_NOT_SUPPORTED;
  }
