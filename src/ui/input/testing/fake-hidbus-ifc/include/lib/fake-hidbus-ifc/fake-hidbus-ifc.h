...
#ifndef SRC_UI_INPUT_TESTING_FAKE_HIDBUS_IFC_INCLUDE_LIB_FAKE_HIDBUS_IFC_FAKE_HIDBUS_IFC_H_
#define SRC_UI_INPUT_TESTING_FAKE_HIDBUS_IFC_INCLUDE_LIB_FAKE_HIDBUS_IFC_FAKE_HIDBUS_IFC_H_
...
class FakeHidbusIfc : public ddk::HidbusIfcProtocol<FakeHidbusIfc> {
 public:
  ...
  void HidbusIfcIoQueue(const uint8_t* buf_buffer, size_t buf_size, zx_time_t time) {
    reports_seen_++;
...
#endif  // SRC_UI_INPUT_TESTING_FAKE_HIDBUS_IFC_INCLUDE_LIB_FAKE_HIDBUS_IFC_FAKE_HIDBUS_IFC_H_
