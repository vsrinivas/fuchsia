...
#ifndef SRC_UI_DRIVERS_INPUT_REPORT_INJECT_INPUT_REPORT_INJECT_INSTANCE_H_
#define SRC_UI_DRIVERS_INPUT_REPORT_INJECT_INPUT_REPORT_INJECT_INSTANCE_H_
...
#endif  // SRC_UI_DRIVERS_INPUT_REPORT_INJECT_INPUT_REPORT_INJECT_INSTANCE_H_
