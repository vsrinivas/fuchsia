...
/// Type of the integration testing environment to setup.
pub enum EnvironmentType {
    /// Start Scenic and RootPresenter and wait for complete initialization.
    ScenicWithRootPresenter,
}

/// Provides setup and utility methods for UI integration tests that use `Scenic` and `RootPresenter`.
pub struct Service {
    session: SessionPtr,
...
/// Setup UI integration testing environment and wait for full setup of dependent services.
