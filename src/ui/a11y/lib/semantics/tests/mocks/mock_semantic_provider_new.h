...
#ifndef SRC_UI_A11Y_LIB_SEMANTICS_TESTS_MOCKS_MOCK_SEMANTIC_PROVIDER_NEW_H_
#define SRC_UI_A11Y_LIB_SEMANTICS_TESTS_MOCKS_MOCK_SEMANTIC_PROVIDER_NEW_H_
...
class MockSemanticProviderNew {
 public:
  ...
  explicit MockSemanticProviderNew(fuchsia::accessibility::semantics::SemanticsManager* manager);
  ~MockSemanticProviderNew() = default;
...
#endif  // SRC_UI_A11Y_LIB_SEMANTICS_TESTS_MOCKS_MOCK_SEMANTIC_PROVIDER_NEW_H_
