...
#ifndef SRC_UI_LIB_ESCHER_RESOURCES_WAITABLE_RESOURCE_H_
#define SRC_UI_LIB_ESCHER_RESOURCES_WAITABLE_RESOURCE_H_
...
#endif  // SRC_UI_LIB_ESCHER_RESOURCES_WAITABLE_RESOURCE_H_
