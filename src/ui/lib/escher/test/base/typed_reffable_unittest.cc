...
const TestTypeInfo SubOne::kTypeInfo("SubOne", TestTypes::kOne, TestTypes::kSubOne);
const TestTypeInfo SubTwo::kTypeInfo("SubTwo", TestTypes::kTwo, TestTypes::kSubTwo);
const TestTypeInfo SubSubTwo::kTypeInfo("SubSubTwo", TestTypes::kTwo, TestTypes::kSubTwo,
                                        TestTypes::kSubSubTwo);
const TestTypeInfo SubSubSubTwo::kTypeInfo("SubSubSubTwo", TestTypes::kTwo, TestTypes::kSubTwo,
                                           TestTypes::kSubSubTwo, TestTypes::kSubSubSubTwo);
