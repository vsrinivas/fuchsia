...
#ifndef SRC_UI_LIB_ESCHER_IMPL_UNIFORM_BUFFER_POOL_H_
#define SRC_UI_LIB_ESCHER_IMPL_UNIFORM_BUFFER_POOL_H_
...
#endif  // SRC_UI_LIB_ESCHER_IMPL_UNIFORM_BUFFER_POOL_H_
