...
#ifndef SRC_UI_LIB_ESCHER_IMPL_VK_PIPELINE_FACTORY_H_
#define SRC_UI_LIB_ESCHER_IMPL_VK_PIPELINE_FACTORY_H_
...
#endif  // SRC_UI_LIB_ESCHER_IMPL_VK_PIPELINE_FACTORY_H_
