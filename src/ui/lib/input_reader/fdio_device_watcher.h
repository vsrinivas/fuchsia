...
#ifndef SRC_UI_LIB_INPUT_READER_FDIO_DEVICE_WATCHER_H_
#define SRC_UI_LIB_INPUT_READER_FDIO_DEVICE_WATCHER_H_
...
#endif  // SRC_UI_LIB_INPUT_READER_FDIO_DEVICE_WATCHER_H_
