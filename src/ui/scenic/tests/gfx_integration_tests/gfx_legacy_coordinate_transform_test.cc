...
class GfxLegacyCoordinateTransformTest : public zxtest::Test, public loop_fixture::RealLoop {
 protected:
...
TEST_F(GfxLegacyCoordinateTransformTest, Rotated) {
...

  {
    ...
    const auto rotation_quaternion = angleAxis(static_cast<float>(M_PI) / 2, {0, 0, 1});
    view_holder.SetRotation(rotation_quaternion[0], rotation_quaternion[1], rotation_quaternion[2],
