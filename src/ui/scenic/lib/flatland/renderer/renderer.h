...
// Used to reference buffer collections registered with the Renderer.
...
class Renderer {
 public:
  ...
  inline static const BufferCollectionId kInvalidId = 0;
  ...
  //
  // Upon registration, this function returns a BufferCollectionId to be used as a unique ID
  ...
  virtual std::optional<BufferCollectionMetadata> Validate(BufferCollectionId collection_id) = 0;
