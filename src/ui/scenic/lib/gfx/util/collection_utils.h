...
#ifndef SRC_UI_SCENIC_LIB_GFX_UTIL_COLLECTION_UTILS_H_
#define SRC_UI_SCENIC_LIB_GFX_UTIL_COLLECTION_UTILS_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_UTIL_COLLECTION_UTILS_H_
