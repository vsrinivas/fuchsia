...
#ifndef SRC_UI_SCENIC_LIB_GFX_UTIL_WRAP_H_
#define SRC_UI_SCENIC_LIB_GFX_UTIL_WRAP_H_
...
inline ::fuchsia::ui::gfx::mat4 Wrap(const escher::mat4& args) {
  ...
  FX_DCHECK(value.matrix.size() == 16);
...
#endif  // SRC_UI_SCENIC_LIB_GFX_UTIL_WRAP_H_
