...
#ifndef SRC_UI_SCENIC_LIB_GFX_ENGINE_HARDWARE_LAYER_ASSIGNMENT_H_
#define SRC_UI_SCENIC_LIB_GFX_ENGINE_HARDWARE_LAYER_ASSIGNMENT_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_ENGINE_HARDWARE_LAYER_ASSIGNMENT_H_
