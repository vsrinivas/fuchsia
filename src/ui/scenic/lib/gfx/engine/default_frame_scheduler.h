...
#ifndef SRC_UI_SCENIC_LIB_GFX_ENGINE_DEFAULT_FRAME_SCHEDULER_H_
#define SRC_UI_SCENIC_LIB_GFX_ENGINE_DEFAULT_FRAME_SCHEDULER_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_ENGINE_DEFAULT_FRAME_SCHEDULER_H_
