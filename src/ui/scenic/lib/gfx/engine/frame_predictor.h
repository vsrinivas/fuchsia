...
#ifndef SRC_UI_SCENIC_LIB_GFX_ENGINE_FRAME_PREDICTOR_H_
#define SRC_UI_SCENIC_LIB_GFX_ENGINE_FRAME_PREDICTOR_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_ENGINE_FRAME_PREDICTOR_H_
