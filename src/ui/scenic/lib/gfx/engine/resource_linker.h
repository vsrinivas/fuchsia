...
#ifndef SRC_UI_SCENIC_LIB_GFX_ENGINE_RESOURCE_LINKER_H_
#define SRC_UI_SCENIC_LIB_GFX_ENGINE_RESOURCE_LINKER_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_ENGINE_RESOURCE_LINKER_H_
