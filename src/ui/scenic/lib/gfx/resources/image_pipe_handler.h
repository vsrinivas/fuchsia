...
#ifndef SRC_UI_SCENIC_LIB_GFX_RESOURCES_IMAGE_PIPE_HANDLER_H_
#define SRC_UI_SCENIC_LIB_GFX_RESOURCES_IMAGE_PIPE_HANDLER_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_RESOURCES_IMAGE_PIPE_HANDLER_H_
