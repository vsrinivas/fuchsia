...
#ifndef SRC_UI_SCENIC_LIB_GFX_RESOURCES_RENDERERS_RENDERER_H_
#define SRC_UI_SCENIC_LIB_GFX_RESOURCES_RENDERERS_RENDERER_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_RESOURCES_RENDERERS_RENDERER_H_
