...
#ifndef SRC_UI_SCENIC_LIB_GFX_TESTS_MOCK_POSE_BUFFER_PROVIDER_H_
#define SRC_UI_SCENIC_LIB_GFX_TESTS_MOCK_POSE_BUFFER_PROVIDER_H_
...
#endif  // SRC_UI_SCENIC_LIB_GFX_TESTS_MOCK_POSE_BUFFER_PROVIDER_H_
