...
TEST_F(ShapeTest, Circle) {
  ...
  float distance = -1.f;
  EXPECT_TRUE(circle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(0.f, distance);
  EXPECT_TRUE(circle->GetIntersection(ray4{vec4(0.f, 0.f, -5.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(5.f, distance);
  EXPECT_TRUE(circle->GetIntersection(ray4{vec4(50.f, 0.f, -10.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(10.f, distance);
  EXPECT_TRUE(circle->GetIntersection(
      ray4{vec4(50.f * kSqrt2_2, -50.f * kSqrt2_2, 0.f, 1.f) - 40.f * kAngledVector, kAngledVector},
      &distance));
  EXPECT_EQ(40.f, distance);
  EXPECT_TRUE(circle->GetIntersection(
      ray4{vec4(50.f * kSqrt2_2 * 3.f, -50.f * kSqrt2_2 * 3.f, 0.f, 3.f) - 40.f * kAngledVector,
           kAngledVector},
      &distance));
  EXPECT_EQ(40.f, distance);

  EXPECT_FALSE(circle->GetIntersection(ray4{vec4(0.f, 0.f, 1.f, 1.f), kDownVector}, &distance));
  EXPECT_FALSE(circle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kUpVector}, &distance));
  EXPECT_FALSE(circle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kSideVector}, &distance));
  EXPECT_FALSE(circle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kZeroVector}, &distance));
  EXPECT_FALSE(circle->GetIntersection(
      ray4{vec4(50.1f * kSqrt2_2, -50.1f * kSqrt2_2, 0.f, 1.f) - 40.f * kAngledVector,
           kAngledVector},
      &distance));
}
...
TEST_F(ShapeTest, Rectangle) {
  ...
  float distance = -1.f;
  EXPECT_TRUE(rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(0.f, distance);
  EXPECT_TRUE(rectangle->GetIntersection(ray4{vec4(0.f, 0.f, -5.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(5.f, distance);
  EXPECT_TRUE(
      rectangle->GetIntersection(ray4{vec4(15.f, 20.f, -10.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(10.f, distance);
  EXPECT_TRUE(rectangle->GetIntersection(
      ray4{vec4(15.f, -20.f, 0.f, 1.f) - 40.f * kAngledVector, kAngledVector}, &distance));
  EXPECT_EQ(40.f, distance);
  EXPECT_TRUE(rectangle->GetIntersection(
      ray4{vec4(15.f * 3.f, -20.f * 3.f, 0.f, 3.f) - 40.f * kAngledVector, kAngledVector},
      &distance));
  EXPECT_EQ(40.f, distance);

  EXPECT_FALSE(rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 1.f, 1.f), kDownVector}, &distance));
  EXPECT_FALSE(rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kUpVector}, &distance));
  EXPECT_FALSE(rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kSideVector}, &distance));
  EXPECT_FALSE(rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kZeroVector}, &distance));
...
TEST_F(ShapeTest, DISABLED_RoundedRectangle) {
  const ResourceId id = 1;
  EXPECT_TRUE(Apply(scenic::NewCreateRoundedRectangleCmd(id, 30.f, 40.f, 2.f, 4.f, 6.f, 8.f)));
  ...
  EXPECT_TRUE(
      rounded_rectangle->ContainsPoint(vec2(15.f - 4.f * kSqrt2_2, -20.f + 4.f * kSqrt2_2)));
  EXPECT_TRUE(rounded_rectangle->ContainsPoint(vec2(0.f, -20.f)));
  EXPECT_TRUE(
      rounded_rectangle->ContainsPoint(vec2(-15.f + 2.f * kSqrt2_2, -20.f + 2.f * kSqrt2_2)));
  EXPECT_TRUE(rounded_rectangle->ContainsPoint(vec2(-15.f, 0.f)));
  EXPECT_TRUE(
      rounded_rectangle->ContainsPoint(vec2(-15.f + 8.f * kSqrt2_2, 20.f - 8.f * kSqrt2_2)));
  EXPECT_TRUE(rounded_rectangle->ContainsPoint(vec2(0.f, 20.f)));
  EXPECT_TRUE(rounded_rectangle->ContainsPoint(vec2(15.f - 6.f * kSqrt2_2, 20.f - 6.f * kSqrt2_2)));
  ...
  float distance = -1.f;
  EXPECT_TRUE(
      rounded_rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(0.f, distance);
  EXPECT_TRUE(
      rounded_rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 5.f, 1.f), kDownVector}, &distance));
  EXPECT_EQ(5.f, distance);
  EXPECT_TRUE(rounded_rectangle->GetIntersection(
      ray4{vec4(15.f - 4.f * kSqrt2_2, -20.f + 4.f * kSqrt2_2, 10.f, 1.f), kDownVector},
      &distance));
  EXPECT_EQ(10.f, distance);
  EXPECT_TRUE(rounded_rectangle->GetIntersection(
      ray4{vec4(15.f - 4.f * kSqrt2_2, -20.f + 4.f * kSqrt2_2, 0.f, 1.f) - 40.f * kAngledVector,
           kAngledVector},
      &distance));
  EXPECT_EQ(40.f, distance);
  EXPECT_TRUE(rounded_rectangle->GetIntersection(
      ray4{vec4((15.f - 4.f * kSqrt2_2) * 3.f, (-20.f + 4.f * kSqrt2_2) * 3.f, 0.f, 3.f) -
               40.f * kAngledVector,
           kAngledVector},
      &distance));
  EXPECT_EQ(40.f, distance);
  ...
  EXPECT_FALSE(
      rounded_rectangle->GetIntersection(ray4{vec4(0.f, 0.f, -1.f, 1.f), kDownVector}, &distance));
  EXPECT_FALSE(
      rounded_rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kUpVector}, &distance));
  EXPECT_FALSE(
      rounded_rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kSideVector}, &distance));
  EXPECT_FALSE(
      rounded_rectangle->GetIntersection(ray4{vec4(0.f, 0.f, 0.f, 1.f), kZeroVector}, &distance));
  EXPECT_FALSE(rounded_rectangle->GetIntersection(
      ray4{vec4(15.1f - 4.f * kSqrt2_2, -20.1f + 4.f * kSqrt2_2, 0.f, 1.f) - 40.f * kAngledVector,
           kAngledVector},
      &distance));
}
