...
#ifndef SRC_UI_SCENIC_LIB_SCENIC_UTIL_RK4_SPRING_SIMULATION_H_
#define SRC_UI_SCENIC_LIB_SCENIC_UTIL_RK4_SPRING_SIMULATION_H_
...
#endif  // SRC_UI_SCENIC_LIB_SCENIC_UTIL_RK4_SPRING_SIMULATION_H_
