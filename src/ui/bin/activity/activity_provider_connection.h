...
#ifndef SRC_UI_BIN_ACTIVITY_ACTIVITY_PROVIDER_CONNECTION_H_
#define SRC_UI_BIN_ACTIVITY_ACTIVITY_PROVIDER_CONNECTION_H_
...
#endif  // SRC_UI_BIN_ACTIVITY_ACTIVITY_PROVIDER_CONNECTION_H_
