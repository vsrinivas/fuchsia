...
#ifndef SRC_UI_BIN_ROOT_PRESENTER_ACTIVITY_NOTIFIER_H_
#define SRC_UI_BIN_ROOT_PRESENTER_ACTIVITY_NOTIFIER_H_
...
#endif  // SRC_UI_BIN_ROOT_PRESENTER_ACTIVITY_NOTIFIER_H_
