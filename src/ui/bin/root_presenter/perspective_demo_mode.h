...
#ifndef SRC_UI_BIN_ROOT_PRESENTER_PERSPECTIVE_DEMO_MODE_H_
#define SRC_UI_BIN_ROOT_PRESENTER_PERSPECTIVE_DEMO_MODE_H_
...
#endif  // SRC_UI_BIN_ROOT_PRESENTER_PERSPECTIVE_DEMO_MODE_H_
