...
#ifndef SRC_UI_BIN_ROOT_PRESENTER_PRESENTATION_SWITCHER_H_
#define SRC_UI_BIN_ROOT_PRESENTER_PRESENTATION_SWITCHER_H_
...
#endif  // SRC_UI_BIN_ROOT_PRESENTER_PRESENTATION_SWITCHER_H_
