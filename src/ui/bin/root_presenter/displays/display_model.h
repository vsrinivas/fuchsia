...
#ifndef SRC_UI_BIN_ROOT_PRESENTER_DISPLAYS_DISPLAY_MODEL_H_
#define SRC_UI_BIN_ROOT_PRESENTER_DISPLAYS_DISPLAY_MODEL_H_
...
#endif  // SRC_UI_BIN_ROOT_PRESENTER_DISPLAYS_DISPLAY_MODEL_H_
