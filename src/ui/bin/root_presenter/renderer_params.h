...
#ifndef SRC_UI_BIN_ROOT_PRESENTER_RENDERER_PARAMS_H_
#define SRC_UI_BIN_ROOT_PRESENTER_RENDERER_PARAMS_H_
...
#endif  // SRC_UI_BIN_ROOT_PRESENTER_RENDERER_PARAMS_H_
