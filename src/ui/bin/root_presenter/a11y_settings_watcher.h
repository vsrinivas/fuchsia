...
#ifndef SRC_UI_BIN_ROOT_PRESENTER_A11Y_SETTINGS_WATCHER_H_
#define SRC_UI_BIN_ROOT_PRESENTER_A11Y_SETTINGS_WATCHER_H_
...
#endif  // SRC_UI_BIN_ROOT_PRESENTER_A11Y_SETTINGS_WATCHER_H_
