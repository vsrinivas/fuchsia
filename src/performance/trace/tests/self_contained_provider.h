...
#ifndef SRC_PERFORMANCE_TRACE_TESTS_SELF_CONTAINED_PROVIDER_H_
#define SRC_PERFORMANCE_TRACE_TESTS_SELF_CONTAINED_PROVIDER_H_
...
#endif  // SRC_PERFORMANCE_TRACE_TESTS_SELF_CONTAINED_PROVIDER_H_
