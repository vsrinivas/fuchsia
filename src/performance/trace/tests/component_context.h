...
#ifndef SRC_PERFORMANCE_TRACE_TESTS_COMPONENT_CONTEXT_H_
#define SRC_PERFORMANCE_TRACE_TESTS_COMPONENT_CONTEXT_H_
...
#endif  // SRC_PERFORMANCE_TRACE_TESTS_COMPONENT_CONTEXT_H_
