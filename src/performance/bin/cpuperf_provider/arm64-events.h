...
#ifndef SRC_PERFORMANCE_BIN_CPUPERF_PROVIDER_ARM64_EVENTS_H_
#define SRC_PERFORMANCE_BIN_CPUPERF_PROVIDER_ARM64_EVENTS_H_
...
#endif  // SRC_PERFORMANCE_BIN_CPUPERF_PROVIDER_ARM64_EVENTS_H_
