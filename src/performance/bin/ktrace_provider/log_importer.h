...
#ifndef SRC_PERFORMANCE_BIN_KTRACE_PROVIDER_LOG_IMPORTER_H_
#define SRC_PERFORMANCE_BIN_KTRACE_PROVIDER_LOG_IMPORTER_H_
...
#endif  // SRC_PERFORMANCE_BIN_KTRACE_PROVIDER_LOG_IMPORTER_H_
