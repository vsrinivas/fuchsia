...
#ifndef SRC_PERFORMANCE_BIN_KTRACE_PROVIDER_READER_H_
#define SRC_PERFORMANCE_BIN_KTRACE_PROVIDER_READER_H_
...
#endif  // SRC_PERFORMANCE_BIN_KTRACE_PROVIDER_READER_H_
