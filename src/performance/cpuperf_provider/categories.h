...
#ifndef SRC_PERFORMANCE_CPUPERF_PROVIDER_CATEGORIES_H_
#define SRC_PERFORMANCE_CPUPERF_PROVIDER_CATEGORIES_H_
...
#endif  // SRC_PERFORMANCE_CPUPERF_PROVIDER_CATEGORIES_H_
