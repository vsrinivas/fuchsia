...
#ifndef SRC_LEDGER_BIN_STORAGE_IMPL_BTREE_ENTRY_CHANGE_ITERATOR_H_
#define SRC_LEDGER_BIN_STORAGE_IMPL_BTREE_ENTRY_CHANGE_ITERATOR_H_
...
#endif  // SRC_LEDGER_BIN_STORAGE_IMPL_BTREE_ENTRY_CHANGE_ITERATOR_H_
