...
#ifndef SRC_LEDGER_BIN_TESTING_NETCONNECTOR_FAKE_NETCONNECTOR_H_
#define SRC_LEDGER_BIN_TESTING_NETCONNECTOR_FAKE_NETCONNECTOR_H_
...
class FakeNetConnector : public fuchsia::netconnector::NetConnector {
 public:
  class Delegate {
   public:
    ...
    virtual void ConnectToServiceProvider(
        std::string device_name, fidl::InterfaceRequest<fuchsia::sys::ServiceProvider> request) = 0;
  };
  ...
  void ConnectToServiceProvider(fidl::InterfaceRequest<fuchsia::sys::ServiceProvider> request);
...
#endif  // SRC_LEDGER_BIN_TESTING_NETCONNECTOR_FAKE_NETCONNECTOR_H_
