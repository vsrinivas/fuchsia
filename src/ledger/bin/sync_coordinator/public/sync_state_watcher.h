...
#ifndef SRC_LEDGER_BIN_SYNC_COORDINATOR_PUBLIC_SYNC_STATE_WATCHER_H_
#define SRC_LEDGER_BIN_SYNC_COORDINATOR_PUBLIC_SYNC_STATE_WATCHER_H_
...
#endif  // SRC_LEDGER_BIN_SYNC_COORDINATOR_PUBLIC_SYNC_STATE_WATCHER_H_
