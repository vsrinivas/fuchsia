...
#ifndef SRC_LEDGER_CLOUD_PROVIDER_FIRESTORE_BIN_FIRESTORE_FIRESTORE_SERVICE_H_
#define SRC_LEDGER_CLOUD_PROVIDER_FIRESTORE_BIN_FIRESTORE_FIRESTORE_SERVICE_H_
...
class FirestoreService {
 public:
  ...
  virtual void GetDocument(
      ...
      fit::function<void(grpc::Status, google::firestore::v1beta1::Document)> callback) = 0;

  // Lists documents.
  virtual void ListDocuments(
      google::firestore::v1beta1::ListDocumentsRequest request,
      std::shared_ptr<grpc::CallCredentials> call_credentials,
      fit::function<void(grpc::Status, google::firestore::v1beta1::ListDocumentsResponse)>
          callback) = 0;
  ...
  // Deletes a document.
  virtual void DeleteDocument(google::firestore::v1beta1::DeleteDocumentRequest request,
                              std::shared_ptr<grpc::CallCredentials> call_credentials,
  ...
  virtual void Commit(
      ...
      std::shared_ptr<grpc::CallCredentials> call_credentials,
      fit::function<void(grpc::Status, google::firestore::v1beta1::CommitResponse)> callback) = 0;
  ...
  virtual std::unique_ptr<ListenCallHandler> Listen(
      std::shared_ptr<grpc::CallCredentials> call_credentials, ListenCallClient* client) = 0;
...
#endif  // SRC_LEDGER_CLOUD_PROVIDER_FIRESTORE_BIN_FIRESTORE_FIRESTORE_SERVICE_H_
