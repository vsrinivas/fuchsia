...
#ifndef SRC_LEDGER_LIB_MEMORY_REF_COUNTED_H_
#define SRC_LEDGER_LIB_MEMORY_REF_COUNTED_H_

#include "src/ledger/lib/memory/ref_counted_internal.h"
...
// |RefCountedThreadSafe<Foo>|; use |LEDGER_FRIEND_REF_COUNTED_THREAD_SAFE()| for this:
//
//   class Foo : public RefCountedThreadSafe<Foo> {
//     ...
//    private:
//     LEDGER_FRIEND_REF_COUNTED_THREAD_SAFE(Foo);
//     ~Foo();
//     ...
//   };
//
...
//   };
//
// Or, to allow |MakeRefCounted()| to be used, use |LEDGER_FRIEND_MAKE_REF_COUNTED()|:
//
//   class Foo : public RefCountedThreadSafe<Foo> {
//     ...
//    private:
//     LEDGER_FRIEND_MAKE_REF_COUNTED(Foo);
//     Foo();
...
#define LEDGER_FRIEND_REF_COUNTED_THREAD_SAFE(T) friend class ::ledger::RefCountedThreadSafe<T>

// If you want to keep your constructor(s) private and still want to use
// |MakeRefCounted<T>()|, use this. (See the example above
// |RefCountedThreadSafe|.)
#define LEDGER_FRIEND_MAKE_REF_COUNTED(T) friend class ::ledger::internal::MakeRefCountedHelper<T>

}  // namespace ledger

#endif  // SRC_LEDGER_LIB_MEMORY_REF_COUNTED_H_
