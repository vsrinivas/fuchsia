...
#include "src/ledger/lib/convert/collection_view.h"
...
template <typename T>
::testing::AssertionResult Equals(const T& collection, size_t begin, size_t length,
...
using CollectionTypes =
    ::testing::Types<std::vector<uint32_t>, std::unordered_set<uint32_t>, std::set<uint32_t>>;
