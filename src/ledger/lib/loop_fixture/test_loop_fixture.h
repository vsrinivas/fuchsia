...
#ifndef SRC_LEDGER_LIB_LOOP_FIXTURE_TEST_LOOP_FIXTURE_H_
#define SRC_LEDGER_LIB_LOOP_FIXTURE_TEST_LOOP_FIXTURE_H_
...
// Example:
//
//   class FooTest : public ledger::TestLoopFixture { /* ... */ };
//
...
#endif  // SRC_LEDGER_LIB_LOOP_FIXTURE_TEST_LOOP_FIXTURE_H_
