...
#ifndef SRC_DEVICES_BLOCK_DRIVERS_MTK_SDMMC_MTK_SDMMC_REG_H_
#define SRC_DEVICES_BLOCK_DRIVERS_MTK_SDMMC_MTK_SDMMC_REG_H_
...
#endif  // SRC_DEVICES_BLOCK_DRIVERS_MTK_SDMMC_MTK_SDMMC_REG_H_
