...
#ifndef SRC_DEVICES_NAND_DRIVERS_CADENCE_HPNFC_CADENCE_HPNFC_REG_H_
#define SRC_DEVICES_NAND_DRIVERS_CADENCE_HPNFC_CADENCE_HPNFC_REG_H_
...
#endif  // SRC_DEVICES_NAND_DRIVERS_CADENCE_HPNFC_CADENCE_HPNFC_REG_H_
