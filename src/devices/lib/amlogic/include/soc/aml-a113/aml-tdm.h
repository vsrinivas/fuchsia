...
#ifndef SRC_DEVICES_LIB_AMLOGIC_INCLUDE_SOC_AML_A113_AML_TDM_H_
#define SRC_DEVICES_LIB_AMLOGIC_INCLUDE_SOC_AML_A113_AML_TDM_H_
...
typedef enum { MCLK_A, MCLK_B, MCLK_C, MCLK_D, MCLK_E, MCLK_F } aml_tdm_mclk_t;
...
#endif  // SRC_DEVICES_LIB_AMLOGIC_INCLUDE_SOC_AML_A113_AML_TDM_H_
