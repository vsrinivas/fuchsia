...
constexpr uint32_t RESET1_REGISTER_UNKNOWN_1_MASK = 0x4;
constexpr uint32_t RESET1_REGISTER_UNKNOWN_2_MASK = 0x1'0000;
constexpr uint32_t RESET1_LEVEL_OFFSET = 0x84;
constexpr uint32_t RESET1_LEVEL_MASK = 0x3'0000;
