...
#define G12A_PCIE_PLL_CNTL0_0  UINT32_C(0x28060464)
#define G12A_PCIE_PLL_CNTL0_1  UINT32_C(0x38060464)
#define G12A_PCIE_PLL_CNTL0_2  UINT32_C(0x3c060464)
#define G12A_PCIE_PLL_CNTL0_3  UINT32_C(0x1c060464)
#define G12A_PCIE_PLL_CNTL1    UINT32_C(0x00000000)
#define G12A_PCIE_PLL_CNTL2_0  UINT32_C(0x00001100)
#define G12A_PCIE_PLL_CNTL2_1  UINT32_C(0x00001000)
#define G12A_PCIE_PLL_CNTL3    UINT32_C(0x10058e00)
#define G12A_PCIE_PLL_CNTL4_0  UINT32_C(0x000100c0)
#define G12A_PCIE_PLL_CNTL4_1  UINT32_C(0x008100c0)
#define G12A_PCIE_PLL_CNTL5_0  UINT32_C(0x68000048)
#define G12A_PCIE_PLL_CNTL5_1  UINT32_C(0x68000068)
...
#define HHI_PCIE_PLL_CNTL1          (UINT32_C(0x27) << 2)
#define HHI_PCIE_PLL_CNTL2          (UINT32_C(0x28) << 2)
#define HHI_PCIE_PLL_CNTL3          (UINT32_C(0x29) << 2)
#define HHI_PCIE_PLL_CNTL4          (UINT32_C(0x2A) << 2)
#define HHI_PCIE_PLL_CNTL5          (UINT32_C(0x2B) << 2)
