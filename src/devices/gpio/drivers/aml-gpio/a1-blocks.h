...
#ifndef SRC_DEVICES_GPIO_DRIVERS_AML_GPIO_A1_BLOCKS_H_
#define SRC_DEVICES_GPIO_DRIVERS_AML_GPIO_A1_BLOCKS_H_
...
#endif  // SRC_DEVICES_GPIO_DRIVERS_AML_GPIO_A1_BLOCKS_H_
