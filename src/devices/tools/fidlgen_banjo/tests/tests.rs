...
mod c {
    ...
    codegen_test!(handles, CBackend, "c/handles.h");
    codegen_test!(interface, CBackend, "c/interface.h");
    codegen_test!(order, CBackend, "c/order.h");
    codegen_test!(order1, CBackend, "c/order1.h");
    codegen_test!(order2, CBackend, "c/order2.h");
    codegen_test!(order3, CBackend, "c/order3.h");
    codegen_test!(order4, CBackend, "c/order4.h");
