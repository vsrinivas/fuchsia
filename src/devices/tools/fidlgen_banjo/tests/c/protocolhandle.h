...
typedef struct synchronous_handle_protocol_ops synchronous_handle_protocol_ops_t;
...
typedef struct async_handle_protocol_ops async_handle_protocol_ops_t;
typedef struct another_synchronous_handle_protocol another_synchronous_handle_protocol_t;
typedef struct another_synchronous_handle_protocol_ops another_synchronous_handle_protocol_ops_t;

// Declarations
struct synchronous_handle_protocol_ops {
...
struct async_handle_protocol_ops {
...
struct another_synchronous_handle_protocol_ops {
    void (*handle)(void* ctx, zx_handle_t h, zx_handle_t* out_h, zx_handle_t* out_h2);
};
