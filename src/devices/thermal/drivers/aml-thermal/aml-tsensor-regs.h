...
#ifndef SRC_DEVICES_THERMAL_DRIVERS_AML_THERMAL_AML_TSENSOR_REGS_H_
#define SRC_DEVICES_THERMAL_DRIVERS_AML_THERMAL_AML_TSENSOR_REGS_H_
...
#endif  // SRC_DEVICES_THERMAL_DRIVERS_AML_THERMAL_AML_TSENSOR_REGS_H_
