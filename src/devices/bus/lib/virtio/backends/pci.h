...
class PciLegacyBackend : public PciBackend {
 public:
  PciLegacyBackend(pci_protocol_t pci, zx_pcie_device_info_t info) : PciBackend(pci, info) {}
...
class PciModernBackend : public PciBackend {
 public:
  PciModernBackend(pci_protocol_t pci, zx_pcie_device_info_t info) : PciBackend(pci, info) {}
