...
#ifndef SRC_DEVICES_BOARD_DRIVERS_X86_ACPI_BUS_TYPE_H_
#define SRC_DEVICES_BOARD_DRIVERS_X86_ACPI_BUS_TYPE_H_
...
#endif  // SRC_DEVICES_BOARD_DRIVERS_X86_ACPI_BUS_TYPE_H_
