...
use {
    ...
    fidl_fuchsia_compat_devicegroup_test as fcdt, fidl_fuchsia_driver_test as fdt,
...
async fn test_compat_devicegroup() -> Result<()> {
    ...
    builder
        .add_route(
            Route::new()
                .capability(Capability::protocol::<fcdt::WaiterMarker>())
                .from(&waiter)
