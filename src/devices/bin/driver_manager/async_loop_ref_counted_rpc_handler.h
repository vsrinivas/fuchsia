...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_ASYNC_LOOP_REF_COUNTED_RPC_HANDLER_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_ASYNC_LOOP_REF_COUNTED_RPC_HANDLER_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_ASYNC_LOOP_REF_COUNTED_RPC_HANDLER_H_
