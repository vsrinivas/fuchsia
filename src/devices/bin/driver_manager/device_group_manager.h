...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_DEVICE_GROUP_MANAGER_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_DEVICE_GROUP_MANAGER_H_
...
class DeviceGroupManager {
 public:
  using DeviceGroupMap = std::unordered_map<std::string_view, std::unique_ptr<DeviceGroup>>;
  ...
  zx::status<> BindAndCreateDeviceGroup(fuchsia_driver_framework::wire::DeviceGroup fidl_group,
                                        fuchsia_driver_index::wire::MatchedCompositeInfo driver);
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_DEVICE_GROUP_MANAGER_H_
