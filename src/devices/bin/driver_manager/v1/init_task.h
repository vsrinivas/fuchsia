...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_V1_INIT_TASK_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_V1_INIT_TASK_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_V1_INIT_TASK_H_
