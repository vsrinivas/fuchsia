...
#ifndef SRC_DEVICES_BIN_DRIVER_MANAGER_DEVHOST_LOADER_SERVICE_H_
#define SRC_DEVICES_BIN_DRIVER_MANAGER_DEVHOST_LOADER_SERVICE_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_MANAGER_DEVHOST_LOADER_SERVICE_H_
