...
#ifndef SRC_DEVICES_BIN_DRIVER_HOST_ASYNC_LOOP_OWNED_RPC_HANDLER_H_
#define SRC_DEVICES_BIN_DRIVER_HOST_ASYNC_LOOP_OWNED_RPC_HANDLER_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_HOST_ASYNC_LOOP_OWNED_RPC_HANDLER_H_
