...
#ifndef SRC_DEVICES_BIN_DRIVER_HOST_DEVFS_CONNECTION_H_
#define SRC_DEVICES_BIN_DRIVER_HOST_DEVFS_CONNECTION_H_
...
#endif  // SRC_DEVICES_BIN_DRIVER_HOST_DEVFS_CONNECTION_H_
