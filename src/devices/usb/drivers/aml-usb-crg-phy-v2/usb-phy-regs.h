...
#ifndef SRC_DEVICES_USB_DRIVERS_AML_USB_CRG_PHY_V2_USB_PHY_REGS_H_
#define SRC_DEVICES_USB_DRIVERS_AML_USB_CRG_PHY_V2_USB_PHY_REGS_H_
...
constexpr uint32_t RESET0_REGISTER_OFFSET = 0x0;
constexpr uint32_t RESET0_LEVEL_OFFSET = 0x40;
...
class PLL_REGISTER_38 : public hwreg::RegisterBase<PLL_REGISTER_38, uint32_t> {
 public:
  DEF_FIELD(28, 27, threshold);
  static auto Get() { return hwreg::RegisterAddr<PLL_REGISTER_38>(0x38); }
};

}  // namespace aml_usb_crg_phy

#endif  // SRC_DEVICES_USB_DRIVERS_AML_USB_CRG_PHY_V2_USB_PHY_REGS_H_
