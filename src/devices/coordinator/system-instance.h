...
#ifndef SRC_DRIVER_FRAMEWORK_DEVCOORDINATOR_SYSTEM_INSTANCE_H_
#define SRC_DRIVER_FRAMEWORK_DEVCOORDINATOR_SYSTEM_INSTANCE_H_
...
#endif  // SRC_DRIVER_FRAMEWORK_DEVCOORDINATOR_SYSTEM_INSTANCE_H_
