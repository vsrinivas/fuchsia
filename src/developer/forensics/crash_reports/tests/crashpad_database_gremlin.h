...
#ifndef SRC_DEVELOPER_FORENSICS_CRASH_REPORTS_TESTS_CRASHPAD_DATABASE_GREMLIN_H_
#define SRC_DEVELOPER_FORENSICS_CRASH_REPORTS_TESTS_CRASHPAD_DATABASE_GREMLIN_H_
...
#endif  // SRC_DEVELOPER_FORENSICS_CRASH_REPORTS_TESTS_CRASHPAD_DATABASE_GREMLIN_H_
