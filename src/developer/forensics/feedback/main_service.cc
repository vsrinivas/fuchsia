...
MainService::MainService(async_dispatcher_t* dispatcher,
    ...
    : dispatcher_(dispatcher),
      ...
      cobalt_(cobalt),
      feedback_data_(dispatcher_, services_, clock_, inspect_root_, cobalt_, feedback_data_options),
      crash_reports_(dispatcher_, services_, clock_, inspect_root_, feedback_data_.DataProvider(),
