...
class SystemImpl final : public System,
 ...
 public:
  ...
  void RequestDownload(const std::string& build_id,
                       DebugSymbolFileType file_type, bool quiet) override;
 ...
 private:
  ...
  // the quiet parameter.
  std::shared_ptr<Download> GetDownload(std::string build_id,
                                        DebugSymbolFileType file_type,
                                        bool quiet);
  ...
  std::map<std::pair<std::string, DebugSymbolFileType>, std::weak_ptr<Download>>
      downloads_;
