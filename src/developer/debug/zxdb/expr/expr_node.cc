...
// static
Err ArrayAccessExprNode::InnerValueToOffset(
    fxl::RefPtr<ExprEvalContext> context, const ExprValue& inner,
    int64_t* offset) {
...
// static
void SizeofExprNode::SizeofType(fxl::RefPtr<ExprEvalContext> context,
