...
class Value : public Symbol {
 public:
  ...
  // Artificial values are ones generated by the compiler that don't appear in
  // the source. The most common example is "this" parameters to functions.
  // Other examples are GCC-generated "__func__" variables and the discriminant
  // data member in a rust enum.
