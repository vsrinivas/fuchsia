...
#ifndef SRC_DEVELOPER_CPUPERF_TESTS_INTEL_INTEL_TESTS_H_
#define SRC_DEVELOPER_CPUPERF_TESTS_INTEL_INTEL_TESTS_H_
...
#endif  // SRC_DEVELOPER_CPUPERF_TESTS_INTEL_INTEL_TESTS_H_
