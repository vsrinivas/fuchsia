...
#include "src/developer/tracing/bin/trace_manager/trace_session.h"
...
#include "src/developer/tracing/bin/trace_manager/trace_manager.h"
#include "src/developer/tracing/bin/trace_manager/util.h"
