...
#ifndef SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TRACE_PROVIDER_BUNDLE_H_
#define SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TRACE_PROVIDER_BUNDLE_H_
...
#endif  // SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TRACE_PROVIDER_BUNDLE_H_
