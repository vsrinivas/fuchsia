...
#ifndef SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TESTS_FAKE_PROVIDER_H_
#define SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TESTS_FAKE_PROVIDER_H_
...
#endif  // SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TESTS_FAKE_PROVIDER_H_
