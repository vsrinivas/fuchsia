...
#ifndef SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TESTS_TRACE_MANAGER_TEST_H_
#define SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TESTS_TRACE_MANAGER_TEST_H_
...
#endif  // SRC_DEVELOPER_TRACING_BIN_TRACE_MANAGER_TESTS_TRACE_MANAGER_TEST_H_
