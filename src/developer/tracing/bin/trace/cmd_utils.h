...
#ifndef SRC_DEVELOPER_TRACING_BIN_TRACE_CMD_UTILS_H_
#define SRC_DEVELOPER_TRACING_BIN_TRACE_CMD_UTILS_H_
...
#endif  // SRC_DEVELOPER_TRACING_BIN_TRACE_CMD_UTILS_H_
