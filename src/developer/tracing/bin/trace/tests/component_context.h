...
#ifndef SRC_DEVELOPER_TRACING_BIN_TRACE_TESTS_COMPONENT_CONTEXT_H_
#define SRC_DEVELOPER_TRACING_BIN_TRACE_TESTS_COMPONENT_CONTEXT_H_
...
#endif  // SRC_DEVELOPER_TRACING_BIN_TRACE_TESTS_COMPONENT_CONTEXT_H_
