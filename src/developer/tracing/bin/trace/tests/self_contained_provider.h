...
#ifndef SRC_DEVELOPER_TRACING_BIN_TRACE_TESTS_SELF_CONTAINED_PROVIDER_H_
#define SRC_DEVELOPER_TRACING_BIN_TRACE_TESTS_SELF_CONTAINED_PROVIDER_H_
...
#endif  // SRC_DEVELOPER_TRACING_BIN_TRACE_TESTS_SELF_CONTAINED_PROVIDER_H_
