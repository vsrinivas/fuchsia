...
#ifndef SRC_DEVELOPER_FEEDBACK_FEEDBACK_AGENT_PRODUCT_PTR_H_
#define SRC_DEVELOPER_FEEDBACK_FEEDBACK_AGENT_PRODUCT_PTR_H_
...
#endif  // SRC_DEVELOPER_FEEDBACK_FEEDBACK_AGENT_PRODUCT_PTR_H_
