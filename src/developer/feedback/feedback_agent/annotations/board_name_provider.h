...
#ifndef SRC_DEVELOPER_FEEDBACK_FEEDBACK_AGENT_BOARD_NAME_PROVIDER_H_
#define SRC_DEVELOPER_FEEDBACK_FEEDBACK_AGENT_BOARD_NAME_PROVIDER_H_
...
#endif  // SRC_DEVELOPER_FEEDBACK_FEEDBACK_AGENT_BOARD_NAME_PROVIDER_H_
