...
#ifndef SRC_DEVELOPER_FEEDBACK_TESTING_STUBS_REBOOT_METHODS_WATCHER_REGISTER_H_
#define SRC_DEVELOPER_FEEDBACK_TESTING_STUBS_REBOOT_METHODS_WATCHER_REGISTER_H_
