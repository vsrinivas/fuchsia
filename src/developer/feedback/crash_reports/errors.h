...
#ifndef SRC_DEVELOPER_FEEDBACK_CRASH_REPORTS_ERRORS_H_
#define SRC_DEVELOPER_FEEDBACK_CRASH_REPORTS_ERRORS_H_
...
#endif  // SRC_DEVELOPER_FEEDBACK_CRASH_REPORTS_ERRORS_H_
