...
#ifndef SRC_DEVELOPER_FEEDBACK_CRASHPAD_AGENT_INFO_AGENT_INFO_H_
#define SRC_DEVELOPER_FEEDBACK_CRASHPAD_AGENT_INFO_AGENT_INFO_H_
...
#endif  // SRC_DEVELOPER_FEEDBACK_CRASHPAD_AGENT_INFO_AGENT_INFO_H_
