...
#ifndef SRC_DEVELOPER_FEEDBACK_AGENT_CHANNEL_PROVIDER_PTR_H_
#define SRC_DEVELOPER_FEEDBACK_AGENT_CHANNEL_PROVIDER_PTR_H_
...
#endif  // SRC_DEVELOPER_FEEDBACK_AGENT_CHANNEL_PROVIDER_PTR_H_
