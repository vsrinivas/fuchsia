...
#ifndef SRC_DEVELOPER_FEEDBACK_AGENT_IMAGE_CONVERSION_H_
#define SRC_DEVELOPER_FEEDBACK_AGENT_IMAGE_CONVERSION_H_
...
#endif  // SRC_DEVELOPER_FEEDBACK_AGENT_IMAGE_CONVERSION_H_
