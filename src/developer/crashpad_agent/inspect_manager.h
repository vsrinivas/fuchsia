...
#ifndef SRC_DEVELOPER_CRASHPAD_AGENT_INSPECT_MANAGER_H_
#define SRC_DEVELOPER_CRASHPAD_AGENT_INSPECT_MANAGER_H_
...
#endif  // SRC_DEVELOPER_CRASHPAD_AGENT_INSPECT_MANAGER_H_
