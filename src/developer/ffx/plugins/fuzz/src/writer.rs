...
pub mod test_fixtures {
    use {super::OutputSink, std::cell::RefCell, std::fmt::Debug, std::fmt::Display, std::rc::Rc};
    ...
    impl BufferSink {
        ...
        ///
        /// This object will write into the shared `data` vector.
    ...
    impl OutputSink for BufferSink {
        ...
        fn print<D: Display>(&self, message: D) {
            let mut data = self.data.borrow_mut();
            data.extend(message.to_string().bytes());
        }
