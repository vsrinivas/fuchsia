...
pub async fn selectors(
    ...
    run_command(rcs_proxy, diagnostics_proxy, iq::SelectorsCommand::from(cmd), &mut output).await
}
...
mod test {
    use {
        ...
        ffx_inspect_test_utils::{
            ...
            setup_fake_diagnostics_bridge, setup_fake_rcs, FakeBridgeData, FakeOutput,
        },
