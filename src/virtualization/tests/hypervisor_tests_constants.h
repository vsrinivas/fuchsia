...
#ifndef SRC_VIRTUALIZATION_TESTS_HYPERVISOR_TESTS_CONSTANTS_H_
#define SRC_VIRTUALIZATION_TESTS_HYPERVISOR_TESTS_CONSTANTS_H_
...
#endif  // SRC_VIRTUALIZATION_TESTS_HYPERVISOR_TESTS_CONSTANTS_H_
