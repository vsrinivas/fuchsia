...
E820Map::E820Map(size_t mem_size, const DevMem &dev_mem) {
  ...
  entries.emplace_back(e820entry_t{kAddr32kb, kAddr512kb - kAddr32kb, E820_RAM});
  // 512kb to 1mb is reserved.
  entries.emplace_back(e820entry_t{kAddr512kb, kAddr1mb - kAddr512kb, E820_RESERVED});
  // 1mb to min(size, 1mb) is available.
  dev_mem.YieldInverseRange(kAddr1mb, mem_size - kAddr1mb, [this](zx_gpaddr_t addr, size_t size) {
