...
${FUCHSIA_DIR}/apps/test_runner/src/run_test "device_runner --user_shell=dev_user_shell --device_shell_args=--test --user_shell_args=--root_module=/system/apps/modular_tests/parent_module"
