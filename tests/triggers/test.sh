...
${FUCHSIA_DIR}/apps/test_runner/src/run_test "device_runner --device_shell=dev_device_shell --device_shell_args=--test --user_shell=dev_user_shell --user_shell_args=--root_module=/system/apps/modular_tests/agent_trigger_test"
