...
class VerifyCtsDeps:
    ...
    Args:
      ...
      allowed_cts_deps(list(string)): A list of allowed deps found in //sdk/ctf/allowed_ctf_deps.gni"
      allowed_cts_dirs(list(string)): A list of allowed directories found in //sdk/ctf/allowed_ctf_dirs.gni"
