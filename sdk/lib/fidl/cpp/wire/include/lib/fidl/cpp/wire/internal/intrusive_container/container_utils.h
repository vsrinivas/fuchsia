...
#ifndef LIB_FIDL_CPP_WIRE_INCLUDE_LIB_FIDL_CPP_WIRE_INTERNAL_INTRUSIVE_CONTAINER_CONTAINER_UTILS_H_
#define LIB_FIDL_CPP_WIRE_INCLUDE_LIB_FIDL_CPP_WIRE_INTERNAL_INTRUSIVE_CONTAINER_CONTAINER_UTILS_H_
...
enum class NodeOptions : uint64_t {
  ...
  //
  // using MainList = fidl::internal_wavl::TaggedDoublyLinkedList<std::unique_ptr<Obj>,
  // MainListTag>; using TmpList = fidl::internal_wavl::TaggedSinglyLinkedList<Obj*, TmpListTag>;
  //
  // fidl::internal_wavl::Mutex all_objects_lock;
  // MainList all_objects TA_GUARDED(all_objects_lock);
  //
  // void do_interesting_things() TA_EXCL(all_objects_lock) {
  //   fidl::internal_wavl::AutoLock lock(&all_objects_lock);
...
//
constexpr fidl::internal_wavl::NodeOptions operator|(fidl::internal_wavl::NodeOptions A,
                                                     fidl::internal_wavl::NodeOptions B) {
  return static_cast<fidl::internal_wavl::NodeOptions>(
      static_cast<std::underlying_type<fidl::internal_wavl::NodeOptions>::type>(A) |
      static_cast<std::underlying_type<fidl::internal_wavl::NodeOptions>::type>(B));
}

constexpr bool operator&(fidl::internal_wavl::NodeOptions A, fidl::internal_wavl::NodeOptions B) {
  return (static_cast<std::underlying_type<fidl::internal_wavl::NodeOptions>::type>(A) &
          static_cast<std::underlying_type<fidl::internal_wavl::NodeOptions>::type>(B)) != 0;
}
...
//
// class MyClass
//     : public fidl::internal_wavl::RefCounted<MyClass>,
//       public fidl::internal_wavl::ContainableBaseClasses<
//           fidl::internal_wavl::WAVLTreeContainable<fidl::internal_wavl::RefPtr<MyClass>, MyTag1>,
//           fidl::internal_wavl::WAVLTreeContainable<fidl::internal_wavl::RefPtr<MyClass>, MyTag2>,
//           fidl::internal_wavl::SinglyLinkedListable<MyClass*, MyTag3>,
//           [...]> { <your class definition> };
//
// Then when you create your container, you use the same tag type:
//
// fidl::internal_wavl::TaggedWAVLTree<uint32_t, fidl::internal_wavl::RefPtr<MyClass>, MyTag1>
// my_tree;
//
...
struct ContainableBaseClassEnumerator<Containable<PtrType, Options, TagType>, Rest...>
  ...
  static_assert(!std::is_same_v<TagType, DefaultObjectTag>,
                "Do not use fidl::internal_wavl::DefaultObjectTag when inheriting from "
                "fidl::internal_wavl::ContainableBaseClasses. Define your own instead.");
  static_assert((!std::is_same_v<TagType, typename Rest::TagType> && ...),
                "All tag types used with fidl::internal_wavl::ContainableBaseClassEnumerator must "
                "be unique.");
...
#endif  // LIB_FIDL_CPP_WIRE_INCLUDE_LIB_FIDL_CPP_WIRE_INTERNAL_INTRUSIVE_CONTAINER_CONTAINER_UTILS_H_
