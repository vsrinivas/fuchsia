...
TEST(Conformance, Sandwich1Case1WithHdr_V1_Encode) {
  conformance::Sandwich1Message v1;

  conformance::TransactionHeader v2;
  ...
  conformance::Sandwich1 v10;

  uint32_t v11 = 67305985ull;
  v10.before = std::move(v11);

  conformance::UnionSize8Align4 v12;

  uint32_t v13 = 202050057ull;
  v12.set_variant(std::move(v13));
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0xfd, 0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00,
...
TEST(Conformance, Sandwich4Case1WithHdr_V1_Encode) {
  conformance::Sandwich4Message v1;
  ...
  conformance::Sandwich4 v10;

  uint32_t v11 = 67305985ull;
  v10.before = std::move(v11);

  conformance::UnionSize36Align4 v12;
...
TEST(Conformance, Sandwich5Case1WithHdr_V1_Encode) {
  conformance::Sandwich5Message v1;
  ...
  conformance::Sandwich5 v10;

  uint32_t v11 = 67305985ull;
  v10.before = std::move(v11);

  conformance::UnionOfUnion v12;

  conformance::UnionSize8Align4 v13;

  uint32_t v14 = 202050057ull;
  v13.set_variant(std::move(v14));
  v12.set_size8align4(std::move(v13));
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,
...
TEST(Conformance, Sandwich5Case2WithHdr_V1_Encode) {
  conformance::Sandwich5Message v1;
  ...
  conformance::UnionSize24Align8 v13;

  conformance::StructSize16Align8 v14;
  ...
  v14.f2 = std::move(v16);
  v13.set_variant(std::move(v14));
  v12.set_size24align8(std::move(v13));
  v10.union_of_union = std::move(v12);
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,
...
TEST(Conformance, Sandwich7Case1WithHdr_V1_Encode) {
  conformance::Sandwich7Message v1;
  ...
  conformance::Sandwich7 v10;

  uint32_t v11 = 336794129ull;
  v10.before = std::move(v11);

  std::unique_ptr<conformance::Sandwich1> v12 = std::make_unique<conformance::Sandwich1>();

  uint32_t v13 = 67305985ull;
  v12->before = std::move(v13);

  conformance::UnionSize8Align4 v14;

  uint32_t v15 = 202050057ull;
  v14.set_variant(std::move(v15));
  ...
  const auto expected = std::vector<uint8_t>{
      0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
      0xff, 0x11, 0x12, 0x13, 0x14, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
TEST(Conformance, Sandwich7Case2WithHdr_V1_Encode) {
  conformance::Sandwich7Message v1;
...
TEST(Conformance, Table_NoFields_V1_Encode) {
  conformance::Struct_Table_NoFields v1;

  conformance::Table_NoFields v2;
  v1.t = std::move(v2);
...
TEST(Conformance, Table_TwoReservedFields_V1_Encode) {
  conformance::Struct_Table_TwoReservedFields v1;

  conformance::Table_TwoReservedFields v2;
  v1.t = std::move(v2);
...
TEST(Conformance, Regression5Enums_V1_Encode) {
  conformance::Regression5 v1;
...
TEST(Conformance, Regression6Bits_V1_Encode) {
  conformance::Regression6 v1;
...
TEST(Conformance, Regression7TableUnionXUnion_V1_Encode) {
  conformance::Regression7TableUnionXUnion v1;

  conformance::TableOfUnionThenXUnionThenTableThenXUnionThenUnion v2;

  conformance::UnionOfXUnionThenTableThenXUnionThenUnion v3;

  conformance::XUnionOfTableThenXUnionThenUnion v4;

  conformance::TableOfXUnionThenUnion v5;

  conformance::XUnionOfUnion v6;

  conformance::UnionAtTheBottom v7;

  uint8_t v8 = 8ull;
  v7.set_tiny(std::move(v8));
  v6.set_variant(std::move(v7));
  v5.set_member(std::move(v6));
  v4.set_variant(std::move(v5));
  v3.set_variant(std::move(v4));
  v2.set_member(std::move(v3));
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x98, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x4e, 0x61,
      0xb8, 0x22, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff,
      ...
      0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x94, 0x05, 0x22, 0x38, 0x00,
      0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
...
TEST(Conformance, Regression8OptUnionSize12Aligned4_V1_Encode) {
  conformance::Regression8OptUnionSize12Align4 v1;

  std::unique_ptr<conformance::UnionSize12Align4> v2 =
      std::make_unique<conformance::UnionSize12Align4>();
  ...
  uint8_t v7 = 165ull;
  uint8_t v8 = 166ull;
  auto v9 = std::array<uint8_t, 6>{std::move(v3), std::move(v4), std::move(v5),
                                   std::move(v6), std::move(v7), std::move(v8)};
  v2->set_variant(std::move(v9));
  v1.opt_union1 = std::move(v2);

  std::unique_ptr<conformance::UnionSize12Align4> v10 =
      std::make_unique<conformance::UnionSize12Align4>();
  ...
  uint8_t v15 = 181ull;
  uint8_t v16 = 182ull;
  auto v17 = std::array<uint8_t, 6>{std::move(v11), std::move(v12), std::move(v13),
                                    std::move(v14), std::move(v15), std::move(v16)};
  v10->set_variant(std::move(v17));
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa1, 0xa2, 0xa3,
      0xa4, 0xa5, 0xa6, 0x00, 0x00, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0x00, 0x00,
...
TEST(Conformance, Regression8VectorOfOptUnionSize12Aligned4_V1_Encode) {
  conformance::Regression8VectorOfOptUnionSize12Align4 v1;

  std::unique_ptr<conformance::UnionSize12Align4> v2;
  std::unique_ptr<conformance::UnionSize12Align4> v3 =
      std::make_unique<conformance::UnionSize12Align4>();
  ...
  auto v10 = std::array<uint8_t, 6>{std::move(v4), std::move(v5), std::move(v6),
                                    std::move(v7), std::move(v8), std::move(v9)};
  v3->set_variant(std::move(v10));
  std::unique_ptr<conformance::UnionSize12Align4> v11;
  std::unique_ptr<conformance::UnionSize12Align4> v12 =
      std::make_unique<conformance::UnionSize12Align4>();
  ...
  uint8_t v17 = 181ull;
  uint8_t v18 = 182ull;
  auto v19 = std::array<uint8_t, 6>{std::move(v13), std::move(v14), std::move(v15),
                                    std::move(v16), std::move(v17), std::move(v18)};
  v12->set_variant(std::move(v19));
  std::unique_ptr<conformance::UnionSize12Align4> v20;
  std::vector<std::unique_ptr<conformance::UnionSize12Align4>> v21;
  v21.push_back(std::move(v2));
  v21.push_back(std::move(v3));
  v21.push_back(std::move(v11));
  v21.push_back(std::move(v12));
  v21.push_back(std::move(v20));
  v1.value = std::move(v21);
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa1, 0xa2, 0xa3, 0xa4,
      0xa5, 0xa6, 0x00, 0x00, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0x00, 0x00,
...
TEST(Conformance, Regression8TableWithUnionSize12Aligned4_V1_Encode) {
  conformance::Regression8TableWithUnionSize12Align4 v1;

  conformance::TableWithUnionSize12Align4 v2;

  uint8_t v3 = 170ull;
  v2.set_before(std::move(v3));

  conformance::UnionSize12Align4 v4;
  ...
  uint8_t v9 = 181ull;
  uint8_t v10 = 182ull;
  auto v11 = std::array<uint8_t, 6>{std::move(v5), std::move(v6), std::move(v7),
                                    std::move(v8), std::move(v9), std::move(v10)};
  v4.set_variant(std::move(v11));
  v2.set_member(std::move(v4));

  uint8_t v12 = 187ull;
  v2.set_after(std::move(v12));
  v1.value = std::move(v2);
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xaa, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0x00,
...
TEST(Conformance, Regression9Response_V1_Encode) {
  conformance::Regression9Message v1;
  ...
  conformance::Regression9Result v10;

  conformance::Regression9Value v11;

  conformance::StringBoolUnion v12;

  std::string v13("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
  v12.set_s(std::move(v13));
  v11.u = std::move(v12);

  std::unique_ptr<conformance::StringBoolUnion> v14 =
      std::make_unique<conformance::StringBoolUnion>();

  bool v15 = false;
  v14->set_b(std::move(v15));
  v11.nullable_u = std::move(v14);
  v10.set_ok(std::move(v11));
  v1.body = std::move(v10);

  const auto expected = std::vector<uint8_t>{
      0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x69, 0xc9, 0xcb,
      0x56, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x20, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x41,
...
TEST(Conformance, StringUnionStructWrapperResponse_V1_Encode) {
  conformance::StringUnionStructWrapperResponse v1;
  ...
  conformance::StringUnionStructWrapper v10;

  conformance::StringUnionStruct v11;
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      0xa0, 0x32, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00,
      ...
      0x6f, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
TEST(Conformance, RegressionNoUnionLauncherCreateComponentRequest_V1_Encode) {
...
TEST(Conformance, CompatTable_V1_Encode) {
  conformance::CompatTable v1;

  conformance::CompatTableValue v2;

  conformance::CompatUnion v3;

  bool v4 = true;
  v3.set_b(std::move(v4));
  v2.set_union_member(std::move(v3));

  uint32_t v5 = 1361667997ull;
  uint32_t v6 = 2492576910ull;
  uint32_t v7 = 2480020305ull;
  auto v8 = std::array<uint32_t, 3>{std::move(v5), std::move(v6), std::move(v7)};
  v2.set_array_member(std::move(v8));

  conformance::CompatTableString v9;

  std::string v10("AB");
  v9.set_s(std::move(v10));
  v2.set_table_member(std::move(v9));

  conformance::CompatXUnion v11;

  std::string v12("CD");
  v11.set_s(std::move(v12));
  v2.set_xunion_member(std::move(v11));
  v1.value = std::move(v2);

  std::string v13("");
  v1.empty = std::move(v13);
  ...
  const auto expected = std::vector<uint8_t>{
      ...
      ,
...
TEST(Conformance, MixedFields_V1_Encode) {
  conformance::MixedFieldsMessage v1;
  ...
  conformance::MixedFieldsBody v10;
  ...
  conformance::UnionSize8Align4 v16;

  uint32_t v17 = 3232800912ull;
  v16.set_variant(std::move(v17));
  ...
  const auto expected = std::vector<uint8_t>{
      0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd,
      0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x0a, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x09, 0x0a,
      0x0b, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x90, 0xa0, 0xb0, 0xc0, 0x00, 0x00, 0x00, 0x00,
...
TEST(Conformance, TableWithXUnion_V1_Encode) {
  conformance::StructOfTableWithXUnion v1;

  conformance::TableWithXUnion v2;

  conformance::CompatXUnion v3;
...
TEST(Conformance, Sandwich1Case1WithHdr_V1_Decode) {
  conformance::Sandwich1Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb,
      0xfc, 0xfd, 0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00,
...
TEST(Conformance, Sandwich4Case1WithHdr_V1_Decode) {
  conformance::Sandwich4Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0xa0, 0xa1, 0xa2,
...
TEST(Conformance, Sandwich5Case1WithHdr_V1_Decode) {
  conformance::Sandwich5Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff,
...
TEST(Conformance, Sandwich5Case2WithHdr_V1_Decode) {
  conformance::Sandwich5Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb,
      0xfc, 0xfd, 0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00,
      0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa0, 0xa1,
      0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf,
...
TEST(Conformance, Sandwich7Case1WithHdr_V1_Decode) {
  conformance::Sandwich7Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd,
      0xfe, 0xff, 0x11, 0x12, 0x13, 0x14, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0x21, 0x22, 0x23, 0x24, 0x00, 0x00, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04,
      0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05, 0x06,
      0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c, 0x00, 0x00, 0x00, 0x00,
...
TEST(Conformance, Sandwich7Case2WithHdr_V1_Decode) {
  conformance::Sandwich7Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb,
      0xfc, 0xfd, 0xfe, 0xff, 0x11, 0x12, 0x13, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x21, 0x22, 0x23, 0x24, 0x00, 0x00, 0x00, 0x00,
...
TEST(Conformance, Table_NoFields_V1_Decode) {
  conformance::Struct_Table_NoFields v1;
...
TEST(Conformance, Table_TwoReservedFields_V1_Decode) {
  conformance::Struct_Table_TwoReservedFields v1;
...
TEST(Conformance, Regression5Enums_V1_Decode) {
  conformance::Regression5 v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x2f, 0x30, 0x31, 0x32,
      0x08, 0x00, 0x15, 0x16, 0x00, 0x00, 0x00, 0x00, 0x5d, 0x5e, 0x5f, 0x60,
      0x61, 0x62, 0x63, 0x64, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,

  };
  EXPECT_TRUE(fidl::Equals(fidl::test::util::DecodedBytes<decltype(v1)>(bytes), v1));
}

TEST(Conformance, Regression6Bits_V1_Decode) {
  conformance::Regression6 v1;
...
TEST(Conformance, Regression7TableUnionXUnion_V1_Decode) {
  conformance::Regression7TableUnionXUnion v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x98, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0xff, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x4e,
      0x61, 0xb8, 0x22, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      ...
      0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x94, 0x05, 0x22, 0x38,
      0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0xff, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x08,
...
TEST(Conformance, Regression8OptUnionSize12Aligned4_V1_Decode) {
  conformance::Regression8OptUnionSize12Align4 v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa1, 0xa2,
      0xa3, 0xa4, 0xa5, 0xa6, 0x00, 0x00, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0x00, 0x00,

  };
  EXPECT_TRUE(fidl::Equals(fidl::test::util::DecodedBytes<decltype(v1)>(bytes), v1));
}

TEST(Conformance, Regression8VectorOfOptUnionSize12Aligned4_V1_Decode) {
  conformance::Regression8VectorOfOptUnionSize12Align4 v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa1, 0xa2,
      0xa3, 0xa4, 0xa5, 0xa6, 0x00, 0x00, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0x00, 0x00,
...
TEST(Conformance, Regression8TableWithUnionSize12Aligned4_V1_Decode) {
  conformance::Regression8TableWithUnionSize12Align4 v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xaa, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6,
...
TEST(Conformance, Regression9Response_V1_Decode) {
  conformance::Regression9Message v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ,
...
TEST(Conformance, StringUnionStructWrapperResponse_V1_Decode) {
  conformance::StringUnionStructWrapperResponse v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      0x25, 0x32, 0xa0, 0x32, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
      0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x68, 0x65,
      0x6c, 0x6c, 0x6f, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,

  };
  EXPECT_TRUE(fidl::Equals(fidl::test::util::DecodedBytes<decltype(v1)>(bytes), v1));
}

TEST(Conformance, RegressionNoUnionLauncherCreateComponentRequest_V1_Decode) {
  conformance::CreateComponentRequest v1;
...
TEST(Conformance, CompatTable_V1_Decode) {
  conformance::CompatTable v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      ,

  };
  EXPECT_TRUE(fidl::Equals(fidl::test::util::DecodedBytes<decltype(v1)>(bytes), v1));
}

TEST(Conformance, MixedFields_V1_Decode) {
  conformance::MixedFieldsMessage v1;
  ...
  auto bytes = std::vector<uint8_t>{
      0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd,
      0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
      0xff, 0xff, 0xff, 0xff, 0x0a, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x07, 0x06,
      0x05, 0x04, 0x03, 0x02, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05,
      0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c, 0x00, 0x00, 0x00, 0x00,
...
TEST(Conformance, TableWithXUnion_V1_Decode) {
  conformance::StructOfTableWithXUnion v1;
  ...
  auto bytes = std::vector<uint8_t>{
      ...
      0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa8, 0xef, 0xf8, 0x5a, 0x00, 0x00, 0x00, 0x00,
      0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
