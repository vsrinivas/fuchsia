...
#define FDIO_ZX_HANDLE_ACQUIRE __attribute__((acquire_handle("Fuchsia")))
...
#define FDIO_ZX_HANDLE_RELEASE __attribute__((release_handle("Fuchsia")))
...
#define FDIO_ZX_HANDLE_USE __attribute__((use_handle("Fuchsia")))
#else
#define FDIO_ZX_HANDLE_ACQUIRE
#define FDIO_ZX_HANDLE_RELEASE
#define FDIO_ZX_HANDLE_USE
#endif
