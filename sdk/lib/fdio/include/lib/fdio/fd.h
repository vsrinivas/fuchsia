...
// to the same handle. In these cases, callers may want to use the less-efficient fdio_fd_clone() to
// create a new connection to the same file, or fdio_fd_transfer_or_clone() to automatically do this
// fallback.
//
// # Errors
//
