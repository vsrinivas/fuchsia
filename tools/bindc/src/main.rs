...
mod tests {
    ...
    fn get_test_generated_cpp(input: &str) -> Vec<String> {
        generate::generate(GeneratedBindingType::Cpp, input, false)
            .unwrap()
            .split("\n")
            .map(|s| s.to_string())
            .filter(|x| !x.is_empty())
    ...
    fn get_test_generated_rust(input: &str) -> Vec<String> {
        generate::generate(GeneratedBindingType::Rust, input, false)
            .unwrap()
            .split("\n")
            .map(|s| s.to_string())
            .filter(|x| !x.is_empty())
    ...
    fn zero_keys() {
        ...
        let expected_cpp = vec![
            ...
            "#ifndef FUCHSIA_PLATFORM_BINDLIB_".to_string(),
            "#define FUCHSIA_PLATFORM_BINDLIB_".to_string(),
            "#include <string>".to_string(),
            "namespace fuchsia_platform {".to_string(),
            "}  // namespace fuchsia_platform".to_string(),
            "#endif  // FUCHSIA_PLATFORM_BINDLIB_".to_string(),
        ];
    ...
    fn one_key_with_using() {
        ...
        let expected = vec![
            ...
            "library bind.fuchsia.platform;".to_string(),
            "using fuchsia.driver.framework as fdf;".to_string(),
            "const SOME_INT_BUS fdf.NodePropertyValueUint = 84;".to_string(),
        ];
        let expected_cpp = vec![
            "// Copyright 2022 The Fuchsia Authors. All rights reserved.".to_string(),
            "// Use of this source code is governed by a BSD-style license that can be".to_string(),
            ...
            "#define FUCHSIA_PLATFORM_BINDLIB_".to_string(),
            "#include <string>".to_string(),
            "#include <another/bindlibrary/bindlib.h>".to_string(),
            "namespace fuchsia_platform {".to_string(),
        ...
        let expected_rust = vec![
            ...
            "// found in the LICENSE file.".to_string(),
            "// WARNING: This file is machine generated by bindc.".to_string(),
            "pub use another_bindlibrary_bindlib;".to_string(),
    ...
    fn duplicate_key_value() {
        ...
        assert!(generate::generate(GeneratedBindingType::Cpp, test_str, false).is_err());
        assert!(generate::generate(GeneratedBindingType::Rust, test_str, false).is_err());
    }
