...
// runnerIface defines the interface for running commands by many means such as via SSH
...
// without error.
func NewBatchRunner(ctx context.Context, runner runnerIface, maxBatchSize int) *BatchRunner {
