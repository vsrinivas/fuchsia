...
impl Right {
    ...
    pub fn expand(&self) -> Vec<fio2::Operations> {
        match self {
            ...
            Self::GetAttributes => vec![fio2::Operations::GET_ATTRIBUTES],
            Self::ModifyDirectory => vec![fio2::Operations::MODIFY_DIRECTORY],
            Self::ReadBytes => vec![fio2::Operations::READ_BYTES],
            Self::Traverse => vec![fio2::Operations::TRAVERSE],
            Self::UpdateAttributes => vec![fio2::Operations::UPDATE_ATTRIBUTES],
            Self::WriteBytes => vec![fio2::Operations::WRITE_BYTES],
            Self::ReadAlias => vec![
...
mod tests {
    ...
    test_expand_rights! {
        ...
        (Right::GetAttributes, vec![fio2::Operations::GET_ATTRIBUTES]),
        (Right::ModifyDirectory, vec![fio2::Operations::MODIFY_DIRECTORY]),
        (Right::ReadBytes, vec![fio2::Operations::READ_BYTES]),
        (Right::Traverse, vec![fio2::Operations::TRAVERSE]),
        (Right::UpdateAttributes, vec![fio2::Operations::UPDATE_ATTRIBUTES]),
        (Right::WriteBytes, vec![fio2::Operations::WRITE_BYTES]),
        (Right::ReadAlias, vec![
            fio2::Operations::CONNECT,
            fio2::Operations::ENUMERATE,
            fio2::Operations::TRAVERSE,
