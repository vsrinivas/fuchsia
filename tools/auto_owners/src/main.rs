...
fn main() -> anyhow::Result<()> {
    let Options { overrides, metadata, gn_bin, out_dir } = argh::from_env();
...
const AUTO_GEN_HEADER: &str = "\
# AUTOGENERATED. TO MAKE CHANGES HERE, UPDATE //third_party/rust_crates/owners.toml.
# BACKGROUND: https://fuchsia.dev/fuchsia-src/development/languages/rust/third_party#owners-files
";

impl std::fmt::Display for OwnersFile {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        writeln!(f, "{}", AUTO_GEN_HEADER)?;
