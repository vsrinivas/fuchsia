...
constexpr UndocumentedErrorDef<1, std::string_view> ErrInvalidCharacter("invalid character '{}'");
...
constexpr UndocumentedErrorDef<77, std::string_view> ErrEmptyPayloadStructs(
...
constexpr UndocumentedWarningDef<145, std::string_view, std::string_view> WarnAttributeTypo(
