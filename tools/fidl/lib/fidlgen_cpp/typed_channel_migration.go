...
var rawChannelInterfaceAllowed = map[string]bool{
	...
	"::fuchsia_driver_framework::DriverHost":             true,
	"::fuchsia_driver_framework::Node":                   true,
	"::fuchsia_gpu_magma::Primary":                       true,
	"::fuchsia_hardware_camera::Device":                  true,
	...
	"::fuchsia_hardware_network::Device":                 true,
	"::fuchsia_hardware_network::DeviceInstance":         true,
	"::fuchsia_hardware_pty::Device":                     true,
	"::fuchsia_hardware_serial::NewDeviceProxy":          true,
	"::fuchsia_hardware_tee::DeviceConnector":            true,
	"::fuchsia_hardware_telephony_transport::Qmi":        true,
	...
	"::fuchsia_sysmem::BufferCollection":                 true,
	"::fuchsia_sysmem::BufferCollectionToken":            true,
