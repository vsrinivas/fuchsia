...
async fn run_jq(
    ...
    // TODO(72434) Find a way to transpantly wrap return values and stderr.
    // As it stands, this program will suppress all output it one call of run_jq
    // prints at all to stderr.
...
mod tests {
    ...
    const JQ_PATH_STR: &str = "jq5_tests/jq";
