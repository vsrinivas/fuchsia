...
func TestMain(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedFFXRepositoryRemoveArgs:   "--config ffx_repository=true repository remove devhost",
		...
		},
		{
			...
			ffxTargetGetSSHAddress:            `[::1f]:22`,
			ffxConfigServerMode:               "\"ffx\"",
			expectedFFXRepositoryRemoveArgs:   "--config ffx_repository=true repository remove test-devhost",
