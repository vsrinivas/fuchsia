...
type BuildArtifacts struct {
	...
	// Names of images produced by the build. We use a struct to avoid needing to
	...
	// Names of archives produced by the build. We use a struct to avoid needing to
	// maintain a copy of the images.json schema here.
...
var file_build_artifacts_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xda, 0x01, 0x0a, 0x0e,
	...
	0x41, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x73, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x6f, 0x2e, 0x66,
...
var file_build_artifacts_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
var file_build_artifacts_proto_depIdxs = []int32{
	1, // 0: fint.BuildArtifacts.built_images:type_name -> google.protobuf.Struct
	1, // 1: fint.BuildArtifacts.built_archives:type_name -> google.protobuf.Struct
