...
type Static struct {
	...
	// Fuchsia.
	ExcludeImages bool `protobuf:"varint,13,opt,name=exclude_images,json=excludeImages,proto3" json:"exclude_images,omitempty"`
	// Whether to build host tests.
	IncludeHostTests bool `protobuf:"varint,14,opt,name=include_host_tests,json=includeHostTests,proto3" json:"include_host_tests,omitempty"`
	...
	TestDurationsFile string `protobuf:"bytes,17,opt,name=test_durations_file,json=testDurationsFile,proto3" json:"test_durations_file,omitempty"`
	...
	DefaultTestDurationsFile string `protobuf:"bytes,18,opt,name=default_test_durations_file,json=defaultTestDurationsFile,proto3" json:"default_test_durations_file,omitempty"`
	...
	UseGoma bool `protobuf:"varint,19,opt,name=use_goma,json=useGoma,proto3" json:"use_goma,omitempty"`
	// Whether to generate a listing of the commands run during the build.
	GenerateCompdb bool `protobuf:"varint,20,opt,name=generate_compdb,json=generateCompdb,proto3" json:"generate_compdb,omitempty"`
	// Whether to use a go cache when building.
	EnableGoCache bool `protobuf:"varint,21,opt,name=enable_go_cache,json=enableGoCache,proto3" json:"enable_go_cache,omitempty"`
	// Whether to use a rust cache when building.
	EnableRustCache bool `protobuf:"varint,22,opt,name=enable_rust_cache,json=enableRustCache,proto3" json:"enable_rust_cache,omitempty"`
	// Which IDE files to generate.
	IdeFiles []string `protobuf:"bytes,23,rep,name=ide_files,json=ideFiles,proto3" json:"ide_files,omitempty"`
	// Passed to --json-ide-script GN flag; GN will execute each of these scripts
	// after regenerating the project.json IDE file.
	JsonIdeScripts []string `protobuf:"bytes,24,rep,name=json_ide_scripts,json=jsonIdeScripts,proto3" json:"json_ide_scripts,omitempty"`
}
...
var file_static_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6e, 0x74, 0x22, 0x93, 0x08, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x12,
	...
	,
	...
	0x18, 0x17, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x69, 0x64, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x73,
	0x12, 0x28, 0x0a, 0x10, 0x6a, 0x73, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x65, 0x5f, 0x73, 0x63, 0x72,
	0x69, 0x70, 0x74, 0x73, 0x18, 0x18, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x6a, 0x73, 0x6f, 0x6e,
	0x49, 0x64, 0x65, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x73, 0x22, 0x3c, 0x0a, 0x08, 0x4f, 0x70,
