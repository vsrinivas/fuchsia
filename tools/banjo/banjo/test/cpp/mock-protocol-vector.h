...
public:
    ...
    MockVector& ExpectBool(std::vector<bool> b, std::vector<bool> out_b) {
        mock_bool_.ExpectCall({std::move(out_b)}, std::move(b));
        return *this;
    }

    MockVector& ExpectInt8(std::vector<int8_t> i8, std::vector<int8_t> out_i8) {
        mock_int8_.ExpectCall({std::move(out_i8)}, std::move(i8));
        return *this;
    }

    MockVector& ExpectInt16(std::vector<int16_t> i16, std::vector<int16_t> out_i16) {
        mock_int16_.ExpectCall({std::move(out_i16)}, std::move(i16));
        return *this;
    }

    MockVector& ExpectInt32(std::vector<int32_t> i32, std::vector<int32_t> out_i32) {
        mock_int32_.ExpectCall({std::move(out_i32)}, std::move(i32));
        return *this;
    }

    MockVector& ExpectInt64(std::vector<int64_t> i64, std::vector<int64_t> out_i64) {
        mock_int64_.ExpectCall({std::move(out_i64)}, std::move(i64));
        return *this;
    }

    MockVector& ExpectUint8(std::vector<uint8_t> u8, std::vector<uint8_t> out_u8) {
        mock_uint8_.ExpectCall({std::move(out_u8)}, std::move(u8));
        return *this;
    }

    MockVector& ExpectUint16(std::vector<uint16_t> u16, std::vector<uint16_t> out_u16) {
        mock_uint16_.ExpectCall({std::move(out_u16)}, std::move(u16));
        return *this;
    }

    MockVector& ExpectUint32(std::vector<uint32_t> u32, std::vector<uint32_t> out_u32) {
        mock_uint32_.ExpectCall({std::move(out_u32)}, std::move(u32));
        return *this;
    }

    MockVector& ExpectUint64(std::vector<uint64_t> u64, std::vector<uint64_t> out_u64) {
        mock_uint64_.ExpectCall({std::move(out_u64)}, std::move(u64));
        return *this;
    }

    MockVector& ExpectFloat32(std::vector<float> f32, std::vector<float> out_f32) {
        mock_float32_.ExpectCall({std::move(out_f32)}, std::move(f32));
        return *this;
    }

    MockVector& ExpectFloat64(std::vector<double> u64, std::vector<double> out_f64) {
        mock_float64_.ExpectCall({std::move(out_f64)}, std::move(u64));
        return *this;
    }

    MockVector& ExpectHandle(std::vector<zx_handle_t> u64, std::vector<zx_handle_t> out_f64) {
...
public:
    ...
    MockVector2& ExpectBool(std::vector<bool> b, std::vector<bool> out_b) {
        mock_bool_.ExpectCall({std::move(out_b)}, std::move(b));
        return *this;
    }

    MockVector2& ExpectInt8(std::vector<int8_t> i8, std::vector<int8_t> out_i8) {
        mock_int8_.ExpectCall({std::move(out_i8)}, std::move(i8));
        return *this;
    }

    MockVector2& ExpectInt16(std::vector<int16_t> i16, std::vector<int16_t> out_i16) {
        mock_int16_.ExpectCall({std::move(out_i16)}, std::move(i16));
        return *this;
    }

    MockVector2& ExpectInt32(std::vector<int32_t> i32, std::vector<int32_t> out_i32) {
        mock_int32_.ExpectCall({std::move(out_i32)}, std::move(i32));
        return *this;
    }

    MockVector2& ExpectInt64(std::vector<int64_t> i64, std::vector<int64_t> out_i64) {
        mock_int64_.ExpectCall({std::move(out_i64)}, std::move(i64));
        return *this;
    }

    MockVector2& ExpectUint8(std::vector<uint8_t> u8, std::vector<uint8_t> out_u8) {
        mock_uint8_.ExpectCall({std::move(out_u8)}, std::move(u8));
        return *this;
    }

    MockVector2& ExpectUint16(std::vector<uint16_t> u16, std::vector<uint16_t> out_u16) {
        mock_uint16_.ExpectCall({std::move(out_u16)}, std::move(u16));
        return *this;
    }

    MockVector2& ExpectUint32(std::vector<uint32_t> u32, std::vector<uint32_t> out_u32) {
        mock_uint32_.ExpectCall({std::move(out_u32)}, std::move(u32));
        return *this;
    }

    MockVector2& ExpectUint64(std::vector<uint64_t> u64, std::vector<uint64_t> out_u64) {
        mock_uint64_.ExpectCall({std::move(out_u64)}, std::move(u64));
        return *this;
    }

    MockVector2& ExpectFloat32(std::vector<float> f32, std::vector<float> out_f32) {
        mock_float32_.ExpectCall({std::move(out_f32)}, std::move(f32));
        return *this;
    }

    MockVector2& ExpectFloat64(std::vector<double> u64, std::vector<double> out_f64) {
        mock_float64_.ExpectCall({std::move(out_f64)}, std::move(u64));
        return *this;
    }

    MockVector2& ExpectHandle(std::vector<zx_handle_t> u64, std::vector<zx_handle_t> out_f64) {
        mock_handle_.ExpectCall({std::move(out_f64)}, std::move(u64));
        return *this;
    }
...
public:
    ...
    MockVectorOfVectors& ExpectBool(std::vector<bool> b, std::vector<bool> out_b) {
        mock_bool_.ExpectCall({std::move(out_b)}, std::move(b));
        return *this;
    }

    MockVectorOfVectors& ExpectInt8(std::vector<int8_t> i8, std::vector<int8_t> out_i8) {
        mock_int8_.ExpectCall({std::move(out_i8)}, std::move(i8));
        return *this;
    }

    MockVectorOfVectors& ExpectInt16(std::vector<int16_t> i16, std::vector<int16_t> out_i16) {
        mock_int16_.ExpectCall({std::move(out_i16)}, std::move(i16));
        return *this;
    }

    MockVectorOfVectors& ExpectInt32(std::vector<int32_t> i32, std::vector<int32_t> out_i32) {
        mock_int32_.ExpectCall({std::move(out_i32)}, std::move(i32));
        return *this;
    }

    MockVectorOfVectors& ExpectInt64(std::vector<int64_t> i64, std::vector<int64_t> out_i64) {
        mock_int64_.ExpectCall({std::move(out_i64)}, std::move(i64));
        return *this;
    }

    MockVectorOfVectors& ExpectUint8(std::vector<uint8_t> u8, std::vector<uint8_t> out_u8) {
        mock_uint8_.ExpectCall({std::move(out_u8)}, std::move(u8));
        return *this;
    }

    MockVectorOfVectors& ExpectUint16(std::vector<uint16_t> u16, std::vector<uint16_t> out_u16) {
        mock_uint16_.ExpectCall({std::move(out_u16)}, std::move(u16));
        return *this;
    }

    MockVectorOfVectors& ExpectUint32(std::vector<uint32_t> u32, std::vector<uint32_t> out_u32) {
        mock_uint32_.ExpectCall({std::move(out_u32)}, std::move(u32));
        return *this;
    }

    MockVectorOfVectors& ExpectUint64(std::vector<uint64_t> u64, std::vector<uint64_t> out_u64) {
        mock_uint64_.ExpectCall({std::move(out_u64)}, std::move(u64));
        return *this;
    }

    MockVectorOfVectors& ExpectFloat32(std::vector<float> f32, std::vector<float> out_f32) {
        mock_float32_.ExpectCall({std::move(out_f32)}, std::move(f32));
        return *this;
    }

    MockVectorOfVectors& ExpectFloat64(std::vector<double> u64, std::vector<double> out_f64) {
        mock_float64_.ExpectCall({std::move(out_f64)}, std::move(u64));
        return *this;
    }

    MockVectorOfVectors& ExpectHandle(std::vector<zx_handle_t> u64, std::vector<zx_handle_t> out_f64) {
        mock_handle_.ExpectCall({std::move(out_f64)}, std::move(u64));
        return *this;
    }
