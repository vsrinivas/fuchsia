...
public:
    ...
    MockSynchronousBase& ExpectStatus(zx_status_t out_status, zx_status_t status, zx_status_t out_status_2) {
        mock_status_.ExpectCall({out_status, out_status_2}, status);
        return *this;
    }

    MockSynchronousBase& ExpectTime(zx_time_t out_time, zx_time_t time, zx_time_t out_time_2) {
        mock_time_.ExpectCall({out_time, out_time_2}, time);
        return *this;
    }

    MockSynchronousBase& ExpectDuration(zx_duration_t out_duration, zx_duration_t duration, zx_duration_t out_duration_2) {
        mock_duration_.ExpectCall({out_duration, out_duration_2}, duration);
        return *this;
    }

    MockSynchronousBase& ExpectKoid(zx_koid_t out_koid, zx_koid_t koid, zx_koid_t out_koid_2) {
        mock_koid_.ExpectCall({out_koid, out_koid_2}, koid);
        return *this;
    }

    MockSynchronousBase& ExpectVaddr(zx_vaddr_t out_vaddr, zx_vaddr_t vaddr, zx_vaddr_t out_vaddr_2) {
        mock_vaddr_.ExpectCall({out_vaddr, out_vaddr_2}, vaddr);
        return *this;
    }

    MockSynchronousBase& ExpectPaddr(zx_paddr_t out_paddr, zx_paddr_t paddr, zx_paddr_t out_paddr_2) {
        mock_paddr_.ExpectCall({out_paddr, out_paddr_2}, paddr);
        return *this;
    }

    MockSynchronousBase& ExpectPaddr32(zx_paddr32_t out_paddr32, zx_paddr32_t paddr32, zx_paddr32_t out_paddr32_2) {
        mock_paddr32_.ExpectCall({out_paddr32, out_paddr32_2}, paddr32);
        return *this;
    }

    MockSynchronousBase& ExpectGpaddr(zx_gpaddr_t out_gpaddr, zx_gpaddr_t gpaddr, zx_gpaddr_t out_gpaddr_2) {
        mock_gpaddr_.ExpectCall({out_gpaddr, out_gpaddr_2}, gpaddr);
        return *this;
    }

    MockSynchronousBase& ExpectOff(zx_off_t out_off, zx_off_t off, zx_off_t out_off_2) {
...
public:
    ...
    MockAsyncBase& ExpectStatus(zx_status_t status, zx_status_t out_status, zx_status_t out_status_2) {
        mock_status_.ExpectCall({out_status, out_status_2}, status);
        return *this;
    }

    MockAsyncBase& ExpectTime(zx_time_t time, zx_time_t out_time, zx_time_t out_time_2) {
        mock_time_.ExpectCall({out_time, out_time_2}, time);
        return *this;
    }

    MockAsyncBase& ExpectDuration(zx_duration_t duration, zx_duration_t out_duration, zx_duration_t out_duration_2) {
        mock_duration_.ExpectCall({out_duration, out_duration_2}, duration);
        return *this;
    }

    MockAsyncBase& ExpectKoid(zx_koid_t koid, zx_koid_t out_koid, zx_koid_t out_koid_2) {
        mock_koid_.ExpectCall({out_koid, out_koid_2}, koid);
        return *this;
    }

    MockAsyncBase& ExpectVaddr(zx_vaddr_t vaddr, zx_vaddr_t out_vaddr, zx_vaddr_t out_vaddr_2) {
        mock_vaddr_.ExpectCall({out_vaddr, out_vaddr_2}, vaddr);
        return *this;
    }

    MockAsyncBase& ExpectPaddr(zx_paddr_t paddr, zx_paddr_t out_paddr, zx_paddr_t out_paddr_2) {
        mock_paddr_.ExpectCall({out_paddr, out_paddr_2}, paddr);
        return *this;
    }

    MockAsyncBase& ExpectPaddr32(zx_paddr32_t paddr32, zx_paddr32_t out_paddr32, zx_paddr32_t out_paddr32_2) {
        mock_paddr32_.ExpectCall({out_paddr32, out_paddr32_2}, paddr32);
        return *this;
    }

    MockAsyncBase& ExpectGpaddr(zx_gpaddr_t gpaddr, zx_gpaddr_t out_gpaddr, zx_gpaddr_t out_gpaddr_2) {
        mock_gpaddr_.ExpectCall({out_gpaddr, out_gpaddr_2}, gpaddr);
        return *this;
    }

    MockAsyncBase& ExpectOff(zx_off_t off, zx_off_t out_off, zx_off_t out_off_2) {
        mock_off_.ExpectCall({out_off, out_off_2}, off);
        return *this;
    }
