...
KTRACE_CONTROL_DISPLAY_TEST(
    ...
    "options:\x1B[32muint32\x1B[0m: \x1B[34m0\x1B[0m, "
    "ptr:string: \x1B[31m\"My_name\"\x1B[0m\n)\n"
    "  -> \x1B[32mZX_OK\x1B[0m\n");
...
DEBUG_READ_DISPLAY_TEST(ZxDebugRead, ZX_OK,
                        ...
                        "buffer:string: \x1B[31m\"My data\"\x1B[0m\n)\n");
...
DEBUG_WRITE_DISPLAY_TEST(ZxDebugWrite, ZX_OK,
                         "\n"
                         "test_3141 \x1B[31m3141\x1B[0m:\x1B[31m8764\x1B[0m "
                         "zx_debug_write(buffer:string: \x1B[31m\"My data\"\x1B[0m\n)\n"
                         "  -> \x1B[32mZX_OK\x1B[0m\n");
