...
TEST_F(InterceptionWorkflowTestX64, ValuesNotImplemented) {
  ...
  std::set<std::string> expected = {
      "zx_debug_read",       "zx_fifo_read",         "zx_fifo_write",         "zx_interrupt_create",
      "zx_iommu_create",     "zx_job_set_policy",    "zx_ktrace_control",     "zx_ktrace_read",
      "zx_object_get_info",  "zx_object_wait_many",  "zx_resource_create",    "zx_socket_create",
      "zx_socket_read",      "zx_socket_shutdown",   "zx_socket_write",       "zx_system_get_event",
      "zx_system_powerctl",  "zx_thread_read_state", "zx_thread_write_state", "zx_vcpu_read_state",
      "zx_vcpu_write_state", "zx_vmar_allocate",     "zx_vmar_map",           "zx_vmar_protect",
      "zx_vmo_create",       "zx_vmo_create_child",  "zx_vmo_op_range"};
