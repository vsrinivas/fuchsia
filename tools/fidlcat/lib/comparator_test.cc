...
echo_client 28777:28779 zx_channel_write(handle:handle: 6d1e0003, options:uint32: 0)
  ...
  std::string message1 = R"(echo_client 28777:28779 zx_channel_create(options:uint32: 0)
)";
  std::string message2 = R"(  -> ZX_OK (out0:handle: 6d3e0273, out1:handle: 6c2e0347)
)";
  std::string message3 =
...
TEST(Comparator, SameProcessNamePidTidTest) {
  ...
  std::string actual0 = R"(compA 28777:28779 zx_channel_create(options:uint32: 0)
)";
  std::string expected0 = R"(compB 32809:32811 zx_channel_create(options:uint32: 0)
)";
...
echo_client 011:021 zx_channel_create(options:uint32: 0)
  ...
  std::string actual2 = R"(echo_client 111:121 zx_channel_create(options:uint32: 0)
)";
  std::string expected2 = R"(echo_client 019:021 zx_channel_create(options:uint32: 0)
)";
  ...
  std::string actual3 = R"(echo_client 119:121 zx_channel_create(options:uint32: 0)
)";
  std::string expected3 = R"(echo_client 011:021 zx_channel_create(options:uint32: 0)
)";
  ...
  std::string actual4 = R"(echo_client 111:121 zx_channel_create(options:uint32: 0)
)";
  std::string expected4 = R"(echo_client 011:029 zx_channel_create(options:uint32: 0)
)";
  ...
  std::string actual5 = R"(echo_client 111:129 zx_channel_create(options:uint32: 0)
)";
  std::string expected5 = R"(echo_client 011:021 zx_channel_create(options:uint32: 0)
)";
...
TEST(Comparator, CouldReplaceHandles) {
  ...
  std::string actual0 = R"(
zx_channel_write(handle:handle: a0, options:uint32: 0)
)";
  std::string expected0 = R"(
zx_channel_write(handle:handle: e0, options:uint32: 0)
)";
  ...
  // If first occurence after "handle = ", saved for "handle: " as well
  std::string actual3 = R"(
zx_channel_write(handle:handle: a1, options:uint32: 0)
)";
  std::string expected3 = R"(
zx_channel_write(handle:handle: e3, options:uint32: 0)
)";
  ...
  // If first occurence after "handle = ", saved for "handle: " as well
  std::string actual5 = R"(
zx_channel_write(handle:handle: a5, options:uint32: 0)
)";
  std::string expected5 = R"(
zx_channel_write(handle:handle: e1, options:uint32: 0)
)";
...
echo_client 28777:28779 zx_channel_write(handle:handle: 6d1e0003, options:uint32: 0)
  ...
  std::string input_1 = R"(echo_client 28777:28779 zx_channel_create(options:uint32: 0)
)";
  comparator.CompareInput(input_1);
  ASSERT_STREQ(comparator.output_string().c_str(), "");

  std::string output_1 = R"(  -> ZX_OK (out0:handle: 6d3e0273, out1:handle: 6c2e0347)
)";
  comparator.CompareOutput(output_1);
  ASSERT_STREQ(comparator.output_string().c_str(), "");

  std::string input_2 = R"(
