...
#ifndef EXAMPLES_MEDIA_AUDIO_TONES_TONE_GENERATOR_H_
#define EXAMPLES_MEDIA_AUDIO_TONES_TONE_GENERATOR_H_
...
#endif  // EXAMPLES_MEDIA_AUDIO_TONES_TONE_GENERATOR_H_
