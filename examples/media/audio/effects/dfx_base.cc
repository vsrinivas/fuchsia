...
bool DfxBase::GetInfo(uint32_t effect_id, fuchsia_audio_effects_description* dfx_desc) {
  switch (effect_id) {
  ...
  switch (effect_id) {
    case media::audio_dfx_test::Effect::Delay:
      return reinterpret_cast<DfxBase*>(
          DfxDelay::Create(frame_rate, channels_in, channels_out, config));

    case media::audio_dfx_test::Effect::Rechannel:
      return reinterpret_cast<DfxBase*>(
          DfxRechannel::Create(frame_rate, channels_in, channels_out, config));

    case media::audio_dfx_test::Effect::Swap:
      return reinterpret_cast<DfxBase*>(
          DfxSwap::Create(frame_rate, channels_in, channels_out, config));
  }
...
//
bool DfxBase::GetParameters(fuchsia_audio_effects_parameters* device_fx_params) {
