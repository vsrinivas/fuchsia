...
- Reviewers: (many; thank you!)
- Implementor: jeremymanson@google.com
- Original Date: 2018-10-26
- Last Updated: 2018-11-28
- Review End Date: 2018-11-29
- Tracking Bug: TBD
...
We will update the
[FIDL readability rubric](https://fuchsia.googlesource.com/docs/+/master/development/api/fidl.md)
...
3. Broadcast intent-to-change to tq-eng so eng is aware of potential issues.
...
The above is a
[soft transition](https://fuchsia.googlesource.com/docs/+/master/development/workflows/multilayer_changes.md#soft-transitions-preferred);
