...
pub const FDIO_PROTOCOL_UNDEFINED: raw::c_uint = 0;
pub const FDIO_PROTOCOL_PIPE: raw::c_uint = 1;
pub const FDIO_PROTOCOL_REMOTE: raw::c_uint = 2;
pub const FDIO_PROTOCOL_VMOFILE: raw::c_uint = 3;
pub const FDIO_PROTOCOL_SOCKET: raw::c_uint = 4;
pub const FDIO_PROTOCOL_SERVICE: raw::c_uint = 5;
pub const FDIO_PROTOCOL_SOCKET_CONNECTED: raw::c_uint = 6;
