...
pub const ERR_NO_RESOURCES      : mx_status_t = -3;
pub const ERR_NO_MEMORY         : mx_status_t = -4;
pub const ERR_CALL_FAILED       : mx_status_t = -5;
pub const ERR_INTERRUPTED_RETRY : mx_status_t = -6;
pub const ERR_INVALID_ARGS      : mx_status_t = -10;
pub const ERR_BAD_HANDLE        : mx_status_t = -11;
pub const ERR_WRONG_TYPE        : mx_status_t = -12;
pub const ERR_BAD_SYSCALL       : mx_status_t = -13;
pub const ERR_OUT_OF_RANGE      : mx_status_t = -14;
pub const ERR_BUFFER_TOO_SMALL  : mx_status_t = -15;
...
pub const ERR_ALREADY_BOUND     : mx_status_t = -27;
pub const ERR_UNAVAILABLE       : mx_status_t = -28;
...
pub const ERR_FILE_BIG          : mx_status_t = -53;
