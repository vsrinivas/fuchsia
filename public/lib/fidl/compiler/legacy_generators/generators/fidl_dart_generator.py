...
_kind_to_dart_decl_type = {
  ...
  mojom.CHANNEL:               "core.Channel",
  mojom.VMO:                   "core.Handle",
  mojom.PROCESS:               "core.Handle",
  mojom.THREAD:                "core.Handle",
  mojom.EVENT:                 "core.Handle",
  mojom.PORT:                  "core.Handle",
  mojom.JOB:                   "core.Handle",
  mojom.SOCKET:                "core.Handle",
  mojom.EVENTPAIR:             "core.Handle",
  mojom.NULLABLE_HANDLE:       "core.Handle",
  mojom.NULLABLE_DCPIPE:       "core.Handle",
  mojom.NULLABLE_DPPIPE:       "core.Handle",
  mojom.NULLABLE_CHANNEL:      "core.Channel",
  mojom.NULLABLE_VMO:          "core.Handle",
  mojom.NULLABLE_PROCESS:      "core.Handle",
  mojom.NULLABLE_THREAD:       "core.Handle",
  mojom.NULLABLE_EVENT:        "core.Handle",
  mojom.NULLABLE_PORT:         "core.Handle",
  mojom.NULLABLE_JOB:          "core.Handle",
  mojom.NULLABLE_SOCKET:       "core.Handle",
  mojom.NULLABLE_EVENTPAIR:    "core.Handle",
  mojom.INT64:                 "int",
  mojom.UINT64:                "int",
  mojom.DOUBLE:                "double",
  mojom.STRING:                "String",
...
_spec_to_decode_method = {
  ...
  mojom.NULLABLE_VMO.spec:          'decodeHandle',
  ...
  mojom.SOCKET.spec:                'decodeHandle',
...
_spec_to_encode_method = {
  ...
  mojom.NULLABLE_VMO.spec:          'encodeHandle',
  ...
  mojom.SOCKET.spec:                'encodeHandle',
