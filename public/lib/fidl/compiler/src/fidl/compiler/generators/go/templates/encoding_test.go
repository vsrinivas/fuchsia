...
func TestEncodingInterfaceFieldEncoding(t *testing.T) {
	expected := `if err := encoder.WriteInterface(s.IntField.TakeChannel()); err != nil {
	return err
}`
...
func TestEncodingNullableInterfaceFieldEncoding(t *testing.T) {
	...
	if err := encoder.WriteInterface(s.IntField.TakeChannel()); err != nil {
		return err
	}
}`
...
func TestEncodingInterfaceRequestFieldEncoding(t *testing.T) {
	expected := `if err := encoder.WriteHandle(s.IntField.TakeChannel()); err != nil {
	return err
}`
...
func TestEncodingNullableInterfaceRequestFieldEncoding(t *testing.T) {
	...
	if err := encoder.WriteHandle(s.IntField.TakeChannel()); err != nil {
		return err
	}
}`
