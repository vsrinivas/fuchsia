...
// Event
const int MX_EVENT_SIGNAL_SIGNALED  = MX_OBJECT_SIGNAL_3;
const int MX_EVENT_SIGNAL_MASK      = MX_USER_SIGNAL_ALL | MX_OBJECT_SIGNAL_3;

// EventPair
const int MX_EPAIR_SIGNAL_SIGNALED  = MX_OBJECT_SIGNAL_3;
const int MX_EPAIR_SIGNAL_CLOSED    = MX_OBJECT_SIGNAL_2;
...
const int MX_SIGNAL_READ_THRESHOLD  = MX_OBJECT_SIGNAL_4;
const int MX_SIGNAL_WRITE_THRESHOLD = MX_OBJECT_SIGNAL_5;
const int MX_SIGNAL_SIGNAL0         = MX_USER_SIGNAL_0;
const int MX_SIGNAL_SIGNAL1         = MX_USER_SIGNAL_1;
const int MX_SIGNAL_SIGNAL2         = MX_USER_SIGNAL_2;
const int MX_SIGNAL_SIGNAL3         = MX_USER_SIGNAL_3;
const int MX_SIGNAL_SIGNAL4         = MX_USER_SIGNAL_4;
