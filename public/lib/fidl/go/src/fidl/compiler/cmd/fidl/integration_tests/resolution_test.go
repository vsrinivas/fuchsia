...
type testFuncType func(*core.MojomDescriptor) error
...
func TestSingleFileResolutionSuccess(t *testing.T) {
	...
	struct MyStruct {
		...
		testFunc := func(descriptor *core.MojomDescriptor) error {
			...
			concreteValue := aColorField.DefaultValue.ResolvedConcreteValue().(*core.EnumValue)
	...
	////////////////////////////////////////////////////////////
	{
		...
		testFunc := func(descriptor *core.MojomDescriptor) error {
			myConst1 := descriptor.ValuesByKey["TYPE_KEY:MyConst1"].(*core.UserDefinedConstant)
