...
#ifndef LIB_FTL_MEMORY_WEAK_PTR_H_
#define LIB_FTL_MEMORY_WEAK_PTR_H_
...
class WeakPtrFactory {
 public:
  explicit WeakPtrFactory(T* ptr) : ptr_(ptr) { FTL_DCHECK(ptr_); }
 ...
 private:
  ...
  FTL_DISALLOW_COPY_AND_ASSIGN(WeakPtrFactory);
};

}  // namespace ftl

#endif  // LIB_FTL_MEMORY_WEAK_PTR_H_
