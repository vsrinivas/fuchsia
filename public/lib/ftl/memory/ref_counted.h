...
#ifndef LIB_FTL_MEMORY_REF_COUNTED_H_
#define LIB_FTL_MEMORY_REF_COUNTED_H_

#include "lib/ftl/macros.h"
#include "lib/ftl/memory/ref_counted_internal.h"
...
class RefCountedThreadSafe : public internal::RefCountedThreadSafeBase {
 ...
 private:
  ...
  FTL_DISALLOW_COPY_AND_ASSIGN(RefCountedThreadSafe);
};
...
#define FRIEND_REF_COUNTED_THREAD_SAFE(T) \
  friend class ::ftl::RefCountedThreadSafe<T>
...
#define FRIEND_MAKE_REF_COUNTED(T) \
  friend class ::ftl::internal::MakeRefCountedHelper<T>

}  // namespace ftl

#endif  // LIB_FTL_MEMORY_REF_COUNTED_H_
