...
#ifndef LIB_FTL_FUNCTIONAL_CANCELABLE_CALLBACK_H_
#define LIB_FTL_FUNCTIONAL_CANCELABLE_CALLBACK_H_
...
//   FTL_LOG(INFO) << "Timeout has expired: " << message
// }
//
...
class CancelableCallback<void(Args...)> {
 ...
 private:
  ...
  ftl::WeakPtrFactory<CancelableCallback> weak_ptr_factory_;

  FTL_DISALLOW_COPY_AND_ASSIGN(CancelableCallback);
};
...
#endif  // LIB_FTL_FUNCTIONAL_CANCELABLE_CALLBACK_H_
