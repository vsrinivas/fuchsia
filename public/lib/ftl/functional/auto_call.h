...
//    int a;
//
//    auto ac = ftl::MakeAutoCall([&](){ a = 1; });
//    auto ac2 = ftl::MakeAutoCall(foo);
//
//    auto func = [&](){ a = 2; };
//    ftl::AutoCall<decltype(func)> ac3(func);
//    ftl::AutoCall<decltype(&foo)> ac4(&foo);
//
//    // abort the call
//    ac2.cancel();
namespace ftl {
...
public:
  ...
  FTL_DISALLOW_COPY_AND_ASSIGN(AutoCall);
