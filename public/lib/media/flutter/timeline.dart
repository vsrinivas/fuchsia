...
import 'package:apps.media.services/timelines.fidl.dart';
...
class TimelineRate {
  ...
  @override
  bool operator ==(Object other) => other is TimelineRate &&
...
class TimelineFunction {
  ...
  TimelineFunction operator*(TimelineFunction other) =>
    new TimelineFunction(
  ...
  @override
  int get hashCode => subjectTime.hashCode ^ referenceTime.hashCode ^
    rate.hashCode;

  @override
  bool operator ==(Object other) => other is TimelineFunction &&
