...
#ifndef APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_SUBPICTURE_STREAM_TYPE_H_
#define APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_SUBPICTURE_STREAM_TYPE_H_
...
#endif  // APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_SUBPICTURE_STREAM_TYPE_H_
