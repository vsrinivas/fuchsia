...
#ifndef APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_VIDEO_STREAM_TYPE_H_
#define APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_VIDEO_STREAM_TYPE_H_
...
#endif  // APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_VIDEO_STREAM_TYPE_H_
