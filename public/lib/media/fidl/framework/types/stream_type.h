...
#ifndef APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_STREAM_TYPE_H_
#define APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_STREAM_TYPE_H_
...
#include "apps/media/services/framework/types/bytes.h"
...
#endif  // APPS_MEDIA_SERVICES_FRAMEWORK_TYPES_STREAM_TYPE_H_
