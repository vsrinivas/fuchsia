...
URL_EXPORT bool FindAndCompareScheme(const char* str, size_t str_len, const char* compare,
...
URL_EXPORT bool Canonicalize(const char* spec, size_t spec_len, bool trim_path_end,
...
URL_EXPORT bool ResolveRelative(const char* base_spec, size_t base_spec_len,
                                ...
                                size_t relative_length, CharsetConverter* charset_converter,
...
URL_EXPORT void EncodeURIComponent(const char* input, size_t length, CanonOutput* output);
