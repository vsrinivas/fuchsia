...
#ifndef LIB_FSL_THREADING_THREAD_H_
#define LIB_FSL_THREADING_THREAD_H_
...
class FXL_EXPORT Thread {
 ...
 private:
  ...
  fxl::Thread thread_;
  fxl::RefPtr<fsl::internal::IncomingTaskQueue> task_runner_;
...
#endif  // LIB_FSL_THREADING_THREAD_H_
