...
#ifndef APPS_LEDGER_STORAGE_PUBLIC_COMMIT_WATCHER_H_
#define APPS_LEDGER_STORAGE_PUBLIC_COMMIT_WATCHER_H_
...
#endif  // APPS_LEDGER_STORAGE_PUBLIC_COMMIT_WATCHER_H_
