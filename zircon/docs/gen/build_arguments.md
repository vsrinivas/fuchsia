...
**Current value (from the default):** `"//prebuilt/downloads/sysroot"`

From //public/gn/config/BUILD.gn:20
...
**Current value (from the default):** `"//z/.build-id"`
...
**Current value (from the default):** `"/usr/local/google/home/mcgrathr/goma"`
