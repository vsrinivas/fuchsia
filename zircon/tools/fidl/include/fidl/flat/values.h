...
#ifndef ZIRCON_TOOLS_FIDL_INCLUDE_FIDL_FLAT_VALUES_H_
#define ZIRCON_TOOLS_FIDL_INCLUDE_FIDL_FLAT_VALUES_H_
...
#endif  // ZIRCON_TOOLS_FIDL_INCLUDE_FIDL_FLAT_VALUES_H_
