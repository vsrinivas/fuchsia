...
char* __asctime(const struct tm* restrict, char* restrict) ATTR_LIBC_VISIBILITY;
...
void __secs_to_zone(long long, int, int*, long*, long*, const char**) ATTR_LIBC_VISIBILITY;
