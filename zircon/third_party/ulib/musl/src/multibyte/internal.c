...
#define D(x) C((x + 16))
#define E(x) \
  ((x == 0 ? R(0xa0, 0xc0) : x == 0xd ? R(0x80, 0xa0) : R(0x80, 0xc0)) | (R(0x80, 0xc0) >> 6) | x)
#define F(x)                                                                        \
  ((x >= 5 ? 0 : x == 0 ? R(0x90, 0xc0) : x == 4 ? R(0x80, 0xa0) : R(0x80, 0xc0)) | \
   (R(0x80, 0xc0) >> 6) | (R(0x80, 0xc0) >> 12) | x)

const uint32_t bittab[] = {C(0x2), C(0x3), C(0x4), C(0x5), C(0x6), C(0x7), C(0x8), C(0x9), C(0xa),
