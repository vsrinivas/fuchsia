...
extern "C" arm_smccc_result_t arm_smccc_smc_internal(uint32_t w0, uint64_t x1, uint64_t x2,
...
// Implemented in assembly.
extern "C" arm_smccc_result_t arm_smccc_hvc_internal(uint32_t w0, uint64_t x1, uint64_t x2,
                                                 uint64_t x3, uint64_t x4, uint64_t x5,
                                                 uint64_t x6, uint32_t w7);

// Calls the low-level HVC function.
