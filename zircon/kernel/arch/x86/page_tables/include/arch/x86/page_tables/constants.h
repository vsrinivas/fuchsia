...
#define _X86_PAT_COMMON_SELECTOR(x) \
  ((((x)&0x2) ? X86_MMU_PG_CD : 0) | (((x)&0x1) ? X86_MMU_PG_WT : 0))
#define X86_PAT_PTE_SELECTOR(x) ((((x)&0x4) ? X86_MMU_PG_PTE_PAT : 0) | _X86_PAT_COMMON_SELECTOR(x))
#define X86_PAT_LARGE_SELECTOR(x) \
  ((((x)&0x4) ? X86_MMU_PG_LARGE_PAT : 0) | _X86_PAT_COMMON_SELECTOR(x))
