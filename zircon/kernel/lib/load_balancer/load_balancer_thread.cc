...
LK_INIT_HOOK(load_balancer_init, &load_balancer_init,
             LK_INIT_LEVEL_TOPOLOGY)
...
STATIC_COMMAND("lb", "Thread Load balancer commands, responsible for balacing processing "
                     "load across processors.", &cmd_lb)
