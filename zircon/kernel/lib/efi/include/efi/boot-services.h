...
typedef efi_status (*efi_image_entry_point)(efi_handle img, efi_system_table* sys);
...
typedef struct {
  ...
  efi_status (*StartImage)(efi_handle image_handle, size_t* exit_data_size, char16_t** exit_data);
