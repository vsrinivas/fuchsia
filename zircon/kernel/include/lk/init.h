...
#ifndef ZIRCON_KERNEL_INCLUDE_LK_INIT_H_
#define ZIRCON_KERNEL_INCLUDE_LK_INIT_H_
...
enum lk_init_level {
  ...
  LK_INIT_LEVEL_TOPOLOGY = 0x70000,
  LK_INIT_LEVEL_KERNEL = 0x80000,
  LK_INIT_LEVEL_THREADING = 0x90000,
  LK_INIT_LEVEL_ARCH = 0xa0000,
  LK_INIT_LEVEL_PLATFORM = 0xb0000,
  LK_INIT_LEVEL_TARGET = 0xc0000,
...
#define LK_INIT_HOOK_FLAGS(_name, _hook, _level, _flags)                                  \
  ...
  __USED __SECTION(                                                                       \
      ".data.rel.ro.lk_init") static const struct lk_init_struct _init_struct_##_name = { \
      .level = _level,                                                                    \
      .flags = _flags,                                                                    \
      .hook = _hook,                                                                      \
      .name = #_name,                                                                     \
...
#endif  // ZIRCON_KERNEL_INCLUDE_LK_INIT_H_
