...
static bool printf_tests() {
  ...
  EXPECT_TRUE(test_printf("int:   -12345678 0 12345678", "int:   %d %d %d", -12345678, 0, 12345678),
              "");
  ...
  EXPECT_TRUE(test_printf("ptrdiff_t: -12345678 0 12345678", "ptrdiff_t: %td %td %td",
              ...
              "");
  EXPECT_TRUE(
      test_printf("ptrdiff_t (u): 18446744073697205938 0 12345678", "ptrdiff_t (u): %tu %tu %tu",
                  (ptrdiff_t)-12345678, (ptrdiff_t)0, (ptrdiff_t)12345678),
      "");
