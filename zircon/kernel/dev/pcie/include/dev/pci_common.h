...
#ifndef ZIRCON_KERNEL_DEV_PCIE_INCLUDE_DEV_PCI_COMMON_H_
#define ZIRCON_KERNEL_DEV_PCIE_INCLUDE_DEV_PCI_COMMON_H_
...
#define PCIE_MAX_CAPABILITIES \
  ((PCIE_BASE_CONFIG_SIZE - PCIE_STANDARD_CONFIG_HDR_SIZE) / PCIE_CAPABILITY_ALIGNMENT)
...
#define PCIE_MAX_EXT_CAPABILITIES \
  ((PCIE_EXTENDED_CONFIG_SIZE - PCIE_BASE_CONFIG_SIZE) / PCIE_CAPABILITY_ALIGNMENT)
...
#endif  // ZIRCON_KERNEL_DEV_PCIE_INCLUDE_DEV_PCI_COMMON_H_
