...
#ifndef ZIRCON_KERNEL_PHYS_LIB_PAGE_TABLE_INCLUDE_LIB_PAGE_TABLE_ARCH_RISCV64_BUILDER_H_
#define ZIRCON_KERNEL_PHYS_LIB_PAGE_TABLE_INCLUDE_LIB_PAGE_TABLE_ARCH_RISCV64_BUILDER_H_
...
class AddressSpaceBuilder final : public AddressSpaceBuilderInterface {
 public:
  ...
  // RISCV64-specific page table root.
...
#endif  // ZIRCON_KERNEL_PHYS_LIB_PAGE_TABLE_INCLUDE_LIB_PAGE_TABLE_ARCH_RISCV64_BUILDER_H_
