...
TEST_F(BlobfsTest, Basics) {
    RunBasicsTest();
}

TEST_F(BlobfsTestWithFvm, Basics) {
    RunBasicsTest();
}
...
TEST_F(BlobfsTest, UnallocatedBlob) {
    RunUnallocatedBlobTest();
}

TEST_F(BlobfsTestWithFvm, UnallocatedBlob) {
    RunUnallocatedBlobTest();
}
