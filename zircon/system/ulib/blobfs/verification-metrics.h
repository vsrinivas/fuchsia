...
#ifndef ZIRCON_SYSTEM_ULIB_BLOBFS_VERIFICATION_METRICS_H_
#define ZIRCON_SYSTEM_ULIB_BLOBFS_VERIFICATION_METRICS_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_BLOBFS_VERIFICATION_METRICS_H_
