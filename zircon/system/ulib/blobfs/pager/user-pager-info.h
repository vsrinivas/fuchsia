...
#ifndef ZIRCON_SYSTEM_ULIB_BLOBFS_PAGER_USER_PAGER_INFO_H_
#define ZIRCON_SYSTEM_ULIB_BLOBFS_PAGER_USER_PAGER_INFO_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_BLOBFS_PAGER_USER_PAGER_INFO_H_
