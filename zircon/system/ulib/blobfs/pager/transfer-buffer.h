...
#ifndef ZIRCON_SYSTEM_ULIB_BLOBFS_PAGER_TRANSFER_BUFFER_H_
#define ZIRCON_SYSTEM_ULIB_BLOBFS_PAGER_TRANSFER_BUFFER_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_BLOBFS_PAGER_TRANSFER_BUFFER_H_
