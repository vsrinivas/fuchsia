...
#ifndef ZIRCON_SYSTEM_ULIB_BLOBFS_BLOB_CORRUPTION_NOTIFIER_H_
#define ZIRCON_SYSTEM_ULIB_BLOBFS_BLOB_CORRUPTION_NOTIFIER_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_BLOBFS_BLOB_CORRUPTION_NOTIFIER_H_
