...
#ifndef ZIRCON_SYSTEM_ULIB_BLOBFS_ALLOCATOR_EXTENT_RESERVER_H_
#define ZIRCON_SYSTEM_ULIB_BLOBFS_ALLOCATOR_EXTENT_RESERVER_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_BLOBFS_ALLOCATOR_EXTENT_RESERVER_H_
