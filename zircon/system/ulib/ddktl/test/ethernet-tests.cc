...
public:
    TestEthernetIfc()
        : ddk::Device<TestEthernetIfc>(nullptr) {
        this_ = get_this();
    }
...
class TestEthernetImplProtocol : public ddk::Device<TestEthernetImplProtocol, ddk::GetProtocolable>,
                                 public ddk::EthernetImplProtocol<TestEthernetImplProtocol,
                                                                  ddk::base_protocol> {
public:
