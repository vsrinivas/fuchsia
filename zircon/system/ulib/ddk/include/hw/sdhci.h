...
#define SDHCI_SD_CLOCK_FREQUENCY_SELECT_SHIFT (6)
#define SDHCI_SD_CLOCK_FREQUENCY_SELECT_MASK (0x3ff << SDHCI_SD_CLOCK_FREQUENCY_SELECT_SHIFT)
...
#define SDHCI_IRQ_ERR_CMD                                                          \
  (SDHCI_IRQ_ERR_CMD_TIMEOUT | SDHCI_IRQ_ERR_CMD_CRC | SDHCI_IRQ_ERR_CMD_END_BIT | \
...
#define SDHCI_IRQ_ERR_DAT \
  (SDHCI_IRQ_ERR_DAT_TIMEOUT | SDHCI_IRQ_ERR_DAT_CRC | SDHCI_IRQ_ERR_DAT_ENDBIT)
