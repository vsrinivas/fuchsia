...
DDK_PROTOCOL_DEF(BUTTONS,        'pBUT', "buttons", PF_NOPUB)
DDK_PROTOCOL_DEF(CODEC,          'pCOD', "codec", PF_NOPUB)
...
DDK_PROTOCOL_DEF(DISPLAY_CAPTURE_IMPL, 'pDCS', "display-capture-impl", PF_NOPUB)
...
DDK_PROTOCOL_DEF(DOTMATRIX_DISPLAY,    'pDLD', "dotmatrix-display", 0)
...
DDK_PROTOCOL_DEF(HID_DEVICE,     'pINP', "input", 0)
DDK_PROTOCOL_DEF(I2C,            'pI2C', "i2c", 0)
DDK_PROTOCOL_DEF(I2C_IMPL ,      'pI2I', "i2c-impl", 0)
DDK_PROTOCOL_DEF(INPUTREPORT,    'pIRT', "input-report", 0)
...
DDK_PROTOCOL_DEF(BT_EMULATOR,    'pBHF', "bt-emulator", 0)  // Bluetooth hardware emulator interface
...
DDK_PROTOCOL_DEF(ISP,            'pISP', "isp", PF_NOPUB)
DDK_PROTOCOL_DEF(ISP_TEST,       'pIDT', "isp-device-test", 0)
DDK_PROTOCOL_DEF(VCAM_FACTORY,   'pVCM', "virtual-camera-factory", 0)
DDK_PROTOCOL_DEF(OUTPUT_STREAM,  'pOST', "output-stream", PF_NOPUB)
...
DDK_PROTOCOL_DEF(SHARED_DMA,     'pDma', "shared-dma", 0)
...
DDK_PROTOCOL_DEF(GDC,            'pGDC', "gdc", PF_NOPUB)
DDK_PROTOCOL_DEF(GE2D,           'pGE2', "ge2d", PF_NOPUB)
