...
#define STUB_HANDLER(name, ...) \
  [[gnu::weak]] extern "C" void __ubsan_handle_##name(__VA_ARGS__) { __builtin_trap(); }
...
RECOVERABLE(alignment_assumption, AlignmentAssumptionData* Data, ValueHandle Pointer,
...
UNRECOVERABLE(cfi_bad_type, CFICheckFailData* Data, ValueHandle Vtable, bool ValidVtable,
              ReportOptions Opts)
