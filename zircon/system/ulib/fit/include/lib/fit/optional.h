...
private:
    ...
    bad_optional_access(const char* reason) noexcept
        : reason_{reason} {}
...
public:
    ...
    constexpr optional(U&& value)
        : storage_(type_tag{}, std::forward<U>(value)) {}
    ...
    constexpr T value_or(U&& default_value) const& {
        ...
        return has_value() ? storage_.get(type_tag{})
    ...
    constexpr assignment_requires_conditions<
        ...
        std::is_constructible<T, const U&>,
        std::is_assignable<T&, U>,
        negation<converts_from_optional<T, U>>,
        negation<assigns_from_optional<T, U>>>
