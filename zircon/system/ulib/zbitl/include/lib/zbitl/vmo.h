...
struct StorageTraits<zx::vmo> {
 public:
  using ErrorTraits = ZxErrorTraits;
  ...
  // size.
  static fitx::result<ErrorTraits::error_type, uint32_t> Capacity(const zx::vmo&);

  // Will enlarge the underlying VMO size if needed, updating
  // ZX_PROP_VMO_CONTENT_SIZE to the new capacity value if so.
  static fitx::result<ErrorTraits::error_type> EnsureCapacity(const zx::vmo&,
                                                              uint32_t capacity_bytes);

  static fitx::result<ErrorTraits::error_type, payload_type> Payload(const zx::vmo& zbi,
                                                                     uint32_t offset,
                                                                     uint32_t length) {
    return fitx::ok(offset);
  }

  static fitx::result<ErrorTraits::error_type> Read(const zx::vmo& zbi, payload_type payload,
  ...
  static fitx::result<ErrorTraits::error_type> Write(const zx::vmo&, uint32_t offset, ByteView);

  static fitx::result<ErrorTraits::error_type, zx::vmo> Create(const zx::vmo&, uint32_t size,
                                                               uint32_t initial_zero_size);

  template <typename SlopCheck>
  static fitx::result<ErrorTraits::error_type, std::optional<std::pair<zx::vmo, uint32_t>>> Clone(
 ...
 private:
  static fitx::result<ErrorTraits::error_type> DoRead(const zx::vmo& zbi, uint64_t offset,
                                                      uint32_t length, bool (*)(void*, ByteView),
                                                      void*);

  static fitx::result<ErrorTraits::error_type, std::optional<std::pair<zx::vmo, uint32_t>>> DoClone(
...
struct StorageTraits<zx::unowned_vmo> {
  ...
  using ErrorTraits = Owned::ErrorTraits;
  ...
  static fitx::result<ErrorTraits::error_type> Read(const zx::unowned_vmo& vmo,
                                                    payload_type payload, void* buffer,
                                                    uint32_t length) {
...
class StorageTraits<MapUnownedVmo> {
 public:
  ...
  static fitx::result<ErrorTraits::error_type> EnsureCapacity(const MapUnownedVmo& zbi,
                                                              uint32_t capacity_bytes) {
  ...
  static std::enable_if_t<(alignof(T) <= kStorageAlignment) && !LowLocality,
                          fitx::result<ErrorTraits::error_type, cpp20::span<const T>>>
  ...
  static fitx::result<ErrorTraits::error_type> Read(const MapUnownedVmo& zbi, payload_type payload,
                                                    void* buffer, uint32_t length) {
  ...
  static fitx::result<ErrorTraits::error_type, void*> Write(MapUnownedVmo& zbi, uint32_t offset,
                                                            uint32_t length) {
    return Map(zbi, offset, length, true);
  }

  static fitx::result<ErrorTraits::error_type, MapOwnedVmo> Create(const MapUnownedVmo& proto,
                                                                   uint32_t size,
                                                                   uint32_t initial_zero_size) {
  ...
  template <typename SlopCheck>
  static fitx::result<ErrorTraits::error_type, std::optional<std::pair<MapOwnedVmo, uint32_t>>>
  Clone(const MapUnownedVmo& zbi, uint32_t offset, uint32_t length, uint32_t to_offset,
        SlopCheck&& slopcheck) {
    auto result =
 ...
 private:
  static fitx::result<ErrorTraits::error_type, void*> Map(MapUnownedVmo& zbi, uint64_t offset,
