...
#ifndef LIB_FIDL_LLCPP_INTERNAL_INTRUSIVE_CONTAINER_HELPER_MACROS_H_
#define LIB_FIDL_LLCPP_INTERNAL_INTRUSIVE_CONTAINER_HELPER_MACROS_H_
...
#endif  // LIB_FIDL_LLCPP_INTERNAL_INTRUSIVE_CONTAINER_HELPER_MACROS_H_
