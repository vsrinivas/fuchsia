...
#ifndef LIB_FIDL_LLCPP_INTERNAL_MAKE_RESPONSE_CONTEXT_H_
#define LIB_FIDL_LLCPP_INTERNAL_MAKE_RESPONSE_CONTEXT_H_
...
#endif  // LIB_FIDL_LLCPP_INTERNAL_MAKE_RESPONSE_CONTEXT_H_
