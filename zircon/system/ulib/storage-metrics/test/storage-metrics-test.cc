...
void ExpectMetricsMatchCallStat(const fuchsia_storage_metrics_CallStat& lhs,
...
void ExpectFsMetricsInitialState(const fuchsia_storage_metrics_FsMetrics& fidl_fs_metrics) {
...
// Compares all fuchsia_storage_metrics_CallStat fields within
// |fidl_block_device_metrics|, with |fidl_call_stat|
void CompareFidlBlockDeviceStatAll(
    const fuchsia_hardware_block_BlockStats& fidl_block_device_metrics,
    const fuchsia_storage_metrics_CallStat& fidl_call_stat) {
