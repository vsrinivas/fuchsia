...
#ifndef ZIRCON_SYSTEM_ULIB_INTEL_HDA_CODEC_UTILS_DEBUG_LOGGING_H_
#define ZIRCON_SYSTEM_ULIB_INTEL_HDA_CODEC_UTILS_DEBUG_LOGGING_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_INTEL_HDA_CODEC_UTILS_DEBUG_LOGGING_H_
