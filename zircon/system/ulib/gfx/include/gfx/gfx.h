...
struct gfx_surface {
  ...
  void (*copyrect)(gfx_surface*, unsigned x, unsigned y, unsigned width, unsigned height,
                   unsigned x2, unsigned y2);
  void (*fillrect)(gfx_surface*, unsigned x, unsigned y, unsigned width, unsigned height,
                   unsigned color);
  void (*putpixel)(gfx_surface*, unsigned x, unsigned y, unsigned color);
  void (*putchar)(gfx_surface*, const gfx_font*, unsigned ch, unsigned x, unsigned y, unsigned fg,
                  unsigned bg);
...
void gfx_putchar(gfx_surface*, const gfx_font*, unsigned ch, unsigned x, unsigned y, unsigned fg,
                 unsigned bg);
...
void gfx_blend(struct gfx_surface* target, struct gfx_surface* source, unsigned srcx, unsigned srcy,
