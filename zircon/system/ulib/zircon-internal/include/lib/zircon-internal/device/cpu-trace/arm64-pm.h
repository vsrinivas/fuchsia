...
#define ARM64_PMCR_EL0_E_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_E_LEN, ARM64_PMCR_EL0_E_SHIFT)

#define ARM64_PMCR_EL0_P_SHIFT (1)
#define ARM64_PMCR_EL0_P_LEN   (1)
#define ARM64_PMCR_EL0_P_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_P_LEN, ARM64_PMCR_EL0_P_SHIFT)

#define ARM64_PMCR_EL0_C_SHIFT (2)
#define ARM64_PMCR_EL0_C_LEN   (1)
#define ARM64_PMCR_EL0_C_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_C_LEN, ARM64_PMCR_EL0_C_SHIFT)

#define ARM64_PMCR_EL0_D_SHIFT (3)
#define ARM64_PMCR_EL0_D_LEN   (1)
#define ARM64_PMCR_EL0_D_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_D_LEN, ARM64_PMCR_EL0_D_SHIFT)

#define ARM64_PMCR_EL0_X_SHIFT (4)
#define ARM64_PMCR_EL0_X_LEN   (1)
#define ARM64_PMCR_EL0_X_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_X_LEN, ARM64_PMCR_EL0_X_SHIFT)

#define ARM64_PMCR_EL0_DP_SHIFT (5)
#define ARM64_PMCR_EL0_DP_LEN   (1)
#define ARM64_PMCR_EL0_DP_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_DP_LEN, ARM64_PMCR_EL0_DP_SHIFT)

#define ARM64_PMCR_EL0_LC_SHIFT (6)
#define ARM64_PMCR_EL0_LC_LEN   (1)
#define ARM64_PMCR_EL0_LC_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_LC_LEN, ARM64_PMCR_EL0_LC_SHIFT)

#define ARM64_PMCR_EL0_N_SHIFT (11)
#define ARM64_PMCR_EL0_N_LEN   (5)
#define ARM64_PMCR_EL0_N_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_N_LEN, ARM64_PMCR_EL0_N_SHIFT)
...
#define ARM64_PMCR_EL0_IMP_MASK \
  ARM64_PMU_MASK(ARM64_PMCR_EL0_IMP_LEN, ARM64_PMCR_EL0_IMP_SHIFT)
