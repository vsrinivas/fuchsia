...
template <typename T>
PrimitiveType<T>::PrimitiveType(fbl::String name, T* value) : name_(name), value_(value) {
...
template <typename T>
PrimitiveTypeArray<T>::PrimitiveTypeArray(fbl::String name, T* value, size_t size) : name_(name),
