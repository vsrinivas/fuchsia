...
void RunDeleteAndWrite(void) {
  ...
  std::vector<std::string> names = {
    BuildPath("/alpha/bravo"),
    BuildPath("/alpha/charlie"),
    BuildPath("/alpha/delta"),
    BuildPath("/alpha/echo"),
    BuildPath("/alpha/foxtrot"),
  };
...
TEST_F(PowerTest, DeleteAndWrite) {
  RunWithFailures(&RunDeleteAndWrite);
}
