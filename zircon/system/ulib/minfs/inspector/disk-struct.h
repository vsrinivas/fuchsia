...
#ifndef ZIRCON_SYSTEM_ULIB_MINFS_INSPECTOR_DISK_STRUCT_H_
#define ZIRCON_SYSTEM_ULIB_MINFS_INSPECTOR_DISK_STRUCT_H_
...
#endif  // ZIRCON_SYSTEM_ULIB_MINFS_INSPECTOR_DISK_STRUCT_H_
