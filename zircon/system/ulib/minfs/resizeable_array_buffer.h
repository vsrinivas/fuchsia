...
#ifndef ZIRCON_SYSTEM_ULIB_MINFS_RESIZEABLE_ARRAY_BUFFER_H_
#define ZIRCON_SYSTEM_ULIB_MINFS_RESIZEABLE_ARRAY_BUFFER_H_
...
public:
  ...
  zx_status_t Detach(fs::TransactionHandler* device) {
    return ZX_OK;
  }
...
#endif  // ZIRCON_SYSTEM_ULIB_MINFS_RESIZEABLE_ARRAY_BUFFER_H_
