...
public:
    ...
    internal::MexecSysCalls Interface() {
        return {
            .mexec = [this](zx_handle_t root, zx_handle_t kernel, zx_handle_t bootdata) {
            ...
            .mexec_payload_get = [this](zx_handle_t root, void* data, size_t size) {
...
protected:
    void SetUp() override {
        ...
        const auto service = [this](zx::channel request) {
            return fidl_bind(loop_->dispatcher(), request.release(),
...
TEST_F(MexecTest, Success) {
    ...
    ASSERT_EQ(ZBI_RESULT_OK, received_zbi.ForEach([](zbi_header_t* hdr, void*, void* ctx) {
