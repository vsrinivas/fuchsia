...
static zx_status_t callback(void* ctx, int depth, zx_handle_t process,
...
static void usage(const char* progname) {
    ...
    fprintf(stderr, "set|clear indicates wether the signal is added to the set_mask (set) or to the clear_mask (clear)\n");
}
...
int main(int argc, const char** argv) {
    ...
    static const zx_signals_t user_signal[8] = {
        ZX_USER_SIGNAL_0,
        ZX_USER_SIGNAL_1,
        ZX_USER_SIGNAL_2,
        ZX_USER_SIGNAL_3,
