...
zx_status_t C18::Msdc0Init() {
  ...
  static const guid_map_t guid_map[] = {
      ...
      {"STATE", GUID_LINUX_FILESYSTEM_DATA_VALUE},
      {"KERN-A", GUID_CROS_KERNEL_VALUE},
      {"ROOT-A", GUID_CROS_ROOTFS_VALUE},
      {"KERN-B", GUID_CROS_KERNEL_VALUE},
      {"ROOT-B", GUID_CROS_ROOTFS_VALUE},
      {"KERN-C", GUID_CROS_KERNEL_VALUE},
      {"ROOT-C", GUID_CROS_ROOTFS_VALUE},
      {"OEM", GUID_LINUX_FILESYSTEM_DATA_VALUE},
      {"reserved", GUID_CROS_RESERVED_NAME},
      {"reserved", GUID_CROS_RESERVED_NAME},
      {"RWFW", GUID_CROS_FIRMWARE_VALUE},
      {"EFI-SYSTEM", GUID_EFI_VALUE},
  };
