...
public:
    static auto Get() {
        return hwreg::RegisterAddr<MutexIntenReg>(MUTEX_INTEN);
    }
};
...
public:
    static auto Get() {
        return hwreg::RegisterAddr<MutexIntstaReg>(MUTEX_INTSTA);
    }
};
...
public:
    DEF_BIT(0, enable);
    static auto Get() {
        return hwreg::RegisterAddr<Mutex0EnReg>(MUTEX0_EN);
    }
};
...
public:
    DEF_BIT(0, reset);
    static auto Get() {
        return hwreg::RegisterAddr<Mutex0RstReg>(MUTEX0_RST);
    }
};
...
public:
    DEF_FIELD(17, 0, mod);
    static auto Get() {
        return hwreg::RegisterAddr<Mutex0ModReg>(MUTEX0_MOD);
    }
};
...
public:
    DEF_FIELD(2, 0, sof);
    static auto Get() {
        return hwreg::RegisterAddr<Mutex0SofReg>(MUTEX0_SOF);
    }
};
