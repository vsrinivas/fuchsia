...
void DispRdma::Reset() {
    ...
    while (((disp_rdma_mmio_->Read32(DISP_RDMA_GLOBAL_CON) & GLOBAL_CON_RESET_STATE_MASK) ==
            GLOBAL_CON_RESTE_STATE_IDLE) && timeout--) {
...
zx_status_t DispRdma::Config() {
    ...
    disp_rdma_mmio_->Write32(FIFO_CON_FIFO_THRESHOLD_DEFAULT |
                             FIFO_CON_UNDERFLOW_EN | disp_rdma_mmio_->Read32(DISP_RDMA_FIFO_CON),
                             DISP_RDMA_FIFO_CON);
