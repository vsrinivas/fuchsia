...
static bool is_skl(uint16_t device_id) { return (device_id & 0xff00) == 0x1900; }

static bool is_kbl(uint16_t device_id) { return (device_id & 0xff00) == 0x5900; }
...
static bool is_skl_y(uint16_t device_id) { return device_id == 0x191e; }
...
static bool is_kbl_y(uint16_t device_id) { return device_id == 0x591c || device_id == 0x591e; }
