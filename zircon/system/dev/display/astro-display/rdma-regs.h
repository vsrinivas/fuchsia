...
#ifndef ZIRCON_SYSTEM_DEV_DISPLAY_ASTRO_DISPLAY_RDMA_REGS_H_
#define ZIRCON_SYSTEM_DEV_DISPLAY_ASTRO_DISPLAY_RDMA_REGS_H_
...
#endif  // ZIRCON_SYSTEM_DEV_DISPLAY_ASTRO_DISPLAY_RDMA_REGS_H_
