...
#define __DEFINE_SMC_RESULT_ARG_4(...) __DEFINE_SMC_RESULT_ARG_5(__VA_ARGS__, uint64_t, unused4)

#define __DEFINE_SMC_RESULT_ARG_3(...) __DEFINE_SMC_RESULT_ARG_4(__VA_ARGS__, uint64_t, unused3)

#define __DEFINE_SMC_RESULT_ARG_2(...) __DEFINE_SMC_RESULT_ARG_3(__VA_ARGS__, uint64_t, unused2)

#define __DEFINE_SMC_RESULT_ARG_1(...) __DEFINE_SMC_RESULT_ARG_2(__VA_ARGS__, uint64_t, unused1)
...
static constexpr zx_smc_parameters_t CreateSmcFunctionCall(
    uint32_t func_id, uint64_t arg1 = 0, uint64_t arg2 = 0, uint64_t arg3 = 0, uint64_t arg4 = 0,
    uint64_t arg5 = 0, uint64_t arg6 = 0, uint16_t client_id = 0, uint16_t secure_os_id = 0) {
...
// arg0 - call count
// arg1..arg3 - not used
constexpr uint32_t kTrustedOsCallCountFuncId =
    CreateFunctionId(kFastCall, kSmc32CallConv, kTrustedOsServiceEnd, 0xFF00);
...
constexpr uint32_t kTrustedOsCallUidFuncId =
    CreateFunctionId(kFastCall, kSmc32CallConv, kTrustedOsServiceEnd, 0xFF01);

DEFINE_SMC_RESULT_STRUCT(TrustedOsCallUidResult, 4, uint32_t, uid_0_3, uint32_t, uid_4_7, uint32_t,
                         uid_8_11, uint32_t, uid_12_15)
...
// arg1 - minor version
// arg2..3 - not used
constexpr uint32_t kTrustedOsCallRevisionFuncId =
    CreateFunctionId(kFastCall, kSmc32CallConv, kTrustedOsServiceEnd, 0xFF03);
