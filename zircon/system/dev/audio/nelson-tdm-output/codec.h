...
#ifndef ZIRCON_SYSTEM_DEV_AUDIO_NELSON_TDM_OUTPUT_CODEC_H_
#define ZIRCON_SYSTEM_DEV_AUDIO_NELSON_TDM_OUTPUT_CODEC_H_
...
#endif  // ZIRCON_SYSTEM_DEV_AUDIO_NELSON_TDM_OUTPUT_CODEC_H_
