...
void a113_pdm_enable(a113_audio_device_t* audio_device, int is_enable) {
  if (is_enable) {
    ...
    a113_pdm_update_bits(audio_device, PDM_CTRL, 1 << 31 | 1 << 16, 0 << 31 | 0 << 16);
...
void a113_pdm_ctrl(a113_audio_device_t* audio_device, int bitdepth) {
  ...
  a113_pdm_update_bits(audio_device, PDM_CTRL, (0x7 << 28 | 0xff << 8 | 0xff << 0),
                       (0 << 30) | (mode << 29) | (0 << 28) | (0xff << 8) | (0xff << 0));

  a113_pdm_write(audio_device, PDM_CHAN_CTRL, ((28 << 24) | (28 << 16) | (28 << 8) | (28 << 0)));
  a113_pdm_write(audio_device, PDM_CHAN_CTRL1, ((28 << 24) | (28 << 16) | (28 << 8) | (28 << 0)));
}
...
void a113_pdm_filter_ctrl(a113_audio_device_t* audio_device) {
  ...
  a113_pdm_write(audio_device, PDM_F1_CTRL, (0x80000000 | 87 | (2 << 12) | (1 << 16)));
  a113_pdm_write(audio_device, PDM_F2_CTRL, (0x80000000 | 33 | (2 << 12) | (0 << 16)));
  a113_pdm_write(audio_device, PDM_F3_CTRL, (0x80000000 | 117 | (2 << 12) | (1 << 16)));

  a113_pdm_write(audio_device, PDM_HPF_CTRL, (0x8000 | (0x7 << 16) | (1 << 31)));
