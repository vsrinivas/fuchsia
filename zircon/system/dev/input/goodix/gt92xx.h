...
class Gt92xxDevice : public ddk::Device<Gt92xxDevice, ddk::UnbindableDeprecated>,
 ...
 public:
  Gt92xxDevice(zx_device_t* device, ddk::I2cChannel i2c, ddk::GpioProtocolClient intr,
      ...
      : ddk::Device<Gt92xxDevice, ddk::UnbindableDeprecated>(device),
        i2c_(std::move(i2c)),
  ...
  void DdkRelease();
  void DdkUnbindDeprecated() __TA_EXCLUDES(client_lock_);
