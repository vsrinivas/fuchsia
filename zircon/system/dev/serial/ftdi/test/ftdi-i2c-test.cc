...
public:
    ...
    void PushExpectedRead(std::vector<uint8_t> read) {
        expected_reads_.push_back(std::move(read));
    }
    ...
    void FailOnUnexpectedReadWrite(bool b) {
        unexpected_is_error_ = b;
    }
...
TEST_F(FtdiI2cTest, TrivialLifetimeTest) {
