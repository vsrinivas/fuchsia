...
static void EXPECT_INTERFACE_EQ(usb_interface_descriptor_t a,
                                usb_interface_descriptor_t b) {
...
static void EXPECT_ENDPOINT_EQ(usb_endpoint_descriptor_t a,
...
static void EXPECT_SS_EP_COMP_EQ(usb_ss_ep_comp_descriptor_t a,
                                 usb_ss_ep_comp_descriptor_t b) {
    EXPECT_EQ(a.bLength, b.bLength);
    EXPECT_EQ(a.bDescriptorType, b.bDescriptorType);
