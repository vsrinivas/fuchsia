...
public:
    ...
    static auto Get(uint32_t index) { return hwreg::RegisterAddr<GUSB3PIPECTL>(0xc2c0 + index * 0x4); }
};
...
public:
    ...
    static auto Get(uint32_t index) { return hwreg::RegisterAddr<DEPCFG_DEPCMDPAR1>(0xc804 + index * 0x10); }
};
...
public:
    ...
    static auto Get(uint32_t index) { return hwreg::RegisterAddr<DEPCFG_DEPCMDPAR0>(0xc808 + index * 0x10); }
