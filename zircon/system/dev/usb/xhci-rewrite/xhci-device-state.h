...
class DeviceState {
 public:
  ...
  std::optional<dma_buffer::Buffer>& GetInputContext() __TA_REQUIRES(transaction_lock_) {
    return input_context_;
  }

  std::optional<dma_buffer::Buffer>& GetDeviceContext() __TA_REQUIRES(transaction_lock_) {
 ...
 private:
  ...
  std::optional<dma_buffer::Buffer> input_context_ __TA_GUARDED(transaction_lock_);
  std::optional<dma_buffer::Buffer> device_context_ __TA_GUARDED(transaction_lock_);
};
}  // namespace usb_xhci
