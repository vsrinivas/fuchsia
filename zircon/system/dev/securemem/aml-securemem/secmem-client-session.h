...
#ifndef ZIRCON_SYSTEM_DEV_SECUREMEM_AML_SECUREMEM_SECMEM_CLIENT_SESSION_H_
#define ZIRCON_SYSTEM_DEV_SECUREMEM_AML_SECUREMEM_SECMEM_CLIENT_SESSION_H_
...
#endif  // ZIRCON_SYSTEM_DEV_SECUREMEM_AML_SECUREMEM_SECMEM_CLIENT_SESSION_H_
