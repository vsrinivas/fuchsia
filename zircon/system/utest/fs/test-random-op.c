...
static struct {
  ...
  uint32_t size;
    ...
    {"thd0000", KB(5)},   {"thd0001", MB(10)}, {"thd0002", KB(512)}, {"thd0003", KB(512)},
    {"thd0004", KB(512)}, {"thd0005", MB(20)}, {"thd0006", KB(512)}, {"thd0007", KB(512)},
};
...
RUN_FOR_ALL_FILESYSTEMS(random_ops_tests, RUN_TEST_LARGE(test_random_op_multithreaded))
