...
TEST(UtilsTest, IrMatcher) {
  // matches despite different locations for games.tictactoe/Foo
  EXPECT_TRUE(IsIrEquals(R"JSON(
{
  "version": "0.0.1",
                         ...
                         R"JSON(
{
  ...
  // does not match: games.tictactoe/Foo vs games.tictactoe/Boo
  EXPECT_FALSE(IsIrEquals(R"JSON({
  "version": "0.0.1",
  "name": "games.tictactoe",
  "library_dependencies": [],
  "bits_declarations": [],
  ...
  "declarations": {
    "games.tictactoe/Boo": "struct"
  }
}
)JSON"));

  // matches despite a difference in location, for FIDL where there's a const
  // string "location: {"
  EXPECT_TRUE(IsIrEquals(R"JSON({
  "version": "0.0.1",
  "name": "games.tictactoe",
  ...
  "const_declarations": [
    {
      "name": "games.tictactoe/BadString",
      "location": {
        "filename": "fidlbolt.fidl",
        "line": 3,
        "column": 14,
  ...
  "type_alias_declarations": [],
  "declaration_order": [
    "games.tictactoe/BadString"
  ],
  "declarations": {
    "games.tictactoe/BadString": "const"
  }
})JSON",
                         R"JSON({
  "version": "0.0.1",
