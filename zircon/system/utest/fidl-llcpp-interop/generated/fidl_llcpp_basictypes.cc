...
::llcpp::fidl::test::llcpp::basictypes::SimpleUnion::SimpleUnion() { tag_ = Tag::Invalid; }

::llcpp::fidl::test::llcpp::basictypes::SimpleUnion::~SimpleUnion() { Destroy(); }
...
void ::llcpp::fidl::test::llcpp::basictypes::SimpleUnion::SizeAndOffsetAssertionHelper() {
  ...
  static_assert(sizeof(::llcpp::fidl::test::llcpp::basictypes::SimpleUnion) ==
                ::llcpp::fidl::test::llcpp::basictypes::SimpleUnion::PrimarySize);
}
...
[[maybe_unused]] constexpr uint64_t kTestInterface_ConsumeSimpleStruct_Ordinal =
    0x2b65368b00000000lu;
extern "C" const fidl_type_t
    fidl_test_llcpp_basictypes_TestInterfaceConsumeSimpleStructRequestTable;
[[maybe_unused]] constexpr uint64_t kTestInterface_ConsumeSimpleUnion_Ordinal =
    0x2e46f97100000000lu;

}  // namespace
template <>
TestInterface::ResultOf::ConsumeSimpleStruct_Impl<TestInterface::ConsumeSimpleStructResponse>::
    ConsumeSimpleStruct_Impl(zx::unowned_channel _client_end, SimpleStruct arg) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<ConsumeSimpleStructRequest>();
  ...
  ::fidl::BytePart _request_bytes(_write_bytes, _kWriteAllocSize,
                                  sizeof(ConsumeSimpleStructRequest));
  ::fidl::DecodedMessage<ConsumeSimpleStructRequest> _decoded_request(std::move(_request_bytes));
  Super::SetResult(TestInterface::InPlace::ConsumeSimpleStruct(
      std::move(_client_end), std::move(_decoded_request), Super::response_buffer()));
}

TestInterface::ResultOf::ConsumeSimpleStruct TestInterface::SyncClient::ConsumeSimpleStruct(
    SimpleStruct arg) {
  return ResultOf::ConsumeSimpleStruct(zx::unowned_channel(this->channel_), std::move(arg));
}

TestInterface::ResultOf::ConsumeSimpleStruct TestInterface::Call::ConsumeSimpleStruct(
    zx::unowned_channel _client_end, SimpleStruct arg) {
  return ResultOf::ConsumeSimpleStruct(std::move(_client_end), std::move(arg));
}

template <>
TestInterface::UnownedResultOf::
    ConsumeSimpleStruct_Impl<TestInterface::ConsumeSimpleStructResponse>::ConsumeSimpleStruct_Impl(
  ...
  if (_request_buffer.capacity() < ConsumeSimpleStructRequest::PrimarySize) {
    Super::SetFailure(::fidl::DecodeResult<ConsumeSimpleStructResponse>(
...
TestInterface::UnownedResultOf::ConsumeSimpleStruct TestInterface::SyncClient::ConsumeSimpleStruct(
    ::fidl::BytePart _request_buffer, SimpleStruct arg, ::fidl::BytePart _response_buffer) {
  return UnownedResultOf::ConsumeSimpleStruct(zx::unowned_channel(this->channel_),
                                              std::move(_request_buffer), std::move(arg),
                                              std::move(_response_buffer));
}

TestInterface::UnownedResultOf::ConsumeSimpleStruct TestInterface::Call::ConsumeSimpleStruct(
    zx::unowned_channel _client_end, ::fidl::BytePart _request_buffer, SimpleStruct arg,
    ::fidl::BytePart _response_buffer) {
  return UnownedResultOf::ConsumeSimpleStruct(std::move(_client_end), std::move(_request_buffer),
                                              std::move(arg), std::move(_response_buffer));
}

zx_status_t TestInterface::SyncClient::ConsumeSimpleStruct_Deprecated(SimpleStruct arg,
                                                                      int32_t* out_status,
                                                                      int32_t* out_field) {
  return TestInterface::Call::ConsumeSimpleStruct_Deprecated(zx::unowned_channel(this->channel_),
                                                             std::move(arg), out_status, out_field);
}

zx_status_t TestInterface::Call::ConsumeSimpleStruct_Deprecated(zx::unowned_channel _client_end,
                                                                SimpleStruct arg,
                                                                int32_t* out_status,
                                                                int32_t* out_field) {
  constexpr uint32_t _kWriteAllocSize =
  ...
  constexpr uint32_t _kReadAllocSize =
      ::fidl::internal::ClampedMessageSize<ConsumeSimpleStructResponse>();
...
::fidl::DecodeResult<TestInterface::ConsumeSimpleStructResponse>
TestInterface::SyncClient::ConsumeSimpleStruct_Deprecated(::fidl::BytePart _request_buffer,
                                                          SimpleStruct arg,
                                                          ::fidl::BytePart _response_buffer,
                                                          int32_t* out_status, int32_t* out_field) {
  return TestInterface::Call::ConsumeSimpleStruct_Deprecated(
      zx::unowned_channel(this->channel_), std::move(_request_buffer), std::move(arg),
      std::move(_response_buffer), out_status, out_field);
}

::fidl::DecodeResult<TestInterface::ConsumeSimpleStructResponse>
TestInterface::Call::ConsumeSimpleStruct_Deprecated(zx::unowned_channel _client_end,
                                                    ::fidl::BytePart _request_buffer,
                                                    SimpleStruct arg,
                                                    ::fidl::BytePart _response_buffer,
                                                    int32_t* out_status, int32_t* out_field) {
  if (_request_buffer.capacity() < ConsumeSimpleStructRequest::PrimarySize) {
    return ::fidl::DecodeResult<ConsumeSimpleStructResponse>(
        ZX_ERR_BUFFER_TOO_SMALL, ::fidl::internal::kErrorRequestBufferTooSmall);
  }
  auto& _request = *reinterpret_cast<ConsumeSimpleStructRequest*>(_request_buffer.data());
  _request._hdr.ordinal = kTestInterface_ConsumeSimpleStruct_Ordinal;
  ...
  auto _encode_request_result = ::fidl::Encode(std::move(_decoded_request));
  if (_encode_request_result.status != ZX_OK) {
    return ::fidl::DecodeResult<ConsumeSimpleStructResponse>(_encode_request_result.status,
  ...
  auto _call_result = ::fidl::Call<ConsumeSimpleStructRequest, ConsumeSimpleStructResponse>(
      ...
      std::move(_response_buffer));
  if (_call_result.status != ZX_OK) {
    return ::fidl::DecodeResult<ConsumeSimpleStructResponse>(_call_result.status,
                                                             _call_result.error);
  }
  auto _decode_result = ::fidl::Decode(std::move(_call_result.message));
  if (_decode_result.status != ZX_OK) {
...
::fidl::DecodeResult<TestInterface::ConsumeSimpleStructResponse>
TestInterface::InPlace::ConsumeSimpleStruct(
...
template <>
TestInterface::ResultOf::ConsumeSimpleUnion_Impl<TestInterface::ConsumeSimpleUnionResponse>::
    ConsumeSimpleUnion_Impl(zx::unowned_channel _client_end, SimpleUnion arg) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<ConsumeSimpleUnionRequest>();
  ::fidl::internal::AlignedBuffer<_kWriteAllocSize> _write_bytes_inlined;
  auto& _write_bytes_array = _write_bytes_inlined;
  uint8_t* _write_bytes = _write_bytes_array.view().data();
  ...
  _request.arg = std::move(arg);
  ::fidl::BytePart _request_bytes(_write_bytes, _kWriteAllocSize,
                                  sizeof(ConsumeSimpleUnionRequest));
  ::fidl::DecodedMessage<ConsumeSimpleUnionRequest> _decoded_request(std::move(_request_bytes));
  Super::SetResult(TestInterface::InPlace::ConsumeSimpleUnion(
      std::move(_client_end), std::move(_decoded_request), Super::response_buffer()));
}

TestInterface::ResultOf::ConsumeSimpleUnion TestInterface::SyncClient::ConsumeSimpleUnion(
    SimpleUnion arg) {
  return ResultOf::ConsumeSimpleUnion(zx::unowned_channel(this->channel_), std::move(arg));
}

TestInterface::ResultOf::ConsumeSimpleUnion TestInterface::Call::ConsumeSimpleUnion(
    zx::unowned_channel _client_end, SimpleUnion arg) {
  return ResultOf::ConsumeSimpleUnion(std::move(_client_end), std::move(arg));
}

template <>
TestInterface::UnownedResultOf::ConsumeSimpleUnion_Impl<TestInterface::ConsumeSimpleUnionResponse>::
  ...
  if (_request_buffer.capacity() < ConsumeSimpleUnionRequest::PrimarySize) {
    Super::SetFailure(::fidl::DecodeResult<ConsumeSimpleUnionResponse>(
        ZX_ERR_BUFFER_TOO_SMALL, ::fidl::internal::kErrorRequestBufferTooSmall));
    return;
  }
...
TestInterface::UnownedResultOf::ConsumeSimpleUnion TestInterface::SyncClient::ConsumeSimpleUnion(
    ::fidl::BytePart _request_buffer, SimpleUnion arg, ::fidl::BytePart _response_buffer) {
  return UnownedResultOf::ConsumeSimpleUnion(zx::unowned_channel(this->channel_),
                                             std::move(_request_buffer), std::move(arg),
                                             std::move(_response_buffer));
}

TestInterface::UnownedResultOf::ConsumeSimpleUnion TestInterface::Call::ConsumeSimpleUnion(
    zx::unowned_channel _client_end, ::fidl::BytePart _request_buffer, SimpleUnion arg,
    ::fidl::BytePart _response_buffer) {
  return UnownedResultOf::ConsumeSimpleUnion(std::move(_client_end), std::move(_request_buffer),
                                             std::move(arg), std::move(_response_buffer));
}

zx_status_t TestInterface::SyncClient::ConsumeSimpleUnion_Deprecated(SimpleUnion arg,
                                                                     uint32_t* out_index,
                                                                     int32_t* out_field) {
  return TestInterface::Call::ConsumeSimpleUnion_Deprecated(zx::unowned_channel(this->channel_),
                                                            std::move(arg), out_index, out_field);
}

zx_status_t TestInterface::Call::ConsumeSimpleUnion_Deprecated(zx::unowned_channel _client_end,
  ...
  constexpr uint32_t _kReadAllocSize =
      ::fidl::internal::ClampedMessageSize<ConsumeSimpleUnionResponse>();
  FIDL_ALIGNDECL uint8_t _read_bytes[_kReadAllocSize];
  ::fidl::BytePart _response_bytes(_read_bytes, _kReadAllocSize);
...
::fidl::DecodeResult<TestInterface::ConsumeSimpleUnionResponse>
TestInterface::SyncClient::ConsumeSimpleUnion_Deprecated(::fidl::BytePart _request_buffer,
                                                         SimpleUnion arg,
                                                         ::fidl::BytePart _response_buffer,
                                                         uint32_t* out_index, int32_t* out_field) {
  return TestInterface::Call::ConsumeSimpleUnion_Deprecated(
      zx::unowned_channel(this->channel_), std::move(_request_buffer), std::move(arg),
      std::move(_response_buffer), out_index, out_field);
}

::fidl::DecodeResult<TestInterface::ConsumeSimpleUnionResponse>
TestInterface::Call::ConsumeSimpleUnion_Deprecated(zx::unowned_channel _client_end,
                                                   ::fidl::BytePart _request_buffer,
                                                   SimpleUnion arg,
                                                   ::fidl::BytePart _response_buffer,
                                                   uint32_t* out_index, int32_t* out_field) {
  if (_request_buffer.capacity() < ConsumeSimpleUnionRequest::PrimarySize) {
    return ::fidl::DecodeResult<ConsumeSimpleUnionResponse>(
        ZX_ERR_BUFFER_TOO_SMALL, ::fidl::internal::kErrorRequestBufferTooSmall);
  }
  auto& _request = *reinterpret_cast<ConsumeSimpleUnionRequest*>(_request_buffer.data());
  _request._hdr.ordinal = kTestInterface_ConsumeSimpleUnion_Ordinal;
  ...
  auto _encode_request_result = ::fidl::Encode(std::move(_decoded_request));
  if (_encode_request_result.status != ZX_OK) {
    return ::fidl::DecodeResult<ConsumeSimpleUnionResponse>(_encode_request_result.status,
                                                            _encode_request_result.error);
  }
  auto _call_result = ::fidl::Call<ConsumeSimpleUnionRequest, ConsumeSimpleUnionResponse>(
      std::move(_client_end), std::move(_encode_request_result.message),
      std::move(_response_buffer));
  if (_call_result.status != ZX_OK) {
    return ::fidl::DecodeResult<ConsumeSimpleUnionResponse>(_call_result.status,
                                                            _call_result.error);
  }
  auto _decode_result = ::fidl::Decode(std::move(_call_result.message));
  if (_decode_result.status != ZX_OK) {
...
::fidl::DecodeResult<TestInterface::ConsumeSimpleUnionResponse>
TestInterface::InPlace::ConsumeSimpleUnion(zx::unowned_channel _client_end,
                                           ::fidl::DecodedMessage<ConsumeSimpleUnionRequest> params,
                                           ::fidl::BytePart response_buffer) {
  params.message()->_hdr = {};
...
void TestInterface::Interface::ConsumeSimpleStructCompleterBase::Reply(int32_t status,
                                                                       int32_t field) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<ConsumeSimpleStructResponse>();
  FIDL_ALIGNDECL uint8_t _write_bytes[_kWriteAllocSize] = {};
  ...
  ::fidl::BytePart _response_bytes(_write_bytes, _kWriteAllocSize,
                                   sizeof(ConsumeSimpleStructResponse));
  CompleterBase::SendReply(
      ::fidl::DecodedMessage<ConsumeSimpleStructResponse>(std::move(_response_bytes)));
}

void TestInterface::Interface::ConsumeSimpleStructCompleterBase::Reply(::fidl::BytePart _buffer,
                                                                       int32_t status,
                                                                       int32_t field) {
...
void TestInterface::Interface::ConsumeSimpleStructCompleterBase::Reply(
    ::fidl::DecodedMessage<ConsumeSimpleStructResponse> params) {
  params.message()->_hdr = {};
  params.message()->_hdr.ordinal = kTestInterface_ConsumeSimpleStruct_Ordinal;
  CompleterBase::SendReply(std::move(params));
}

void TestInterface::Interface::ConsumeSimpleUnionCompleterBase::Reply(uint32_t index,
                                                                      int32_t field) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<ConsumeSimpleUnionResponse>();
  FIDL_ALIGNDECL uint8_t _write_bytes[_kWriteAllocSize] = {};
  ...
  _response.field = std::move(field);
  ::fidl::BytePart _response_bytes(_write_bytes, _kWriteAllocSize,
                                   sizeof(ConsumeSimpleUnionResponse));
  CompleterBase::SendReply(
      ::fidl::DecodedMessage<ConsumeSimpleUnionResponse>(std::move(_response_bytes)));
}

void TestInterface::Interface::ConsumeSimpleUnionCompleterBase::Reply(::fidl::BytePart _buffer,
                                                                      uint32_t index,
                                                                      int32_t field) {
...
void TestInterface::Interface::ConsumeSimpleUnionCompleterBase::Reply(
    ::fidl::DecodedMessage<ConsumeSimpleUnionResponse> params) {
  params.message()->_hdr = {};
  params.message()->_hdr.ordinal = kTestInterface_ConsumeSimpleUnion_Ordinal;
  CompleterBase::SendReply(std::move(params));
}
