...
[[maybe_unused]] constexpr uint64_t kControlFlow_Shutdown_Ordinal = 0x7d0a313700000000lu;
[[maybe_unused]] constexpr uint64_t kControlFlow_NoReplyMustSendAccessDeniedEpitaph_Ordinal =
    0x2141b1d000000000lu;
[[maybe_unused]] constexpr uint64_t kControlFlow_MustSendAccessDeniedEpitaph_Ordinal =
    0x531dcb0700000000lu;
extern "C" const fidl_type_t
    fidl_test_llcpp_controlflow_ControlFlowMustSendAccessDeniedEpitaphResponseTable;
...
ControlFlow::ResultOf::Shutdown_Impl::Shutdown_Impl(zx::unowned_channel _client_end) {
  ...
  Super::operator=(ControlFlow::InPlace::Shutdown(std::move(_client_end)));
}
...
ControlFlow::ResultOf::NoReplyMustSendAccessDeniedEpitaph_Impl::
    NoReplyMustSendAccessDeniedEpitaph_Impl(zx::unowned_channel _client_end) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<NoReplyMustSendAccessDeniedEpitaphRequest>();
  ::fidl::internal::AlignedBuffer<_kWriteAllocSize> _write_bytes_inlined;
  auto& _write_bytes_array = _write_bytes_inlined;
  uint8_t* _write_bytes = _write_bytes_array.view().data();
  ...
  ::fidl::BytePart _request_bytes(_write_bytes, _kWriteAllocSize,
                                  sizeof(NoReplyMustSendAccessDeniedEpitaphRequest));
  ::fidl::DecodedMessage<NoReplyMustSendAccessDeniedEpitaphRequest> _decoded_request(
      std::move(_request_bytes));
  Super::operator=(
      ControlFlow::InPlace::NoReplyMustSendAccessDeniedEpitaph(std::move(_client_end)));
}

ControlFlow::ResultOf::NoReplyMustSendAccessDeniedEpitaph
ControlFlow::SyncClient::NoReplyMustSendAccessDeniedEpitaph() {
  return ResultOf::NoReplyMustSendAccessDeniedEpitaph(zx::unowned_channel(this->channel_));
}

ControlFlow::ResultOf::NoReplyMustSendAccessDeniedEpitaph
ControlFlow::Call::NoReplyMustSendAccessDeniedEpitaph(zx::unowned_channel _client_end) {
...
zx_status_t ControlFlow::SyncClient::NoReplyMustSendAccessDeniedEpitaph_Deprecated() {
  return ControlFlow::Call::NoReplyMustSendAccessDeniedEpitaph_Deprecated(
      zx::unowned_channel(this->channel_));
}

zx_status_t ControlFlow::Call::NoReplyMustSendAccessDeniedEpitaph_Deprecated(
...
::fidl::internal::StatusAndError ControlFlow::InPlace::NoReplyMustSendAccessDeniedEpitaph(
    zx::unowned_channel _client_end) {
  constexpr uint32_t _write_num_bytes = sizeof(NoReplyMustSendAccessDeniedEpitaphRequest);
  ::fidl::internal::AlignedBuffer<_write_num_bytes> _write_bytes;
  ::fidl::BytePart _request_buffer = _write_bytes.view();
  _request_buffer.set_actual(_write_num_bytes);
  ::fidl::DecodedMessage<NoReplyMustSendAccessDeniedEpitaphRequest> params(
...
template <>
ControlFlow::ResultOf::MustSendAccessDeniedEpitaph_Impl<
    ControlFlow::MustSendAccessDeniedEpitaphResponse>::
    MustSendAccessDeniedEpitaph_Impl(zx::unowned_channel _client_end) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<MustSendAccessDeniedEpitaphRequest>();
  ::fidl::internal::AlignedBuffer<_kWriteAllocSize> _write_bytes_inlined;
  auto& _write_bytes_array = _write_bytes_inlined;
  uint8_t* _write_bytes = _write_bytes_array.view().data();
  memset(_write_bytes, 0, MustSendAccessDeniedEpitaphRequest::PrimarySize);
  ::fidl::BytePart _request_bytes(_write_bytes, _kWriteAllocSize,
                                  sizeof(MustSendAccessDeniedEpitaphRequest));
  ::fidl::DecodedMessage<MustSendAccessDeniedEpitaphRequest> _decoded_request(
      std::move(_request_bytes));
  Super::SetResult(ControlFlow::InPlace::MustSendAccessDeniedEpitaph(std::move(_client_end),
                                                                     Super::response_buffer()));
}

ControlFlow::ResultOf::MustSendAccessDeniedEpitaph
ControlFlow::SyncClient::MustSendAccessDeniedEpitaph() {
  return ResultOf::MustSendAccessDeniedEpitaph(zx::unowned_channel(this->channel_));
}

ControlFlow::ResultOf::MustSendAccessDeniedEpitaph ControlFlow::Call::MustSendAccessDeniedEpitaph(
    zx::unowned_channel _client_end) {
  return ResultOf::MustSendAccessDeniedEpitaph(std::move(_client_end));
}

template <>
ControlFlow::UnownedResultOf::MustSendAccessDeniedEpitaph_Impl<
    ControlFlow::MustSendAccessDeniedEpitaphResponse>::
    MustSendAccessDeniedEpitaph_Impl(zx::unowned_channel _client_end,
...
ControlFlow::UnownedResultOf::MustSendAccessDeniedEpitaph
ControlFlow::SyncClient::MustSendAccessDeniedEpitaph(::fidl::BytePart _response_buffer) {
  return UnownedResultOf::MustSendAccessDeniedEpitaph(zx::unowned_channel(this->channel_),
                                                      std::move(_response_buffer));
}

ControlFlow::UnownedResultOf::MustSendAccessDeniedEpitaph
ControlFlow::Call::MustSendAccessDeniedEpitaph(zx::unowned_channel _client_end,
                                               ::fidl::BytePart _response_buffer) {
  return UnownedResultOf::MustSendAccessDeniedEpitaph(std::move(_client_end),
                                                      std::move(_response_buffer));
}

zx_status_t ControlFlow::SyncClient::MustSendAccessDeniedEpitaph_Deprecated(int32_t* out_reply) {
  return ControlFlow::Call::MustSendAccessDeniedEpitaph_Deprecated(
      zx::unowned_channel(this->channel_), out_reply);
}

zx_status_t ControlFlow::Call::MustSendAccessDeniedEpitaph_Deprecated(
    zx::unowned_channel _client_end, int32_t* out_reply) {
  constexpr uint32_t _kWriteAllocSize =
      ::fidl::internal::ClampedMessageSize<MustSendAccessDeniedEpitaphRequest>();
  FIDL_ALIGNDECL uint8_t _write_bytes[_kWriteAllocSize] = {};
  ...
  constexpr uint32_t _kReadAllocSize =
      ::fidl::internal::ClampedMessageSize<MustSendAccessDeniedEpitaphResponse>();
  FIDL_ALIGNDECL uint8_t _read_bytes[_kReadAllocSize];
  ::fidl::BytePart _response_bytes(_read_bytes, _kReadAllocSize);
  auto _call_result =
      ::fidl::Call<MustSendAccessDeniedEpitaphRequest, MustSendAccessDeniedEpitaphResponse>(
...
::fidl::DecodeResult<ControlFlow::MustSendAccessDeniedEpitaphResponse>
ControlFlow::SyncClient::MustSendAccessDeniedEpitaph_Deprecated(::fidl::BytePart _response_buffer,
                                                                int32_t* out_reply) {
  return ControlFlow::Call::MustSendAccessDeniedEpitaph_Deprecated(
      zx::unowned_channel(this->channel_), std::move(_response_buffer), out_reply);
}

::fidl::DecodeResult<ControlFlow::MustSendAccessDeniedEpitaphResponse>
ControlFlow::Call::MustSendAccessDeniedEpitaph_Deprecated(zx::unowned_channel _client_end,
                                                          ::fidl::BytePart _response_buffer,
                                                          int32_t* out_reply) {
  FIDL_ALIGNDECL uint8_t _write_bytes[sizeof(MustSendAccessDeniedEpitaphRequest)] = {};
  ::fidl::BytePart _request_buffer(_write_bytes, sizeof(_write_bytes));
  ...
  auto _encode_request_result = ::fidl::Encode(std::move(_decoded_request));
  if (_encode_request_result.status != ZX_OK) {
    return ::fidl::DecodeResult<MustSendAccessDeniedEpitaphResponse>(_encode_request_result.status,
  ...
  auto _call_result =
      ::fidl::Call<MustSendAccessDeniedEpitaphRequest, MustSendAccessDeniedEpitaphResponse>(
          ...
          std::move(_response_buffer));
  if (_call_result.status != ZX_OK) {
    return ::fidl::DecodeResult<MustSendAccessDeniedEpitaphResponse>(_call_result.status,
                                                                     _call_result.error);
  }
  auto _decode_result = ::fidl::Decode(std::move(_call_result.message));
  if (_decode_result.status != ZX_OK) {
...
::fidl::DecodeResult<ControlFlow::MustSendAccessDeniedEpitaphResponse>
ControlFlow::InPlace::MustSendAccessDeniedEpitaph(zx::unowned_channel _client_end,
...
bool ControlFlow::TryDispatch(Interface* impl, fidl_msg_t* msg, ::fidl::Transaction* txn) {
  ...
  switch (hdr->ordinal) {
    case kControlFlow_Shutdown_Ordinal: {
      ...
      impl->Shutdown(Interface::ShutdownCompleter::Sync(txn));
      return true;
    }
    ...
    case kControlFlow_MustSendAccessDeniedEpitaph_Ordinal: {
      ...
      impl->MustSendAccessDeniedEpitaph(Interface::MustSendAccessDeniedEpitaphCompleter::Sync(txn));
      return true;
    }
    default: {
      return false;
...
void ControlFlow::Interface::MustSendAccessDeniedEpitaphCompleterBase::Reply(int32_t reply) {
  ...
  ::fidl::BytePart _response_bytes(_write_bytes, _kWriteAllocSize,
                                   sizeof(MustSendAccessDeniedEpitaphResponse));
  CompleterBase::SendReply(
      ::fidl::DecodedMessage<MustSendAccessDeniedEpitaphResponse>(std::move(_response_bytes)));
}

void ControlFlow::Interface::MustSendAccessDeniedEpitaphCompleterBase::Reply(
    ::fidl::BytePart _buffer, int32_t reply) {
  ...
  CompleterBase::SendReply(
      ::fidl::DecodedMessage<MustSendAccessDeniedEpitaphResponse>(std::move(_buffer)));
}

void ControlFlow::Interface::MustSendAccessDeniedEpitaphCompleterBase::Reply(
    ::fidl::DecodedMessage<MustSendAccessDeniedEpitaphResponse> params) {
  params.message()->_hdr = {};
  params.message()->_hdr.ordinal = kControlFlow_MustSendAccessDeniedEpitaph_Ordinal;
