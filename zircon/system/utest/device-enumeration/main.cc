...
TEST_F(DeviceEnumerationTest, AstroTest) {
  static const char* kDevicePaths[] = {
      ...
      "display/astro-display/display-controller", "sys/platform/05:00:10/aml-canvas",
      "sys/platform/00:00:e/optee-tz", "aml-video/amlogic_video",
      ...
      "aml-sdio/aml-sd-emmc/sdmmc/sdmmc-sdio",
      "aml-sdio/aml-sd-emmc/sdmmc/sdmmc-sdio/sdmmc-sdio-1/component",
      "aml-sdio/aml-sd-emmc/sdmmc/sdmmc-sdio/sdmmc-sdio-2/component", "wifi/broadcom-wlanphy",
