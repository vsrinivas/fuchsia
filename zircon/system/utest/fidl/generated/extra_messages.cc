...
const fidl_type_t fidl_test_coding_LinearizerTestVectorOfUint32RequestTable = fidl_type_t(::fidl::FidlCodedStruct(Fields52fidl_test_coding_LinearizerTestVectorOfUint32Request, 1u, 32u, nullptr, fidl_test_coding_LinearizerTestVectorOfUint32RequestAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_LinearizerTestVectorOfStringRequestTable = fidl_type_t(::fidl::FidlCodedStruct(Fields52fidl_test_coding_LinearizerTestVectorOfStringRequest, 1u, 32u, nullptr, fidl_test_coding_LinearizerTestVectorOfStringRequestAltTypePointerTable()));


static constexpr bool EnumValidatorFor_fidl_test_coding_Uint8Enum(uint64_t v) { return (v == 0ul) || (v == 255ul) || (v == 42ul) || false; }
const fidl_type_t fidl_test_coding_Uint8EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint8, &EnumValidatorFor_fidl_test_coding_Uint8Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Uint8EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields32fidl_test_coding_Uint8EnumStruct, 1u, 1u, nullptr, fidl_test_coding_Uint8EnumStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_Uint64EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint64, &EnumValidatorFor_fidl_test_coding_Uint64Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Uint64EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields33fidl_test_coding_Uint64EnumStruct, 1u, 8u, nullptr, fidl_test_coding_Uint64EnumStructAltTypePointerTable()));

static constexpr bool EnumValidatorFor_fidl_test_coding_Uint32Enum(uint64_t v) { return (v == 0ul) || (v == 4294967295ul) || (v == 42ul) || false; }
const fidl_type_t fidl_test_coding_Uint32EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint32, &EnumValidatorFor_fidl_test_coding_Uint32Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Uint32EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields33fidl_test_coding_Uint32EnumStruct, 1u, 4u, nullptr, fidl_test_coding_Uint32EnumStructAltTypePointerTable()));

static constexpr bool EnumValidatorFor_fidl_test_coding_Uint16Enum(uint64_t v) { return (v == 0ul) || (v == 65535ul) || (v == 42ul) || false; }
const fidl_type_t fidl_test_coding_Uint16EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint16, &EnumValidatorFor_fidl_test_coding_Uint16Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Uint16EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields33fidl_test_coding_Uint16EnumStruct, 1u, 2u, nullptr, fidl_test_coding_Uint16EnumStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_StructWithManyHandlesTable = fidl_type_t(::fidl::FidlCodedStruct(Fields38fidl_test_coding_StructWithManyHandles, 3u, 24u, nullptr, fidl_test_coding_StructWithManyHandlesAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_SmallerTableOfStructWithHandleTable = fidl_type_t(::fidl::FidlCodedTable(Fields47fidl_test_coding_SmallerTableOfStructWithHandle, 1u, nullptr));
...
const fidl_type_t fidl_test_coding_StructWithHandleTable = fidl_type_t(::fidl::FidlCodedStruct(Fields33fidl_test_coding_StructWithHandle, 1u, 8u, nullptr, fidl_test_coding_StructWithHandleAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_TableOfStructWithHandleTable = fidl_type_t(::fidl::FidlCodedTable(Fields40fidl_test_coding_TableOfStructWithHandle, 2u, nullptr));
...
const fidl_type_t fidl_test_coding_SampleNullableXUnionStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields43fidl_test_coding_SampleNullableXUnionStruct, 1u, 24u, nullptr, fidl_test_coding_SampleNullableXUnionStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_IntStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields26fidl_test_coding_IntStruct, 0u, 8u, nullptr, fidl_test_coding_IntStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_SimpleTableTable = fidl_type_t(::fidl::FidlCodedTable(Fields28fidl_test_coding_SimpleTable, 2u, nullptr));
...
const fidl_type_t fidl_test_coding_SampleXUnionTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields29fidl_test_coding_SampleXUnion, ::fidl::kNonnullable, nullptr, ::fidl::kFlexible));
...
const fidl_type_t fidl_test_coding_SampleXUnionNullableRefTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields40fidl_test_coding_SampleXUnionNullableRef, ::fidl::kNullable, nullptr, ::fidl::kFlexible));
...
const fidl_type_t fidl_test_coding_SampleXUnionStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35fidl_test_coding_SampleXUnionStruct, 1u, 24u, nullptr, fidl_test_coding_SampleXUnionStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_SampleUnionTable = fidl_type_t(::fidl::FidlCodedUnion(Fields28fidl_test_coding_SampleUnion, 3u, 8u, 24u, nullptr, fidl_test_coding_SampleUnionAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_SampleStrictXUnionTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields35fidl_test_coding_SampleStrictXUnion, ::fidl::kNonnullable, nullptr, ::fidl::kStrict));
...
const fidl_type_t fidl_test_coding_SampleStrictXUnionNullableRefTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields46fidl_test_coding_SampleStrictXUnionNullableRef, ::fidl::kNullable, nullptr, ::fidl::kStrict));
...
const fidl_type_t fidl_test_coding_SampleStrictXUnionStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields41fidl_test_coding_SampleStrictXUnionStruct, 1u, 24u, nullptr, fidl_test_coding_SampleStrictXUnionStructAltTypePointerTable()));

static const ::fidl::FidlTableField Fields33fidl_test_coding_OlderSimpleTable[] = {
    ::fidl::FidlTableField(&fidl_test_coding_IntStructTable,1u)
};
const fidl_type_t fidl_test_coding_OlderSimpleTableTable = fidl_type_t(::fidl::FidlCodedTable(Fields33fidl_test_coding_OlderSimpleTable, 1u, nullptr));
...
const fidl_type_t fidl_test_coding_NewerSimpleTableTable = fidl_type_t(::fidl::FidlCodedTable(Fields33fidl_test_coding_NewerSimpleTable, 3u, nullptr));
...
const fidl_type_t fidl_test_coding_Int8EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt8, &EnumValidatorFor_fidl_test_coding_Int8Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Int8EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields31fidl_test_coding_Int8EnumStruct, 1u, 1u, nullptr, fidl_test_coding_Int8EnumStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_Int64EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt64, &EnumValidatorFor_fidl_test_coding_Int64Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Int64EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields32fidl_test_coding_Int64EnumStruct, 1u, 8u, nullptr, fidl_test_coding_Int64EnumStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_Int32EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt32, &EnumValidatorFor_fidl_test_coding_Int32Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Int32EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields32fidl_test_coding_Int32EnumStruct, 1u, 4u, nullptr, fidl_test_coding_Int32EnumStructAltTypePointerTable()));

const fidl_type_t fidl_test_coding_Int32BitsTable = fidl_type_t(::fidl::FidlCodedBits(::fidl::FidlCodedPrimitive::kUint32, 67110976ul, nullptr));
...
const fidl_type_t fidl_test_coding_Int32BitsStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields32fidl_test_coding_Int32BitsStruct, 1u, 4u, nullptr, fidl_test_coding_Int32BitsStructAltTypePointerTable()));
...
const fidl_type_t fidl_test_coding_Int16EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt16, &EnumValidatorFor_fidl_test_coding_Int16Enum, nullptr));
...
const fidl_type_t fidl_test_coding_Int16EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields32fidl_test_coding_Int16EnumStruct, 1u, 2u, nullptr, fidl_test_coding_Int16EnumStructAltTypePointerTable()));

const fidl_type_t fidl_test_coding_Int16BitsTable = fidl_type_t(::fidl::FidlCodedBits(::fidl::FidlCodedPrimitive::kUint16, 21ul, nullptr));
...
const fidl_type_t fidl_test_coding_Int16BitsStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields32fidl_test_coding_Int16BitsStruct, 1u, 2u, nullptr, fidl_test_coding_Int16BitsStructAltTypePointerTable()));
...
extern const fidl_type_t v1_v1_fidl_test_coding_SampleXUnionNullableRefTable;
...
extern const fidl_type_t v1_v1_fidl_test_coding_SampleStrictXUnionNullableRefTable;
...
const fidl_type_t v1_fidl_test_coding_LinearizerTestVectorOfUint32RequestTable = fidl_type_t(::fidl::FidlCodedStruct(Fields55v1_fidl_test_coding_LinearizerTestVectorOfUint32Request, 1u, 32u, nullptr, v1_fidl_test_coding_LinearizerTestVectorOfUint32RequestAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_LinearizerTestVectorOfStringRequestTable = fidl_type_t(::fidl::FidlCodedStruct(Fields55v1_fidl_test_coding_LinearizerTestVectorOfStringRequest, 1u, 32u, nullptr, v1_fidl_test_coding_LinearizerTestVectorOfStringRequestAltTypePointerTable()));


static constexpr bool EnumValidatorFor_v1_fidl_test_coding_Uint8Enum(uint64_t v) { return (v == 0ul) || (v == 255ul) || (v == 42ul) || false; }
const fidl_type_t v1_fidl_test_coding_Uint8EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint8, &EnumValidatorFor_v1_fidl_test_coding_Uint8Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Uint8EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35v1_fidl_test_coding_Uint8EnumStruct, 1u, 1u, nullptr, v1_fidl_test_coding_Uint8EnumStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_Uint64EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint64, &EnumValidatorFor_v1_fidl_test_coding_Uint64Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Uint64EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields36v1_fidl_test_coding_Uint64EnumStruct, 1u, 8u, nullptr, v1_fidl_test_coding_Uint64EnumStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_Uint32EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint32, &EnumValidatorFor_v1_fidl_test_coding_Uint32Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Uint32EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields36v1_fidl_test_coding_Uint32EnumStruct, 1u, 4u, nullptr, v1_fidl_test_coding_Uint32EnumStructAltTypePointerTable()));

static constexpr bool EnumValidatorFor_v1_fidl_test_coding_Uint16Enum(uint64_t v) { return (v == 0ul) || (v == 65535ul) || (v == 42ul) || false; }
const fidl_type_t v1_fidl_test_coding_Uint16EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kUint16, &EnumValidatorFor_v1_fidl_test_coding_Uint16Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Uint16EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields36v1_fidl_test_coding_Uint16EnumStruct, 1u, 2u, nullptr, v1_fidl_test_coding_Uint16EnumStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_StructWithManyHandlesTable = fidl_type_t(::fidl::FidlCodedStruct(Fields41v1_fidl_test_coding_StructWithManyHandles, 3u, 24u, nullptr, v1_fidl_test_coding_StructWithManyHandlesAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_SmallerTableOfStructWithHandleTable = fidl_type_t(::fidl::FidlCodedTable(Fields50v1_fidl_test_coding_SmallerTableOfStructWithHandle, 1u, nullptr));
...
const fidl_type_t v1_fidl_test_coding_StructWithHandleTable = fidl_type_t(::fidl::FidlCodedStruct(Fields36v1_fidl_test_coding_StructWithHandle, 1u, 8u, nullptr, v1_fidl_test_coding_StructWithHandleAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_TableOfStructWithHandleTable = fidl_type_t(::fidl::FidlCodedTable(Fields43v1_fidl_test_coding_TableOfStructWithHandle, 2u, nullptr));
...
static const ::fidl::FidlStructField Fields46v1_fidl_test_coding_SampleNullableXUnionStruct[] = {
    ::fidl::FidlStructField(&v1_v1_fidl_test_coding_SampleXUnionNullableRefTable, 0u, 0u, Fields46v1_fidl_test_coding_SampleNullableXUnionStruct_field0_alt_field())
};
...
const fidl_type_t v1_fidl_test_coding_SampleNullableXUnionStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields46v1_fidl_test_coding_SampleNullableXUnionStruct, 1u, 24u, nullptr, v1_fidl_test_coding_SampleNullableXUnionStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_IntStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields29v1_fidl_test_coding_IntStruct, 0u, 8u, nullptr, v1_fidl_test_coding_IntStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_SimpleTableTable = fidl_type_t(::fidl::FidlCodedTable(Fields31v1_fidl_test_coding_SimpleTable, 2u, nullptr));
...
const fidl_type_t v1_fidl_test_coding_SampleXUnionTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields32v1_fidl_test_coding_SampleXUnion, ::fidl::kNonnullable, nullptr, ::fidl::kFlexible));

static const ::fidl::FidlXUnionField Fields46v1_v1_fidl_test_coding_SampleXUnionNullableRef[] = {
    ::fidl::FidlXUnionField(&::fidl::internal::kInt32Table,319709411u),
    ::fidl::FidlXUnionField(&v1_fidl_test_coding_IntStructTable,376675050u),
    ::fidl::FidlXUnionField(&v1_fidl_test_coding_SimpleTableTable,586453270u)
};
const fidl_type_t v1_v1_fidl_test_coding_SampleXUnionNullableRefTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields46v1_v1_fidl_test_coding_SampleXUnionNullableRef, ::fidl::kNullable, nullptr, ::fidl::kFlexible));
...
const fidl_type_t v1_fidl_test_coding_SampleXUnionStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields38v1_fidl_test_coding_SampleXUnionStruct, 1u, 24u, nullptr, v1_fidl_test_coding_SampleXUnionStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_SampleUnionTable = fidl_type_t(::fidl::FidlCodedUnion(Fields31v1_fidl_test_coding_SampleUnion, 3u, 8u, 24u, nullptr, v1_fidl_test_coding_SampleUnionAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_SampleStrictXUnionTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields38v1_fidl_test_coding_SampleStrictXUnion, ::fidl::kNonnullable, nullptr, ::fidl::kStrict));

static const ::fidl::FidlXUnionField Fields52v1_v1_fidl_test_coding_SampleStrictXUnionNullableRef[] = {
    ::fidl::FidlXUnionField(&::fidl::internal::kInt32Table,419938224u),
    ::fidl::FidlXUnionField(&v1_fidl_test_coding_SimpleTableTable,915108668u),
    ::fidl::FidlXUnionField(&v1_fidl_test_coding_IntStructTable,1928460319u)
};
const fidl_type_t v1_v1_fidl_test_coding_SampleStrictXUnionNullableRefTable = fidl_type_t(::fidl::FidlCodedXUnion(3u, Fields52v1_v1_fidl_test_coding_SampleStrictXUnionNullableRef, ::fidl::kNullable, nullptr, ::fidl::kStrict));
...
const fidl_type_t v1_fidl_test_coding_SampleStrictXUnionStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields44v1_fidl_test_coding_SampleStrictXUnionStruct, 1u, 24u, nullptr, v1_fidl_test_coding_SampleStrictXUnionStructAltTypePointerTable()));

static const ::fidl::FidlTableField Fields36v1_fidl_test_coding_OlderSimpleTable[] = {
    ::fidl::FidlTableField(&v1_fidl_test_coding_IntStructTable,1u)
};
const fidl_type_t v1_fidl_test_coding_OlderSimpleTableTable = fidl_type_t(::fidl::FidlCodedTable(Fields36v1_fidl_test_coding_OlderSimpleTable, 1u, nullptr));
...
const fidl_type_t v1_fidl_test_coding_NewerSimpleTableTable = fidl_type_t(::fidl::FidlCodedTable(Fields36v1_fidl_test_coding_NewerSimpleTable, 3u, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int8EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt8, &EnumValidatorFor_v1_fidl_test_coding_Int8Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int8EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields34v1_fidl_test_coding_Int8EnumStruct, 1u, 1u, nullptr, v1_fidl_test_coding_Int8EnumStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_Int64EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt64, &EnumValidatorFor_v1_fidl_test_coding_Int64Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int64EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35v1_fidl_test_coding_Int64EnumStruct, 1u, 8u, nullptr, v1_fidl_test_coding_Int64EnumStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_Int32EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt32, &EnumValidatorFor_v1_fidl_test_coding_Int32Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int32EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35v1_fidl_test_coding_Int32EnumStruct, 1u, 4u, nullptr, v1_fidl_test_coding_Int32EnumStructAltTypePointerTable()));

const fidl_type_t v1_fidl_test_coding_Int32BitsTable = fidl_type_t(::fidl::FidlCodedBits(::fidl::FidlCodedPrimitive::kUint32, 67110976ul, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int32BitsStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35v1_fidl_test_coding_Int32BitsStruct, 1u, 4u, nullptr, v1_fidl_test_coding_Int32BitsStructAltTypePointerTable()));
...
const fidl_type_t v1_fidl_test_coding_Int16EnumTable = fidl_type_t(::fidl::FidlCodedEnum(::fidl::FidlCodedPrimitive::kInt16, &EnumValidatorFor_v1_fidl_test_coding_Int16Enum, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int16EnumStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35v1_fidl_test_coding_Int16EnumStruct, 1u, 2u, nullptr, v1_fidl_test_coding_Int16EnumStructAltTypePointerTable()));

const fidl_type_t v1_fidl_test_coding_Int16BitsTable = fidl_type_t(::fidl::FidlCodedBits(::fidl::FidlCodedPrimitive::kUint16, 21ul, nullptr));
...
const fidl_type_t v1_fidl_test_coding_Int16BitsStructTable = fidl_type_t(::fidl::FidlCodedStruct(Fields35v1_fidl_test_coding_Int16BitsStruct, 1u, 2u, nullptr, v1_fidl_test_coding_Int16BitsStructAltTypePointerTable()));
