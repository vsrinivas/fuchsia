...
uint8_t sandwich1_case1_v1[] = {
    ...
    0xdb, 0xf0, 0xc2, 0x7f,  // UnionSize8Aligned4.tag, i.e. Sandwich1.the_union
...
uint8_t sandwich1_with_opt_union_present_v1[] = {
    ...
    0xdb, 0xf0, 0xc2, 0x7f,  // UnionSize8Aligned4.tag, i.e. Sandwich1WithOptUnion.union
    0x00, 0x00, 0x00, 0x00,  // UnionSize8Aligned4.padding
    0x08, 0x00, 0x00, 0x00,  // UnionSize8Aligned4.env.num_bytes
    0x00, 0x00, 0x00, 0x00,  // UnionSize8Aligned4.env.num_handle
...
uint8_t sandwich2_case1_v1[] = {
    ...
    0xbf, 0xd3, 0xd1, 0x20,  // UnionSize16Aligned4.tag, i.e. Sandwich2.the_union
...
uint8_t sandwich3_case1_v1[] = {
    ...
    0x9b, 0x55, 0x04, 0x34,  // UnionSize24Alignement8.tag, i.e. Sandwich2.the_union
...
uint8_t sandwich6_case1_v1[] = {
    ...
    0xad, 0xcc, 0xc3, 0x79,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
...
uint8_t sandwich6_case2_v1[] = {
    ...
    0x38, 0x43, 0x31, 0x3b,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
...
uint8_t sandwich6_case3_v1[] = {
    ...
    0xdc, 0x3c, 0xc1, 0x4b,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
...
uint8_t sandwich6_case4_v1[] = {
    ...
    0x3c, 0xaa, 0x08, 0x1d,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
    0x20, 0x00, 0x00, 0x00,  // UnionWithVector.env.num_bytes
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.env.num_handle
    0xff, 0xff, 0xff, 0xff,  // UnionWithVector.env.presence
...
uint8_t sandwich6_case5_v1[] = {
    ...
    0x76, 0xaa, 0x1e, 0x47,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
    0x20, 0x00, 0x00, 0x00,  // UnionWithVector.env.num_bytes
...
uint8_t sandwich6_case6_v1[] = {
    ...
    0x10, 0xa8, 0xa0, 0x5e,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
...
uint8_t sandwich6_case7_v1[] = {
    ...
    0x0d, 0xb7, 0xf8, 0x5c,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
    0x08, 0x00, 0x00, 0x00,  // UnionWithVector.env.num_bytes
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.env.num_handle
    0xff, 0xff, 0xff, 0xff,  // UnionWithVector.env.presence
...
uint8_t sandwich6_case8_v1[] = {
    ...
    0x31, 0x8c, 0x76, 0x2b,  // UnionWithVector.ordinal (start of Sandwich6.the_union)
    0x00, 0x00, 0x00, 0x00,  // UnionWithVector.ordinal (padding)
...
uint8_t arraystruct_v1[] = {
    0x80, 0xBB, 0x5F, 0x4B,  // unions[0].tag  0x00
    ...
    0x80, 0xBB, 0x5F, 0x4B,  // unions[1].tag
    ...
    0x80, 0xBB, 0x5F, 0x4B,  // unions[2].tag  0x30
    ...
    0x80, 0xBB, 0x5F, 0x4B,  // unions[3].tag
    ...
    0x80, 0xBB, 0x5F, 0x4B,  // unions[4].tag  0x60
    ...
    0x80, 0xBB, 0x5F, 0x4B,  // unions[5].tag
