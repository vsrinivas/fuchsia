...
#ifndef ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_VMO_WRITER_H_
#define ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_VMO_WRITER_H_
...
#endif  // ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_VMO_WRITER_H_
