...
#ifndef ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_BOOT_ARGS_H_
#define ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_BOOT_ARGS_H_
...
#endif  // ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_BOOT_ARGS_H_
