...
#ifndef ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_METADATA_H_
#define ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_METADATA_H_
...
#endif  // ZIRCON_SYSTEM_CORE_DEVMGR_DEVCOORDINATOR_METADATA_H_
