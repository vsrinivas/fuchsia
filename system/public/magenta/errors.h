...
#define ERR_NO_RESOURCES (MX_ERR_NO_RESOURCES)
#define ERR_NO_MEMORY (MX_ERR_NO_MEMORY)
#define ERR_CALL_FAILED (MX_ERR_CALL_FAILED)
#define ERR_INTERRUPTED_RETRY (MX_ERR_INTERRUPTED_RETRY)
#define ERR_INVALID_ARGS (MX_ERR_INVALID_ARGS)
#define ERR_BAD_HANDLE (MX_ERR_BAD_HANDLE)
#define ERR_WRONG_TYPE (MX_ERR_WRONG_TYPE)
#define ERR_BAD_SYSCALL (MX_ERR_BAD_SYSCALL)
#define ERR_OUT_OF_RANGE (MX_ERR_OUT_OF_RANGE)
#define ERR_BUFFER_TOO_SMALL (MX_ERR_BUFFER_TOO_SMALL)
#define ERR_BAD_STATE (MX_ERR_BAD_STATE)
#define ERR_TIMED_OUT (MX_ERR_TIMED_OUT)
#define ERR_SHOULD_WAIT (MX_ERR_SHOULD_WAIT)
#define ERR_CANCELED (MX_ERR_CANCELED)
#define ERR_PEER_CLOSED (MX_ERR_PEER_CLOSED)
#define ERR_NOT_FOUND (MX_ERR_NOT_FOUND)
#define ERR_ALREADY_EXISTS (MX_ERR_ALREADY_EXISTS)
#define ERR_ALREADY_BOUND (MX_ERR_ALREADY_BOUND)
#define ERR_UNAVAILABLE (MX_ERR_UNAVAILABLE)
#define ERR_ACCESS_DENIED (MX_ERR_ACCESS_DENIED)
#define ERR_IO (MX_ERR_IO)
#define ERR_IO_REFUSED (MX_ERR_IO_REFUSED)
#define ERR_IO_DATA_INTEGRITY (MX_ERR_IO_DATA_INTEGRITY)
#define ERR_IO_DATA_LOSS (MX_ERR_IO_DATA_LOSS)
#define ERR_BAD_PATH (MX_ERR_BAD_PATH)
#define ERR_NOT_DIR (MX_ERR_NOT_DIR)
#define ERR_NOT_FILE (MX_ERR_NOT_FILE)
#define ERR_FILE_BIG (MX_ERR_FILE_BIG)
