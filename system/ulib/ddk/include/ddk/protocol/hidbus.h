...
typedef struct hidbus_protocol {
    ...
    mx_status_t (*query)(mx_device_t* dev, uint32_t options, hid_info_t* info);
    ...
    mx_status_t (*start)(mx_device_t* dev, hidbus_ifc_t* ifc, void* cookie);
    ...
    mx_status_t (*get_descriptor)(mx_device_t* dev, uint8_t desc_type, void** data, size_t* len);
    mx_status_t (*get_report)(mx_device_t* dev, uint8_t rpt_type, uint8_t rpt_id, void* data,
                              size_t len);
    mx_status_t (*set_report)(mx_device_t* dev, uint8_t rpt_type, uint8_t rpt_id, void* data,
                              size_t len);
