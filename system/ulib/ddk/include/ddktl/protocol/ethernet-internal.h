...
constexpr void CheckEthmacIfc() {
    ...
    static_assert(mxtl::is_same<decltype(&D::EthmacStatus),
    ...
    static_assert(mxtl::is_same<decltype(&D::EthmacRecv),
...
constexpr void CheckEthmacProtocolSubclass() {
    ...
    static_assert(mxtl::is_same<decltype(&D::EthmacQuery),
    ...
    static_assert(mxtl::is_same<decltype(&D::EthmacStop),
                                void (D::*)()>::value,
    ...
    static_assert(mxtl::is_same<decltype(&D::EthmacStart),
                                mx_status_t (D::*)(mxtl::unique_ptr<EthmacIfcProxy>)>::value,
                  "EthmacStart must be a non-static member function with signature "
                  "'mx_status_t EthmacStart(mxtl::unique_ptr<EthmacIfcProxy>)', and be visible "
    ...
    static_assert(mxtl::is_same<decltype(&D::EthmacSend),
