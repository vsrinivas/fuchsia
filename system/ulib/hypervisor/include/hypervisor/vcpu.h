...
typedef mx_status_t (*vcpu_state_op)(vcpu_context_t* vcpu,
...
typedef struct vcpu_context {
    ...
    vcpu_state_op read_state;
    vcpu_state_op write_state;
} vcpu_context_t;

/* Initialize a VCPU context. */
void vcpu_init(vcpu_context_t* context);

/* Controls execution of a VCPU context, providing the main logic and event
 * processing.
 */
mx_status_t vcpu_loop(vcpu_context_t* context);

/* Process a single guest packet generated by a VM exit. */
