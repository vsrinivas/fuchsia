...
#define LDMSG_ORDINAL_DONE                    1u
#define LDMSG_ORDINAL_LOAD_OBJECT             2u
#define LDMSG_ORDINAL_LOAD_SCRIPT_INTERPRETER 3u
#define LDMSG_ORDINAL_CONFIG                  4u
#define LDMSG_ORDINAL_CLONE                   5u
#define LDMSG_ORDINAL_DEBUG_PRINT             6u
#define LDMSG_ORDINAL_DEBUG_PUBLISH_DATA_SINK 7u
#define LDMSG_ORDINAL_DEBUG_LOAD_CONFIG       8u

// The payload format used for all the requests other than LDMSG_ORDINAL_CLONE.
...
// The payload format used for LDMSG_ORDINAL_CLONE.
...
struct ldmsg_req {
    ...
    union {
        ...
        ldmsg_clone_t clone;
        char data[1024 - sizeof(fidl_message_header_t)];
    };
};
