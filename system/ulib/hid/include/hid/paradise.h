...
extern bool is_paradise_touchpad_v1_report_desc(const uint8_t* data, size_t len);
extern bool is_paradise_touchpad_v2_report_desc(const uint8_t* data, size_t len);
