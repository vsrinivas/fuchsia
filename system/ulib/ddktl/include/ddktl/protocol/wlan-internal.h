...
DECLARE_HAS_MEMBER_FN(has_wlanmac_query2, WlanmacQuery2);
...
constexpr void CheckWlanmacProtocolSubclass() {
    static_assert(!QueryRenamed || internal::has_wlanmac_query<D>::value,
    ...
    //              "friendship).");
    static_assert(QueryRenamed || internal::has_wlanmac_query2<D>::value,
