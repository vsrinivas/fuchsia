...
constexpr void CheckWlanmacIfc() {
    ...
    static_assert(mxtl::is_same<decltype(&D::WlanmacStatus),
...
constexpr void CheckWlanmacProtocolSubclass() {
    ...
    static_assert(mxtl::is_same<decltype(&D::WlanmacQuery),
    ...
    static_assert(mxtl::is_same<decltype(&D::WlanmacStop),
                                void (D::*)()>::value,
    ...
    static_assert(mxtl::is_same<decltype(&D::WlanmacStart),
                                mx_status_t (D::*)(mxtl::unique_ptr<WlanmacIfcProxy>)>::value,
                  "WlanmacStart must be a non-static member function with signature "
                  "'mx_status_t WlanmacStart(mxtl::unique_ptr<WlanmacIfcProxy>)', and be visible "
    ...
    static_assert(mxtl::is_same<decltype(&D::WlanmacSetChannel),
