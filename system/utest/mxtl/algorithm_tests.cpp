...
bool lower_bound_test() {
    ...
    int* null = nullptr;
    EXPECT_EQ(mxtl::lower_bound(null, null, 0), null, "");

    int value = 5;
    EXPECT_EQ(mxtl::lower_bound(&value, &value, 4), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value, 5), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value, 6), &value, "");

    EXPECT_EQ(mxtl::lower_bound(&value, &value + 1, 4), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value + 1, 5), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value + 1, 6), &value + 1, "");
    ...
    EXPECT_EQ(*mxtl::lower_bound(first, last, 0), 1, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 1), 1, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 2), 3, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 3), 3, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 4), 5, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 5), 5, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 6), 7, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 7), 7, "");
    EXPECT_EQ(mxtl::lower_bound(first, last, 8), last, "");

    last = first - 1;
    EXPECT_EQ(mxtl::lower_bound(first, first, 0), first, "");
    EXPECT_EQ(mxtl::lower_bound(first, last, 0), last, "");
...
bool lower_bound_compare_test() {
    ...
    int* null = nullptr;
    EXPECT_EQ(mxtl::lower_bound(null, null, 0, lessThan), null, "");

    int value = 5;
    EXPECT_EQ(mxtl::lower_bound(&value, &value, 4, lessThan), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value, 5, lessThan), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value, 6, lessThan), &value, "");

    EXPECT_EQ(mxtl::lower_bound(&value, &value + 1, 4, lessThan), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value + 1, 5, lessThan), &value, "");
    EXPECT_EQ(mxtl::lower_bound(&value, &value + 1, 6, lessThan), &value + 1, "");
    ...
    EXPECT_EQ(*mxtl::lower_bound(first, last, 0, lessThan), 1, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 1, lessThan), 1, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 2, lessThan), 3, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 3, lessThan), 3, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 4, lessThan), 5, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 5, lessThan), 5, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 6, lessThan), 7, "");
    EXPECT_EQ(*mxtl::lower_bound(first, last, 7, lessThan), 7, "");
    EXPECT_EQ(mxtl::lower_bound(first, last, 8, lessThan), last, "");

    last = first - 1;
    EXPECT_EQ(mxtl::lower_bound(first, first, 0, lessThan), first, "");
    EXPECT_EQ(mxtl::lower_bound(first, last, 0, lessThan), last, "");
