...
bool capacity_test() {
    ...
    {
        mxtl::StringBuffer<0u> buf;
        EXPECT_EQ(0u, buf.capacity());
    }

    {
        mxtl::StringBuffer<100u> buf;
...
bool append_test() {
    ...
    {
        mxtl::StringBuffer<16u> str;
        str.Append('a')
            .Append('b')
            .Append("cd")
            .Append("efghi", 3u)
            .Append(mxtl::StringPiece("hijkl", 3u))
            .Append(mxtl::String("klmnopqrstuvwxyz"))
            .Append('z') // these will be truncated away
            .Append("zz")
            .Append("zzzzzz", 3u)
            .Append(mxtl::StringPiece("zzzzz", 3u))
            .Append(mxtl::String("zzzzz"));
    ...
    {
        mxtl::StringBuffer<3u> str;
        str.Append(mxtl::StringPiece("abcdef", 2u));
        EXPECT_CSTR_EQ("ab", str.data());
        str.Append(mxtl::StringPiece("zzzz", 0u));
        EXPECT_CSTR_EQ("ab", str.data());
        str.Append(mxtl::StringPiece("cdefghijk", 5u));
        EXPECT_CSTR_EQ("abc", str.data());
    }

    {
        mxtl::StringBuffer<3u> str;
        str.Append(mxtl::String("ab"));
        EXPECT_CSTR_EQ("ab", str.data());
        str.Append(mxtl::String());
        EXPECT_CSTR_EQ("ab", str.data());
        str.Append(mxtl::String("cdefg"));
        EXPECT_CSTR_EQ("abc", str.data());
    }
...
bool to_string_test() {
    ...
    {
        mxtl::StringBuffer<16u> buf;
        buf.Append("abcdef");

        mxtl::String str = buf.ToString();
...
bool to_string_piece_test() {
...

    {
        ...
        mxtl::StringPiece piece = buf.ToStringPiece();
