...
static bool ufptr_test_move() {
    ...
    {
        mxtl::unique_free_ptr<int> ptr(static_cast<int*>(malloc(sizeof(int))));

        mxtl::unique_free_ptr<int> ptr2 = mxtl::move(ptr);
...
static bool ufptr_test_null_scoped_destruction() {
    ...
    // deleter.
    {
        mxtl::unique_free_ptr<int> ptr(nullptr);
    }
...
static bool ufptr_test_diff_scope_swap() {
    ...
    {
        mxtl::unique_free_ptr<int> ptr1(static_cast<int*>(malloc(sizeof(int))));
        *ptr1 = 4;
        {
            mxtl::unique_free_ptr<int> ptr2(static_cast<int*>(malloc(sizeof(int))));
            *ptr2 = 7;
...
static bool ufptr_test_comparison() {
    ...
    mxtl::unique_free_ptr<int> null_unique;
    mxtl::unique_free_ptr<int> lesser_unique(static_cast<int*>(malloc(sizeof(int))));
    *lesser_unique = 1;
