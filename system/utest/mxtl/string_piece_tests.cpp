...
bool non_empty_string_test() {
    ...
    mxtl::StringPiece str2(data + 1u, 2u);
...
bool copy_move_and_assignment_test() {
    ...
    {
        mxtl::StringPiece abc(data);
        mxtl::StringPiece str(abc);
    ...
    {
        mxtl::StringPiece abc(data);
        mxtl::StringPiece str(mxtl::move(abc));
        EXPECT_EQ(data, str.data());
        EXPECT_EQ(3u, str.length());
    }
