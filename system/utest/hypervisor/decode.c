...
static bool decode_failure(void) {
    ...
    EXPECT_EQ(decode_instruction(NULL, 0, NULL, NULL), MX_ERR_BAD_STATE, "");
    EXPECT_EQ(decode_instruction(NULL, 32, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");

    uint8_t bad_rex[] = { 0b0100u << 4, 0, 0 };
    EXPECT_EQ(decode_instruction(bad_rex, 1, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");
    EXPECT_EQ(decode_instruction(bad_rex, 2, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    EXPECT_EQ(decode_instruction(bad_rex, 3, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");

    uint8_t bad_len[] = { 0, 0 };
    EXPECT_EQ(decode_instruction(bad_len, 2, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");
...
static bool decode_mov_89(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_len, 3, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    uint8_t bad_disp[] = { 0x89, 0b01000000 };
    EXPECT_EQ(decode_instruction(bad_disp, 2, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    uint8_t has_sib[] = { 0x89, 0b01000100, 0, 0 };
    EXPECT_EQ(decode_instruction(has_sib, 4, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");
    uint8_t bad_h66[] = { 0x66, 0b01001000, 0x89, 0b00010000 };
    EXPECT_EQ(decode_instruction(bad_h66, 4, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");

    // mov %ecx, (%rax)
    uint8_t mov[] = { 0x89, 0b00001000 };
    mx_guest_gpr_t guest_gpr;
    instruction_t inst;
    EXPECT_EQ(decode_instruction(mov, 2, &guest_gpr, &inst), MX_OK, "");
    ...
    EXPECT_EQ(decode_instruction(rex_mov, 3, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 4u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    ...
    EXPECT_EQ(decode_instruction(mov_disp_1, 3, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 4u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    ...
    EXPECT_EQ(decode_instruction(mov_disp_4, 6, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 4u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    EXPECT_EQ(inst.reg, &guest_gpr.rbx, "");
    ...
    EXPECT_EQ(decode_instruction(rex_mov_disp, 4, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    ...
    EXPECT_EQ(decode_instruction(h66_mov_disp, 5, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
...
static bool decode_mov_c7(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_len, 2, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    uint8_t bad_disp[] = { 0xc7, 0b01000000 };
    EXPECT_EQ(decode_instruction(bad_disp, 2, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    uint8_t has_sib[] = { 0xc7, 0b01000100, 0, 0, 0, 0, 0, 0 };
    EXPECT_EQ(decode_instruction(has_sib, 8, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");
    uint8_t bad_mod_rm[] = { 0xc7, 0b00111000, 0x1, 0, 0, 0 };
    EXPECT_EQ(decode_instruction(bad_mod_rm, 6, NULL, NULL), MX_ERR_INVALID_ARGS, "");
    uint8_t bad_h66[] = { 0x66, 0b01001000, 0xc7, 0, 0, 0, 0, 0x1 };
    EXPECT_EQ(decode_instruction(bad_h66, 8, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");

    // movl 0x1, (%rax)
    uint8_t mov[] = { 0xc7, 0, 0x1, 0, 0, 0 };
    mx_guest_gpr_t guest_gpr;
    instruction_t inst;
    EXPECT_EQ(decode_instruction(mov, 6, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 4u, "");
    ...
    EXPECT_EQ(decode_instruction(rex_mov, 7, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 8u, "");
    ...
    EXPECT_EQ(decode_instruction(mov_disp_1, 7, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 4u, "");
    ...
    EXPECT_EQ(decode_instruction(mov_disp_4, 10, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 4u, "");
    EXPECT_EQ(inst.imm, 0x1000000u, "");
    EXPECT_EQ(inst.reg, NULL, "");
    ...
    EXPECT_EQ(decode_instruction(h66_mov_disp, 7, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 2u, "");
...
static bool decode_movz_0f_b6(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_len, 4, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    uint8_t bad_disp[] = { 0x0f, 0xb6, 0b01000000 };
    EXPECT_EQ(decode_instruction(bad_disp, 3, NULL, NULL), MX_ERR_OUT_OF_RANGE, "");
    uint8_t has_sib[] = { 0x0f, 0xb6, 0b01000100, 0, 0 };
    EXPECT_EQ(decode_instruction(has_sib, 5, NULL, NULL), MX_ERR_NOT_SUPPORTED, "");
    uint8_t has_h66[] = { 0x66, 0x0f, 0xb6, 0b00001000 };
    EXPECT_EQ(decode_instruction(has_h66, 4, NULL, NULL), MX_ERR_BAD_STATE, "");

    // movzb (%rax), %ecx
    uint8_t movz[] = { 0x0f, 0xb6, 0b00001000 };
    mx_guest_gpr_t guest_gpr;
    instruction_t inst;
    EXPECT_EQ(decode_instruction(movz, 3, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_READ, "");
    ...
    EXPECT_EQ(decode_instruction(rex_movz, 4, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_READ, "");
    EXPECT_EQ(inst.mem, 1u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    EXPECT_EQ(inst.reg, &guest_gpr.r10, "");
    ...
    EXPECT_EQ(decode_instruction(movz_disp_1, 4, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_READ, "");
    EXPECT_EQ(inst.mem, 1u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    EXPECT_EQ(inst.reg, &guest_gpr.rbx, "");
    ...
    EXPECT_EQ(decode_instruction(movz_disp_4, 7, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_READ, "");
    EXPECT_EQ(inst.mem, 1u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    EXPECT_EQ(inst.reg, &guest_gpr.rbx, "");
    ...
    EXPECT_EQ(decode_instruction(rex_movz_disp, 5, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_MOV_READ, "");
    EXPECT_EQ(inst.mem, 1u, "");
    EXPECT_EQ(inst.imm, 0u, "");
    EXPECT_EQ(inst.reg, &guest_gpr.r12, "");
...
static bool decode_test_f6(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_mod_rm, 3, NULL, NULL), MX_ERR_INVALID_ARGS, "");
    ...
    mx_guest_gpr_t guest_gpr;
    instruction_t inst;
    EXPECT_EQ(decode_instruction(test, 3, &guest_gpr, &inst), MX_OK, "");
    ...
    EXPECT_EQ(decode_instruction(test_disp_1, 4, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_TEST, "");
    EXPECT_EQ(inst.mem, 1u, "");
    EXPECT_EQ(inst.imm, 0x10u, "");
    EXPECT_EQ(inst.reg, NULL, "");
    ...
    EXPECT_EQ(decode_instruction(test_disp_4, 7, &guest_gpr, &inst), MX_OK, "");
    EXPECT_EQ(inst.type, INST_TEST, "");
    EXPECT_EQ(inst.mem, 1u, "");
