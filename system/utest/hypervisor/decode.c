...
static bool decode_mov_89(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_h66, 4, NULL, NULL), ERR_NOT_SUPPORTED, "");
    ...
    EXPECT_EQ(decode_instruction(h66_mov_disp, 5, &guest_gpr, &inst), NO_ERROR, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
...
static bool decode_mov_c7(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_h66, 8, NULL, NULL), ERR_NOT_SUPPORTED, "");
    ...
    EXPECT_EQ(decode_instruction(h66_mov_disp, 7, &guest_gpr, &inst), NO_ERROR, "");
    EXPECT_EQ(inst.type, INST_MOV_WRITE, "");
    EXPECT_EQ(inst.mem, 2u, "");
...
static bool decode_movz_0f_b6(void) {
    ...
    EXPECT_EQ(decode_instruction(has_h66, 4, NULL, NULL), ERR_BAD_STATE, "");
...
static bool decode_test_f6(void) {
    ...
    EXPECT_EQ(decode_instruction(bad_mod_rm, 3, NULL, NULL), ERR_INVALID_ARGS, "");
    ...
    mx_guest_gpr_t guest_gpr;
    instruction_t inst;
    EXPECT_EQ(decode_instruction(test, 3, &guest_gpr, &inst), NO_ERROR, "");
    ...
    EXPECT_EQ(decode_instruction(test_disp_1, 4, &guest_gpr, &inst), NO_ERROR, "");
    EXPECT_EQ(inst.type, INST_TEST, "");
    EXPECT_EQ(inst.mem, 1u, "");
    EXPECT_EQ(inst.imm, 0x10u, "");
    EXPECT_EQ(inst.reg, NULL, "");
    ...
    EXPECT_EQ(decode_instruction(test_disp_4, 7, &guest_gpr, &inst), NO_ERROR, "");
    EXPECT_EQ(inst.type, INST_TEST, "");
    EXPECT_EQ(inst.mem, 1u, "");
