...
bool argument_value_test() {
    ...
    {
        trace::ArgumentValue m(mxtl::move(av));
        EXPECT_EQ(trace::ArgumentType::kNull, av.type());
...
bool metadata_data_test() {
...

    {
        ...
        trace::MetadataContent m(mxtl::move(d));
...
bool record_test() {
    ...
    {
        mxtl::Vector<trace::Argument> args;
...

    {
        ...
        trace::Record r(trace::Record::KernelObject{
            123, MX_OBJ_TYPE_VMO, "name", mxtl::move(args)});
