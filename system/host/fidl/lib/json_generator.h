...
#ifndef ZIRCON_SYSTEM_HOST_FIDL_LIB_JSON_GENERATOR_H_
#define ZIRCON_SYSTEM_HOST_FIDL_LIB_JSON_GENERATOR_H_
...
#endif // ZIRCON_SYSTEM_HOST_FIDL_LIB_C_GENERATOR_H_
