...
extern zx_status_t imx227_bind(void* ctx, zx_device_t* parent);

static zx_driver_ops_t imx227_driver_ops = {
    .version = DRIVER_OPS_VERSION,
    .bind = imx227_bind,
};

// clang-format off
ZIRCON_DRIVER_BEGIN(imx227, imx227_driver_ops, "imx227", "0.1", 3)
