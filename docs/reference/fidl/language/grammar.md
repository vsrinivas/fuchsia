...
<div class="syntax-selector-intro">
  <devsite-nav-buttons name="syntax" id="selector" type="text" param="always">
    <button value="old" default>Old syntax</button>
    <button value="new">New syntax (RFC-0050)</button>
  </devsite-nav-buttons>
</div>
...
```
file = "deprecated_syntax" , ";" , library-header , ( using-list ) , declaration-list ;
