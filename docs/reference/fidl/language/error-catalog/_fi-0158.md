...
```fidl
{% includecode gerrit_repo="fuchsia/fuchsia" gerrit_path="tools/fidl/fidlc/tests/fidl/bad/vector_bound_twice.test.fidl" exclude_regexp="\/\/ (Copyright 20|Use of|found in).*" %}
```
...
```fidl
{% includecode gerrit_repo="fuchsia/fuchsia" gerrit_path="tools/fidl/fidlc/tests/fidl/good/unbounded_vector_bound_twice.test.fidl" exclude_regexp="\/\/ (Copyright 20|Use of|found in).*" %}
```
