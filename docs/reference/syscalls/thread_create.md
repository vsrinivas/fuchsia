...
*process* is the controlling [process object](/docs/zircon/objects/process.md) for the
new thread, which will become a child of that process.

For thread lifecycle details see [thread object](/docs/zircon/objects/thread.md).
