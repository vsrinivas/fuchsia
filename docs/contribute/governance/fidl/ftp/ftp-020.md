# [FTP](../README.md)-020: Interface Ordinal Hashing
...
method names in this format (c.f. [`fidlc`'s **NameName()** method](https://fuchsia-review.googlesource.com/c/fuchsia/+/HEAD/zircon/tools/fidl/include/fidl/names.h)).
