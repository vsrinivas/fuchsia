# [FTP](../README.md)-050: Syntax Revamp
...
### Relation to other FTPs

*   This FTP subsumes [FTP-038: Separating Layout from Constraints][ftp-038] and
    [FTP-039: Types Come Second][ftp-039] i.e. accepting FTP-050 means rejecting
    both FTP-038 and FTP-039 as "obsolete".
*   This FTP proposes an alternative solution to
    [FTP-044: Extensible Method Arguments][ftp-044], i.e. accepting FTP-050
    means rejecting FTP-044 as "obsolete".
...
This FTP does not introduce new functionality to FIDL, and limitations on
...
FIDL is primarily concerned with defining
[Application Binary Interface](https://en.wikipedia.org/wiki/Application_binary_interface)
(ABI) concerns, and second with Application Programming Interface (API)
concerns. This can result in a syntax that is more verbose than one may be
accustomed to, or may be expecting when comparing to other programming
languages. For instance, a‘unit’ variant of a union would be expressed as an
empty struct as can be seen in the `InvocationPayload` example above. We could
choose to introduce syntactic sugar to elide this type, but that would go
against making ABI concerns front-and-center.
...
Those changes are discussed in the [design](#design) section of this FTP.

Note: This FTP does not introduce new functionality to FIDL, and so` box<T>` is
...
FTP, for instance by allowing optional primitives natively through boxing.
...
[FTP-044: Extensible Method Arguments][ftp-044]
...
Handles with rights introduced in [FTP-028: Handle Rights][ftp-028]:
...
In [FTP-052: Type Aliasing and New Types][ftp-052] we evolved type aliasing and
...
i.e. unchanged from syntax proposed in FTP-052.
...
the initially proposed syntax in [FTP-052][ftp-052].
...
these arguments is fixed for a given type. This FTP defines the following
...
type Foo = struct {
  ...
  h3 zx.handle:VMO,
  h4 zx.handle:zx.READ,
  h5 zx.handle:<VMO,optional>,
  h6 zx.handle:<zx.READ,optional>,
  h7 zx.handle:<VMO,zx.READ>,
  h8 zx.handle:<VMO,zx.READ,optional>,
...
rendering (not on the precise semantics, which warrants separate FTPs). For
...
ongoing to introduce [FTP-028: Handle Rights][ftp-028],
...
![Visualization: build pipeline strategy](images/ftp-050-strategy.png)
...
This FTP is all about ergonomics.
...
*   [FTP-038: Separating Layout from Constraints][ftp-038]
*   [FTP-039: Types Come Second][ftp-039]
...
*   [FTP-052: Type Aliasing and New Types][ftp-052]
...
[envelopes]: /docs/contribute/governance/fidl/ftp/ftp-007.md#envelopes
[ftp-028]: /docs/contribute/governance/fidl/ftp/ftp-028.md
[ftp-038]: /docs/contribute/governance/fidl/ftp/ftp-038.md
[ftp-039]: /docs/contribute/governance/fidl/ftp/ftp-039.md
[ftp-044]: /docs/contribute/governance/fidl/ftp/ftp-044.md
