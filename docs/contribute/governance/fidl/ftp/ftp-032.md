...
In February 21, 2019, this FTP was initially accepted. The FIDL team worked to
...
* **Major** [FTP-015: Extensible Unions](ftp-015.md)
* [FTP-032: Efficient Envelopes](ftp-032.md), i.e. this FTP
* [FTP-037: Transactional Message Header v3](ftp-037.md)
* [FTP-048: Explicit Union Ordinals](ftp-048.md)
...
FIDL wire format (e.g. [tables' dense format](ftp-007.md#dense-vs-sparse)).
...
# [FTP](../README.md)-032: Efficient Envelopes
...
16 bits reserved](images/ftp-032-figure1.png)
...
*   **A size of `UINT32_MAX` and handle count of `0` is special: it
    ...
    *   This is reserved for future use if [zero-size empty structs][ftp-045]
...
<!-- xrefs -->
[envelopes]: ftp-007.md#envelopes
[ftp-015]: ftp-015.md
[ftp-026]: ftp-026.md
[ftp-045]: ftp-045.md
