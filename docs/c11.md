...
|`int fegetround(void);`| No |
|`int fesetround(int round);`| No |
...
|`size_t mbstowcs(wchar_t * restrict pwcs, const char * restrict s, size_t n);`| No |
...
|`wchar_t *wcsncat(wchar_t * restrict s1, const wchar_t * restrict s2, size_t n);`| No |
...
|`wchar_t *wcschr(const wchar_t *s, wchar_t c);`| No |
