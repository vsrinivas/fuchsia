...
### zedboot_cmdline_args
 ...
 See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/eaed741a38d648f6f2236d3dd171059d4b0c4c7a/docs/kernel_cmdline.md) and
...
### zircon_build_abi_dir
 ...
 files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/eaed741a38d648f6f2236d3dd171059d4b0c4c7a/public) libraries will link against.
...
### synthesize_packages
 ...
 a package() template invocation (see [//build/package.gni](https://fuchsia.googlesource.com/build/+/f5acbc985f51e09d26fa65196f7958e936331be7/package.gni)).  That scope
...
From [//build/gn/packages.gni:8](https://fuchsia.googlesource.com/build/+/f5acbc985f51e09d26fa65196f7958e936331be7/gn/packages.gni#8)
 ...
 *This should never be set as a build argument.*
 ...
 See [//build/toolchain/clang_toolchain.gni](https://fuchsia.googlesource.com/build/+/f5acbc985f51e09d26fa65196f7958e936331be7/toolchain/clang_toolchain.gni) for details.
...
### amber_repository_dir
 ...
 ASCII hex.  The [//build/image](https://fuchsia.googlesource.com/build/+/f5acbc985f51e09d26fa65196f7958e936331be7/image):amber_publish_blobs target populates
...
### host_tools_dir
 ...
 by an explicit install_host_tools() rule (see [//build/host.gni](https://fuchsia.googlesource.com/build/+/f5acbc985f51e09d26fa65196f7958e936331be7/host.gni)).

**Current value (from the default):** `"//root_build_dir/tools"`

### kernel_cmdline_args
 List of kernel command line arguments to bake into the boot image.
 See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/eaed741a38d648f6f2236d3dd171059d4b0c4c7a/docs/kernel_cmdline.md) and
...
### use_prebuilt_ffmpeg
 ...
 [//garnet/bin/media/media_player/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/9e905ad5bf3862c04c03eafb6780a773b2e9a34e/bin/media/media_player/ffmpeg/README.md) for details.  This is
