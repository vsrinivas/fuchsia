...
From [//build/config/BUILDCONFIG.gn:11](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#11)

### magma_build_root

**Current value (from the default):** `"//garnet/lib/magma"`

From [//garnet/lib/magma/gnbuild/magma.gni:6](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#6)
...
From [//build/images/BUILD.gn:25](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#25)
...
From [//build/config/BUILDCONFIG.gn:393](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#393)
...
From [//build/config/sysroot.gni:7](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/sysroot.gni#7)
...
From [//build/config/BUILDCONFIG.gn:413](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#413)

### amlogic_decoder_tests

**Current value (from the default):** `false`

From [//garnet/drivers/video/amlogic-decoder/BUILD.gn:10](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/drivers/video/amlogic-decoder/BUILD.gn#10)

### cloudkms_key_dir

**Current value (from the default):** `"projects/fuchsia-infra/locations/global/keyRings/test-secrets/cryptoKeys"`

From [//build/testing/secret_spec.gni:8](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/testing/secret_spec.gni#8)

### enable_value_subsystem

**Current value (from the default):** `false`

From [//garnet/bin/ui/scenic/BUILD.gn:11](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/ui/scenic/BUILD.gn#11)

### expat_build_root

**Current value (from the default):** `"//third_party/expat"`

From [//garnet/lib/magma/gnbuild/magma.gni:7](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#7)
...
From [//build/gn/packages.gni:30](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/gn/packages.gni#30)
...
From [//garnet/lib/magma/gnbuild/magma.gni:19](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#19)

### prebuilt_libvulkan_arm_path

**Current value (from the default):** `""`

From [//garnet/lib/magma/gnbuild/magma.gni:25](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#25)
...
From [//build/rust/config.gni:23](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/rust/config.gni#23)
...
a package() template invocation (see [//build/package.gni](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/package.gni)).  That scope
...
From [//build/gn/packages.gni:43](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/gn/packages.gni#43)

### toolchain_variant
*This should never be set as a build argument.*
It exists only to be set in `toolchain_args`.
See [//build/toolchain/clang_toolchain.gni](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/toolchain/clang_toolchain.gni) for details.
...
From [//build/config/BUILDCONFIG.gn:71](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#71)
...
From [//build/config/fuchsia/zircon.gni:32](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/zircon.gni#32)
...
From [//garnet/public/lib/escher/BUILD.gn:15](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/public/lib/escher/BUILD.gn#15)
...
From [//build/images/BUILD.gn:595](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#595)

### scenic_ignore_vsync

**Current value (from the default):** `false`

From [//garnet/lib/ui/gfx/BUILD.gn:16](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/ui/gfx/BUILD.gn#16)
...
From [//build/config/scudo/scudo.gni:8](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/scudo/scudo.gni#8)

### enable_input_subsystem

**Current value (from the default):** `true`

From [//garnet/bin/ui/scenic/BUILD.gn:14](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/ui/scenic/BUILD.gn#14)

### magma_python_path

**Current value (from the default):** `"/b/s/w/ir/kitchen-workdir/third_party/mako"`

From [//garnet/lib/magma/gnbuild/magma.gni:12](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#12)
...
From [//build/config/lto/config.gni:13](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/lto/config.gni#13)

### use_prebuilt_ffmpeg
Use a prebuilt ffmpeg binary rather than building it locally.  See
[//garnet/bin/mediaplayer/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/mediaplayer/ffmpeg/README.md) for details.  This is
...
From [//garnet/bin/mediaplayer/ffmpeg/BUILD.gn:14](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/mediaplayer/ffmpeg/BUILD.gn#14)
...
From [//build/dart/toolchain.gni:11](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/dart/toolchain.gni#11)

### enable_gfx_subsystem

**Current value (from the default):** `true`

From [//garnet/bin/ui/scenic/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/ui/scenic/BUILD.gn#12)

### host_byteorder

**Current value (from the default):** `"undefined"`

From [//build/config/host_byteorder.gni:7](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/host_byteorder.gni#7)
...
From [//build/config/BUILDCONFIG.gn:334](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#334)
...
From [//build/rust/config.gni:20](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/rust/config.gni#20)
...
From [//build/config/fuchsia/sdk.gni:10](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/sdk.gni#10)
...
From [//build/config/BUILDCONFIG.gn:618](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#618)
...
From [//build/config/compiler.gni:13](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/compiler.gni#13)
...
From [//build/config/clang/clang.gni:9](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/clang/clang.gni#9)
...
From [//build/config/BUILDCONFIG.gn:613](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#613)
...
From [//build/toolchain/ccache.gni:9](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/toolchain/ccache.gni#9)

### zedboot_cmdline_args
List of kernel command line arguments to bake into the Zedboot image.
See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/b8d610c10e76241a1e9b247df4f6934638e9c710/docs/kernel_cmdline.md) and
[`zedboot_devmgr_config`](#zedboot_devmgr_config).

**Current value (from the default):** `[]`

From [//build/images/zedboot/BUILD.gn:15](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/zedboot/BUILD.gn#15)

### zircon_build_abi_dir
Zircon build directory for `target_cpu`, containing link-time `.so.abi`
files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/b8d610c10e76241a1e9b247df4f6934638e9c710/public) libraries will link against.
This should not be a sanitizer build.

**Current value (from the default):** `"//out/build-zircon/build-arm64"`

From [//build/config/fuchsia/zircon.gni:14](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/zircon.gni#14)
...
From [//build/images/BUILD.gn:337](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#337)

### msd_intel_gen_build_root

**Current value (from the default):** `"//garnet/drivers/gpu/msd-intel-gen"`

From [//garnet/lib/magma/gnbuild/magma.gni:8](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#8)
...
From [//build/toolchain/goma.gni:9](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/toolchain/goma.gni#9)
...
From [//garnet/go/src/pm/pm.gni:14](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/go/src/pm/pm.gni#14)

### build_intel_gen

**Current value (from the default):** `false`

From [//garnet/lib/magma/gnbuild/magma.gni:23](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#23)
...
From [//garnet/lib/magma/gnbuild/magma.gni:38](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#38)
...
From [//build/sdk/sdk.gni:11](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/sdk/sdk.gni#11)
...
From [//build/images/BUILD.gn:589](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#589)
...
by an explicit install_host_tools() rule (see [//build/host.gni](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/host.gni)).

**Current value (from the default):** `"//root_build_dir/tools"`

From [//build/host.gni:13](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/host.gni#13)

### scenic_vulkan_swapchain

**Current value (from the default):** `1`

From [//garnet/lib/ui/gfx/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/ui/gfx/BUILD.gn#12)
...
From [//build/package.gni:16](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/package.gni#16)
...
From [//build/config/lto/config.gni:16](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/lto/config.gni#16)
...
From [//build/images/manifest.gni:11](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/manifest.gni#11)
...
From [//build/config/BUILD.gn:16](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILD.gn#16)

### zircon_use_asan
Set this if [`zircon_build_dir`](#zircon_build_dir) was built with
`USE_ASAN=true`, e.g. `[//scripts/build-zircon.sh](https://fuchsia.googlesource.com/scripts/+/c1228681fdfcf4d72d5528a4964417b901859aa0/build-zircon.sh) -A`.  This mainly
...
by [//scripts/fx](https://fuchsia.googlesource.com/scripts/+/c1228681fdfcf4d72d5528a4964417b901859aa0/fx) commands that rebuild Zircon so that they use `-A`
again next time.

**Current value (from the default):** `false`

From [//build/config/fuchsia/zircon.gni:40](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/zircon.gni#40)
...
From [//garnet/lib/magma/gnbuild/magma.gni:15](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#15)
...
From [//garnet/bin/ui/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/ui/BUILD.gn#12)
...
From [//build/config/fuchsia/zircon.gni:9](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/zircon.gni#9)

### amber_repository_dir
Directory containing files named by their merkleroot content IDs in
ASCII hex.  The [//build/image](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/image):pm_publish_blobs target populates
this with copies of build products, but never removes old files.

**Current value (from the default):** `"//root_build_dir/amber-files"`

From [//garnet/go/src/pm/pm.gni:11](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/go/src/pm/pm.gni#11)

### enable_sketchy_subsystem

**Current value (from the default):** `true`

From [//garnet/bin/ui/scenic/BUILD.gn:13](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/bin/ui/scenic/BUILD.gn#13)
...
From [//build/images/manifest.gni:47](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/manifest.gni#47)
...
From [//build/toolchain/goma.gni:12](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/toolchain/goma.gni#12)
...
From [//build/rust/config.gni:17](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/rust/config.gni#17)
...
From [//build/images/BUILD.gn:360](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#360)
...
From [//build/config/lto/config.gni:10](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/lto/config.gni#10)
...
From [//garnet/lib/magma/gnbuild/magma.gni:33](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#33)
...
From [//build/images/zedboot/BUILD.gn:24](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/zedboot/BUILD.gn#24)

### zircon_asserts

**Current value (from the default):** `true`

From [//build/config/fuchsia/BUILD.gn:138](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/BUILD.gn#138)
...
From [//build/images/manifest.gni:44](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/manifest.gni#44)

### build_msd_arm_mali

**Current value (from the default):** `true`

From [//garnet/lib/magma/gnbuild/magma.gni:21](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#21)
...
From [//build/images/BUILD.gn:348](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#348)
...
From [//build/config/scudo/scudo.gni:15](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/scudo/scudo.gni#15)
...
From [//build/config/BUILDCONFIG.gn:439](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/BUILDCONFIG.gn#439)

### zircon_build_root

**Current value (from the default):** `"//zircon"`

From [//garnet/lib/magma/gnbuild/magma.gni:10](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#10)
...
From [//build/images/BUILD.gn:354](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#354)
...
From [//build/gn/packages.gni:25](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/gn/packages.gni#25)
...
From [//build/images/zedboot/BUILD.gn:21](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/zedboot/BUILD.gn#21)
...
From [//build/images/BUILD.gn:605](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#605)

### build_vsl_gc

**Current value (from the default):** `true`

From [//garnet/lib/magma/gnbuild/magma.gni:22](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#22)
...
From [//build/images/crashpad.gni:9](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/crashpad.gni#9)
...
From [//build/images/BUILD.gn:602](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#602)

### glm_build_root

**Current value (from the default):** `"//third_party/glm"`

From [//garnet/lib/magma/gnbuild/magma.gni:9](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#9)

### kernel_cmdline_args
List of kernel command line arguments to bake into the boot image.
See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/b8d610c10e76241a1e9b247df4f6934638e9c710/docs/kernel_cmdline.md) and
[`devmgr_config`](#devmgr_config).

**Current value (from the default):** `[]`

From [//build/images/BUILD.gn:342](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#342)

### ledger_sync_credentials_file

**Current value (from the default):** `""`

From [//peridot/bin/ledger/testing/sync_params.gni:6](https://fuchsia.googlesource.com/peridot/+/56cb2b4880abc7243100dee81be36f939e788cb6/bin/ledger/testing/sync_params.gni#6)
...
From [//build/config/lto/config.gni:7](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/lto/config.gni#7)
...
From [//build/config/fuchsia/zircon.gni:24](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/fuchsia/zircon.gni#24)
...
From [//build/images/BUILD.gn:36](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/BUILD.gn#36)

### amber_repository_blobs_dir

**Current value (from the default):** `"//root_build_dir/amber-files/repository/blobs"`

From [//garnet/go/src/pm/pm.gni:16](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/go/src/pm/pm.gni#16)
...
From [//build/images/custom_signing.gni:10](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/custom_signing.gni#10)

### zircon_aux_manifests

**Current value (from the default):** `["//out/build-zircon/build-arm64-asan/bootfs.manifest"]`

From [//build/images/manifest.gni:32](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/images/manifest.gni#32)
...
From [//build/config/arm.gni:31](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/arm.gni#31)
...
From [//build/config/arm.gni:25](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/arm.gni#25)
...
From [//build/config/arm.gni:28](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/arm.gni#28)

### arm_version

**Current value (from the default):** `8`

From [//build/config/arm.gni:12](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/arm.gni#12)
...
From [//garnet/drivers/gpu/msd-arm-mali/src/BUILD.gn:9](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/drivers/gpu/msd-arm-mali/src/BUILD.gn#9)
...
From [//garnet/drivers/gpu/msd-arm-mali/src/BUILD.gn:13](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/drivers/gpu/msd-arm-mali/src/BUILD.gn#13)
...
From [//build/config/arm.gni:20](https://fuchsia.googlesource.com/build/+/7b3da3c4cd2001a541fd696f79752420760ab4d8/config/arm.gni#20)
...
From [//garnet/drivers/gpu/msd-intel-gen/src/BUILD.gn:8](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/drivers/gpu/msd-intel-gen/src/BUILD.gn#8)
...
From [//garnet/lib/magma/gnbuild/magma.gni:41](https://fuchsia.googlesource.com/garnet/+/7fac5197b7a5ef056c4f3e58a3282af0338729a7/lib/magma/gnbuild/magma.gni#41)
