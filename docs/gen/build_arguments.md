...
**Current value (from the default):** `true`
	From [//garnet/bin/ui/scenic/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/bin/ui/scenic/BUILD.gn#12)
...
**Current value (from the default):** `[{
  ...
  name = "release"
	...
	From [//build/config/BUILDCONFIG.gn:393](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#393)
...
**Current value (from the default):** `false`
	From [//build/config/scudo/scudo.gni:8](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/scudo/scudo.gni#8)

### zircon_build_abi_dir
Zircon build directory for `target_cpu`, containing link-time `.so.abi`
files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/4c60965b759e640fc898af512ece9ca48fa27a6c/public) libraries will link against.
This should not be a sanitizer build.

**Current value (from the default):** `"//out/build-zircon/build-arm64"`
	From [//build/config/fuchsia/zircon.gni:14](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/zircon.gni#14)

### zircon_use_asan
Set this if [`zircon_build_dir`](#zircon_build_dir) was built with
`USE_ASAN=true`, e.g. `[//scripts/build-zircon.sh](https://fuchsia.googlesource.com/scripts/+/1998dc444f74ef0fe3581c99ad85d6c44eaf9ad7/build-zircon.sh) -A`.  This mainly
...
by [//scripts/fx](https://fuchsia.googlesource.com/scripts/+/1998dc444f74ef0fe3581c99ad85d6c44eaf9ad7/fx) commands that rebuild Zircon so that they use `-A`
again next time.

**Current value (from the default):** `false`
	From [//build/config/fuchsia/zircon.gni:40](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/zircon.gni#40)
...
**Current value (from the default):** `false`
	From [//build/images/BUILD.gn:282](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#282)

### clang_prefix

**Current value (from the default):** `"../buildtools/linux-x64/clang/bin"`
	From [//build/config/clang/clang.gni:9](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/clang/clang.gni#9)
...
**Current value (from the default):** `[{
  ...
  remove_shared_configs = ["//build/config:symbol_no_undefined"]
	...
	From [//build/config/BUILDCONFIG.gn:335](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#335)
...
**Current value (from the default):** `["abort_on_error=1", "QuarantineSizeKb=0", "ThreadLocalQuarantineSizeKb=0", "DeallocationTypeMismatch=false", "DeleteSizeMismatch=false"]`
	From [//build/config/scudo/scudo.gni:15](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/scudo/scudo.gni#15)

### build_msd_arm_mali

**Current value (from the default):** `true`
	From [//garnet/lib/magma/gnbuild/magma.gni:21](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#21)

### magma_python_path

**Current value (from the default):** `"/b/s/w/ir/kitchen-workdir/third_party/mako"`
	From [//garnet/lib/magma/gnbuild/magma.gni:12](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#12)

### scenic_vulkan_swapchain

**Current value (from the default):** `1`
	From [//garnet/lib/ui/gfx/BUILD.gn:10](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/ui/gfx/BUILD.gn#10)

### use_lto
Use link time optimization (LTO).

**Current value (from the default):** `false`
	From [//build/config/lto/config.gni:7](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/lto/config.gni#7)

### zircon_aux_manifests

**Current value (from the default):** `["//out/build-zircon/build-arm64-asan/bootfs.manifest"]`
	From [//build/images/manifest.gni:32](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/manifest.gni#32)
...
**Current value (from the default):** `"misc,test"`
	From [//build/images/BUILD.gn:32](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#32)
...
**Current value (from the default):** `"10m"`
	From [//build/images/BUILD.gn:459](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#459)
...
**Current value (from the default):** `[]`
	From [//garnet/lib/magma/gnbuild/magma.gni:38](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#38)
...
**Current value (from the default):** `true`
	From [//build/config/BUILDCONFIG.gn:11](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#11)
...
a package() template invocation (see [//build/package.gni](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/package.gni)).  That scope
...
**Current value (from the default):** `[]`
	From [//build/gn/packages.gni:21](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/gn/packages.gni#21)

### toolchain_variant
*This should never be set as a build argument.*
It exists only to be set in `toolchain_args`.
See [//build/toolchain/clang_toolchain.gni](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/toolchain/clang_toolchain.gni) for details.
...
**Current value (from the default):** `{
  base = "//build/toolchain/fuchsia:arm64"
	...
	From [//build/config/BUILDCONFIG.gn:71](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#71)
...
**Current value (from the default):** `""`
	From [//build/config/fuchsia/zircon.gni:24](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/zircon.gni#24)

### amber_repository_blobs_dir

**Current value (from the default):** `"//root_build_dir/amber-files/repository/blobs"`
	From [//garnet/go/src/amber/amber.gni:16](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/go/src/amber/amber.gni#16)
...
**Current value (from the default):** `"//out/build-zircon/tools"`
	From [//build/config/fuchsia/zircon.gni:9](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/zircon.gni#9)

### rust_lto
Sets the default LTO type for rustc bulids.

**Current value (from the default):** `"unset"`
	From [//build/rust/rustc_artifact.gni:14](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/rust/rustc_artifact.gni#14)

### use_goma
Set to true to enable distributed compilation using Goma.

**Current value (from the default):** `false`
	From [//build/toolchain/goma.gni:9](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/toolchain/goma.gni#9)

### zircon_asserts

**Current value (from the default):** `true`
	From [//build/config/fuchsia/BUILD.gn:135](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/BUILD.gn#135)

### zircon_build_root

**Current value (from the default):** `"//zircon"`
	From [//garnet/lib/magma/gnbuild/magma.gni:10](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#10)

### amber_repository_dir
Directory containing files named by their merkleroot content IDs in
ASCII hex.  The [//build/image](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/image):amber_publish_blobs target populates
this with copies of build products, but never removes old files.

**Current value (from the default):** `"//root_build_dir/amber-files"`
	From [//garnet/go/src/amber/amber.gni:11](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/go/src/amber/amber.gni#11)
...
**Current value (from the default):** `""`
	From [//build/images/BUILD.gn:465](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#465)

### host_byteorder

**Current value (from the default):** `"undefined"`
	From [//build/config/host_byteorder.gni:7](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/host_byteorder.gni#7)
...
**Current value (from the default):** `"//garnet/lib/magma"`
	From [//garnet/lib/magma/gnbuild/magma.gni:6](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#6)
...
**Current value (from the default):** `[{
  ...
  name = "host_asan"
	...
	From [//build/config/BUILDCONFIG.gn:419](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#419)
...
**Current value (from the default):** `"//build/development.key"`
	From [//build/package.gni:13](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/package.gni#13)

### thinlto_jobs
Number of parallel ThinLTO jobs.

**Current value (from the default):** `8`
	From [//build/config/lto/config.gni:13](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/lto/config.gni#13)
...
**Current value (from the default):** `false`
	From [//build/toolchain/ccache.gni:9](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/toolchain/ccache.gni#9)
...
**Current value (from the default):** `false`
	From [//garnet/lib/magma/gnbuild/magma.gni:19](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#19)
...
**Overridden from the default:** `[]`
	From [//build/gn/packages.gni:8](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/gn/packages.gni#8)
...
**Current value (from the default):** `[]`
	From [//build/images/zedboot/BUILD.gn:19](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/zedboot/BUILD.gn#19)
...
**Current value (from the default):** `""`
	From [//build/config/fuchsia/zircon.gni:32](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/zircon.gni#32)
...
**Current value (from the default):** `"core"`
	From [//build/images/BUILD.gn:21](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#21)
...
**Current value (from the default):** `true`
	From [//build/config/BUILD.gn:23](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILD.gn#23)

### enable_value_subsystem

**Current value (from the default):** `false`
	From [//garnet/bin/ui/scenic/BUILD.gn:11](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/bin/ui/scenic/BUILD.gn#11)
...
by an explicit install_host_tools() rule (see [//build/host.gni](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/host.gni)).

**Current value (from the default):** `"//root_build_dir/tools"`
	From [//build/host.gni:13](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/host.gni#13)
...
**Current value (from the default):** `"//buildtools/linux-x64/rust/bin"`
	From [//build/rust/rustc_artifact.gni:11](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/rust/rustc_artifact.gni#11)
...
**Current value (from the default):** `["//garnet/public", "//peridot/public", "//topaz/public"]`
	From [//build/config/fuchsia/sdk.gni:10](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/fuchsia/sdk.gni#10)

### target_sysroot
The absolute path of the sysroot that is used with the target toolchain.

**Current value (from the default):** `""`
	From [//build/config/sysroot.gni:7](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/sysroot.gni#7)

### use_prebuilt_ffmpeg
Use a prebuilt ffmpeg binary rather than building it locally.  See
[//garnet/bin/media/media_player/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/bin/media/media_player/ffmpeg/README.md) for details.  This is
...
**Current value (from the default):** `true`
	From [//garnet/bin/media/media_player/ffmpeg/BUILD.gn:14](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/bin/media/media_player/ffmpeg/BUILD.gn#14)
...
**Current value (from the default):** `[]`
	From [//build/images/BUILD.gn:304](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#304)

### build_vsl_gc

**Current value (from the default):** `true`
	From [//garnet/lib/magma/gnbuild/magma.gni:22](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#22)
...
**Current value (from the default):** `[]`
	From [//build/images/BUILD.gn:287](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#287)

### enable_sketchy_subsystem

**Current value (from the default):** `true`
	From [//garnet/bin/ui/scenic/BUILD.gn:14](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/bin/ui/scenic/BUILD.gn#14)
...
**Current value (from the default):** `[]`
	From [//build/config/BUILDCONFIG.gn:575](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#575)
...
**Current value (from the default):** `[]`
	From [//build/config/BUILDCONFIG.gn:580](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#580)
...
**Current value (from the default):** `true`
	From [//garnet/lib/magma/gnbuild/magma.gni:33](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#33)

### amber_keys_dir
Directory containing signing keys used by amber-publish.

**Current value (from the default):** `"//garnet/go/src/amber/keys"`
	From [//garnet/go/src/amber/amber.gni:14](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/go/src/amber/amber.gni#14)
...
**Current value (from the default):** `[]`
	From [//build/config/BUILDCONFIG.gn:373](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILDCONFIG.gn#373)
...
**Current value (from the default):** `[]`
	From [//build/images/BUILD.gn:298](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#298)

### prebuilt_libvulkan_arm_path

**Current value (from the default):** `""`
	From [//garnet/lib/magma/gnbuild/magma.gni:25](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#25)
...
**Current value (from the default):** `["/b/s/w/ir/kitchen-workdir/buildtools/linux-x64/clang/lib/aarch64-fuchsia.manifest"]`
	From [//build/images/manifest.gni:11](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/manifest.gni#11)

### use_thinlto
Use ThinLTO variant of LTO if use_lto = true.

**Current value (from the default):** `true`
	From [//build/config/lto/config.gni:10](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/lto/config.gni#10)
...
**Current value (from the default):** `["netsvc.netboot=true", "virtcon.font=18x32"]`
	From [//build/images/zedboot/BUILD.gn:22](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/zedboot/BUILD.gn#22)
...
**Current value (from the default):** `"/home/swarming/goma"`
	From [//build/toolchain/goma.gni:12](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/toolchain/goma.gni#12)
...
**Current value (from the default):** `2`
	From [//build/config/BUILD.gn:13](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/BUILD.gn#13)

### thinlto_cache_dir
ThinLTO cache directory path.

**Current value (from the default):** `"thinlto-cache"`
	From [//build/config/lto/config.gni:16](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/config/lto/config.gni#16)
...
**Current value (from the default):** `true`
	From [//garnet/bin/ui/scenic/BUILD.gn:13](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/bin/ui/scenic/BUILD.gn#13)

### zedboot_cmdline_args
List of kernel command line arguments to bake into the Zedboot image.
See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/4c60965b759e640fc898af512ece9ca48fa27a6c/docs/kernel_cmdline.md) and
[`zedboot_devmgr_config`](#zedboot_devmgr_config).

**Current value (from the default):** `[]`
	From [//build/images/zedboot/BUILD.gn:13](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/zedboot/BUILD.gn#13)

### build_intel_gen

**Current value (from the default):** `false`
	From [//garnet/lib/magma/gnbuild/magma.gni:23](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#23)

### kernel_cmdline_args
List of kernel command line arguments to bake into the boot image.
See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/4c60965b759e640fc898af512ece9ca48fa27a6c/docs/kernel_cmdline.md) and
[`devmgr_config`](#devmgr_config).

**Current value (from the default):** `[]`
	From [//build/images/BUILD.gn:292](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#292)

### glm_build_root

**Current value (from the default):** `"//third_party/glm"`
	From [//garnet/lib/magma/gnbuild/magma.gni:9](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#9)
...
**Current value (from the default):** `["//out/build-zircon/build-arm64/bootfs.manifest"]`
	From [//build/images/manifest.gni:44](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/manifest.gni#44)

### expat_build_root

**Current value (from the default):** `"//third_party/expat"`
	From [//garnet/lib/magma/gnbuild/magma.gni:7](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#7)
...
**Current value (from the default):** `true`
	From [//garnet/lib/magma/gnbuild/magma.gni:15](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#15)

### msd_intel_gen_build_root

**Current value (from the default):** `"//garnet/drivers/gpu/msd-intel-gen"`
	From [//garnet/lib/magma/gnbuild/magma.gni:8](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#8)

### always_zedboot
Build boot images that prefer Zedboot over local boot.

**Current value (from the default):** `false`
	From [//build/images/BUILD.gn:468](https://fuchsia.googlesource.com/build/+/ce3321b365a8ec3def973e74595be784631548db/images/BUILD.gn#468)
...
**Current value (from the default):** `true`
	From [//garnet/drivers/gpu/msd-arm-mali/src/BUILD.gn:9](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/drivers/gpu/msd-arm-mali/src/BUILD.gn#9)
...
**Current value (from the default):** `true`
	From [//garnet/drivers/gpu/msd-arm-mali/src/BUILD.gn:13](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/drivers/gpu/msd-arm-mali/src/BUILD.gn#13)
...
**Current value (from the default):** `"//third_party/mesa"`
	From [//garnet/lib/magma/gnbuild/magma.gni:41](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/lib/magma/gnbuild/magma.gni#41)

### msd_intel_enable_mapping_cache

**Current value (from the default):** `false`
	From [//garnet/drivers/gpu/msd-intel-gen/src/BUILD.gn:8](https://fuchsia.googlesource.com/garnet/+/72371fa02b57e9c02da2d3bb5ecf00ec7b70b70b/drivers/gpu/msd-intel-gen/src/BUILD.gn#8)
