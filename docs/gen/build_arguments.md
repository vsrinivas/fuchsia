...
From [//garnet/lib/magma/gnbuild/magma.gni:10](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#10)
...
From [//garnet/lib/magma/gnbuild/magma.gni:25](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#25)
...
[//garnet/bin/mediaplayer/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/mediaplayer/ffmpeg/README.md) for details.  This is
...
From [//garnet/bin/mediaplayer/ffmpeg/BUILD.gn:14](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/mediaplayer/ffmpeg/BUILD.gn#14)
...
See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/6b0964fe57e1b90de536fd061f6ad9aedc3fe44a/docs/kernel_cmdline.md) and
...
From [//garnet/go/src/amber/amber.gni:14](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/go/src/amber/amber.gni#14)
...
From [//garnet/lib/magma/gnbuild/magma.gni:9](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#9)
...
See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/6b0964fe57e1b90de536fd061f6ad9aedc3fe44a/docs/kernel_cmdline.md) and
...
From [//garnet/public/lib/escher/BUILD.gn:15](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/public/lib/escher/BUILD.gn#15)
...
From [//garnet/lib/magma/gnbuild/magma.gni:38](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#38)

### build_msd_arm_mali

**Current value (from the default):** `true`

From [//garnet/lib/magma/gnbuild/magma.gni:21](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#21)

### magma_build_root

**Current value (from the default):** `"//garnet/lib/magma"`

From [//garnet/lib/magma/gnbuild/magma.gni:6](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#6)
...
From [//garnet/lib/magma/gnbuild/magma.gni:15](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#15)
...
From [//garnet/lib/magma/gnbuild/magma.gni:23](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#23)

### build_vsl_gc

**Current value (from the default):** `true`

From [//garnet/lib/magma/gnbuild/magma.gni:22](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#22)
...
From [//garnet/drivers/video/amlogic-decoder/BUILD.gn:10](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/drivers/video/amlogic-decoder/BUILD.gn#10)
...
`USE_ASAN=true`, e.g. `[//scripts/build-zircon.sh](https://fuchsia.googlesource.com/scripts/+/5aa87c7bb89f9baf1085305a383f6054f0fc7349/build-zircon.sh) -A`.  This mainly
...
by [//scripts/fx](https://fuchsia.googlesource.com/scripts/+/5aa87c7bb89f9baf1085305a383f6054f0fc7349/fx) commands that rebuild Zircon so that they use `-A`
again next time.
...
From [//garnet/lib/magma/gnbuild/magma.gni:33](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#33)

### magma_python_path

**Current value (from the default):** `"/b/s/w/ir/kitchen-workdir/third_party/mako"`

From [//garnet/lib/magma/gnbuild/magma.gni:12](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#12)

### msd_intel_gen_build_root

**Current value (from the default):** `"//garnet/drivers/gpu/msd-intel-gen"`

From [//garnet/lib/magma/gnbuild/magma.gni:8](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#8)
...
From [//garnet/bin/ui/scenic/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/ui/scenic/BUILD.gn#12)

### enable_sketchy_subsystem

**Current value (from the default):** `true`

From [//garnet/bin/ui/scenic/BUILD.gn:13](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/ui/scenic/BUILD.gn#13)
...
From [//garnet/lib/magma/gnbuild/magma.gni:19](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#19)
...
From [//peridot/bin/ledger/testing/sync_params.gni:6](https://fuchsia.googlesource.com/peridot/+/b8eb032416bacdb0420e6856d105e193904b2995/bin/ledger/testing/sync_params.gni#6)
...
From [//garnet/lib/magma/gnbuild/magma.gni:7](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#7)
...
From [//garnet/bin/ui/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/ui/BUILD.gn#12)
...
From [//garnet/go/src/amber/amber.gni:16](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/go/src/amber/amber.gni#16)

### enable_value_subsystem

**Current value (from the default):** `false`

From [//garnet/bin/ui/scenic/BUILD.gn:11](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/ui/scenic/BUILD.gn#11)
...
From [//garnet/go/src/amber/amber.gni:11](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/go/src/amber/amber.gni#11)

### enable_input_subsystem

**Current value (from the default):** `true`

From [//garnet/bin/ui/scenic/BUILD.gn:14](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/bin/ui/scenic/BUILD.gn#14)
...
From [//garnet/lib/ui/gfx/BUILD.gn:12](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/ui/gfx/BUILD.gn#12)
...
From [//garnet/lib/ui/gfx/BUILD.gn:16](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/ui/gfx/BUILD.gn#16)
...
files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/6b0964fe57e1b90de536fd061f6ad9aedc3fe44a/public) libraries will link against.
...
From [//garnet/drivers/gpu/msd-arm-mali/src/BUILD.gn:9](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/drivers/gpu/msd-arm-mali/src/BUILD.gn#9)
...
From [//garnet/drivers/gpu/msd-arm-mali/src/BUILD.gn:13](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/drivers/gpu/msd-arm-mali/src/BUILD.gn#13)
...
From [//garnet/lib/magma/gnbuild/magma.gni:41](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/lib/magma/gnbuild/magma.gni#41)

### msd_intel_enable_mapping_cache

**Current value (from the default):** `false`

From [//garnet/drivers/gpu/msd-intel-gen/src/BUILD.gn:8](https://fuchsia.googlesource.com/garnet/+/864cad727625794708e7409ff6ea91e9d2651076/drivers/gpu/msd-intel-gen/src/BUILD.gn#8)
