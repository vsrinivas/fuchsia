...
### zircon_build_abi_dir
 ...
 files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/8dc5df7e57e6705cb4a6b1f1ebf90943d1181825/public) libraries will link against.
...
### zedboot_cmdline_args
 ...
 See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/8dc5df7e57e6705cb4a6b1f1ebf90943d1181825/docs/kernel_cmdline.md) and
...
From [//build/gn/packages.gni:31](https://fuchsia.googlesource.com/build/+/e0e7bb6c3923b56c275cac41e385ae7fb2e2317c/gn/packages.gni#31)
...
### amber_repository_dir
 ...
 ASCII hex.  The [//build/image](https://fuchsia.googlesource.com/build/+/e0e7bb6c3923b56c275cac41e385ae7fb2e2317c/image):amber_publish_blobs target populates
 ...
 *This should never be set as a build argument.*
 ...
 See [//build/toolchain/clang_toolchain.gni](https://fuchsia.googlesource.com/build/+/e0e7bb6c3923b56c275cac41e385ae7fb2e2317c/toolchain/clang_toolchain.gni) for details.
...
### host_tools_dir
 ...
 by an explicit install_host_tools() rule (see [//build/host.gni](https://fuchsia.googlesource.com/build/+/e0e7bb6c3923b56c275cac41e385ae7fb2e2317c/host.gni)).

**Current value (from the default):** `"//root_build_dir/tools"`

### kernel_cmdline_args
 List of kernel command line arguments to bake into the boot image.
 See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/8dc5df7e57e6705cb4a6b1f1ebf90943d1181825/docs/kernel_cmdline.md) and
...
### zircon_use_asan
 ...
 `USE_ASAN=true`, e.g. `[//scripts/build-zircon.sh](https://fuchsia.googlesource.com/scripts/+/f7118983317a0303299aa9f68479bb53fc4e2b1b/build-zircon.sh) -A`.  This mainly
 ...
 by [//scripts/fx](https://fuchsia.googlesource.com/scripts/+/f7118983317a0303299aa9f68479bb53fc4e2b1b/fx) commands that rebuild Zircon so that they use `-A`
 again next time.
...
### use_prebuilt_ffmpeg
 ...
 [//garnet/bin/media/media_player/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/06b47fd94ee2ca39160b0a4113bd0ed7bdf0eeb9/bin/media/media_player/ffmpeg/README.md) for details.  This is
...
### synthesize_packages
 ...
 a package() template invocation (see [//build/package.gni](https://fuchsia.googlesource.com/build/+/e0e7bb6c3923b56c275cac41e385ae7fb2e2317c/package.gni)).  That scope
