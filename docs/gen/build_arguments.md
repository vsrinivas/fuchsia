...
### kernel_cmdline_args
 ...
 See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/e26a9b8f2621c89088215876093a0a7d3d3ec708/docs/kernel_cmdline.md) and
...
### amber_repository_dir
 ...
 ASCII hex.  The [//build/image](https://fuchsia.googlesource.com/build/+/a223b7029c536a496561d74902ddd80885934f30/image):amber_publish_blobs target populates
...
**Overridden from the default:** `[]`
	From [//build/gn/packages.gni:8](https://fuchsia.googlesource.com/build/+/a223b7029c536a496561d74902ddd80885934f30/gn/packages.gni#8)
...
### zedboot_cmdline_args
 ...
 See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/e26a9b8f2621c89088215876093a0a7d3d3ec708/docs/kernel_cmdline.md) and
 ...
 *This should never be set as a build argument.*
 ...
 See [//build/toolchain/clang_toolchain.gni](https://fuchsia.googlesource.com/build/+/a223b7029c536a496561d74902ddd80885934f30/toolchain/clang_toolchain.gni) for details.

**Current value (from the default):** `[]`

### use_prebuilt_ffmpeg
 Use a prebuilt ffmpeg binary rather than building it locally.  See
 [//garnet/bin/media/media_player/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/df40a04a384ef7e2b964d7897db9cd17d24ed156/bin/media/media_player/ffmpeg/README.md) for details.  This is
...
### host_tools_dir
 ...
 by an explicit install_host_tools() rule (see [//build/host.gni](https://fuchsia.googlesource.com/build/+/a223b7029c536a496561d74902ddd80885934f30/host.gni)).
...
### zircon_use_asan
 ...
 `USE_ASAN=true`, e.g. `[//scripts/build-zircon.sh](https://fuchsia.googlesource.com/scripts/+/112b1dfbc34fb3f3bb34bb127185c7db8751dac7/build-zircon.sh) -A`.  This mainly
 ...
 by [//scripts/fx](https://fuchsia.googlesource.com/scripts/+/112b1dfbc34fb3f3bb34bb127185c7db8751dac7/fx) commands that rebuild Zircon so that they use `-A`
 again next time.
...
### synthesize_packages
 ...
 a package() template invocation (see [//build/package.gni](https://fuchsia.googlesource.com/build/+/a223b7029c536a496561d74902ddd80885934f30/package.gni)).  That scope
...
### zircon_build_abi_dir
 ...
 files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/e26a9b8f2621c89088215876093a0a7d3d3ec708/public) libraries will link against.
