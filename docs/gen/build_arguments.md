 ...
 *This should never be set as a build argument.*
 ...
 See [//build/toolchain/clang_toolchain.gni](https://fuchsia.googlesource.com/build/+/f8ecf229f328c51f26e721ed8680f13158131dea/toolchain/clang_toolchain.gni) for details.
...
### host_tools_dir
 ...
 by an explicit install_host_tools() rule (see [//build/host.gni](https://fuchsia.googlesource.com/build/+/f8ecf229f328c51f26e721ed8680f13158131dea/host.gni)).

**Current value (from the default):** `"//root_build_dir/tools"`

### kernel_cmdline_args
 List of kernel command line arguments to bake into the boot image.
 See also [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/8b4af9240adc50c34ceccc5cba695a51dfea88c6/docs/kernel_cmdline.md) and
...
### amber_repository_dir
 ...
 ASCII hex.  The [//build/image](https://fuchsia.googlesource.com/build/+/f8ecf229f328c51f26e721ed8680f13158131dea/image):amber_publish_blobs target populates
...
### use_prebuilt_ffmpeg
 ...
 [//garnet/bin/media/media_player/ffmpeg/README.md](https://fuchsia.googlesource.com/garnet/+/6e8e7fa027e8069739b86a1055d1f13dd35958d8/bin/media/media_player/ffmpeg/README.md) for details.  This is
...
### zircon_build_abi_dir
 ...
 files that GN `deps` on [//zircon/public](https://fuchsia.googlesource.com/zircon/+/8b4af9240adc50c34ceccc5cba695a51dfea88c6/public) libraries will link against.
...
### synthesize_packages
 ...
 a package() template invocation (see [//build/package.gni](https://fuchsia.googlesource.com/build/+/f8ecf229f328c51f26e721ed8680f13158131dea/package.gni)).  That scope
...
### zedboot_cmdline_args
 ...
 See [//zircon/docs/kernel_cmdline.md](https://fuchsia.googlesource.com/zircon/+/8b4af9240adc50c34ceccc5cba695a51dfea88c6/docs/kernel_cmdline.md) and
...
### zircon_use_asan
 ...
 `USE_ASAN=true`, e.g. `[//scripts/build-zircon.sh](https://fuchsia.googlesource.com/scripts/+/7911a125f42af65f46cbe6dd0f187e8a946f9e2b/build-zircon.sh) -A`.  This mainly
 ...
 by [//scripts/fx](https://fuchsia.googlesource.com/scripts/+/7911a125f42af65f46cbe6dd0f187e8a946f9e2b/fx) commands that rebuild Zircon so that they use `-A`
 again next time.
...
From [//build/gn/packages.gni:31](https://fuchsia.googlesource.com/build/+/f8ecf229f328c51f26e721ed8680f13158131dea/gn/packages.gni#31)
