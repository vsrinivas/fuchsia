...
The [FIDL API rubric][fidl-rubric] suggests working around this
...
Replace the passage in the [FIDL rubric][rubric] that
...
This feature will be documented (and an example provided) in the [FIDL API
Readability Rubric][rubric].
