...
least significant bit zero, 16 bits handle_count](ftp-026-figure1.png)
...
bits of inline data](ftp-026-figure2.png)
...
zero and next 16 bits indicating handle_count set to 1](ftp-026-figure3.png)
...
to 1, next 31 bits reserved, next 32 bits handle_value](ftp-026-figure4.png)
...
### Encoding Sizes for Out-of-Line Envelopes
...
Since current 64-bit platforms tend to use 48 bits ([or
less][pointer-encoding]) to encode a pointer, we considered stealing more
...
[FTP-032]: ftp-032.md
[FTP-015]: ftp-015.md
[wformat-handles]: /docs/development/languages/fidl/reference/wire-format/README.md#Handles
[wformat-strings]: /docs/development/languages/fidl/reference/wire-format/README.md#Strings
[wformat-vectors]: /docs/development/languages/fidl/reference/wire-format/README.md#Vectors
...
[pointer-encoding]: http://www.alex-ionescu.com/?p=50
