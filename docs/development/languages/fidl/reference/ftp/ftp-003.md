...
For example (from [//zircon/system/host/fidl/examples/types.fidl][example-types]):
...
[example-types]: https://fuchsia.googlesource.com/fuchsia/+/master/zircon/system/host/fidl/examples/types.fidl#34
