...
* Reserved (`uint32`) OR [Epitaph value
  (zx.status)](/docs/development/languages/fidl/reference/ftp/ftp-008.md#wire-format)
* Flags (`uint32`)
* Ordinal (`uint32`)
...
![drawing](ftp-037-transaction-header.png)
...
<!-- xrefs -->
[wire-format]: /docs/development/languages/fidl/reference/wire-format
