...
{%includecode gerrit_repo="fuchsia/fuchsia" gerrit_path="src/lib/intl/example/BUILD.gn" adjust_indentation="auto" %}
...
{%includecode gerrit_repo="fuchsia/fuchsia" gerrit_path="src/lib/intl/example/BUILD.gn" region_tag="strings" adjust_indentation="auto" %}
...
{%includecode gerrit_repo="fuchsia/fuchsia" gerrit_path="src/lib/intl/example/BUILD.gn" region_tag="resources" adjust_indentation="auto" %}
