...
Many `fx` commands are wrappers around build actions in [GN](/docs/development/build/build_system/intro.md)
...
Note: For more information on supported products, see [product and board](/docs/development/build/build_system/boards_and_products.md).
