...
<pre><code class="devsite-terminal">[zxdb] as</code></pre>
...
<pre><code class="devsite-terminal">[zxdb] as 0x10b7f304d28</code></pre>
...
<pre><code class="devsite-terminal">Start              End   Size  Name<
...
<pre><code class="devsite-terminal">[zxdb] ma 0x42ff9c2fdd30
       Address               Data
...
<pre><code class="devsite-terminal">[zxdb] x -s 100 0x42ff9c2fdd30
...
<pre><code class="devsite-terminal">[zxdb] x &self->main_waker
...
<pre><code class="devsite-terminal">[zxdb] stack
      Address               Data 
...
<pre><code class="devsite-terminal">[zxdb] sym-near 0x125dd3a845e
