...
| target netsvc addr   | fe80::xxxx:xx4d:fexx:xxxx%XX | fx device-finder list --mdns=false --netboot         |
| host link-local addr | fe80::xxxx:xxxx:xxxx:xxxx%XX | fx device-finder list --ipv4=false --netboot --local |
