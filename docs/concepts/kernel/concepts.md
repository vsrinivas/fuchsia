...
exclusively via [Handles](/docs/zircon/handles.md).  In userspace, a Handle is represented as
...
slack. See [timer slack](/docs/zircon/timer_slack.md) for more information.
