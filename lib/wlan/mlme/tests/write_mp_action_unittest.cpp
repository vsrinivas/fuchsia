...
TEST(WriteMpAction, Open) {
    ...
    WriteMpOpenActionFrame(&buf.w, MacHeaderWriter(common::MacAddr("a0:a1:a2:a3:a4:a5"), &seq), a);
...
TEST(WriteMpAction, Confirm) {
    ...
    WriteMpConfirmActionFrame(&buf.w,
                              MacHeaderWriter(common::MacAddr("a0:a1:a2:a3:a4:a5"), &seq), a);
