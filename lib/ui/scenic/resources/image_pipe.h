...
#ifndef GARNET_LIB_UI_SCENIC_RESOURCES_IMAGE_PIPE_H_
#define GARNET_LIB_UI_SCENIC_RESOURCES_IMAGE_PIPE_H_
...
#endif  // GARNET_LIB_UI_SCENIC_RESOURCES_IMAGE_PIPE_H_
