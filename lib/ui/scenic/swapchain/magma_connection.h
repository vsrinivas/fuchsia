...
#ifndef GARNET_LIB_UI_SCENIC_SWAPCHAIN_MAGMA_CONNECTION_H_
#define GARNET_LIB_UI_SCENIC_SWAPCHAIN_MAGMA_CONNECTION_H_
...
#endif  // GARNET_LIB_UI_SCENIC_SWAPCHAIN_MAGMA_CONNECTION_H_
