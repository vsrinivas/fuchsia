...
#ifndef GARNET_LIB_UI_SCENIC_SWAPCHAIN_VULKAN_DISPLAY_SWAPCHAIN_H_
#define GARNET_LIB_UI_SCENIC_SWAPCHAIN_VULKAN_DISPLAY_SWAPCHAIN_H_
...
#endif  // GARNET_LIB_UI_SCENIC_SWAPCHAIN_VULKAN_DISPLAY_SWAPCHAIN_H_
