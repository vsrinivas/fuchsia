...
#ifndef GARNET_LIB_UI_SCENIC_ENGINE_HIT_TESTER_H_
#define GARNET_LIB_UI_SCENIC_ENGINE_HIT_TESTER_H_

#include <vector>

#include "garnet/lib/ui/scenic/engine/hit.h"
...
#endif  // GARNET_LIB_UI_SCENIC_ENGINE_HIT_TESTER_H_
