...
#ifndef GARNET_LIB_UI_SCENIC_ENGINE_FRAME_TIMINGS_H_
#define GARNET_LIB_UI_SCENIC_ENGINE_FRAME_TIMINGS_H_
...
#endif  // GARNET_LIB_UI_SCENIC_ENGINE_FRAME_TIMINGS_H_
