...
#ifndef GARNET_LIB_UI_SCENIC_ENGINE_UNRESOLVED_IMPORTS_H_
#define GARNET_LIB_UI_SCENIC_ENGINE_UNRESOLVED_IMPORTS_H_
...
#endif  // GARNET_LIB_UI_SCENIC_ENGINE_UNRESOLVED_IMPORTS_H_
