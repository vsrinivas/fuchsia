...
#ifndef GARNET_LIB_UI_SCENIC_DISPLAYS_DISPLAY_WATCHER_H_
#define GARNET_LIB_UI_SCENIC_DISPLAYS_DISPLAY_WATCHER_H_
...
#endif  // GARNET_LIB_UI_SCENIC_DISPLAYS_DISPLAY_WATCHER_H_
