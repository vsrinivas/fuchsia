...
#ifndef GARNET_LIB_UI_MOZART_TESTS_CLOCK_TASK_RUNNER_H_
#define GARNET_LIB_UI_MOZART_TESTS_CLOCK_TASK_RUNNER_H_
...
#endif  // GARNET_LIB_UI_MOZART_TESTS_CLOCK_TASK_RUNNER_H_
