...
#ifndef GARNET_LIB_BACKOFF_EXPONENTIAL_BACKOFF_H_
#define GARNET_LIB_BACKOFF_EXPONENTIAL_BACKOFF_H_
...
class ExponentialBackoff : public Backoff {
 public:
  ...
  ExponentialBackoff(
      fxl::TimeDelta initial_delay, uint32_t retry_factor,
...
#endif  // GARNET_LIB_BACKOFF_EXPONENTIAL_BACKOFF_H_
