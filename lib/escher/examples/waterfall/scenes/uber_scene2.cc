...
UberScene2::UberScene2(escher::VulkanContext* vulkan_context,
...
escher::Model* UberScene2::Update(const escher::Stopwatch& stopwatch,
  ...
  Object ring3b(ring_mesh1, ring3b_pos, purple_);
