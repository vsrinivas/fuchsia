...
bool MagmaConnection::ExportBufferObject(MagmaBuffer* buffer, uint32_t* buffer_handle_out)
{
    magma_system_export(sys_connection_, buffer->handle, buffer_handle_out);
    return true;
}
