...
magma_status_t magma_alloc(struct magma_connection_t* connection, uint64_t size,
...
magma_status_t magma_map(struct magma_connection_t* connection, magma_buffer_t buffer,
                                void** addr_out);
magma_status_t magma_unmap(struct magma_connection_t* connection,
...
magma_status_t magma_export(struct magma_connection_t* connection,
...
magma_status_t magma_import(struct magma_connection_t* connection,
...
// reused.
void magma_display_page_flip(struct magma_connection_t* connection,
