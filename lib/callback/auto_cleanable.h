...
#ifndef GARNET_LIB_CALLBACK_AUTO_CLEANABLE_H_
#define GARNET_LIB_CALLBACK_AUTO_CLEANABLE_H_
...
class AutoCleanableSet {
 ...
 private:
  ...
  void CheckEmpty() {
    if (set_.empty() && on_empty_callback_) on_empty_callback_();
  }
...
class AutoCleanableMap {
 ...
 private:
  void CheckEmpty() {
    if (map_.empty() && on_empty_callback_) on_empty_callback_();
  }
...
#endif  // GARNET_LIB_CALLBACK_AUTO_CLEANABLE_H_
