...
#ifndef PERIDOT_LIB_CALLBACK_OPERATION_SERIALIZER_H_
#define PERIDOT_LIB_CALLBACK_OPERATION_SERIALIZER_H_
...
#endif  // PERIDOT_LIB_CALLBACK_OPERATION_SERIALIZER_H_
