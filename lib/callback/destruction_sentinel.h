...
#ifndef PERIDOT_LIB_CALLBACK_DESTRUCTION_SENTINEL_H_
#define PERIDOT_LIB_CALLBACK_DESTRUCTION_SENTINEL_H_
...
#endif  // PERIDOT_LIB_CALLBACK_DESTRUCTION_SENTINEL_H_
