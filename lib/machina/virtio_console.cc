...
class VirtioConsole::Port {
 public:
  Port(async_dispatcher_t* dispatcher, VirtioQueue* rx_queue, VirtioQueue* tx_queue,
       zx::socket socket)
...
VirtioConsole::VirtioConsole(const PhysMem& phys_mem, async_dispatcher_t* dispatcher,
                             zx::socket socket)
