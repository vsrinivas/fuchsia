...
constexpr uint8_t kControlAndBasebandOGF = 0x03;
constexpr OpCode ControlAndBasebandOpCode(const uint16_t ocf) {
  return DefineOpCode(kControlAndBasebandOGF, ocf);
}
...
// The following is an alphabetically ordered list of HCI command and event
// declarations. Each declaration is preceded by the name of the command or
// event followed by the Bluetooth Core Specification version in which it was
// introduced. Commands that apply to a specific Bluetooth sub-technology
...
constexpr OpCode kReadClassOfDevice = ControlAndBasebandOpCode(0x0023);
...
constexpr OpCode kReadFlowControlMode = ControlAndBasebandOpCode(0x0066);
...
constexpr OpCode kReadLocalName = ControlAndBasebandOpCode(0x0014);
...
constexpr OpCode kWriteFlowControlMode = ControlAndBasebandOpCode(0x0067);
...
constexpr OpCode kWriteLocalName = ControlAndBasebandOpCode(0x0013);
