...
#define BCM_MEMORY_APERTURE_SIZE    (30ULL * 1024 * 1024 * 1024)
...
#define INTC_LOCAL_MAILBOX0_SET0 (ARM_LOCAL_BASE + 0x80)    // MAILBOX sets for core 0
#define INTC_LOCAL_MAILBOX1_SET0 (ARM_LOCAL_BASE + 0x84)
#define INTC_LOCAL_MAILBOX2_SET0 (ARM_LOCAL_BASE + 0x88)
#define INTC_LOCAL_MAILBOX3_SET0 (ARM_LOCAL_BASE + 0x8c)

#define INTC_LOCAL_MAILBOX0_SET1 (ARM_LOCAL_BASE + 0x90)    // MAILBOX sets for core 1
#define INTC_LOCAL_MAILBOX1_SET1 (ARM_LOCAL_BASE + 0x94)
#define INTC_LOCAL_MAILBOX2_SET1 (ARM_LOCAL_BASE + 0x98)
#define INTC_LOCAL_MAILBOX3_SET1 (ARM_LOCAL_BASE + 0x9c)

#define INTC_LOCAL_MAILBOX0_SET2 (ARM_LOCAL_BASE + 0xa0)    // MAILBOX sets for core 2
#define INTC_LOCAL_MAILBOX1_SET2 (ARM_LOCAL_BASE + 0xa4)
#define INTC_LOCAL_MAILBOX2_SET2 (ARM_LOCAL_BASE + 0xa8)
#define INTC_LOCAL_MAILBOX3_SET2 (ARM_LOCAL_BASE + 0xac)

#define INTC_LOCAL_MAILBOX0_SET3 (ARM_LOCAL_BASE + 0xb0)    // MAILBOX sets for core 3
#define INTC_LOCAL_MAILBOX1_SET3 (ARM_LOCAL_BASE + 0xb4)
#define INTC_LOCAL_MAILBOX2_SET3 (ARM_LOCAL_BASE + 0xb8)
#define INTC_LOCAL_MAILBOX3_SET3 (ARM_LOCAL_BASE + 0xbc)

#define INTC_LOCAL_MAILBOX0_CLR0 (ARM_LOCAL_BASE + 0xc0)    // MAILBOX clear for core 0
#define INTC_LOCAL_MAILBOX1_CLR0 (ARM_LOCAL_BASE + 0xc4)
#define INTC_LOCAL_MAILBOX2_CLR0 (ARM_LOCAL_BASE + 0xc8)
#define INTC_LOCAL_MAILBOX3_CLR0 (ARM_LOCAL_BASE + 0xcc)

#define INTC_LOCAL_MAILBOX0_CLR1 (ARM_LOCAL_BASE + 0xd0)    // MAILBOX clear for core 1
#define INTC_LOCAL_MAILBOX1_CLR1 (ARM_LOCAL_BASE + 0xd4)
#define INTC_LOCAL_MAILBOX2_CLR1 (ARM_LOCAL_BASE + 0xd8)
#define INTC_LOCAL_MAILBOX3_CLR1 (ARM_LOCAL_BASE + 0xdc)

#define INTC_LOCAL_MAILBOX0_CLR2 (ARM_LOCAL_BASE + 0xe0)    // MAILBOX clear for core 2
#define INTC_LOCAL_MAILBOX1_CLR2 (ARM_LOCAL_BASE + 0xe4)
#define INTC_LOCAL_MAILBOX2_CLR2 (ARM_LOCAL_BASE + 0xe8)
#define INTC_LOCAL_MAILBOX3_CLR2 (ARM_LOCAL_BASE + 0xec)

#define INTC_LOCAL_MAILBOX0_CLR3 (ARM_LOCAL_BASE + 0xf0)    // MAILBOX clear for core 3
#define INTC_LOCAL_MAILBOX1_CLR3 (ARM_LOCAL_BASE + 0xf4)
#define INTC_LOCAL_MAILBOX2_CLR3 (ARM_LOCAL_BASE + 0xf8)
#define INTC_LOCAL_MAILBOX3_CLR3 (ARM_LOCAL_BASE + 0xfc)
