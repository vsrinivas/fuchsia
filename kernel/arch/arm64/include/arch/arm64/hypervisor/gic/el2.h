...
extern uint32_t arm64_el2_gicv3_read_gich_apr(uint32_t idx, uint8_t grp);
extern void arm64_el2_gicv3_write_gich_apr(uint32_t val, uint32_t idx, uint8_t grp);
...
extern uint64_t arm64_el2_gicv3_read_gich_lr(uint32_t idx);
extern void arm64_el2_gicv3_write_gich_lr(uint64_t val, uint32_t idx);
