...
public:
    ...
    mx_ssize_t Read(mxtl::user_ptr<void> user_data, mx_size_t length, uint64_t offset);
    mx_ssize_t Write(mxtl::user_ptr<const void> user_data, mx_size_t length, uint64_t offset);
