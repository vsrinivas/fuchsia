...
bool named_ctor_exact(void* context) {
    ...
    mxtl::Name<Size> name(expected_name, Size);
    name.get(sizeof(out), out);
...
bool named_ctor_overflow(void* context) {
    ...
    mxtl::Name<Size> name(expected_name, overflow_size);
    name.get(sizeof(out), out);
...
bool output_buffer_size(void* context) {
    ...
    mxtl::Name<NameSize> name(expected_name, sizeof(expected_name));
