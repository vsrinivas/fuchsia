...
// Usage Notes:
//
// utils::SinglyLinkedList<> is a templated intrusive container class which
...
//
// class Foo : public utils::SinglyLinkedListable<Foo*> {
//      ...
// };
//
// void Test() {
//     utils::SinglyLinkedList<Foo*> list;
//
...
//
// class Foo : public utils::SinglyLinkedListable<unique_ptr<Foo>> {
//      ...
// };
//
// void Test() {
//     utils::SinglyLinkedList<unique_ptr<Foo>> list;
//
//     for (size_t i = 0; SOME_NUMBER; ++i) {
//         unique_ptr<Foo> new_foo(new Foo(...));
//         list.push_front(utils::move(new_foo));
//     }
//
//     for (const auto& foo : list)
//         foo.print();
...
//
// class Foo : public utils::SinglyLinkedListable<utils::RefPtr<Foo>>
//           , public utils::RefCounted<Foo> {
// public:
...
//
// void Test() {
//     using DefaultList = utils::SinglyLinkedList<utils::RefPtr<Foo>>;
//     using TypeAList   = utils::SinglyLinkedList<utils::RefPtr<Foo>, Foo:TypeATraits>;
//     using TypeBList   = utils::SinglyLinkedList<utils::RefPtr<Foo>, Foo:TypeBTraits>;
//
...
//         }
//
//         default_list.push_front(utils::move(new_foo));
//     }
//
