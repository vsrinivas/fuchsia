...
zx_status_t sys_futex_wait(user_inout_ptr<zx_futex_t> value_ptr, int current_value, zx_time_t deadline) {
...
zx_status_t sys_futex_requeue(user_inout_ptr<zx_futex_t> wake_ptr, uint32_t wake_count, int current_value,
                              user_inout_ptr<zx_futex_t> requeue_ptr, uint32_t requeue_count) {
