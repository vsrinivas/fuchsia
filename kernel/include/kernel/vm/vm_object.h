...
public:
    ...
    virtual vm_page_t* GetPageLocked(uint64_t offset) = 0;
    ...
    virtual vm_page_t* FaultPageLocked(uint64_t offset, uint pf_flags) = 0;
...
public:
    ...
    virtual vm_page_t* GetPageLocked(uint64_t offset);
    virtual vm_page_t* FaultPageLocked(uint64_t offset, uint pf_flags);
