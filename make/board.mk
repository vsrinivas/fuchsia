...
$(BOARD_ZIRCON_BOOTIMAGE): BOARD_BOOT_SHIM_OPTS:=$(BOARD_BOOT_SHIM_OPTS)

# prepend shim to the zircon bootimage
$(BOARD_ZIRCON_BOOTIMAGE): $(MKBOOTFS) $(ZIRCON_BOOTIMAGE) $(BOOT_SHIM_BIN)
	$(call BUILDECHO,generating $@)
	@$(MKDIR)
	$(NOECHO)$(MKBOOTFS) -o $@ $(ZIRCON_BOOTIMAGE) $(BOARD_BOOT_SHIM_OPTS)
