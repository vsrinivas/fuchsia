...
$(MODULE_FIDL_COBJS): MODULE_COMPILEFLAGS:=$(MODULE_COMPILEFLAGS) -Isystem/ulib/fidl/include $(foreach dep,$(MODULE_FIDL_DEPS),-I$(MODULE_FIDL_INCLUDE_$(dep))) -I$(MODULE_FIDL_INCLUDE)
...
$(MODULE_FIDL_CPPOBJS): MODULE_COMPILEFLAGS:=$(MODULE_COMPILEFLAGS) -Isystem/ulib/fidl/include $(foreach dep,$(MODULE_FIDL_DEPS),-I$(MODULE_FIDL_INCLUDE_$(dep))) -I$(MODULE_FIDL_INCLUDE)
