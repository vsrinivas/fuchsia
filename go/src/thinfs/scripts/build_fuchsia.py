...
def main():
  ...
  parser.add_argument('--fuchsia_root', help='Path to root of Fuchsia project',
                      required=True)
  parser.add_argument('--go_binary', help='Path to go binary which can compile Fuchsia programs',
                      required=True)
