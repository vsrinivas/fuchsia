...
//! Representation of the product_bundle metadata independent of whether it's in
//! a product bundle or product bundle container. This is similar to common.rs,
//! with a focus on product bundle data.
