...
//! Version 1 of the Product Bundle format.
//!
//! This format uses json-schemas to validate the result, and implements RFC-0100
...
mod tests {
    ...
    fn test_validation_minimal() {
        let pb: ProductBundleV1 = from_value(json!({
            "name": "generic-x64",
            "type": "product_bundle",
