...
#define ZXC_DM (builtincmd + 10)
#define ZXC_DUMP (builtincmd + 11)
#define ZXC_K (builtincmd + 21)
#define ZXC_LIST (builtincmd + 22)
#define ZXC_LS (builtincmd + 24)
#define ZXC_MKDIR (builtincmd + 25)
