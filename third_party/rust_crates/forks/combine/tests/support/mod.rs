    ...
    R: Unpin,
{
    ...
    {
        PartialAsyncRead { inner, ops: Box::new(ops.into_iter()) }
    }
}
        ...
        match self.ops.next() {
            ...
            Some(PartialOp::Err(err)) => {
                if err == io::ErrorKind::WouldBlock {
                    ...
                    Err(io::Error::new(err, "error during read, generated by partial-io")).into()
                }
            }
    ...
    R: crate::futures::io::AsyncRead + Unpin,
{
    ...
    where
        ...
        I::IntoIter: Send + 'static,
    {
        FuturesPartialAsyncRead { inner, ops: Box::new(ops.into_iter()) }
    }
}
