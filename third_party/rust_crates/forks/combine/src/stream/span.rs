        ...
        StreamErrorInto<S::Token, S::Range>,
{
    ...
    fn reset(&mut self, checkpoint: Self::Checkpoint) -> Result<(), Self::Error> {
        self.0.reset(checkpoint).map_err(ParseErrorInto::into_other_error)
    }
}
        ...
        StreamErrorInto<S::Token, S::Range>,
{
    ...
    fn uncons_range(&mut self, size: usize) -> Result<Self::Range, StreamErrorFor<Self>> {
        self.0.uncons_range(size).map_err(StreamErrorInto::into_other_error)
    }
    ...
    {
        self.0.uncons_while(f).map_err(StreamErrorInto::into_other_error)
    }
    ...
    where
        F: FnMut(Self::Token) -> bool,
    {
        self.0.uncons_while1(f).map_err(StreamErrorInto::into_other_error)
    }
