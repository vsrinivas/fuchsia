...
extern "C" {
    pub fn ubrk_openBinaryRules_64(
...
extern "C" {
    pub fn ubrk_close_64(bi: *mut UBreakIterator);
}
extern "C" {
    pub fn ubrk_setText_64(
...
extern "C" {
    pub fn ubrk_setUText_64(bi: *mut UBreakIterator, text: *mut UText, status: *mut UErrorCode);
}
extern "C" {
    pub fn ubrk_current_64(bi: *const UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_next_64(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_previous_64(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_first_64(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_last_64(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_preceding_64(bi: *mut UBreakIterator, offset: i32) -> i32;
}
extern "C" {
    pub fn ubrk_following_64(bi: *mut UBreakIterator, offset: i32) -> i32;
}
extern "C" {
    pub fn ubrk_getAvailable_64(index: i32) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn ubrk_countAvailable_64() -> i32;
}
extern "C" {
    pub fn ubrk_isBoundary_64(bi: *mut UBreakIterator, offset: i32) -> UBool;
}
extern "C" {
    pub fn ubrk_getRuleStatus_64(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_getRuleStatusVec_64(
        bi: *mut UBreakIterator,
        fillInVec: *mut i32,
        capacity: i32,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn ubrk_getLocaleByType_64(
        bi: *const UBreakIterator,
...
extern "C" {
    pub fn ubrk_refreshUText_64(bi: *mut UBreakIterator, text: *mut UText, status: *mut UErrorCode);
}
extern "C" {
    pub fn ubrk_getBinaryRules_64(
        bi: *mut UBreakIterator,
        binaryRules: *mut u8,
        rulesCapacity: i32,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn udatpg_open_64(
        locale: *const ::std::os::raw::c_char,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UDateTimePatternGenerator;
}
extern "C" {
    pub fn udatpg_openEmpty_64(pErrorCode: *mut UErrorCode) -> *mut UDateTimePatternGenerator;
}
extern "C" {
    pub fn udatpg_close_64(dtpg: *mut UDateTimePatternGenerator);
}
extern "C" {
    pub fn udatpg_clone_64(
        dtpg: *const UDateTimePatternGenerator,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UDateTimePatternGenerator;
}
extern "C" {
    pub fn udatpg_getBestPattern_64(
...
extern "C" {
    pub fn udatpg_getBestPatternWithOptions_64(
        dtpg: *mut UDateTimePatternGenerator,
        skeleton: *const UChar,
        length: i32,
...
extern "C" {
    pub fn udatpg_getBaseSkeleton_64(
        unusedDtpg: *mut UDateTimePatternGenerator,
        pattern: *const UChar,
        length: i32,
...
extern "C" {
    pub fn udatpg_setAppendItemFormat_64(
        dtpg: *mut UDateTimePatternGenerator,
...
extern "C" {
    pub fn udatpg_getAppendItemFormat_64(
        dtpg: *const UDateTimePatternGenerator,
        field: UDateTimePatternField,
        pLength: *mut i32,
    ) -> *const UChar;
...
extern "C" {
    pub fn udatpg_setAppendItemName_64(
        dtpg: *mut UDateTimePatternGenerator,
        field: UDateTimePatternField,
        value: *const UChar,
        length: i32,
...
extern "C" {
    pub fn udatpg_getAppendItemName_64(
        dtpg: *const UDateTimePatternGenerator,
        field: UDateTimePatternField,
        pLength: *mut i32,
    ) -> *const UChar;
...
extern "C" {
    pub fn udatpg_getFieldDisplayName_64(
        dtpg: *const UDateTimePatternGenerator,
        field: UDateTimePatternField,
...
extern "C" {
    pub fn udatpg_setDateTimeFormat_64(
        dtpg: *const UDateTimePatternGenerator,
...
extern "C" {
    pub fn udatpg_getDateTimeFormat_64(
        dtpg: *const UDateTimePatternGenerator,
        pLength: *mut i32,
    ) -> *const UChar;
}
extern "C" {
    pub fn udatpg_setDecimal_64(
        dtpg: *mut UDateTimePatternGenerator,
        decimal: *const UChar,
        length: i32,
    );
...
extern "C" {
    pub fn udatpg_getDecimal_64(
        dtpg: *const UDateTimePatternGenerator,
        pLength: *mut i32,
    ) -> *const UChar;
}
extern "C" {
    pub fn udatpg_replaceFieldTypes_64(
        dtpg: *mut UDateTimePatternGenerator,
        pattern: *const UChar,
        patternLength: i32,
        skeleton: *const UChar,
...
extern "C" {
    pub fn udatpg_replaceFieldTypesWithOptions_64(
        dtpg: *mut UDateTimePatternGenerator,
        pattern: *const UChar,
        patternLength: i32,
        skeleton: *const UChar,
...
extern "C" {
    pub fn udatpg_openSkeletons_64(
        dtpg: *const UDateTimePatternGenerator,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UEnumeration;
}
extern "C" {
    pub fn udatpg_openBaseSkeletons_64(
        dtpg: *const UDateTimePatternGenerator,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UEnumeration;
}
extern "C" {
    pub fn udatpg_getPatternForSkeleton_64(
        dtpg: *const UDateTimePatternGenerator,
        skeleton: *const UChar,
        skeletonLength: i32,
        pLength: *mut i32,
...
extern "C" {
    pub fn utrans_openInverse_64(
        trans: *const UTransliterator,
        status: *mut UErrorCode,
    ) -> *mut UTransliterator;
}
extern "C" {
    pub fn utrans_clone_64(
        trans: *const UTransliterator,
        status: *mut UErrorCode,
    ) -> *mut UTransliterator;
}
extern "C" {
    pub fn utrans_close_64(trans: *mut UTransliterator);
}
extern "C" {
    pub fn utrans_getUnicodeID_64(
        trans: *const UTransliterator,
        resultLength: *mut i32,
    ) -> *const UChar;
}
extern "C" {
    pub fn utrans_register_64(adoptedTrans: *mut UTransliterator, status: *mut UErrorCode);
}
extern "C" {
    pub fn utrans_unregisterID_64(id: *const UChar, idLength: i32);
}
extern "C" {
    pub fn utrans_setFilter_64(
...
extern "C" {
    pub fn utrans_countAvailableIDs_64() -> i32;
}
extern "C" {
    pub fn utrans_openIDs_64(pErrorCode: *mut UErrorCode) -> *mut UEnumeration;
}
extern "C" {
    pub fn utrans_trans_64(
        trans: *const UTransliterator,
...
extern "C" {
    pub fn utrans_transIncremental_64(
        trans: *const UTransliterator,
        rep: *mut UReplaceable,
        repFunc: *const UReplaceableCallbacks,
...
extern "C" {
    pub fn utrans_transIncrementalUChars_64(
        trans: *const UTransliterator,
        text: *mut UChar,
        textLength: *mut i32,
        textCapacity: i32,
...
extern "C" {
    pub fn utrans_unregister_64(id: *const ::std::os::raw::c_char);
}
extern "C" {
    pub fn utrans_getAvailableID_64(
        index: i32,
        buf: *mut ::std::os::raw::c_char,
        bufCapacity: i32,
    ) -> i32;
