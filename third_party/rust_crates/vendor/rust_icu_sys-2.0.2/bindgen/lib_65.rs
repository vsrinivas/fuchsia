...
extern "C" {
    pub fn ubrk_openBinaryRules_65(
...
extern "C" {
    pub fn ubrk_close_65(bi: *mut UBreakIterator);
}
extern "C" {
    pub fn ubrk_setText_65(
...
extern "C" {
    pub fn ubrk_setUText_65(bi: *mut UBreakIterator, text: *mut UText, status: *mut UErrorCode);
}
extern "C" {
    pub fn ubrk_current_65(bi: *const UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_next_65(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_previous_65(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_first_65(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_last_65(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_preceding_65(bi: *mut UBreakIterator, offset: i32) -> i32;
}
extern "C" {
    pub fn ubrk_following_65(bi: *mut UBreakIterator, offset: i32) -> i32;
}
extern "C" {
    pub fn ubrk_getAvailable_65(index: i32) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn ubrk_countAvailable_65() -> i32;
}
extern "C" {
    pub fn ubrk_isBoundary_65(bi: *mut UBreakIterator, offset: i32) -> UBool;
}
extern "C" {
    pub fn ubrk_getRuleStatus_65(bi: *mut UBreakIterator) -> i32;
}
extern "C" {
    pub fn ubrk_getRuleStatusVec_65(
        bi: *mut UBreakIterator,
        fillInVec: *mut i32,
        capacity: i32,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn ubrk_getLocaleByType_65(
        bi: *const UBreakIterator,
...
extern "C" {
    pub fn ubrk_refreshUText_65(bi: *mut UBreakIterator, text: *mut UText, status: *mut UErrorCode);
}
extern "C" {
    pub fn ubrk_getBinaryRules_65(
        bi: *mut UBreakIterator,
        binaryRules: *mut u8,
        rulesCapacity: i32,
        status: *mut UErrorCode,
...
extern "C" {
    pub fn udatpg_open_65(
        locale: *const ::std::os::raw::c_char,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UDateTimePatternGenerator;
}
extern "C" {
    pub fn udatpg_openEmpty_65(pErrorCode: *mut UErrorCode) -> *mut UDateTimePatternGenerator;
}
extern "C" {
    pub fn udatpg_close_65(dtpg: *mut UDateTimePatternGenerator);
}
extern "C" {
    pub fn udatpg_clone_65(
        dtpg: *const UDateTimePatternGenerator,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UDateTimePatternGenerator;
}
extern "C" {
    pub fn udatpg_getBestPattern_65(
...
extern "C" {
    pub fn udatpg_getBestPatternWithOptions_65(
        dtpg: *mut UDateTimePatternGenerator,
        skeleton: *const UChar,
        length: i32,
...
extern "C" {
    pub fn udatpg_getBaseSkeleton_65(
        unusedDtpg: *mut UDateTimePatternGenerator,
        pattern: *const UChar,
        length: i32,
...
extern "C" {
    pub fn udatpg_setAppendItemFormat_65(
        dtpg: *mut UDateTimePatternGenerator,
...
extern "C" {
    pub fn udatpg_getAppendItemFormat_65(
        dtpg: *const UDateTimePatternGenerator,
        field: UDateTimePatternField,
        pLength: *mut i32,
    ) -> *const UChar;
...
extern "C" {
    pub fn udatpg_setAppendItemName_65(
        dtpg: *mut UDateTimePatternGenerator,
        field: UDateTimePatternField,
        value: *const UChar,
        length: i32,
...
extern "C" {
    pub fn udatpg_getAppendItemName_65(
        dtpg: *const UDateTimePatternGenerator,
        field: UDateTimePatternField,
        pLength: *mut i32,
    ) -> *const UChar;
...
extern "C" {
    pub fn udatpg_getFieldDisplayName_65(
        dtpg: *const UDateTimePatternGenerator,
        field: UDateTimePatternField,
...
extern "C" {
    pub fn udatpg_setDateTimeFormat_65(
        dtpg: *const UDateTimePatternGenerator,
...
extern "C" {
    pub fn udatpg_getDateTimeFormat_65(
        dtpg: *const UDateTimePatternGenerator,
        pLength: *mut i32,
    ) -> *const UChar;
}
extern "C" {
    pub fn udatpg_setDecimal_65(
        dtpg: *mut UDateTimePatternGenerator,
        decimal: *const UChar,
        length: i32,
    );
...
extern "C" {
    pub fn udatpg_getDecimal_65(
        dtpg: *const UDateTimePatternGenerator,
        pLength: *mut i32,
    ) -> *const UChar;
}
extern "C" {
    pub fn udatpg_replaceFieldTypes_65(
        dtpg: *mut UDateTimePatternGenerator,
        pattern: *const UChar,
        patternLength: i32,
        skeleton: *const UChar,
...
extern "C" {
    pub fn udatpg_replaceFieldTypesWithOptions_65(
        dtpg: *mut UDateTimePatternGenerator,
        pattern: *const UChar,
        patternLength: i32,
        skeleton: *const UChar,
...
extern "C" {
    pub fn udatpg_openSkeletons_65(
        dtpg: *const UDateTimePatternGenerator,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UEnumeration;
}
extern "C" {
    pub fn udatpg_openBaseSkeletons_65(
        dtpg: *const UDateTimePatternGenerator,
        pErrorCode: *mut UErrorCode,
    ) -> *mut UEnumeration;
}
extern "C" {
    pub fn udatpg_getPatternForSkeleton_65(
        dtpg: *const UDateTimePatternGenerator,
        skeleton: *const UChar,
        skeletonLength: i32,
        pLength: *mut i32,
...
extern "C" {
    pub fn utrans_openInverse_65(
        trans: *const UTransliterator,
        status: *mut UErrorCode,
    ) -> *mut UTransliterator;
}
extern "C" {
    pub fn utrans_clone_65(
        trans: *const UTransliterator,
        status: *mut UErrorCode,
    ) -> *mut UTransliterator;
}
extern "C" {
    pub fn utrans_close_65(trans: *mut UTransliterator);
}
extern "C" {
    pub fn utrans_getUnicodeID_65(
        trans: *const UTransliterator,
        resultLength: *mut i32,
    ) -> *const UChar;
}
extern "C" {
    pub fn utrans_register_65(adoptedTrans: *mut UTransliterator, status: *mut UErrorCode);
}
extern "C" {
    pub fn utrans_unregisterID_65(id: *const UChar, idLength: i32);
}
extern "C" {
    pub fn utrans_setFilter_65(
...
extern "C" {
    pub fn utrans_countAvailableIDs_65() -> i32;
}
extern "C" {
    pub fn utrans_openIDs_65(pErrorCode: *mut UErrorCode) -> *mut UEnumeration;
}
extern "C" {
    pub fn utrans_trans_65(
        trans: *const UTransliterator,
...
extern "C" {
    pub fn utrans_transIncremental_65(
        trans: *const UTransliterator,
        rep: *mut UReplaceable,
        repFunc: *const UReplaceableCallbacks,
...
extern "C" {
    pub fn utrans_transIncrementalUChars_65(
        trans: *const UTransliterator,
        text: *mut UChar,
        textLength: *mut i32,
        textCapacity: i32,
...
extern "C" {
    pub fn utrans_unregister_65(id: *const ::std::os::raw::c_char);
}
extern "C" {
    pub fn utrans_getAvailableID_65(
        index: i32,
        buf: *mut ::std::os::raw::c_char,
        bufCapacity: i32,
    ) -> i32;
