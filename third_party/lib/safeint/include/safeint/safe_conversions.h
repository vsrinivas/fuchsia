...
template <typename T>
constexpr typename utils::enable_if<utils::numeric_limits<T>::is_signed, bool>::type
IsValueNegative(T value) {
  static_assert(utils::numeric_limits<T>::is_specialized,
                "Argument must be numeric.");
  return value < 0;
}

template <typename T>
constexpr typename utils::enable_if<!utils::numeric_limits<T>::is_signed,
...
inline Dst saturated_cast(Src value) {
  switch (internal::DstRangeRelationToSrcRange<Dst>(value)) {
    ...
    case internal::RANGE_UNDERFLOW:
      return utils::numeric_limits<Dst>::min();

    case internal::RANGE_OVERFLOW:
      return utils::numeric_limits<Dst>::max();
...
inline constexpr Dst strict_cast(Src value) {
  static_assert(utils::numeric_limits<Src>::is_specialized,
                "Argument must be numeric.");
  static_assert(utils::numeric_limits<Dst>::is_specialized,
