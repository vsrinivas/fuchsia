...
#ifndef GARNET_DRIVERS_GPU_MSD_ARM_MALI_INCLUDE_MAGMA_VENDOR_QUERIES_H_
#define GARNET_DRIVERS_GPU_MSD_ARM_MALI_INCLUDE_MAGMA_VENDOR_QUERIES_H_
...
#endif  // GARNET_DRIVERS_GPU_MSD_ARM_MALI_INCLUDE_MAGMA_VENDOR_QUERIES_H_
