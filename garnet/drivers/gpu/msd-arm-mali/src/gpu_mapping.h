...
#ifndef GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_GPU_MAPPING_H_
#define GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_GPU_MAPPING_H_
...
#endif  // GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_GPU_MAPPING_H_
