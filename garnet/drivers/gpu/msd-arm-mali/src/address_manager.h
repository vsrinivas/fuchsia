...
#ifndef GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_ADDRESS_MANAGER_H_
#define GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_ADDRESS_MANAGER_H_
...
#endif  // GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_ADDRESS_MANAGER_H_
