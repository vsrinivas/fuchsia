...
#ifndef GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_MSD_ARM_ATOM_H_
#define GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_MSD_ARM_ATOM_H_
...
#endif  // GARNET_DRIVERS_GPU_MSD_ARM_MALI_SRC_MSD_ARM_ATOM_H_
