...
#ifndef GARNET_DRIVERS_GPU_MSD_VSL_GC_SRC_PAGE_TABLE_SLOT_ALLOCATOR_H_
#define GARNET_DRIVERS_GPU_MSD_VSL_GC_SRC_PAGE_TABLE_SLOT_ALLOCATOR_H_
...
#endif  // GARNET_DRIVERS_GPU_MSD_VSL_GC_SRC_PAGE_TABLE_SLOT_ALLOCATOR_H_
