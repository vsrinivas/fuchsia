...
std::vector<std::pair<uint32_t, uint32_t>> TestQcomDevice::sparse_register_dump = {
    ...
    {0x00002020, 0x00000001}, {0x000020c0, 0x01000000}, {0x000020c4, 0x00000000},
    ...
    {0x00002160, 0x8000050e}, {0x00002164, 0x0000050f}, {0x00002168, 0x80000510},
    {0x0000216c, 0x13e40000}, {0x00002170, 0x00280501}, {0x00002174, 0x01100511},
    {0x00002178, 0x80380e00}, {0x0000217c, 0x80008e00}, {0x00002180, 0x803c8e50},
    {0x00002184, 0x8000be02}, {0x00002188, 0xc7ccbe20}, {0x0000218c, 0x82080800},
    {0x00002190, 0x802008a0}, {0x00002194, 0x806408ab}, {0x00002198, 0x81340900},
    {0x0000219c, 0x81d8098d}, {0x000021a0, 0x00100980}, {0x000021a4, 0x8000a630},
    {0x00002304, 0x8040362c}, {0x00002308, 0x010000c0}, {0x0000230c, 0x00000080},
    {0x00002340, 0x00000000}, {0x00002634, 0x00000001}, {0x00003804, 0x00400000},
    {0x00003814, 0xffffffc0}, {0x00003818, 0x0001ffff}, {0x0000381c, 0xfffff000},
    {0x00003820, 0x0001ffff}, {0x00003824, 0xfffff000}, {0x00003828, 0x0001ffff},
    {0x0000382c, 0x00100000}, {0x00003830, 0x00000000}, {0x00003834, 0x001fffff},
    {0x00003838, 0x00000000}, {0x0000385c, 0x00000004}, {0x00003860, 0x00000804},
    {0x00003864, 0x00000001}, {0x0000c0a8, 0x00000009}, {0x00023820, 0x00000004},
    {0x00027800, 0x00180000}, {0x0002b808, 0x00000004}, {0x0002d810, 0x00000004},
    {0x0003e000, 0x00000000}, {0x0003e004, 0x00000000}, {0x0003e008, 0x00000000},
    {0x0003e00c, 0x00000000},
};
