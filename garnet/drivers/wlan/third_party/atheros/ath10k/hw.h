...
#ifndef GARNET_DRIVERS_WLAN_THIRD_PARTY_ATHEROS_ATH10K_HW_H_
#define GARNET_DRIVERS_WLAN_THIRD_PARTY_ATHEROS_ATH10K_HW_H_
...
struct ath10k_hw_params {
    ...
    uint16_t dev_id;
    const char* name;
    uint32_t patch_load_addr;
    int uart_pin;
    uint32_t otp_exe_param;
    ...
    uint32_t channel_counters_freq_hz;

    /* Mgmt tx descriptors threshold for limiting probe response
     * frames.
     */
    uint32_t max_probe_resp_desc_thres;
