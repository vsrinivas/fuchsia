...
#ifndef GARNET_DRIVERS_WLAN_THIRD_PARTY_ATHEROS_ATH10K_RX_DESC_H_
#define GARNET_DRIVERS_WLAN_THIRD_PARTY_ATHEROS_ATH10K_RX_DESC_H_
...
#define RX_MSDU_START_INFO2_DA_BCAST_MCAST      (1 << 11)
...
#define RX_MSDU_END_INFO1_IRO_ELIGIBLE      (1 << 9)
...
#define RX_PPDU_START_RATE_FLAG (1 << 3)
...
#define RX_PPDU_END_INFO1_BB_DATA             (1 << 0)
#define RX_PPDU_END_INFO1_PEER_IDX_VALID      (1 << 1)
...
#define RX_PPDU_END_RTT_NORMAL_MODE            (1 << 31)
...
#define RX_PKT_END_INFO0_RX_SUCCESS              (1 << 0)
#define RX_PKT_END_INFO0_ERR_TX_INTERRUPT_RX     (1 << 3)
#define RX_PKT_END_INFO0_ERR_OFDM_POWER_DROP     (1 << 4)
#define RX_PKT_END_INFO0_ERR_OFDM_RESTART        (1 << 5)
#define RX_PKT_END_INFO0_ERR_CCK_POWER_DROP      (1 << 6)
#define RX_PKT_END_INFO0_ERR_CCK_RESTART         (1 << 7)
...
#define RX_LOCATION_INFO_CIR_STATUS              (1 << 17)
#define RX_LOCATION_INFO_RTT_MAC_PHY_PHASE       (1 << 25)
#define RX_LOCATION_INFO_RTT_TX_DATA_START_X     (1 << 26)
#define RX_LOCATION_INFO_HW_IFFT_MODE            (1 << 30)
#define RX_LOCATION_INFO_RX_LOCATION_VALID       (1 << 31)
...
#define RX_LOCATION_INFO0_RTT_FAC_LEGACY_STATUS     (1 << 14)
#define RX_LOCATION_INFO0_RTT_FAC_VHT_STATUS        (1 << 29)
...
#define RX_LOCATION_INFO1_RTT_CFR_STATUS            (1 << 0)
#define RX_LOCATION_INFO1_RTT_CIR_STATUS            (1 << 1)
#define RX_LOCATION_INFO1_RTT_GI_TYPE               (1 << 7)
#define RX_LOCATION_INFO1_RTT_MAC_PHY_PHASE         (1 << 29)
#define RX_LOCATION_INFO1_RTT_TX_DATA_START_X_PHASE (1 << 30)
#define RX_LOCATION_INFO1_RX_LOCATION_VALID         (1 << 31)
...
enum rx_phy_ppdu_end_info0 {
    RX_PHY_PPDU_END_INFO0_ERR_RADAR           = (1 << 2),
    RX_PHY_PPDU_END_INFO0_ERR_RX_ABORT        = (1 << 3),
    RX_PHY_PPDU_END_INFO0_ERR_RX_NAP          = (1 << 4),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_TIMING     = (1 << 5),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_PARITY     = (1 << 6),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_RATE       = (1 << 7),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_LENGTH     = (1 << 8),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_RESTART    = (1 << 9),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_SERVICE    = (1 << 10),
    RX_PHY_PPDU_END_INFO0_ERR_OFDM_POWER_DROP = (1 << 11),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_BLOCKER     = (1 << 12),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_TIMING      = (1 << 13),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_HEADER_CRC  = (1 << 14),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_RATE        = (1 << 15),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_LENGTH      = (1 << 16),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_RESTART     = (1 << 17),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_SERVICE     = (1 << 18),
    RX_PHY_PPDU_END_INFO0_ERR_CCK_POWER_DROP  = (1 << 19),
    RX_PHY_PPDU_END_INFO0_ERR_HT_CRC          = (1 << 20),
    RX_PHY_PPDU_END_INFO0_ERR_HT_LENGTH       = (1 << 21),
    RX_PHY_PPDU_END_INFO0_ERR_HT_RATE         = (1 << 22),
    RX_PHY_PPDU_END_INFO0_ERR_HT_ZLF          = (1 << 23),
    RX_PHY_PPDU_END_INFO0_ERR_FALSE_RADAR_EXT = (1 << 24),
    RX_PHY_PPDU_END_INFO0_ERR_GREEN_FIELD     = (1 << 25),
    RX_PHY_PPDU_END_INFO0_ERR_SPECTRAL_SCAN   = (1 << 26),
    RX_PHY_PPDU_END_INFO0_ERR_RX_DYN_BW       = (1 << 27),
    RX_PHY_PPDU_END_INFO0_ERR_LEG_HT_MISMATCH = (1 << 28),
    RX_PHY_PPDU_END_INFO0_ERR_VHT_CRC         = (1 << 29),
    RX_PHY_PPDU_END_INFO0_ERR_VHT_SIGA        = (1 << 30),
    RX_PHY_PPDU_END_INFO0_ERR_VHT_LSIG        = (1 << 31),
};

enum rx_phy_ppdu_end_info1 {
    RX_PHY_PPDU_END_INFO1_ERR_VHT_NDP            = (1 << 0),
    RX_PHY_PPDU_END_INFO1_ERR_VHT_NSYM           = (1 << 1),
    RX_PHY_PPDU_END_INFO1_ERR_VHT_RX_EXT_SYM     = (1 << 2),
    RX_PHY_PPDU_END_INFO1_ERR_VHT_RX_SKIP_ID0    = (1 << 3),
    RX_PHY_PPDU_END_INFO1_ERR_VHT_RX_SKIP_ID1_62 = (1 << 4),
    RX_PHY_PPDU_END_INFO1_ERR_VHT_RX_SKIP_ID63   = (1 << 5),
    RX_PHY_PPDU_END_INFO1_ERR_OFDM_LDPC_DECODER  = (1 << 6),
    RX_PHY_PPDU_END_INFO1_ERR_DEFER_NAP          = (1 << 7),
    RX_PHY_PPDU_END_INFO1_ERR_FDOMAIN_TIMEOUT    = (1 << 8),
    RX_PHY_PPDU_END_INFO1_ERR_LSIG_REL_CHECK     = (1 << 9),
    RX_PHY_PPDU_END_INFO1_ERR_BT_COLLISION       = (1 << 10),
    RX_PHY_PPDU_END_INFO1_ERR_MU_FEEDBACK        = (1 << 11),
    RX_PHY_PPDU_END_INFO1_ERR_TX_INTERRUPT_RX    = (1 << 12),
    RX_PHY_PPDU_END_INFO1_ERR_RX_CBF             = (1 << 13),
};
...
#define RX_PPDU_END_RX_INFO_TX_HT_VHT_ACK          (1 << 24)
#define RX_PPDU_END_RX_INFO_RX_PKT_END_VALID       (1 << 25)
#define RX_PPDU_END_RX_INFO_RX_PHY_PPDU_END_VALID  (1 << 26)
#define RX_PPDU_END_RX_INFO_RX_TIMING_OFFSET_VALID (1 << 27)
#define RX_PPDU_END_RX_INFO_BB_CAPTURED_CHANNEL    (1 << 28)
#define RX_PPDU_END_RX_INFO_UNSUPPORTED_MU_NC      (1 << 29)
#define RX_PPDU_END_RX_INFO_OTP_TXBF_DISABLE       (1 << 30)
