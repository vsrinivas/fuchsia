...
#ifndef GARNET_DRIVERS_BLUETOOTH_LIB_GAP_LOW_ENERGY_ADDRESS_MANAGER_H_
#define GARNET_DRIVERS_BLUETOOTH_LIB_GAP_LOW_ENERGY_ADDRESS_MANAGER_H_
...
#endif  // GARNET_DRIVERS_BLUETOOTH_LIB_GAP_LOW_ENERGY_ADDRESS_MANAGER_H_
