...
#ifndef GARNET_DRIVERS_BLUETOOTH_LIB_L2CAP_BASIC_MODE_TX_ENGINE_H_
#define GARNET_DRIVERS_BLUETOOTH_LIB_L2CAP_BASIC_MODE_TX_ENGINE_H_
...
class BasicModeTxEngine final : public TxEngine {
 ...
 private:
  FXL_DISALLOW_COPY_AND_ASSIGN(BasicModeTxEngine);
};
...
#endif  // GARNET_DRIVERS_BLUETOOTH_LIB_L2CAP_BASIC_MODE_TX_ENGINE_H_
