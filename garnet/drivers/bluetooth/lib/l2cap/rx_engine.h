...
#ifndef GARNET_DRIVERS_BLUETOOTH_LIB_L2CAP_RX_ENGINE_H_
#define GARNET_DRIVERS_BLUETOOTH_LIB_L2CAP_RX_ENGINE_H_
...
#endif  // GARNET_DRIVERS_BLUETOOTH_LIB_L2CAP_RX_ENGINE_H_
