...
#ifndef GARNET_DRIVERS_BLUETOOTH_LIB_SDP_SERVICE_DISCOVERER_H_
#define GARNET_DRIVERS_BLUETOOTH_LIB_SDP_SERVICE_DISCOVERER_H_
...
#endif  // GARNET_DRIVERS_BLUETOOTH_LIB_SDP_SERVICE_DISCOVERER_H_
