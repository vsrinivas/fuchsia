...
#ifndef GARNET_DRIVERS_BLUETOOTH_LIB_COMMON_IDENTIFIER_H_
#define GARNET_DRIVERS_BLUETOOTH_LIB_COMMON_IDENTIFIER_H_
...
#endif  // GARNET_DRIVERS_BLUETOOTH_LIB_COMMON_IDENTIFIER_H_
