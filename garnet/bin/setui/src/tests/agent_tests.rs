...
async fn test_sequential() {
  ...
  let completion_ack = authority.execute_lifespan(Lifespan::Initialization, service_context, true);
...
async fn test_simultaneous() {
  ...
  let completion_ack = authority.execute_lifespan(Lifespan::Initialization, service_context, false);
