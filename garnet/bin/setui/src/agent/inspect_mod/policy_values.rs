...
blueprint_definition!(
    "policy_values",
    crate::agent::inspect_mod::policy_values::PolicyValuesInspectAgent::create
);
...
mod tests {
    ...
    use crate::agent::inspect_mod::policy_values::{PolicyValuesInspectAgent, INSPECT_NODE_NAME};
