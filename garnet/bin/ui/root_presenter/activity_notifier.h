...
#ifndef GARNET_BIN_UI_ROOT_PRESENTER_ACTIVITY_NOTIFIER_H_
#define GARNET_BIN_UI_ROOT_PRESENTER_ACTIVITY_NOTIFIER_H_
...
#endif  // GARNET_BIN_UI_ROOT_PRESENTER_ACTIVITY_NOTIFIER_H_
