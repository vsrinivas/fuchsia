...
#ifndef GARNET_BIN_UI_ROOT_PRESENTER_TESTS_FAKES_FAKE_SCENIC_H_
#define GARNET_BIN_UI_ROOT_PRESENTER_TESTS_FAKES_FAKE_SCENIC_H_
...
#endif  // GARNET_BIN_UI_ROOT_PRESENTER_TESTS_FAKES_FAKE_SCENIC_H_
