...
pub const DICTIONARY: [&str; 1296] = [
    ...
    "cozy", "craft", "cramp", "crane", "crank", "crate", "crave", "crawl", "creek", "creme",
    ...
    "feast", "feed", "femur", "fence", "fend", "ferry", "feta", "fetch", "fever", "fiber", "fifth",
    "fifty", "film", "filth", "final", "finch", "fit", "five", "flag", "flaky", "flame", "flap",
    "flask", "fled", "flick", "fling", "flint", "flip", "flirt", "float", "flock", "flop", "floss",
    "flyer", "foam", "foe", "fog", "foil", "folic", "folk", "food", "fool", "found", "fox",
    "foyer", "frail", "frame", "fray", "fresh", "fried", "frill", "frisk", "from", "front",
    ...
    "think", "third", "thorn", "those", "throb", "thud", "thumb", "thump", "thus", "tiara",
