...
#ifndef GARNET_BIN_MEDIAPLAYER_DECODE_SOFTWARE_DECODER_H_
#define GARNET_BIN_MEDIAPLAYER_DECODE_SOFTWARE_DECODER_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_DECODE_SOFTWARE_DECODER_H_
