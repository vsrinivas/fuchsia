...
#ifndef GARNET_BIN_MEDIAPLAYER_TEST_FAKES_FAKE_AUDIO_H_
#define GARNET_BIN_MEDIAPLAYER_TEST_FAKES_FAKE_AUDIO_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_TEST_FAKES_FAKE_AUDIO_H_
