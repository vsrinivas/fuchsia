...
#ifndef GARNET_BIN_MEDIAPLAYER_CORE_RENDERER_SINK_SEGMENT_H_
#define GARNET_BIN_MEDIAPLAYER_CORE_RENDERER_SINK_SEGMENT_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_CORE_RENDERER_SINK_SEGMENT_H_
