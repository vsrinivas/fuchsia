...
#ifndef GARNET_BIN_MEDIAPLAYER_CORE_TEST_FAKE_AUDIO_RENDERER_H_
#define GARNET_BIN_MEDIAPLAYER_CORE_TEST_FAKE_AUDIO_RENDERER_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_CORE_TEST_FAKE_AUDIO_RENDERER_H_
