...
#ifndef GARNET_BIN_MEDIAPLAYER_DEMUX_SLIDING_BUFFER_H_
#define GARNET_BIN_MEDIAPLAYER_DEMUX_SLIDING_BUFFER_H_
...
#endif  // GARNET_BIN_MEDIAPLAYER_DEMUX_SLIDING_BUFFER_H_
