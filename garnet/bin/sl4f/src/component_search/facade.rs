...
use crate::component_search::types::{ComponentSearchRequest, ComponentSearchResult};
use anyhow::Error;
...
/// Perform Component Search operations.
///
/// Note this object is shared among all threads created by server.
///
#[derive(Debug)]
pub struct ComponentSearchFacade {}

impl ComponentSearchFacade {
    pub fn new() -> ComponentSearchFacade {
        ComponentSearchFacade {}
    }
