...
#ifndef GARNET_BIN_MEDIA_CODECS_SW_LOCAL_SINGLE_CODEC_FACTORY_H_
#define GARNET_BIN_MEDIA_CODECS_SW_LOCAL_SINGLE_CODEC_FACTORY_H_
...
#endif  // GARNET_BIN_MEDIA_CODECS_SW_LOCAL_SINGLE_CODEC_FACTORY_H_
