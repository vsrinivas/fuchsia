...
#ifndef GARNET_LIB_WLAN_COMMON_INCLUDE_WLAN_COMMON_ELEMENT_SPLITTER_H_
#define GARNET_LIB_WLAN_COMMON_INCLUDE_WLAN_COMMON_ELEMENT_SPLITTER_H_
...
class ElementSplitter {
 public:
    ...
    ElementIterator begin() const {
        return ElementIterator(buffer_);
    }
...
#endif // GARNET_LIB_WLAN_COMMON_INCLUDE_WLAN_COMMON_ELEMENT_SPLITTER_H_
