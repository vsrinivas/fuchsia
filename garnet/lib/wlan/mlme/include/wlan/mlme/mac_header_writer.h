...
#ifndef GARNET_LIB_WLAN_MLME_INCLUDE_WLAN_MLME_MAC_HEADER_WRITER_H_
#define GARNET_LIB_WLAN_MLME_INCLUDE_WLAN_MLME_MAC_HEADER_WRITER_H_
...
#endif  // GARNET_LIB_WLAN_MLME_INCLUDE_WLAN_MLME_MAC_HEADER_WRITER_H_
