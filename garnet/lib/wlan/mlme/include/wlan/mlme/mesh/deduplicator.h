...
#ifndef GARNET_LIB_WLAN_MLME_INCLUDE_WLAN_MLME_MESH_DEDUPLICATOR_H_
#define GARNET_LIB_WLAN_MLME_INCLUDE_WLAN_MLME_MESH_DEDUPLICATOR_H_
...
class DeDuplicator {
   ...
   private:
    ...
    // The unordered_set is used to cache the received packets for duplicate detection
    std::unordered_set<MacAddrSeqPair, addr_seq_hash> cache_of_received_packets_;
};

}  // namespace wlan

#endif  // GARNET_LIB_WLAN_MLME_INCLUDE_WLAN_MLME_MESH_DEDUPLICATOR_H_
