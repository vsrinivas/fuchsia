...
CodecClient::CodecClient(async::Loop* loop, thrd_t loop_thread, fidl::InterfaceHandle<fuchsia::sysmem::Allocator> sysmem)
...
void CodecClient::Stop() {
  ...
  PostToFidlThread([this, &unbind_and_loop_lambdas_done]{
    ...
    PostToFidlThread([&unbind_and_loop_lambdas_done]{
      unbind_and_loop_lambdas_done.Signal();
    }, false);
  });
