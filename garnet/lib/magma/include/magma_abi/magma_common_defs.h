...
enum {
    MAGMA_FORMAT_MODIFIER_INTEL_I915_X_TILED = 0x0100000000000001,
    MAGMA_FORMAT_MODIFIER_INTEL_I915_Y_TILED = 0x0100000000000002,
    MAGMA_FORMAT_MODIFIER_INTEL_I915_YF_TILED = 0x0100000000000003,
};
