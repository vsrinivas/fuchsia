...
VkResult VulkanShimInit() {
  ...
  vkDestroyDevice =
      reinterpret_cast<PFN_vkDestroyDevice>(vulkan_shim_get_proc_addr(instance, "vkDestroyDevice"));
  ...
  vkQueueWaitIdle =
      reinterpret_cast<PFN_vkQueueWaitIdle>(vulkan_shim_get_proc_addr(instance, "vkQueueWaitIdle"));
  ...
  vkWaitForFences =
      reinterpret_cast<PFN_vkWaitForFences>(vulkan_shim_get_proc_addr(instance, "vkWaitForFences"));
  ...
  vkSetEvent = reinterpret_cast<PFN_vkSetEvent>(vulkan_shim_get_proc_addr(instance, "vkSetEvent"));
  vkResetEvent =
  ...
  vkDestroyBuffer =
      reinterpret_cast<PFN_vkDestroyBuffer>(vulkan_shim_get_proc_addr(instance, "vkDestroyBuffer"));
  ...
  vkCreateSampler =
      reinterpret_cast<PFN_vkCreateSampler>(vulkan_shim_get_proc_addr(instance, "vkCreateSampler"));
  ...
  vkCmdSetScissor =
      reinterpret_cast<PFN_vkCmdSetScissor>(vulkan_shim_get_proc_addr(instance, "vkCmdSetScissor"));
  ...
  vkCmdCopyBuffer =
      reinterpret_cast<PFN_vkCmdCopyBuffer>(vulkan_shim_get_proc_addr(instance, "vkCmdCopyBuffer"));
  vkCmdCopyImage =
  ...
  vkCmdFillBuffer =
      reinterpret_cast<PFN_vkCmdFillBuffer>(vulkan_shim_get_proc_addr(instance, "vkCmdFillBuffer"));
  ...
  vkCmdResetEvent =
      reinterpret_cast<PFN_vkCmdResetEvent>(vulkan_shim_get_proc_addr(instance, "vkCmdResetEvent"));
  vkCmdWaitEvents =
      reinterpret_cast<PFN_vkCmdWaitEvents>(vulkan_shim_get_proc_addr(instance, "vkCmdWaitEvents"));
  vkCmdPipelineBarrier = reinterpret_cast<PFN_vkCmdPipelineBarrier>(
      vulkan_shim_get_proc_addr(instance, "vkCmdPipelineBarrier"));
  vkCmdBeginQuery =
      reinterpret_cast<PFN_vkCmdBeginQuery>(vulkan_shim_get_proc_addr(instance, "vkCmdBeginQuery"));
  vkCmdEndQuery =
  ...
  vkGetPhysicalDeviceWaylandPresentationSupportKHR =
      reinterpret_cast<PFN_vkGetPhysicalDeviceWaylandPresentationSupportKHR>(
          vulkan_shim_get_proc_addr(instance, "vkGetPhysicalDeviceWaylandPresentationSupportKHR"));
#endif
