...
#define TRACE_VTHREAD_FLOW_BEGIN(category, name, vthread_name, vthread_id, flow_id, timestamp, args...)
#define TRACE_VTHREAD_FLOW_STEP(category, name, vthread_name, vthread_id, flow_id, timestamp, args...)
#define TRACE_VTHREAD_FLOW_END(category, name, vthread_name, vthread_id, flow_id, timestamp, args...)
#endif
