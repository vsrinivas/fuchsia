...
#ifndef GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_COMMAND_BUFFER_H_
#define GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_COMMAND_BUFFER_H_
...
#endif  // GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_COMMAND_BUFFER_H_
