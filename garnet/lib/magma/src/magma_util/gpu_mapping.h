...
#ifndef GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_GPU_MAPPING_H
#define GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_GPU_MAPPING_H
...
#endif  // GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_GPU_MAPPING_H
