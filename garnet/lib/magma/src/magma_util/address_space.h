...
#ifndef GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_ADDRESS_SPACE_H_
#define GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_ADDRESS_SPACE_H_
...
#endif  // GARNET_LIB_MAGMA_SRC_MAGMA_UTIL_ADDRESS_SPACE_H_
