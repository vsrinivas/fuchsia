...
// __attribute__ ((__visibility__("default"))) async_dispatcher_t* async_get_default_dispatcher(void)
// {
//     return NULL;
// }
...
// __attribute__ ((__visibility__("default"))) void async_set_default_dispatcher(async_dispatcher_t* dispatcher)
// {}
