...
#ifndef GARNET_EXAMPLES_UI_EMBEDDER_EXAMPLE_VIEW_PROVIDER_SERVICE_H_
#define GARNET_EXAMPLES_UI_EMBEDDER_EXAMPLE_VIEW_PROVIDER_SERVICE_H_
...
#endif  // GARNET_EXAMPLES_UI_EMBEDDER_EXAMPLE_VIEW_PROVIDER_SERVICE_H_
