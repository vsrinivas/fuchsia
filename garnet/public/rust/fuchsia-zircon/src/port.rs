...
/// [port](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/objects/port.md).
///
...
/// [zx_port_packet_t](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_wait.md).
...
/// [zx_packet_user_t](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_wait.md).
#[derive(Debug, Copy, Clone)]
...
/// [zx_packet_signal_t](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_wait.md).
#[derive(Debug, Copy, Clone)]
...
impl Port {
    ...
    ///
    /// Wraps the
    /// [zx_port_create](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_create.md)
    /// syscall.
    ...
    ///
    /// Wraps the
    /// [zx_port_queue](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_queue.md)
    /// syscall.
    ...
    ///
    /// Wraps the
    /// [zx_port_wait](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_wait.md)
    /// syscall.
    ...
    ///
    /// Wraps the
    /// [zx_port_cancel](https://fuchsia.googlesource.com/fuchsia/+/master/docs/zircon/syscalls/port_cancel.md)
    /// syscall.
