...
use fidl_fuchsia_ui_gfx::{
    CircleArgs, ColorRgba, EntityNodeArgs, ImageArgs, MaterialArgs, MemoryArgs, RectangleArgs,
    ResourceArgs, RoundedRectangleArgs, ShapeNodeArgs, Value, ViewArgs2, ViewHolderArgs2,
    ViewProperties,
};
