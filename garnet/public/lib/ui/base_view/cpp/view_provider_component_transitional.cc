...
#include "garnet/public/lib/ui/base_view/cpp/view_provider_component_transitional.h"
...
ViewProviderComponentTransitional::ViewProviderComponentTransitional(
    ViewFactoryTransitional factory, async::Loop* loop, sys::ComponentContext* component_context)
...
ViewProviderComponentTransitional::ViewImpl::ViewImpl(ViewFactoryTransitional factory,
...
void ViewProviderComponentTransitional::ViewImpl::Present(
...
void ViewProviderComponentTransitional::ViewImpl::SetErrorHandler(fit::closure error_handler) {
  error_handler_ = std::move(error_handler);
}

void ViewProviderComponentTransitional::ViewImpl::OnError(zx_status_t epitaph_value) {
