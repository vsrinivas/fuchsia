...
#ifndef LIB_UI_BASE_VIEW_CPP_BASE_VIEW_TRANSITIONAL_H_
#define LIB_UI_BASE_VIEW_CPP_BASE_VIEW_TRANSITIONAL_H_
...
// Parameters for creating a BaseViewTransitional.
struct ViewContextTransitional {
...
class BaseViewTransitional : private fuchsia::ui::scenic::SessionListener,
 ...
 public:
  ...
  BaseViewTransitional(ViewContextTransitional context, const std::string& debug_name);

  BaseViewTransitional(const BaseViewTransitional&) = delete;
  ...
  // Called when an event that is not handled directly by BaseViewTransitional is received.
  // For example, BaseViewTransitional handles fuchsia::ui::gfx::ViewPropertiesChangedEvent,
...
#endif  // LIB_UI_BASE_VIEW_CPP_BASE_VIEW_TRANSITIONAL_H_
