...
inline float Length(const fuchsia::ui::gfx::vec2& v) { return sqrt(v.x * v.x + v.y * v.y); }

inline float Distance2(const fuchsia::ui::gfx::vec2& a, const fuchsia::ui::gfx::vec2& b) {
