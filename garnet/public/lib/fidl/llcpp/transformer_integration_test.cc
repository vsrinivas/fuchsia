...
#include <llcpptest/transformerintegration/test/llcpp/fidl.h>

#include "gtest/gtest.h"

namespace test = ::llcpp::llcpptest::transformerintegration::test;
...
TEST_F(TransformerIntegrationTest, UnionEvent) {
...
TEST_F(TransformerIntegrationTest, SendUnion) {
...
TEST_F(TransformerIntegrationTest, ReceiveUnion) {
  auto client = TakeClient();
