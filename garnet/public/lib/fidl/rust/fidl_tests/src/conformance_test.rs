...
#[test]
fn test_reverse_ordinal_table_old_encode() {
    let value = &mut conformance::StructOfReverseOrdinalTable {
        table: conformance::ReverseOrdinalTable {
            x: Some(170i64),
            y: Some(187i64),
            z: Some(204i64),
        },
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xcc, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0xbb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xaa, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            ,
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x73, 0x6f, 0x66, 0x74, 0x20, 0x6d, 0x69, 0x67,
            0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x20, 0x72, 0x6f, 0x63, 0x6b, 0x21, 0x00,
            0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
            0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c, 0x68, 0x61, 0x72, 0x64, 0x20, 0x74, 0x72, 0x61,
            0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x20, 0x73, 0x75, 0x63, 0x6b, 0x21,
            0x00, 0x00,
        ][..]
    );
}
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0x00, 0x00, 0x00, 0x00, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x68, 0x61,
            0x72, 0x64, 0x20, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73,
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0xa6, 0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3,
            0xb4, 0xb5, 0xb6, 0xb7, 0xb8, 0xb9, 0xba, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf, 0x05, 0x06,
            0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0x11, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0x10, 0x11, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x13, 0x14, 0x15, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x00,
            0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xaa, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xbb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
#[test]
fn test_reverse_ordinal_table_old_decode() {
    let value = &mut conformance::StructOfReverseOrdinalTable::new_empty();
    let bytes = &mut [
...
fn test_out_of_line_sandwich1_case1_old_decode() {
    ...
    let bytes = &mut [
        ...
        0x04, 0x02, 0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c, 0x05, 0x06, 0x07, 0x08, 0x68, 0x61,
        0x72, 0x64, 0x20, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x20,
        0x73, 0x75, 0x63, 0x6b, 0x21, 0x00, 0x00,
    ];
    Decoder::decode_with_context(OLD_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
...
fn test_sandwich4_align8_old_decode() {
    ...
    let bytes = &mut [
        ...
        0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5,
        0xb6, 0xb7, 0xb8, 0xb9, 0xba, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf, 0x05, 0x06, 0x07, 0x08, 0x00,
        0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10,
    ];
    Decoder::decode_with_context(OLD_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
...
fn test_sandwich4_align8_with_pointer_old_decode() {
    ...
    let bytes = &mut [
        ...
        0xa7, 0xa8, 0xa9, 0xaa, 0xab, 0xac, 0xad, 0xae, 0xaf, 0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5,
        0xb6, 0xb7, 0xb8, 0xb9, 0xba, 0xbb, 0xbc, 0xbd, 0xbe, 0xbf, 0x05, 0x06, 0x07, 0x08, 0x00,
        0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x09, 0x0a, 0x0b, 0x0c,
        0x0d, 0x0e, 0x0f, 0x10,
    ];
    Decoder::decode_with_context(OLD_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
