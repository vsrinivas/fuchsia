...
#[test]
fn test_sandwich1_case1_with_hdr_v1_encode() {
    let value = &mut conformance::Sandwich1Message {
        header: conformance::TransactionHeader {
            tx_id: 4092785136u32,
            flags: [244u8, 245u8, 246u8],
            magic_number: 247u8,
            ordinal: 18446460386757245432u64,
        },
        body: conformance::Sandwich1 {
            before: 67305985u32,
            the_union: conformance::UnionSize8Align4::Variant(202050057u32),
            after: 134678021u32,
        },
...
#[test]
fn test_sandwich4_case1_with_hdr_v1_encode() {
    let value = &mut conformance::Sandwich4Message {
        header: conformance::TransactionHeader {
            tx_id: 0u32,
            flags: [0u8, 0u8, 0u8],
            magic_number: 0u8,
...
#[test]
fn test_sandwich5_case1_with_hdr_v1_encode() {
    let value = &mut conformance::Sandwich5Message {
        header: conformance::TransactionHeader {
            tx_id: 4092785136u32,
            flags: [244u8, 245u8, 246u8],
            magic_number: 247u8,
    ...
    assert_eq!(
        *bytes,
        &[
            0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd,
            0xfe, 0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00,
...
#[test]
fn test_sandwich5_case2_with_hdr_v1_encode() {
    let value = &mut conformance::Sandwich5Message {
        header: conformance::TransactionHeader {
            tx_id: 4092785136u32,
            flags: [244u8, 245u8, 246u8],
...
#[test]
fn test_sandwich7_case1_with_hdr_v1_encode() {
    let value = &mut conformance::Sandwich7Message {
        header: conformance::TransactionHeader {
            tx_id: 4092785136u32,
            flags: [244u8, 245u8, 246u8],
            magic_number: 247u8,
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c,
            0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}
...
#[test]
fn test_sandwich7_case2_with_hdr_v1_encode() {
    let value = &mut conformance::Sandwich7Message {
        header: conformance::TransactionHeader {
            tx_id: 4092785136u32,
            flags: [244u8, 245u8, 246u8],
...
#[test]
fn test_table_no_fields_v1_encode() {
    let value = &mut conformance::StructTableNoFields { t: conformance::TableNoFields {} };
    let bytes = &mut Vec::new();
    Encoder::encode_with_context(V1_CONTEXT, bytes, &mut Vec::new(), value).unwrap();
    assert_eq!(
        *bytes,
...
#[test]
fn test_table_two_reserved_fields_v1_encode() {
    let value = &mut conformance::StructTableTwoReservedFields {
        t: conformance::TableTwoReservedFields {},
    };
    let bytes = &mut Vec::new();
    Encoder::encode_with_context(V1_CONTEXT, bytes, &mut Vec::new(), value).unwrap();
    assert_eq!(
...
#[test]
fn test_regression5_enums_v1_encode() {
    let value = &mut conformance::Regression5 {
        f1: 1u8,
        f2: 842084399u32,
        f3: 8u8,
        f4: 5653u16,
        f5: 7233733596855361117u64,
        f6: 8u8,
    };
    let bytes = &mut Vec::new();
    Encoder::encode_with_context(V1_CONTEXT, bytes, &mut Vec::new(), value).unwrap();
    assert_eq!(
        *bytes,
        &[
            0x01, 0x00, 0x00, 0x00, 0x2f, 0x30, 0x31, 0x32, 0x08, 0x00, 0x15, 0x16, 0x00, 0x00,
            0x00, 0x00, 0x5d, 0x5e, 0x5f, 0x60, 0x61, 0x62, 0x63, 0x64, 0x08, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}
...
#[test]
fn test_regression6_bits_v1_encode() {
    let value = &mut conformance::Regression6 {
        f1: 1u8,
        f2: 842084399u32,
        f3: 8u8,
        f4: 5653u16,
...
#[test]
fn test_regression7_table_union_x_union_v1_encode() {
    let value = &mut conformance::Regression7TableUnionXUnion {
        value: conformance::TableOfUnionThenXUnionThenTableThenXUnionThenUnion {
            member: Some(conformance::UnionOfXUnionThenTableThenXUnionThenUnion::Variant(
                conformance::XUnionOfTableThenXUnionThenUnion::Variant(
                    conformance::TableOfXUnionThenUnion {
                        member: Some(conformance::XUnionOfUnion::Variant(
                            conformance::UnionAtTheBottom::Tiny(8u8),
                        )),
                    },
                ),
            )),
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            ,
        ][..]
    );
}
...
#[test]
fn test_regression8_opt_union_size12_aligned4_v1_encode() {
    let value = &mut conformance::Regression8OptUnionSize12Align4 {
        opt_union1: Some(Box::new(conformance::UnionSize12Align4::Variant([
            161u8, 162u8, 163u8, 164u8, 165u8, 166u8,
        ]))),
        opt_union3: Some(Box::new(conformance::UnionSize12Align4::Variant([
            177u8, 178u8, 179u8, 180u8, 181u8, 182u8,
        ]))),
        opt_union2: None,
    };
    let bytes = &mut Vec::new();
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0x00, 0x00, 0xb1, 0xb2, 0xb3, 0xb4,
            0xb5, 0xb6, 0x00, 0x00,
        ][..]
    );
}
...
#[test]
fn test_regression8_vector_of_opt_union_size12_aligned4_v1_encode() {
    let value = &mut conformance::Regression8VectorOfOptUnionSize12Align4 {
        value: vec![
            None,
            Some(Box::new(conformance::UnionSize12Align4::Variant([
                161u8, 162u8, 163u8, 164u8, 165u8, 166u8,
            ]))),
            None,
            Some(Box::new(conformance::UnionSize12Align4::Variant([
...
#[test]
fn test_regression8_table_with_union_size12_aligned4_v1_encode() {
    let value = &mut conformance::Regression8TableWithUnionSize12Align4 {
        value: conformance::TableWithUnionSize12Align4 {
            before: Some(170u8),
            member: Some(conformance::UnionSize12Align4::Variant([
                177u8, 178u8, 179u8, 180u8, 181u8, 182u8,
            ])),
            after: Some(187u8),
        },
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xaa, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0x00, 0x00, 0xbb, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}
...
#[test]
fn test_regression9_response_v1_encode() {
    let value = &mut conformance::Regression9Message {
        header: conformance::TransactionHeader {
            tx_id: 1u32,
            flags: [1u8, 0u8, 0u8],
            magic_number: 1u8,
            ordinal: 6254313960342814720u64,
        },
        body: conformance::Regression9Result::Ok(conformance::Regression9Value {
            u: conformance::StringBoolUnion::S(String::from("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")),
            nullable_u: Some(Box::new(conformance::StringBoolUnion::B(false))),
        }),
    };
    let bytes = &mut Vec::new();
    Encoder::encode_with_context(V1_CONTEXT, bytes, &mut Vec::new(), value).unwrap();
    assert_eq!(
        *bytes,
        &[
            ...
            0xcb, 0x56, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x68, 0x00, 0x00, 0x00,
            ...
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
            0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
            0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}
...
#[test]
fn test_string_union_struct_wrapper_response_v1_encode() {
    let value = &mut conformance::StringUnionStructWrapperResponse {
        header: conformance::TransactionHeader {
            tx_id: 0u32,
            flags: [1u8, 0u8, 0u8],
            magic_number: 1u8,
            ordinal: 3647970832665280512u64,
        },
        body: conformance::StringUnionStructWrapper {
            sus: conformance::StringUnionStruct {
                u: conformance::StringBoolUnion::S(String::from("hello")),
                nullable_u: Some(Box::new(conformance::StringBoolUnion::B(true))),
            },
        },
    };
    let bytes = &mut Vec::new();
...
#[test]
fn test_regression_no_union_launcher_create_component_request_v1_encode() {
...
#[test]
fn test_compat_table_v1_encode() {
    let value = &mut conformance::CompatTable {
        value: conformance::CompatTableValue {
            union_member: Some(conformance::CompatUnion::B(true)),
            array_member: Some([1361667997u32, 2492576910u32, 2480020305u32]),
            table_member: Some(conformance::CompatTableString { s: Some(String::from("AB")) }),
            xunion_member: Some(conformance::CompatXUnion::S(String::from("CD"))),
        },
        empty: String::from(""),
    };
    let bytes = &mut Vec::new();
    ...
    assert_eq!(
        *bytes,
        &[
            ...
            0xff, 0xff, 0xff, 0xff, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x30, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x02, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x9d, 0x67, 0x29, 0x51, 0x8e, 0xb4, 0x91, 0x94, 0x51, 0x1b, 0xd2, 0x93,
            ...
            0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x41, 0x42, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0xa8, 0xef, 0xf8, 0x5a, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
            0xff, 0xff, 0x43, 0x44, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ][..]
    );
}

#[test]
fn test_mixed_fields_v1_encode() {
    let value = &mut conformance::MixedFieldsMessage {
        header: conformance::TransactionHeader {
            tx_id: 4092785136u32,
            flags: [244u8, 245u8, 246u8],
            magic_number: 247u8,
        ...
        body: conformance::MixedFieldsBody {
            before: 67305985u32,
            first_union: conformance::UnionSize8Align4::Variant(202050057u32),
            middle_start: 2826u16,
            middle_end: 72623859790382856u64,
            second_union: conformance::UnionSize8Align4::Variant(3232800912u32),
            after: 134678021u32,
        },
    };
    let bytes = &mut Vec::new();
...
#[test]
fn test_table_with_x_union_v1_encode() {
    let value = &mut conformance::StructOfTableWithXUnion {
        value: conformance::TableWithXUnion {
            member: Some(conformance::CompatXUnion::S(String::from("AB"))),
        },
    };
    let bytes = &mut Vec::new();
    Encoder::encode_with_context(V1_CONTEXT, bytes, &mut Vec::new(), value).unwrap();
...
#[test]
fn test_sandwich1_case1_with_hdr_v1_decode() {
    let value = &mut conformance::Sandwich1Message::new_empty();
    let bytes = &mut [
        0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
        0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c,
        0x00, 0x00, 0x00, 0x00,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
        conformance::Sandwich1Message {
            header: conformance::TransactionHeader {
                tx_id: 4092785136u32,
                flags: [244u8, 245u8, 246u8],
                magic_number: 247u8,
...
#[test]
fn test_sandwich4_case1_with_hdr_v1_decode() {
    let value = &mut conformance::Sandwich4Message::new_empty();
    let bytes = &mut [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
#[test]
fn test_sandwich5_case1_with_hdr_v1_decode() {
    let value = &mut conformance::Sandwich5Message::new_empty();
    let bytes = &mut [
        0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
...
#[test]
fn test_sandwich5_case2_with_hdr_v1_decode() {
    let value = &mut conformance::Sandwich5Message::new_empty();
    let bytes = &mut [
        0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
        0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0x05, 0x06, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xa0, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0xa7, 0xa8, 0xa9,
...
#[test]
fn test_sandwich7_case1_with_hdr_v1_decode() {
    let value = &mut conformance::Sandwich7Message::new_empty();
    let bytes = &mut [
        0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
...
#[test]
fn test_sandwich7_case2_with_hdr_v1_decode() {
    let value = &mut conformance::Sandwich7Message::new_empty();
    let bytes = &mut [
        0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
        0xff, 0x11, 0x12, 0x13, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x21, 0x22, 0x23, 0x24, 0x00, 0x00, 0x00, 0x00,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
...
#[test]
fn test_table_no_fields_v1_decode() {
    let value = &mut conformance::StructTableNoFields::new_empty();
    let bytes = &mut [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(*value, conformance::StructTableNoFields { t: conformance::TableNoFields {} });
}

#[test]
fn test_table_two_reserved_fields_v1_decode() {
    let value = &mut conformance::StructTableTwoReservedFields::new_empty();
    let bytes = &mut [
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff,
    ];
    ...
    assert_eq!(
        *value,
        conformance::StructTableTwoReservedFields { t: conformance::TableTwoReservedFields {} }
    );
}
...
#[test]
fn test_regression5_enums_v1_decode() {
    let value = &mut conformance::Regression5::new_empty();
    let bytes = &mut [
        0x01, 0x00, 0x00, 0x00, 0x2f, 0x30, 0x31, 0x32, 0x08, 0x00, 0x15, 0x16, 0x00, 0x00, 0x00,
        0x00, 0x5d, 0x5e, 0x5f, 0x60, 0x61, 0x62, 0x63, 0x64, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
        conformance::Regression5 {
            f1: 1u8,
            f2: 842084399u32,
            f3: 8u8,
            f4: 5653u16,
...
#[test]
fn test_regression6_bits_v1_decode() {
    let value = &mut conformance::Regression6::new_empty();
    let bytes = &mut [
        0x01, 0x00, 0x00, 0x00, 0x2f, 0x30, 0x31, 0x32, 0x08, 0x00, 0x15, 0x16, 0x00, 0x00, 0x00,
        0x00, 0x5d, 0x5e, 0x5f, 0x60, 0x61, 0x62, 0x63, 0x64, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00,
...
#[test]
fn test_regression7_table_union_x_union_v1_decode() {
    let value = &mut conformance::Regression7TableUnionXUnion::new_empty();
    let bytes = &mut [
        0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    assert_eq!(
        *value,
        conformance::Regression7TableUnionXUnion {
            value: conformance::TableOfUnionThenXUnionThenTableThenXUnionThenUnion {
                member: Some(conformance::UnionOfXUnionThenTableThenXUnionThenUnion::Variant(
                    conformance::XUnionOfTableThenXUnionThenUnion::Variant(
                        conformance::TableOfXUnionThenUnion {
...
#[test]
fn test_regression8_opt_union_size12_aligned4_v1_decode() {
    let value = &mut conformance::Regression8OptUnionSize12Align4::new_empty();
    let bytes = &mut [
    ...
    assert_eq!(
        *value,
        conformance::Regression8OptUnionSize12Align4 {
            opt_union1: Some(Box::new(conformance::UnionSize12Align4::Variant([
                161u8, 162u8, 163u8, 164u8, 165u8, 166u8
            ]))),
            opt_union3: Some(Box::new(conformance::UnionSize12Align4::Variant([
...
#[test]
fn test_regression8_vector_of_opt_union_size12_aligned4_v1_decode() {
    let value = &mut conformance::Regression8VectorOfOptUnionSize12Align4::new_empty();
    let bytes = &mut [
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0xa1, 0xa2, 0xa3, 0xa4, 0xa5, 0xa6, 0x00, 0x00, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6,
        0x00, 0x00,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
        conformance::Regression8VectorOfOptUnionSize12Align4 {
            value: vec![
                None,
                Some(Box::new(conformance::UnionSize12Align4::Variant([
                    161u8, 162u8, 163u8, 164u8, 165u8, 166u8
...
#[test]
fn test_regression8_table_with_union_size12_aligned4_v1_decode() {
    let value = &mut conformance::Regression8TableWithUnionSize12Align4::new_empty();
    let bytes = &mut [
        0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    assert_eq!(
        *value,
        conformance::Regression8TableWithUnionSize12Align4 {
            value: conformance::TableWithUnionSize12Align4 {
                before: Some(170u8),
                member: Some(conformance::UnionSize12Align4::Variant([
                    177u8, 178u8, 179u8, 180u8, 181u8, 182u8
...
#[test]
fn test_regression9_response_v1_decode() {
    let value = &mut conformance::Regression9Message::new_empty();
    let bytes = &mut [
    ...
    assert_eq!(
        *value,
        conformance::Regression9Message {
            header: conformance::TransactionHeader {
                tx_id: 1u32,
                flags: [1u8, 0u8, 0u8],
                magic_number: 1u8,
            ...
            body: conformance::Regression9Result::Ok(conformance::Regression9Value {
                u: conformance::StringBoolUnion::S(String::from(
...
#[test]
fn test_string_union_struct_wrapper_response_v1_decode() {
    let value = &mut conformance::StringUnionStructWrapperResponse::new_empty();
    let bytes = &mut [
        0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x25, 0x32, 0xa0,
        0x32, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x02, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0xff, 0xff, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x00, 0x00, 0x00, 0x01, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
        conformance::StringUnionStructWrapperResponse {
            header: conformance::TransactionHeader {
                tx_id: 0u32,
                flags: [1u8, 0u8, 0u8],
                magic_number: 1u8,
...
#[test]
fn test_regression_no_union_launcher_create_component_request_v1_decode() {
...
#[test]
fn test_compat_table_v1_decode() {
    let value = &mut conformance::CompatTable::new_empty();
    let bytes = &mut [
        0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
#[test]
fn test_mixed_fields_v1_decode() {
    let value = &mut conformance::MixedFieldsMessage::new_empty();
    let bytes = &mut [
        0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xfe,
        0xff, 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xff, 0x0a, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x07, 0x06, 0x05,
        0x04, 0x03, 0x02, 0x01, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x05, 0x06,
        0x07, 0x08, 0x00, 0x00, 0x00, 0x00, 0x09, 0x0a, 0x0b, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x90,
        0xa0, 0xb0, 0xc0, 0x00, 0x00, 0x00, 0x00,
    ];
    Decoder::decode_with_context(V1_CONTEXT, bytes, &mut [], value).unwrap();
    assert_eq!(
        *value,
        conformance::MixedFieldsMessage {
            header: conformance::TransactionHeader {
                tx_id: 4092785136u32,
                flags: [244u8, 245u8, 246u8],
                magic_number: 247u8,
...
#[test]
fn test_table_with_x_union_v1_decode() {
    let value = &mut conformance::StructOfTableWithXUnion::new_empty();
    let bytes = &mut [
        0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        0xff, 0xff, 0xa8, 0xef, 0xf8, 0x5a, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x02, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x41, 0x42, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00,
    ];
    ...
    assert_eq!(
        *value,
        conformance::StructOfTableWithXUnion {
            value: conformance::TableWithXUnion {
                member: Some(conformance::CompatXUnion::S(String::from("AB")))
            }
        }
